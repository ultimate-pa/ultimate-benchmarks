...
modifies ;
{
  ...
  loc2_0:
    ...
    assume v_rep_select_ULTIMATE.start_main_~a~4_ULTIMATE.start_main_~x~4__1 <= main_~max~4 || !(v_rep_select_ULTIMATE.start_main_~a~4_ULTIMATE.start_main_~x~4__1 <= main_~max~4);
    __VERIFIER_assert_#in~cond := (if v_rep_select_ULTIMATE.start_main_~a~4_ULTIMATE.start_main_~x~4__1 <= main_~max~4 then 1 else 0);
