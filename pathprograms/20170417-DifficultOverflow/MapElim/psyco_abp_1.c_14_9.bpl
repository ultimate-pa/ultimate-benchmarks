...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~nondet0, main_#t~nondet30, main_#t~nondet32, main_#t~nondet4, main_#t~nondet11, main_#t~nondet34, main_#t~nondet2, main_#t~nondet13, main_#t~nondet36, main_~P8~4, main_#t~nondet8, main_#t~nondet6, main_~P9~4, main_#t~nondet27, main_#t~nondet29, main_~this_buffer_empty~3, main_#t~nondet20, main_#t~nondet22, main_~method_id~3, main_~q~3, main_#t~nondet15, main_#t~nondet38, main_#t~nondet17, main_#t~nondet19, main_~P3~4, main_~this_expect~3, main_#t~nondet1, main_#t~short41, main_#t~nondet10, main_#t~nondet31, main_#t~nondet5, main_#t~nondet12, main_#t~nondet33, main_#t~nondet3, main_#t~nondet14, main_#t~nondet35, main_#t~nondet9, main_~P4~4, main_#t~nondet7, main_~P2~4, main_#t~nondet26, main_#t~nondet28, main_~P5~4, main_~P1~4, main_#t~nondet21, main_#t~nondet40, main_#t~nondet23, main_~P6~4, main_#t~nondet25, main_~P7~4, main_#t~nondet16, main_#t~short24, main_#t~nondet37, main_#t~nondet18, main_#t~nondet39;
    main_~q~3 := 0;
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume main_~this_expect~3 <= 2147483646;
    assume 0 <= main_~this_expect~3 + 2147483649;
    main_~this_expect~3 := main_~this_expect~3 + 1;
    assume 0 <= main_~this_buffer_empty~3 + 2147483646;
    assume main_~this_buffer_empty~3 <= 2147483649;
  ...
  loc5_0:
    ...
    assume main_~P1~4 == 0;
    main_~method_id~3 := 3;
    assume !(main_~this_buffer_empty~3 == 1);
    main_#t~short24 := false;
    assume !main_#t~short24;
    assume main_~this_expect~3 <= 2147483648;
    assume 0 <= main_~this_expect~3 + 2147483647;
    assume ((main_~this_expect~3 < 1 && !((main_~this_expect~3 + 1) % 2 == 0)) && main_~P3~4 == (main_~this_expect~3 + 1) % 2 - 2) || ((!(main_~this_expect~3 < 1) || (main_~this_expect~3 + 1) % 2 == 0) && main_~P3~4 == (main_~this_expect~3 + 1) % 2);
    main_#t~short24 := false;
    assume !main_#t~short24;
    havoc main_#t~short24;
    main_~q~3 := 4;
  ...
  loc7_0:
    ...
    assume 0 <= main_#t~nondet32 + 2147483648 && main_#t~nondet32 <= 2147483647;
    assume !(main_#t~nondet32 == 0);
    havoc main_#t~nondet32;
    assume (if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == 1;
    main_~method_id~3 := 5;
    assume main_~this_buffer_empty~3 == 1 && (if main_~P6~4 < 0 && !(main_~P6~4 % 2 == 0) then main_~P6~4 % 2 - 2 else main_~P6~4 % 2) == (if main_~this_expect~3 < 0 && !(main_~this_expect~3 % 2 == 0) then main_~this_expect~3 % 2 - 2 else main_~this_expect~3 % 2);
    main_~q~3 := 5;
    assume main_~this_expect~3 <= 2147483646;
    assume 0 <= main_~this_expect~3 + 2147483649;
    main_~this_expect~3 := main_~this_expect~3 + 1;
  ...
  loc7_1:
    ...
    assume 0 <= main_#t~nondet37 + 2147483648 && main_#t~nondet37 <= 2147483647;
    assume main_#t~nondet37 == 0;
    havoc main_#t~nondet37;
    assume main_#t~nondet38 <= 2147483647 && 0 <= main_#t~nondet38 + 2147483648;
    assume main_#t~nondet38 == 0;
    havoc main_#t~nondet38;
    assume main_#t~nondet39 <= 2147483647 && 0 <= main_#t~nondet39 + 2147483648;
    assume main_#t~nondet39 == 0;
    havoc main_#t~nondet39;
    assume 0 <= main_#t~nondet40 + 2147483648 && main_#t~nondet40 <= 2147483647;
    assume !(main_#t~nondet40 == 0);
    havoc main_#t~nondet40;
    assume main_~P1~4 == 1;
    main_~method_id~3 := 7;
    assume !(main_~this_buffer_empty~3 == 1);
    main_#t~short41 := false;
    assume !main_#t~short41;
    assume main_~this_expect~3 <= 2147483648;
    assume 0 <= main_~this_expect~3 + 2147483647;
    assume ((main_~this_expect~3 < 1 && !((main_~this_expect~3 + 1) % 2 == 0)) && main_~P9~4 == (main_~this_expect~3 + 1) % 2 - 2) || ((!(main_~this_expect~3 < 1) || (main_~this_expect~3 + 1) % 2 == 0) && main_~P9~4 == (main_~this_expect~3 + 1) % 2);
    main_#t~short41 := false;
    assume !main_#t~short41;
    havoc main_#t~short41;
    main_~q~3 := 1;
    main_~this_expect~3 := main_~this_expect~3;
    assume 0 <= main_~this_buffer_empty~3 + 2147483646;
    assume main_~this_buffer_empty~3 <= 2147483649;
