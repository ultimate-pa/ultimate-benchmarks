...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_1:
    ...
    havoc main_#t~mem4;
    assume main_~c~5 % 256 <= 57 && 48 <= main_~c~5 % 256;
    main_~j~5 := main_~c~5 % 256 - 48;
    assume (10 * main_~i~5 + main_~j~5) % 4294967296 <= 2147483647 || !((10 * main_~i~5 + main_~j~5) % 4294967296 <= 2147483647);
    main_~i~5 := (if (main_~j~5 + 10 * main_~i~5) % 4294967296 <= 2147483647 then (main_~j~5 + 10 * main_~i~5) % 4294967296 else (main_~j~5 + 10 * main_~i~5) % 4294967296 - 4294967296);
    main_#t~post5 := main_~idx_in~5;
