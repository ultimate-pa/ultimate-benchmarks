...
modifies ;
{
  ...
  loc2_0:
    ...
    assume 0 <= main_~buf~5 || !(0 <= main_~buf~5);
    __VERIFIER_assert_#in~cond := (if 0 <= main_~buf~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
    assume main_~buf~5 < main_~bufferlen~5 || !(main_~buf~5 < main_~bufferlen~5);
    __VERIFIER_assert_#in~cond := (if main_~buf~5 < main_~bufferlen~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
    ...
    havoc main_#t~post4;
    assume 0 <= main_~in~5 || !(0 <= main_~in~5);
    __VERIFIER_assert_#in~cond := (if 0 <= main_~in~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
    assume main_~in~5 < main_~inlen~5 || !(main_~in~5 < main_~inlen~5);
    __VERIFIER_assert_#in~cond := (if main_~in~5 < main_~inlen~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
    goto loc1;
