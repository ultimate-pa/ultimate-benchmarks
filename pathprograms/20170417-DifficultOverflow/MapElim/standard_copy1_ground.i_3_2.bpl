...
modifies ;
{
  ...
  loc2_1:
    ...
    assume v_rep_select_ULTIMATE.start_main_~a1~4_ULTIMATE.start_main_~x~4__1 == v_rep_select_ULTIMATE.start_main_~a2~4_ULTIMATE.start_main_~x~4__1 || !(v_rep_select_ULTIMATE.start_main_~a1~4_ULTIMATE.start_main_~x~4__1 == v_rep_select_ULTIMATE.start_main_~a2~4_ULTIMATE.start_main_~x~4__1);
    __VERIFIER_assert_#in~cond := (if v_rep_select_ULTIMATE.start_main_~a1~4_ULTIMATE.start_main_~x~4__1 == v_rep_select_ULTIMATE.start_main_~a2~4_ULTIMATE.start_main_~x~4__1 then 1 else 0);
