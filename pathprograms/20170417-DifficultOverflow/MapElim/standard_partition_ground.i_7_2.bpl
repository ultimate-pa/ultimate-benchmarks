...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_~c~4, main_~a~4, v_rep_select_ULTIMATE.start_main_~aa~4_ULTIMATE.start_main_~a~4__1, main_~b~4, main_~x~4, main_#t~post1, main_#t~post0, v_rep_select_ULTIMATE.start_main_~bb~4_ULTIMATE.start_main_~b~4__1;
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume main_~b~4 <= 2147483646;
    assume 0 <= main_~b~4 + 2147483649;
