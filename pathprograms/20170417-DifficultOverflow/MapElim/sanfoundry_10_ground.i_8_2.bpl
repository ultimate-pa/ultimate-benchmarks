...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_~n~4, main_~element~4, main_~found~4, main_~x~9, main_#t~post2, main_#t~post1, main_#t~post0, main_~i~4, main_~pos~4, v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~i~4__1;
