...
modifies ;
{
  ...
  loc1:
    ...
    assume main_~i~5 <= 2147483646;
    assume 0 <= main_~i~5 + 2147483649;
    assume main_~i~5 + 1 < main_~len~5 || !(main_~i~5 + 1 < main_~len~5);
    __VERIFIER_assert_#in~cond := (if main_~i~5 + 1 < main_~len~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
    assume 0 <= main_~i~5 || !(0 <= main_~i~5);
    __VERIFIER_assert_#in~cond := (if 0 <= main_~i~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
  ...
  loc2_0:
    ...
    assume main_~i~5 < main_~len~5 || !(main_~i~5 < main_~len~5);
    __VERIFIER_assert_#in~cond := (if main_~i~5 < main_~len~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
    assume 0 <= main_~i~5 || !(0 <= main_~i~5);
    ...
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
    assume main_~j~5 < main_~bufsize~5 || !(main_~j~5 < main_~bufsize~5);
    __VERIFIER_assert_#in~cond := (if main_~j~5 < main_~bufsize~5 then 1 else 0);
    havoc __VERIFIER_assert_~cond;
    __VERIFIER_assert_~cond := __VERIFIER_assert_#in~cond;
    assume !(__VERIFIER_assert_~cond == 0);
