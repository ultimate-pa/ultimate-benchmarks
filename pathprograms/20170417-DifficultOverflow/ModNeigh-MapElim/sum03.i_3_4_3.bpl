...
modifies ;
{
  ...
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume main_~x~5 < 10 && 0 <= main_~x~5;
    goto loc2;
  loc1_1:
    assume main_~x~5 + 4294967286 < 0 && 0 <= main_~x~5 + 4294967296;
    goto loc2;
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    ...
    havoc main_#t~post2;
    assume (((2 * main_~x~5 + 4294967296 < 0 && !(main_~sn~5 == 0)) && !(main_~sn~5 == 2 * main_~x~5 % 4294967296)) && main_~sn~5 < 4294967296) && 0 <= main_~sn~5;
