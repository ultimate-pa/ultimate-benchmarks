...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~nondet0, main_~n~5, main_#t~post3, main_#t~post2, main_#t~post1, main_~k~5, main_~j~5, main_~i~5;
    havoc main_~n~5;
    havoc main_~i~5;
    havoc main_~k~5;
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume main_~i~5 <= 2147483645;
    assume 0 <= main_~i~5 + 2147483650;
