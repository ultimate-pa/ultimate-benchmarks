...
modifies ~a12, ~a16, ~a15, ~a18;
{
  ...
  loc54_0:
    assume (((~a15 == 3 && ~a12 == 5) && calculate_output_~input == 1) && 0 < ~a18 + 79) && ~a16 == 11;
  ...
  loc54_1:
    ...
    assume ((((0 < ~a18 + 156 && ~a16 == 11) && ~a15 == 3) && ~a12 == 5) && ~a18 + 79 <= 0) && calculate_output_~input == 4;
