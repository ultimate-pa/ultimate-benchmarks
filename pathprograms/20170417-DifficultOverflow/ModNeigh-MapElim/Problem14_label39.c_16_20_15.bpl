...
modifies ~a24, ~a12, ~a21, ~a15;
{
  ...
  loc81_0:
    assume (((~a12 + 43 <= 0 && ~a21 == 7) && calculate_output_~input == 5) && ~a24 == 1) && ~a15 == 8;
    ~a21 := 10;
  ...
  loc83_0:
    ...
    assume (!(~a21 == 7) && !(~a21 == 6)) && !(~a21 == 8);
    assume !(~a12 + 43 <= 0);
    assume ((((~a24 == 1 && ~a15 == 8) && calculate_output_~input == 2) && ~a21 == 9) && 0 < ~a12 + 43) && ~a12 <= 11;
    ...
    goto loc82;
  loc83_1:
    assume ((((~a24 == 1 && 0 < ~a12 + 43) && ~a21 == 7) && ~a15 == 8) && calculate_output_~input == 1) && ~a12 <= 11;
    ~a21 := 9;
