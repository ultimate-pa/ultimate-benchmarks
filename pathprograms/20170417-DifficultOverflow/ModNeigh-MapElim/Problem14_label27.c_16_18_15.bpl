...
modifies ~a24, ~a12, ~a21, ~a15;
{
  ...
  loc54_0:
    ...
    goto loc55;
  loc54_1:
    assume (((calculate_output_~input == 3 && ~a15 == 8) && ~a21 == 8) && ~a24 == 1) && 80 < ~a12;
  ...
  loc77_1:
    ...
    goto loc78;
  loc77_2:
    assume (((~a24 == 1 && ~a21 == 10) && ~a12 + 43 <= 0) && calculate_output_~input == 6) && ~a15 == 8;
    assume ~a12 % 26 < 1;
    ~a12 := ((~a12 % 26 + -1) / 5 + 1) / 5;
    ~a21 := 7;
  ...
  loc78_0:
    assume (((calculate_output_~input == 5 && ~a21 == 7) && ~a24 == 1) && ~a15 == 8) && ~a12 + 43 <= 0;
    ~a21 := 10;
  ...
  loc83_0:
    assume ((((~a24 == 1 && ~a12 <= 11) && 0 < ~a12 + 43) && calculate_output_~input == 1) && ~a21 == 7) && ~a15 == 8;
    ~a21 := 9;
  ...
  loc83_1:
    ...
    assume (!(~a21 == 7) && !(~a21 == 6)) && !(~a21 == 8);
    assume !(~a12 + 43 <= 0);
    assume ((((~a12 <= 11 && ~a24 == 1) && 0 < ~a12 + 43) && calculate_output_~input == 2) && ~a21 == 9) && ~a15 == 8;
