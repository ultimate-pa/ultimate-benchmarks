...
implementation main() returns (#res : int){
  ...
  loc8_0:
    ...
    ~method_id~3 := 7;
    #t~short41 := (~this_buffer_empty~3 == 1 && ~P9~4 != 0) && ~P9~4 != 0 && !(~P9~4 != 1 && ~P9~4 != 0);
    assume !#t~short41;
    assume ~this_expect~3 - 1 <= 2147483647;
    assume ~this_expect~3 - 1 >= -2147483648;
    #t~short41 := ((~P9~4 != (if ~this_expect~3 - 1 < 0 && (~this_expect~3 - 1) % 2 != 0 then (~this_expect~3 - 1) % 2 - 2 else (~this_expect~3 - 1) % 2) && ~this_buffer_empty~3 != 1) && ~P9~4 != 0) && ~P9~4 != 0 && !(~P9~4 != 1 && ~P9~4 != 0);
    assume !#t~short41;
    havoc #t~short41;
    ~q~3 := 1;
    ~this_expect~3 := ~this_expect~3;
