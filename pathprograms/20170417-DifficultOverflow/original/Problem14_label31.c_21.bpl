...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc9_0:
    ...
    assume (if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039 <= 2147483647;
    assume (if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039 >= -2147483648;
    assume ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) * 1 <= 2147483647;
    assume ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) * 1 >= -2147483648;
    assume ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) * 1 * 1 <= 2147483647;
    assume ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) * 1 * 1 >= -2147483648;
  ...
  loc10_0:
    ...
    assume ~a12 - -61 <= 2147483647;
    assume ~a12 - -61 >= -2147483648;
    assume ~a12 - -61 - -3 <= 2147483647;
    assume ~a12 - -61 - -3 >= -2147483648;
    assume ~a12 - -61 - -3 - -1 <= 2147483647;
    assume ~a12 - -61 - -3 - -1 >= -2147483648;
    ~a12 := ~a12 - -61 - -3 - -1;
    ~a21 := 8;
    #res := 26;
    goto loc5;
  loc10_1:
    ...
    assume ~a12 * 68 <= 2147483647;
    assume ~a12 * 68 >= -2147483648;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) <= 2147483647;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) >= -2147483648;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) * 5 <= 2147483647;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) * 5 >= -2147483648;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) * 5 + -454858 <= 2147483647;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) * 5 + -454858 >= -2147483648;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) * 5 + -454858 + 972700 <= 2147483647;
    assume (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) * 5 + -454858 + 972700 >= -2147483648;
    ~a12 := (if ~a12 * 68 < 0 && ~a12 * 68 % 10 != 0 then ~a12 * 68 / 10 + 1 else ~a12 * 68 / 10) * 5 + -454858 + 972700;
    ~a21 := 6;
    #res := 25;
    goto loc5;
}
