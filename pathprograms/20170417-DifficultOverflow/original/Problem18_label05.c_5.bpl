...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc5_0:
    ...
    assume (if ~a3 + 0 < 0 && (~a3 + 0) % 95 != 0 then (~a3 + 0) % 95 - 95 else (~a3 + 0) % 95) + 211 <= 2147483647;
    assume (if ~a3 + 0 < 0 && (~a3 + 0) % 95 != 0 then (~a3 + 0) % 95 - 95 else (~a3 + 0) % 95) + 211 >= -2147483648;
    assume (if ~a3 + 0 < 0 && (~a3 + 0) % 95 != 0 then (~a3 + 0) % 95 - 95 else (~a3 + 0) % 95) + 211 - 1 <= 2147483647;
    assume (if ~a3 + 0 < 0 && (~a3 + 0) % 95 != 0 then (~a3 + 0) % 95 - 95 else (~a3 + 0) % 95) + 211 - 1 >= -2147483648;
