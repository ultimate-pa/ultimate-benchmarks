...
modifies ~__CS_round, ~__CS_thread.offset, ~__THREAD_UNUSED, ~flag1, ~flag2, ~x, ~__CS_thread.base, ~__CS_thread_status, #NULL.offset, ~__CS_thread_index, #NULL.base, ~__THREAD_FINISHED, ~__CS_thread_lockedon.offset, ~__CS_ret_ERROR, ~__CS_error, #valid, ~__CS_ret_PREEMPTED, ~__CS_thread_lockedon.base, ~__THREAD_RUNNING, ~turn, ~__CS_thread_allocated, ~__CS_thread_born_round, ~__CS_ret;
{
  ...
  loc2_0:
    assume main_~j~28 < 3;
    main_~__CS_cp___CS_thread_status~28 := main_~__CS_cp___CS_thread_status~28[main_~i~28 := main_~__CS_cp___CS_thread_status~28[main_~i~28][main_~j~28 := main_#t~nondet21]];
    havoc main_#t~nondet21;
    main_~__CS_cp___CS_thread_lockedon~28.base, main_~__CS_cp___CS_thread_lockedon~28.offset := main_~__CS_cp___CS_thread_lockedon~28.base[main_~i~28 := main_~__CS_cp___CS_thread_lockedon~28.base[main_~i~28][main_~j~28 := main_#t~nondet22.base]], main_~__CS_cp___CS_thread_lockedon~28.offset[main_~i~28 := main_~__CS_cp___CS_thread_lockedon~28.offset[main_~i~28][main_~j~28 := main_#t~nondet22.offset]];
