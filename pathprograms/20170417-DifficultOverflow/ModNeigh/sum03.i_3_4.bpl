...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume -4294967296 <= main_~x~5 && main_~x~5 + 4294967286 < 0;
    goto loc3;
  loc2_1:
  ...
  loc3_1:
    ...
    havoc main_#t~post2;
    assume (((!(main_~sn~5 == 0) && !(main_~sn~5 == 2 * main_~x~5 % 4294967296)) && main_~sn~5 < 4294967296) && 0 <= main_~sn~5) && 2 * main_~x~5 < -4294967296;
