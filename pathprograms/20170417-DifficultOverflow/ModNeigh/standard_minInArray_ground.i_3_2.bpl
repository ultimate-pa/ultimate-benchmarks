...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_~a~4, main_~min~4, main_~x~4, main_#t~post0, main_~i~4;
    havoc main_~a~4;
    main_~min~4 := 0;
    main_~i~4 := 0;
    goto loc1;
  ...
  loc2_0:
    ...
    assume main_~a~4[main_~i~4] < main_~min~4;
    main_~min~4 := main_~a~4[main_~i~4];
  ...
  loc2_1:
    ...
    assume !(main_~min~4 < main_~a~4[main_~x~4]);
