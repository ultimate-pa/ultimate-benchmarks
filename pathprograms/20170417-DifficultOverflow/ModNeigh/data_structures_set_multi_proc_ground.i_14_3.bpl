...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    #valid := #valid[0 := 0];
    havoc main_#res;
    havoc main_#t~post10, main_~n~7, main_#t~mem12, main_#t~mem13, main_#t~post11, main_~x~7, main_~values~7, main_#t~post3, main_#t~post7, main_#t~post4, main_~#set~7.base, main_~y~7, main_~v~7, main_#t~ret9, main_#t~ret8, main_~#set~7.offset, main_#t~mem6, main_#t~mem5;
    main_~n~7 := 0;
  ...
  loc3_0:
    ...
    elem_exists_#t~post1 := elem_exists_~i~5;
    goto loc4;
  loc3_1:
    assume !(elem_exists_~i~5 < elem_exists_~size);
    elem_exists_#res := 0;
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume elem_exists_#t~post1 <= 2147483646;
    assume 0 <= elem_exists_#t~post1 + 2147483649;
    elem_exists_~i~5 := elem_exists_#t~post1 + 1;
    havoc elem_exists_#t~post1;
    goto loc2;
  loc4_1:
    assume !(elem_exists_#t~post1 <= 2147483646);
    goto loc5;
