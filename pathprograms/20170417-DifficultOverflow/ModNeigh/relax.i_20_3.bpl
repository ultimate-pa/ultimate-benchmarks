...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    assume 4 * main_~pat_len~11 < -4294967296 && 4 * main_~pat_len~11 % 4294967296 <= 2147483647;
    ...
    #Ultimate.alloc_old_#valid, #Ultimate.alloc_old_#length := #valid, #length;
    assume (4 * main_~a_len~11 + 2147483649 <= 0 && 4 * main_~a_len~11 < 0) && -4294967296 <= 4 * main_~a_len~11;
  ...
  loc1:
    ...
    assume !((main_~i~17 + 18446744073709551615 * main_~differences~16) % 18446744073709551616 <= 9223372036854775807);
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~a~11.base, main_~a~11.offset + 4 * ((18446744073709551615 * main_~differences~16 + main_~i~17) % 18446744073709551616) + -73786976294838206464, 4;
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
