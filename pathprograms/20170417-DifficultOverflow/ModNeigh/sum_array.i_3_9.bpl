...
modifies ;
{
  ...
  loc2_0:
    ...
    goto loc1;
  loc2_1:
    assume ((4294967296 <= main_~i~6 && main_~i~6 < 4294967296 + 4294967296) && 0 <= main_~M~6) && !(main_~i~6 < main_~M~6 + 4294967296);
    main_~i~6 := 0;
    goto loc3;
  loc3:
    goto loc4;
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume ((main_~i~6 < 4294967296 && 0 <= main_~M~6) && !(main_~i~6 < main_~M~6)) && 0 <= main_~i~6;
    main_~i~6 := 0;
    assume ((0 <= main_~i~6 && 0 <= main_~M~6) && main_~i~6 < main_~M~6) && main_~M~6 < 4294967296;
    assume (main_~i~6 < 4294967296 && !(main_~A~6[main_~i~6] + main_~B~6[main_~i~6] <= 2147483647)) && 0 <= main_~i~6;
    goto loc5;
  loc4_1:
    assume ((0 <= main_~i~6 && main_~M~6 < 4294967296) && main_~i~6 < 4294967296) && main_~i~6 < main_~M~6;
    ...
    assume (main_~i~6 < 4294967296 && main_~B~6[main_~i~6] <= 1000000) && 0 <= main_~i~6;
