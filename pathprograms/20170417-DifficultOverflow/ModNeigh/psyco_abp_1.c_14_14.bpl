...
modifies ;
{
  ...
  loc3_1:
    ...
    assume main_~P1~4 % 2 == 0;
    main_~method_id~3 := 2;
    assume main_~this_buffer_empty~3 == 1 && main_~P1~4 % 2 == main_~this_expect~3 % 2;
    main_~q~3 := 3;
    goto loc5;
  loc4:
    goto loc4_0, loc4_1;
  ...
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume (main_~this_expect~3 + 1) % 2 == 0 && main_~P3~4 == (main_~this_expect~3 + 1) % 2;
    main_#t~short24 := false;
    goto loc9;
  loc6_1:
    assume !(main_~this_expect~3 < 1) && main_~P3~4 == (main_~this_expect~3 + 1) % 2;
    main_#t~short24 := false;
    goto loc9;
  loc7:
    goto loc7_0, loc7_1;
  loc7_0:
    ...
    assume main_~this_expect~3 <= 2147483648;
    assume 0 <= main_~this_expect~3 + 2147483647;
    assume main_~P9~4 == (main_~this_expect~3 + 1) % 2 && (main_~this_expect~3 + 1) % 2 == 0;
    main_#t~short41 := false;
    assume !main_#t~short41;
  ...
  loc7_1:
    ...
    assume main_~P1~4 % 2 == 1 && !(main_~P1~4 < 0);
    main_~method_id~3 := 5;
    assume !(main_~P6~4 % 2 == 0) && main_~P6~4 < 0;
    main_~q~3 := 5;
    assume main_~this_expect~3 <= 2147483646;
    assume 0 <= main_~this_expect~3 + 2147483649;
    main_~this_expect~3 := main_~this_expect~3 + 1;
