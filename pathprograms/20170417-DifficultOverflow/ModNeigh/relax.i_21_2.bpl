...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc1:
    ...
    assume is_relaxed_prefix_~i~9 <= is_relaxed_prefix_~shift~8 + 2147483647;
    assume is_relaxed_prefix_~shift~8 <= is_relaxed_prefix_~i~9 + 2147483648;
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume !(is_relaxed_prefix_#t~post1 <= 2147483646);
    goto loc3;
  loc2_1:
    assume is_relaxed_prefix_#t~post1 <= 2147483646;
    assume 0 <= is_relaxed_prefix_#t~post1 + 2147483649;
