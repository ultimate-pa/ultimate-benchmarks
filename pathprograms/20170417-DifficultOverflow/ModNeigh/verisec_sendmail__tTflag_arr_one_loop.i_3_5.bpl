...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_0:
    ...
    havoc main_#t~mem4;
    assume main_~c~5 <= 313 && 304 <= main_~c~5;
    assume 256 <= main_~c~5 && main_~c~5 < 256 + 256;
    assume 0 <= main_~c~5 % 256 + 2147483600;
    assume 256 <= main_~c~5 && main_~c~5 < 256 + 256;
    main_~j~5 := main_~c~5 - 256 - 48;
    assume (0 <= 10 * main_~i~5 + main_~j~5 && 10 * main_~i~5 + main_~j~5 < 4294967296) && 10 * main_~i~5 + main_~j~5 <= 2147483647;
    main_~i~5 := main_~j~5 + 10 * main_~i~5;
