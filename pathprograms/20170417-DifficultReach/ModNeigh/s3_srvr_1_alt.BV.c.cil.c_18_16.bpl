...
modifies ;
{
  ...
  loc19_0:
    assume (!(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) && ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0) && ssl3_accept_~ag_Z~6 < 0;
    ssl3_accept_~s__state~6 := ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 / ssl3_accept_~ag_Z~6 - 1;
    goto loc20;
  loc19_1:
    assume ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0;
