...
modifies ;
{
  ...
  loc2_0:
    ...
    assume (((0 <= main_~x~4 && main_~x~4 == main_~y~4 - 256) && main_~x~4 < 256) && main_~y~4 < 256 + 256) && 256 <= main_~y~4;
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume (main_~y~4 < 256 + 256 && 256 <= main_~y~4) && main_~i~5 < -256;
    main_~y~4 := main_~i~5 % 256 + main_~y~4 + -256;
    goto loc5;
  loc4_1:
