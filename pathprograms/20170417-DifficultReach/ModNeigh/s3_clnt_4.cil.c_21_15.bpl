...
modifies ;
{
  ...
  loc18_1:
    ...
    assume (ssl3_connect_~__cil_tmp58~4 < 4294967296 && 0 <= ssl3_connect_~__cil_tmp58~4) && ssl3_connect_~__cil_tmp58~4 <= 2147483647;
    ssl3_connect_~s__s3__flags~4 := ssl3_connect_~__cil_tmp58~4;
    assume ssl3_connect_~s__hit~4 == 0;
