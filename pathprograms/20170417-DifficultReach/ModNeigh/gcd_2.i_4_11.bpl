...
modifies ;
{
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume (((((!(gcd_test_~a % gcd_test_~b == 0) && !(gcd_test_~b < 0)) && 256 + 256 <= gcd_test_~a % gcd_test_~b) && !(gcd_test_~b + gcd_test_~a % gcd_test_~b + 129 <= 0)) && gcd_test_~a < 0) && (255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b;
