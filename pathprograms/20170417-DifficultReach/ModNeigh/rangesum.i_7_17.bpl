...
modifies ~N, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_0:
    ...
    assume (((4294967296 + 4294967296 <= rangesum_~ret~3 / rangesum_~cnt~3 + 1 && rangesum_~ret~3 % rangesum_~cnt~3 == 0) && 4294967296 + 4294967296 <= rangesum_~ret~3 / rangesum_~cnt~3 - 1) && rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647) && 4294967296 + 4294967296 <= rangesum_~ret~3 / rangesum_~cnt~3;
