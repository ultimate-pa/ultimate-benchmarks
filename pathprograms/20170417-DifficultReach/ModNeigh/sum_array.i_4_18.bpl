...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume ((0 <= main_~i~6 && -4294967296 <= main_~M~6) && main_~i~6 < 4294967296) && !(main_~i~6 < main_~M~6 + 4294967296);
    main_~i~6 := 0;
    goto loc3;
  loc2_1:
    assume ((main_~i~6 < main_~M~6 + 4294967296 && 0 <= main_~i~6) && main_~M~6 < 0) && -4294967296 <= main_~M~6;
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume ((main_~i~6 < main_~M~6 + 4294967296 && main_~M~6 < 0) && main_~i~6 < 4294967296) && 0 <= main_~i~6;
    ...
    goto loc3;
  loc4_1:
    assume ((0 <= main_~i~6 && !(main_~i~6 < main_~M~6 + 4294967296)) && -4294967296 <= main_~M~6) && main_~i~6 < 4294967296;
    main_~i~6 := 0;
    goto loc5;
  loc5:
    goto loc6;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume ((main_~i~6 < 4294967296 && -4294967296 <= main_~M~6) && !(main_~i~6 < main_~M~6 + 4294967296)) && main_~M~6 < 0;
    main_~i~6 := 0;
    goto loc7;
  loc6_1:
    assume ((-4294967296 <= main_~M~6 && main_~i~6 < main_~M~6 + 4294967296) && 0 <= main_~i~6) && main_~M~6 < 0;
    assume main_~i~6 < 4294967296 && 0 <= main_~i~6;
  ...
  loc8:
    goto loc8_0, loc8_1;
  loc8_0:
    assume ((main_~i~6 < main_~M~6 + 8589934592 && main_~M~6 < 0) && 4294967296 <= main_~i~6) && main_~i~6 < 4294967296 + 4294967296;
    goto loc9;
  loc8_1:
    assume ((main_~i~6 < 4294967296 && main_~i~6 < main_~M~6 + 4294967296) && main_~M~6 < 0) && 0 <= main_~i~6;
    goto loc9;
  loc9:
    goto loc9_0, loc9_1;
  loc9_0:
    assume (main_~i~6 < 4294967296 && main_~C~6[main_~i~6] == main_~A~6[main_~i~6] + main_~B~6[main_~i~6]) && 0 <= main_~i~6;
    __VERIFIER_assert_#in~cond := 1;
    goto loc10;
  loc9_1:
    assume (4294967296 <= main_~i~6 && main_~i~6 < 4294967296 + 4294967296) && !(main_~C~6[main_~i~6 - 4294967296] == main_~A~6[main_~i~6 - 4294967296] + main_~B~6[main_~i~6 - 4294967296]);
