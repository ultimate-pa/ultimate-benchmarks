...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume ((!(main_~j~5 + 4294967296 < main_~N_COL~5) && 0 <= main_~N_COL~5) && main_~j~5 < 0) && main_~N_COL~5 < 4294967296;
  ...
  loc5_0:
    ...
    goto loc4;
  loc5_1:
    assume ((main_~k~5 < 4294967296 + 4294967296 && !(main_~k~5 < main_~N_LIN~5 + 4294967296)) && 0 <= main_~N_LIN~5) && main_~N_LIN~5 < 4294967296;
