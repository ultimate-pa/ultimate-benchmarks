...
modifies ;
{
  ...
  loc22_1:
    ...
    assume (ssl3_connect_~__cil_tmp58~4 < 4294967296 + 4294967296 && ssl3_connect_~__cil_tmp58~4 <= 6442450943) && 4294967296 <= ssl3_connect_~__cil_tmp58~4;
    ssl3_connect_~s__s3__flags~4 := ssl3_connect_~__cil_tmp58~4 - 4294967296;
    assume ssl3_connect_~s__hit~4 == 0;
