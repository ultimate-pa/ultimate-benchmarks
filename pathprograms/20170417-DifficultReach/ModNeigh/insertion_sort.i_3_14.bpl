...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume ((main_~SIZE~5 < 4294967296 + 4294967296 && main_~j~5 + 4294967296 < main_~SIZE~5) && 0 <= main_~j~5) && main_~j~5 < 4294967296;
    ...
    goto loc1;
  loc2_1:
    assume ((main_~SIZE~5 < 4294967296 + 4294967296 && main_~j~5 < 4294967296) && 4294967296 <= main_~SIZE~5) && !(main_~j~5 + 4294967296 < main_~SIZE~5);
    main_~k~5 := 1;
    assume ((0 <= main_~k~5 && main_~SIZE~5 < 4294967296 + 4294967296) && main_~k~5 + 4294967296 < main_~SIZE~5) && main_~k~5 < 4294967296;
