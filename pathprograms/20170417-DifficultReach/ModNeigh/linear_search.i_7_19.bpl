...
modifies ~SIZE, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume (((-4294967296 <= linear_search_~n && !(linear_search_~j~5 < linear_search_~n + 4294967296)) && 0 <= linear_search_~j~5) && linear_search_~n < 0) && linear_search_~j~5 < 4294967296;
