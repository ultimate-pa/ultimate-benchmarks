...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc4_0:
    assume !(avg_~i~3 < 5);
    assume (((!(avg_~ret~3 / 5 % 4294967296 <= 2147483647) && !((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647)) && avg_~ret~3 % 5 == 0) && avg_~ret~3 / 5 + 1 < -4294967296) && avg_~ret~3 / 5 < -4294967296;
    avg_#res := avg_~ret~3 / 5 % 4294967296 - 4294967296;
  ...
  loc6_1:
    assume !(avg_~i~3 < 5);
    assume (((avg_~ret~3 < 0 && avg_~ret~3 / 5 < -4294967296) && -4294967296 <= avg_~ret~3 / 5 + 1) && !(avg_~ret~3 % 5 == 0)) && avg_~ret~3 / 5 + 1 + 4294967296 <= 2147483647;
    avg_#res := avg_~ret~3 / 5 + 1 + 4294967296;
  ...
  loc10_0:
    assume !(avg_~i~3 < 5);
    assume ((((avg_~ret~3 / 5 < -4294967296 && avg_~ret~3 < 0) && !((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647)) && !(avg_~ret~3 % 5 == 0)) && avg_~ret~3 / 5 + 1 < -4294967296) && avg_~ret~3 / 5 % 4294967296 <= 2147483647;
    avg_#res := (avg_~ret~3 / 5 + 1) % 4294967296 - 4294967296;
