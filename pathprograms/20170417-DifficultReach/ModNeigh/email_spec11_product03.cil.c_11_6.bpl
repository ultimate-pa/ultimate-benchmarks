...
modifies ~queued_message, ~queue_empty, ~__ste_client_autoResponse0, ~__ste_client_autoResponse2, ~__ste_client_idCounter1, ~__ste_client_autoResponse1, ~__ste_client_idCounter0, ~__ste_client_idCounter2, #NULL.offset, ~rjh, #NULL.base, ~__ste_email_to1, ~chuck, #valid, ~bob, ~__ste_email_from1, ~__ste_email_from0, ~queued_client, #length, ~__ste_email_to0;
{
