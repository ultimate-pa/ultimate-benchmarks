...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume ((4294967296 <= main_~i~6 && main_~M~6 < -4294967296) && !(main_~i~6 < main_~M~6 % 4294967296 + 4294967296)) && main_~i~6 < 4294967296 + 4294967296;
    main_~i~6 := 0;
    goto loc3;
  loc2_1:
  ...
  loc6_0:
    ...
    goto loc5;
  loc6_1:
    assume (4294967296 + 4294967296 <= main_~i~6 && main_~M~6 < -4294967296) && !(main_~i~6 % 4294967296 < main_~M~6 % 4294967296);
    main_~i~6 := 0;
