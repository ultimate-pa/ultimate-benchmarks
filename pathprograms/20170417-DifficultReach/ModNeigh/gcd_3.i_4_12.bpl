...
modifies ;
{
  ...
  loc2_1:
    ...
    assume ((((!(gcd_test_~a < 0) && !((255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127)) && gcd_test_~a % gcd_test_~b < 256) && 256 + 256 <= 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) && 0 <= gcd_test_~b + gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b <= 127;
