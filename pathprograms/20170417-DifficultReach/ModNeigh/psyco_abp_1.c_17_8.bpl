...
modifies ;
{
  ...
  loc5:
    goto loc5_0, loc5_1;
  loc5_0:
    assume main_~P1~4 % 2 == 0 && !(main_~P1~4 % 2 == main_~this_expect~3 % 2);
    goto loc7;
  loc5_1:
    assume main_~P1~4 % 2 == main_~this_expect~3 % 2 && main_~this_buffer_empty~3 == 1;
    main_~q~3 := 3;
  ...
  loc6_1:
    ...
    assume main_~P1~4 == 1;
    main_~method_id~3 := 7;
    assume (main_~P9~4 == (main_~this_expect~3 + 1) % 2 && !(main_~this_buffer_empty~3 == 1)) && !(main_~this_expect~3 < 1);
    main_~q~3 := 1;
    main_~this_expect~3 := main_~this_expect~3;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
