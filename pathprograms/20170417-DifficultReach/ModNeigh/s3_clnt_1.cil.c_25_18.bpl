...
modifies ;
{
  ...
  loc22_0:
    ...
    assume ssl3_connect_~__cil_tmp57~4 % 4294967296 <= 2147483647 && 4294967296 + 4294967296 <= ssl3_connect_~__cil_tmp57~4;
    ssl3_connect_~s__s3__flags~4 := ssl3_connect_~__cil_tmp57~4 % 4294967296;
    assume ssl3_connect_~s__hit~4 == 0;
  ...
  loc22_1:
    ...
    assume !(0 < ssl3_connect_~__cil_tmp61~4);
