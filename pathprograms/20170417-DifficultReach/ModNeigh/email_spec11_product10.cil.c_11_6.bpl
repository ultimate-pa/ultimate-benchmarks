...
modifies ~queued_message, ~queue_empty, ~__ste_client_autoResponse1, ~__ste_client_idCounter0, ~__ste_client_idCounter2, #NULL.offset, ~__ste_email_id1, ~chuck, ~__ste_email_from1, ~__ste_client_forwardReceiver2, ~__ste_client_forwardReceiver0, #length, ~__ste_email_to0, ~__ste_client_autoResponse0, ~__ste_client_autoResponse2, ~__ste_client_idCounter1, ~rjh, #NULL.base, ~__ste_email_to1, #valid, ~bob, ~__ste_email_from0, ~__ste_client_forwardReceiver1, ~__ste_email_id0, ~queued_client;
{
  ...
  loc3_0:
    ...
    assume 0 <= test_#t~nondet15 + 2147483648 && test_#t~nondet15 <= 2147483647;
    test_~tmp___8~152 := test_#t~nondet15;
    havoc test_#t~nondet15;
    assume test_~tmp___8~152 == 0;
    assume test_~op3~152 == 0;
    assume 0 <= test_#t~nondet16 + 2147483648 && test_#t~nondet16 <= 2147483647;
    test_~tmp___7~152 := test_#t~nondet16;
    havoc test_#t~nondet16;
