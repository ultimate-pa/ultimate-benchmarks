...
modifies ;
{
  ...
  loc16_1:
    ...
    assume (!(ssl3_connect_~s__s3__flags~3 + 6442450940 <= 0) && -4294967296 <= ssl3_connect_~s__s3__flags~3 + 4294967291) && ssl3_connect_~s__s3__flags~3 + 4294967291 < 0;
    ssl3_connect_~s__s3__flags~3 := ssl3_connect_~s__s3__flags~3 + 8589934587 - 4294967296;
    assume ssl3_connect_~s__hit~3 == 0;
