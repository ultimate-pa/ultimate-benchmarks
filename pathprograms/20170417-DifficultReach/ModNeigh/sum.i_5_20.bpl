...
modifies ~N, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_1:
    assume !(sum_~i~3 < ~N);
    assume !(sum_~ret~3 % 4294967296 <= 2147483647) && 4294967296 + 4294967296 <= sum_~ret~3;
  ...
  loc8_0:
    assume !(sum_~i~3 < ~N);
    assume (4294967296 <= sum_~ret~3 && sum_~ret~3 < 4294967296 + 4294967296) && !(sum_~ret~3 <= 6442450943);
    sum_#res := sum_~ret~3 - 4294967296 - 4294967296;
