...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_1:
    ...
    assume ((rangesum_~ret~2 % rangesum_~cnt~2 == 0 && rangesum_~ret~2 / rangesum_~cnt~2 + 4294967296 <= 2147483647) && rangesum_~ret~2 / rangesum_~cnt~2 - 1 < 0) && -4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2;
  ...
  loc6_1:
    assume !(rangesum_~i~2 < 5);
    assume !(rangesum_~cnt~2 == 0);
    assume ((((((rangesum_~cnt~2 < 0 && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 - 1) && rangesum_~ret~2 < 0) && !((rangesum_~ret~2 / rangesum_~cnt~2 - 1) % 4294967296 <= 2147483647)) && (rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296 <= 2147483647) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 + 1;
  ...
  loc12_1:
    assume !(rangesum_~i~2 < 5);
    assume !(rangesum_~cnt~2 == 0);
    assume ((((((rangesum_~ret~2 / rangesum_~cnt~2 + 1 < 4294967296 + 4294967296 && !(rangesum_~cnt~2 < 0)) && rangesum_~ret~2 / rangesum_~cnt~2 < 4294967296 + 4294967296) && 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 - 1) && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && rangesum_~ret~2 / rangesum_~cnt~2 - 1 < 4294967296 + 4294967296) && rangesum_~ret~2 / rangesum_~cnt~2 + 1 - 4294967296 <= 2147483647) && rangesum_~ret~2 < 0;
