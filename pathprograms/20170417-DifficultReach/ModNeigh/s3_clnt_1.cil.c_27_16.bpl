...
modifies ;
{
  ...
  loc14_1:
    ...
    assume (4294967296 <= ssl3_connect_~__cil_tmp57~4 && ssl3_connect_~__cil_tmp57~4 <= 6442450943) && ssl3_connect_~__cil_tmp57~4 < 4294967296 + 4294967296;
    ssl3_connect_~s__s3__flags~4 := ssl3_connect_~__cil_tmp57~4 - 4294967296;
    assume !(ssl3_connect_~s__hit~4 == 0);
    ssl3_connect_~s__s3__tmp__next_state___0~4 := 3;
    ssl3_connect_~__cil_tmp58~4 := ssl3_connect_~s__s3__flags~4;
    assume ssl3_connect_~__cil_tmp58~4 - 2 == 0;
    ssl3_connect_~s__init_num~4 := 0;
    goto loc3;
  loc15:
