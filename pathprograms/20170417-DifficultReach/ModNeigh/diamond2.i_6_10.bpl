...
modifies ;
{
  ...
  loc2_0:
    ...
    goto loc1;
  loc2_1:
    assume !(main_~x~5 + 4294967197 < 0) && main_~x~5 < 0;
    assume ((((main_~x~5 < 0 && !(main_~x~5 % 2 == main_~y~5 % 2)) && !(main_~x~5 + 4294967296 < 0)) && main_~y~5 < 0) && -4294967296 <= main_~x~5) && !(main_~y~5 + 4294967296 < 0);
