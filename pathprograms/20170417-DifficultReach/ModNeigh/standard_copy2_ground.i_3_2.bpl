...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_~a3~4, main_#t~post2, main_~x~4, main_#t~post1, main_#t~post0, main_~a1~4, main_~i~4, main_~a2~4;
    havoc main_~a1~4;
    havoc main_~a2~4;
    havoc main_~a3~4;
    havoc main_~i~4;
  ...
  loc2_0:
    ...
    main_~a3~4 := main_~a3~4[main_~i~4 := main_~a1~4[main_~i~4]];
  ...
  loc4_0:
    ...
    assume main_~a1~4[main_~x~4] == main_~a3~4[main_~x~4];
