...
modifies ;
{
  ...
  loc2_0:
    ...
    assume ((((256 <= gcd_test_~a % gcd_test_~b && !(gcd_test_~a < 0)) && gcd_test_~a % gcd_test_~b <= 383) && 256 + 256 <= 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b < 256 + 256;
