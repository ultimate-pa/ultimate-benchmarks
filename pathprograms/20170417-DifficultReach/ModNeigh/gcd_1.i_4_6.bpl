...
modifies ;
{
  ...
  loc0:
    ...
    havoc main_~g~7;
    assume main_~x~7 % main_~y~7 == 0 && 0 < main_~y~7;
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume (((((((256 <= gcd_test_~a % gcd_test_~b && !(gcd_test_~a % gcd_test_~b == 0)) && !(gcd_test_~b < 0)) && !(gcd_test_~b + gcd_test_~a % gcd_test_~b + 129 <= 0)) && gcd_test_~a < 0) && (255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127) && 256 + 256 <= 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b < 256 + 256;
    gcd_test_~b := (255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256;
    goto loc5;
  loc4_1:
    assume ((!(gcd_test_~a < 0) && gcd_test_~a % gcd_test_~b % 256 <= 127) && 256 + 256 <= gcd_test_~a % gcd_test_~b) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b;
