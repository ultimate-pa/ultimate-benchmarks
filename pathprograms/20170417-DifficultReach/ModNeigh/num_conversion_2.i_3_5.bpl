...
modifies ;
{
  ...
  loc2_0:
    ...
    assume ((0 <= main_~y~5 && main_~i~6 < 256 + 256) && 256 <= main_~i~6) && main_~y~5 < 256;
    main_~y~5 := main_~i~6 + main_~y~5 + -256;
    assume main_~c~5 < 256 && 0 <= main_~c~5;
    main_~c~5 := main_~c~5 + 1;
    goto loc1;
  loc2_1:
    assume main_~c~5 < 256 && !(main_~c~5 < 8);
    assume (((256 <= main_~x~5 && main_~x~5 - 256 == main_~y~5 - 256) && main_~y~5 < 256 + 256) && 256 <= main_~y~5) && main_~x~5 < 256 + 256;
