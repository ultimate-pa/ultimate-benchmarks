...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc4_0:
    assume !(avg_~i~3 < 40);
    assume (((avg_~ret~3 / 40 < 0 && -4294967296 <= avg_~ret~3 / 40 + 1) && -4294967296 <= avg_~ret~3 / 40) && avg_~ret~3 / 40 + 4294967296 <= 2147483647) && avg_~ret~3 % 40 == 0;
    avg_#res := avg_~ret~3 / 40 + 4294967296;
  ...
  loc6_1:
    assume !(avg_~i~3 < 40);
    assume ((0 <= avg_~ret~3 / 40 + 1 && avg_~ret~3 % 40 == 0) && avg_~ret~3 / 40 < 4294967296) && avg_~ret~3 / 40 <= 2147483647;
    avg_#res := avg_~ret~3 / 40;
  ...
  loc10_0:
    assume !(avg_~i~3 < 40);
    assume ((((!(avg_~ret~3 % 40 == 0) && avg_~ret~3 < 0) && avg_~ret~3 / 40 + 4294967296 <= 2147483647) && -4294967296 <= avg_~ret~3 / 40) && !(avg_~ret~3 / 40 + 1 + 4294967296 <= 2147483647)) && avg_~ret~3 / 40 < 0;
    avg_#res := avg_~ret~3 / 40 + 1 + 4294967296 - 4294967296;
