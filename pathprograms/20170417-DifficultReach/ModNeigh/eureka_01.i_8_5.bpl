...
modifies ~INFINITY;
{
  ...
  loc0:
    ~INFINITY := 899;
    havoc main_#res;
    havoc main_#t~nondet0, main_#t~nondet1, main_~Dest~5, main_#t~post3, main_#t~post2, main_~source~5, main_~x~5, main_#t~post6, main_#t~post5, main_#t~post4, main_~i~5, main_~Weight~5, main_~edgecount~5, main_~distance~5, main_~Source~5, main_~nodecount~5, main_~y~5, main_~j~5;
    ...
    assume main_~nodecount~5 <= 4 && 0 <= main_~nodecount~5;
    assume main_~edgecount~5 <= 19 && 0 <= main_~edgecount~5;
    main_~source~5 := 0;
  ...
  loc7_1:
    assume main_~j~5 < main_~edgecount~5;
    main_~x~5 := main_~Dest~5[main_~j~5];
    main_~y~5 := main_~Source~5[main_~j~5];
    assume main_~distance~5[main_~y~5] + main_~Weight~5[main_~j~5] < main_~distance~5[main_~x~5];
    main_~distance~5 := main_~distance~5[main_~x~5 := -1];
  ...
  loc8_0:
    ...
    main_~i~5 := 0;
    assume main_~i~5 < main_~nodecount~5;
    assume !(0 <= main_~distance~5[main_~i~5]);
  ...
  loc8_1:
    assume main_~i~5 < main_~edgecount~5;
    main_~x~5 := main_~Dest~5[main_~i~5];
    main_~y~5 := main_~Source~5[main_~i~5];
    assume !(main_~distance~5[main_~y~5] + main_~Weight~5[main_~i~5] < main_~distance~5[main_~x~5]);
    main_#t~post5 := main_~i~5;
    main_~i~5 := main_#t~post5 + 1;
    havoc main_#t~post5;
    goto loc6;
  loc9:
    assert false;
