...
modifies ;
{
  ...
  loc14_1:
    ...
    assume (!(ssl3_connect_~__cil_tmp57~4 + 2147483649 <= 0) && -4294967296 <= ssl3_connect_~__cil_tmp57~4) && ssl3_connect_~__cil_tmp57~4 < 0;
    ssl3_connect_~s__s3__flags~4 := ssl3_connect_~__cil_tmp57~4 + 4294967296 - 4294967296;
    assume ssl3_connect_~s__hit~4 == 0;
