...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_0:
    ...
    assume ((((((!(rangesum_~cnt~2 < 0) && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 - 1) && rangesum_~ret~2 < 0) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 + 1) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2) && !((rangesum_~ret~2 / rangesum_~cnt~2 - 1) % 4294967296 <= 2147483647)) && !((rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296 <= 2147483647);
  ...
  loc5_0:
    assume !(rangesum_~i~2 < 10);
    assume !(rangesum_~cnt~2 == 0);
    assume ((((4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 + 1 && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && !(rangesum_~cnt~2 < 0)) && rangesum_~ret~2 < 0) && rangesum_~ret~2 / rangesum_~cnt~2 + 1 < 4294967296 + 4294967296) && rangesum_~ret~2 / rangesum_~cnt~2 + 1 - 4294967296 <= 2147483647;
    rangesum_#res := rangesum_~ret~2 / rangesum_~cnt~2 + 1 - 4294967296;
  ...
  loc12_0:
    assume !(rangesum_~i~2 < 10);
    assume !(rangesum_~cnt~2 == 0);
    assume ((((((!(rangesum_~cnt~2 < 0) && 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 - 1) && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && rangesum_~ret~2 / rangesum_~cnt~2 - 1 < 4294967296 + 4294967296) && rangesum_~ret~2 / rangesum_~cnt~2 % 4294967296 <= 2147483647) && rangesum_~ret~2 < 0) && (rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296 <= 2147483647) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2;
    rangesum_#res := (rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296;
