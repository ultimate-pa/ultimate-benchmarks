...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc2_1:
    ...
    assume ((!(rangesum_~ret~2 < 0) && rangesum_~ret~2 / rangesum_~cnt~2 <= 2147483647) && 0 <= rangesum_~ret~2 / rangesum_~cnt~2) && rangesum_~ret~2 / rangesum_~cnt~2 - 1 < 4294967296;
    rangesum_#res := rangesum_~ret~2 / rangesum_~cnt~2;
