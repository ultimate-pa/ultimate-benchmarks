...
modifies ;
{
  ...
  loc2_1:
    ...
    assume v_rep_select_ULTIMATE.start_main_~dst~5_ULTIMATE.start_main_~x~5__1 == v_rep_select_ULTIMATE.start_main_~src~5_ULTIMATE.start_main_~x~5__1 || !(v_rep_select_ULTIMATE.start_main_~dst~5_ULTIMATE.start_main_~x~5__1 == v_rep_select_ULTIMATE.start_main_~src~5_ULTIMATE.start_main_~x~5__1);
    __VERIFIER_assert_#in~cond := (if v_rep_select_ULTIMATE.start_main_~dst~5_ULTIMATE.start_main_~x~5__1 == v_rep_select_ULTIMATE.start_main_~src~5_ULTIMATE.start_main_~x~5__1 then 1 else 0);
