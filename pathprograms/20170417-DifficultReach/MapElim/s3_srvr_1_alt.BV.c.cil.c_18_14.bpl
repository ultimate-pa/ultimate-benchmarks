...
modifies ;
{
  ...
  loc18:
    assume !(ssl3_accept_~ret~6 <= 0);
    assume ((!(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) && (((!(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) && ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0) && (ssl3_accept_~ag_Z~6 < 0 || !(ssl3_accept_~ag_Z~6 < 0))) || ((!(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0) || ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) && (ssl3_accept_~ag_Z~6 < 0 || !(ssl3_accept_~ag_Z~6 < 0))))) && ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0) || ((!(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0) || ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) && (((!(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) && ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0) && (ssl3_accept_~ag_Z~6 < 0 || !(ssl3_accept_~ag_Z~6 < 0))) || ((!(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0) || ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) && (ssl3_accept_~ag_Z~6 < 0 || !(ssl3_accept_~ag_Z~6 < 0)))));
    ssl3_accept_~s__state~6 := (if ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 < 0 && !(ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 % ssl3_accept_~ag_Z~6 == 0) then (if ssl3_accept_~ag_Z~6 < 0 then ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 / ssl3_accept_~ag_Z~6 - 1 else ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 / ssl3_accept_~ag_Z~6 + 1) else ssl3_accept_~ag_X~6 * ssl3_accept_~ag_Y~6 / ssl3_accept_~ag_Z~6);
    ssl3_accept_~s__init_num~6 := 0;
