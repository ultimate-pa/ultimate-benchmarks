...
modifies ~queued_message, ~__ste_client_autoResponse0, ~queue_empty, ~__ste_client_autoResponse2, ~__ste_client_idCounter1, ~__ste_client_autoResponse1, ~__ste_client_idCounter0, ~__ste_client_idCounter2, #NULL.offset, ~rjh, v_rep_select_#valid_0__1, #NULL.base, ~__ste_email_to1, ~__ste_email_id1, ~chuck, ~bob, ~__ste_email_from1, ~__ste_client_forwardReceiver2, ~__ste_email_from0, ~__ste_client_forwardReceiver1, ~__ste_email_id0, ~__ste_client_forwardReceiver0, ~queued_client, ~__ste_email_to0;
{
