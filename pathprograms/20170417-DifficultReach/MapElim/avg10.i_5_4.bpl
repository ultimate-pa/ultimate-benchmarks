...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc4_1:
    assume !(avg_~i~3 < 10);
    assume ((avg_~ret~3 < 0 && ((avg_~ret~3 / 10 + 1) % 4294967296 <= 2147483647 || !((avg_~ret~3 / 10 + 1) % 4294967296 <= 2147483647))) && !(avg_~ret~3 % 10 == 0)) || ((avg_~ret~3 / 10 % 4294967296 <= 2147483647 || !(avg_~ret~3 / 10 % 4294967296 <= 2147483647)) && (!(avg_~ret~3 < 0) || avg_~ret~3 % 10 == 0));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 - 4294967296);
  ...
  loc6_0:
    assume !(avg_~i~3 < 10);
    assume ((avg_~ret~3 < 0 && ((avg_~ret~3 / 10 + 1) % 4294967296 <= 2147483647 || !((avg_~ret~3 / 10 + 1) % 4294967296 <= 2147483647))) && !(avg_~ret~3 % 10 == 0)) || ((!(avg_~ret~3 < 0) || avg_~ret~3 % 10 == 0) && (avg_~ret~3 / 10 % 4294967296 <= 2147483647 || !(avg_~ret~3 / 10 % 4294967296 <= 2147483647)));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 - 4294967296);
  ...
  loc8_0:
    assume !(main_~i~7 < 9);
    v_rep_select__select_ULTIMATE.start_write~int_old_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_ULTIMATE.start_write~int_old_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1 := v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, main_~#x~5.base, main_~temp~5, main_~#x~5.offset + 36;
    havoc v_rep_select__select_ULTIMATE.start_write~int_old_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1;
    havoc v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1;
    assume v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1 == write~int_#value;
    avg_#in~x.base, avg_#in~x.offset := main_~#x~5.base, main_~#x~5.offset;
  ...
  loc10_0:
    assume !(avg_~i~3 < 10);
    assume ((((((avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 10 == 0) && avg_~ret~3 / 10 % 4294967296 <= 2147483647) || (!(avg_~ret~3 / 10 % 4294967296 <= 2147483647) && (((avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 10 == 0))) && (avg_~ret~3 / 10 + 1) % 4294967296 <= 2147483647) || (!((avg_~ret~3 / 10 + 1) % 4294967296 <= 2147483647) && (((((avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 10 == 0) && avg_~ret~3 / 10 % 4294967296 <= 2147483647) || ((((avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 10 == 0) && !(avg_~ret~3 / 10 % 4294967296 <= 2147483647))));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 10 == 0) then avg_~ret~3 / 10 + 1 else avg_~ret~3 / 10) % 4294967296 - 4294967296);
