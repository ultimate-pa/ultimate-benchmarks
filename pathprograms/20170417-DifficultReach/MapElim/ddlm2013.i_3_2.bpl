...
modifies ;
{
  ...
  loc2_0:
    ...
    assume (if main_~i~5 % 4294967296 < 0 && !(main_~i~5 % 2 == 0) then main_~i~5 % 2 - 2 else main_~i~5 % 2) % 4294967296 == 0;
  ...
  loc2_1:
    ...
    havoc main_#t~nondet1;
    assume !(main_~flag~5 == 0);
    assume main_~a~5 % 4294967296 == main_~b~5 % 4294967296 || !(main_~a~5 % 4294967296 == main_~b~5 % 4294967296);
