...
modifies ;
{
    ...
    var ssl3_accept_~__retres67~4 : int;
  ...
  loc0:
    ...
    havoc ssl3_accept_#t~nondet5, ssl3_accept_#t~nondet40, ssl3_accept_~tmp___6~4, ssl3_accept_~buf~4, ssl3_accept_#t~nondet7, ssl3_accept_~s__s3__tmp__use_rsa_tmp~4, ssl3_accept_#t~nondet9, ssl3_accept_~cb~4, ssl3_accept_~num1~4, ssl3_accept_~s__s3__tmp__new_cipher__algorithms~4, ssl3_accept_~s__new_session~4, ssl3_accept_~tmp~4, ssl3_accept_#t~nondet18, ssl3_accept_~tmp___5~4, ssl3_accept_#t~nondet16, ssl3_accept_#t~nondet39, ssl3_accept_~s__version~4, ssl3_accept_#t~nondet14, ssl3_accept_#t~nondet37, ssl3_accept_~s__info_callback~4, ssl3_accept_~s__shutdown~4, ssl3_accept_#t~nondet12, ssl3_accept_#t~nondet35, ssl3_accept_#t~nondet1, ssl3_accept_#t~nondet10, ssl3_accept_#t~nondet33, ssl3_accept_#t~nondet3, ssl3_accept_#t~nondet31, ssl3_accept_~s__ctx__info_callback~4, ssl3_accept_~__retres67~4, ssl3_accept_~s__type~4, ssl3_accept_~state~4, ssl3_accept_~s__server~4, ssl3_accept_~tmp___8~4, ssl3_accept_~tmp___9~4, ssl3_accept_~s__ctx__stats__sess_accept_good~4, ssl3_accept_~s__state~4, ssl3_accept_~tmp___10~4, ssl3_accept_~new_state~4, ssl3_accept_~ret~4, ssl3_accept_~s__cert__pkeys__AT0__privatekey~4, ssl3_accept_~s__options~4, ssl3_accept_#t~nondet29, ssl3_accept_~initial_state, ssl3_accept_#t~nondet27, ssl3_accept_~tmp___7~4, ssl3_accept_#t~nondet25, ssl3_accept_#t~nondet23, ssl3_accept_~s__ctx__stats__sess_accept_renegotiate~4, ssl3_accept_~blastFlag~4, ssl3_accept_#t~nondet21, ssl3_accept_~s__session__cipher~4, ssl3_accept_#t~nondet6, ssl3_accept_~tmp___1~4, ssl3_accept_~s__cert~4, ssl3_accept_#t~nondet8, ssl3_accept_~s__ctx__stats__sess_accept~4, ssl3_accept_~s__s3__tmp__cert_request~4, ssl3_accept_~s__init_buf___0~4, ssl3_accept_~tmp___2~4, ssl3_accept_~s__s3__tmp__reuse_message~4, ssl3_accept_#t~nondet19, ssl3_accept_~s__hit~4, ssl3_accept_#t~nondet38, ssl3_accept_#t~nondet17, ssl3_accept_#t~nondet15, ssl3_accept_#t~nondet36, ssl3_accept_#t~nondet34, ssl3_accept_#t~nondet0, ssl3_accept_#t~nondet13, ssl3_accept_#t~nondet2, ssl3_accept_#t~nondet11, ssl3_accept_~s__init_num~4, ssl3_accept_#t~nondet32, ssl3_accept_~s__in_handshake~4, ssl3_accept_#t~nondet30, ssl3_accept_~s__verify_mode~4, ssl3_accept_#t~nondet4, ssl3_accept_~s__session__peer~4, ssl3_accept_~s__s3__tmp__next_state___0~4, ssl3_accept_~Time~4, ssl3_accept_~tmp___4~4, ssl3_accept_~s__s3__tmp__new_cipher__algo_strength~4, ssl3_accept_~s__rwstate~4, ssl3_accept_~l~4, ssl3_accept_~skip~4, ssl3_accept_~s__debug~4, ssl3_accept_#t~nondet28, ssl3_accept_#t~nondet26, ssl3_accept_~tmp___3~4, ssl3_accept_#t~nondet24, ssl3_accept_~s__s3__tmp__new_cipher~4, ssl3_accept_#t~nondet22, ssl3_accept_#t~nondet20, ssl3_accept_#t~nondet41, ssl3_accept_~got_new_session~4;
    ...
    havoc ssl3_accept_~__retres67~4;
  ...
  loc9_1:
    ...
    ssl3_accept_~ret~4 := ssl3_accept_#t~nondet34;
    havoc ssl3_accept_#t~nondet34;
    assume !(ssl3_accept_~ret~4 <= 0);
    assume !(ssl3_accept_~ret~4 == 2);
    assume 0 <= ssl3_accept_#t~nondet35 + 2147483648 && ssl3_accept_#t~nondet35 <= 2147483647;
    ssl3_accept_~ret~4 := ssl3_accept_#t~nondet35;
    havoc ssl3_accept_#t~nondet35;
    assume !(ssl3_accept_~ret~4 <= 0);
    ssl3_accept_~s__init_num~4 := 0;
    ssl3_accept_~s__state~4 := 8592;
    goto loc4;
  loc10:
  ...
  loc10_0:
    ...
    ssl3_accept_~ret~4 := ssl3_accept_#t~nondet36;
    havoc ssl3_accept_#t~nondet36;
    assume !(ssl3_accept_~ret~4 <= 0);
    ssl3_accept_~s__state~4 := 8608;
    ssl3_accept_~s__init_num~4 := 0;
    goto loc4;
  loc10_1:
    assume !(ssl3_accept_~s__state~4 == 8592);
  ...
  loc11_1:
    ...
    ssl3_accept_~ret~4 := ssl3_accept_#t~nondet37;
    havoc ssl3_accept_#t~nondet37;
    assume !(ssl3_accept_~ret~4 <= 0);
    ssl3_accept_~s__state~4 := 8640;
    ssl3_accept_~s__init_num~4 := 0;
    goto loc4;
  loc12:
  ...
  loc12_1:
    ...
    ssl3_accept_~ret~4 := ssl3_accept_#t~nondet38;
  ...
  loc14_1:
    assume ssl3_accept_~blastFlag~4 == 3;
    assume ((((!(ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0) && ssl3_accept_~s__state~4 < 0) || !(ssl3_accept_~s__state~4 < 0)) || ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0) && ssl3_accept_~s__s3__tmp__next_state___0~4 < 0) || (!(ssl3_accept_~s__s3__tmp__next_state___0~4 < 0) && (((!(ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0) && ssl3_accept_~s__state~4 < 0) || !(ssl3_accept_~s__state~4 < 0)) || ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0));
    ssl3_accept_~blastFlag~4 := ssl3_accept_~blastFlag~4 + (if ssl3_accept_~s__state~4 < 0 && !(ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0) then (if ssl3_accept_~s__s3__tmp__next_state___0~4 < 0 then ssl3_accept_~s__state~4 / ssl3_accept_~s__s3__tmp__next_state___0~4 - 1 else ssl3_accept_~s__state~4 / ssl3_accept_~s__s3__tmp__next_state___0~4 + 1) else ssl3_accept_~s__state~4 / ssl3_accept_~s__s3__tmp__next_state___0~4);
    goto loc17;
  loc15:
