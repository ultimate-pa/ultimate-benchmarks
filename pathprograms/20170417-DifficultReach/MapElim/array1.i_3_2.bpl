...
modifies ;
{
  ...
  loc2_0:
    ...
    assume !(v_rep_select_ULTIMATE.start_main_~A~4_1023__1 == 1023) || v_rep_select_ULTIMATE.start_main_~A~4_1023__1 == 1023;
    __VERIFIER_assert_#in~cond := (if !(v_rep_select_ULTIMATE.start_main_~A~4_1023__1 == 1023) then 1 else 0);
