...
modifies ;
{
  ...
  loc4_1:
    ...
    assume (if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == 0;
    main_~method_id~3 := 2;
    assume ((if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == (if main_~this_expect~3 < 0 && !(main_~this_expect~3 % 2 == 0) then main_~this_expect~3 % 2 - 2 else main_~this_expect~3 % 2) && (if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == 0) && main_~this_buffer_empty~3 == 1;
    goto loc5;
  loc5:
    assert false;
}
