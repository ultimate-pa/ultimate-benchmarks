...
modifies ;
{
  ...
  loc18_0:
    ...
    assume ssl3_connect_~__cil_tmp58~4 % 4294967296 <= 2147483647 || !(ssl3_connect_~__cil_tmp58~4 % 4294967296 <= 2147483647);
    ssl3_connect_~s__s3__flags~4 := (if ssl3_connect_~__cil_tmp58~4 % 4294967296 <= 2147483647 then ssl3_connect_~__cil_tmp58~4 % 4294967296 else ssl3_connect_~__cil_tmp58~4 % 4294967296 - 4294967296);
    assume !(ssl3_connect_~s__hit~4 == 0);
    ssl3_connect_~s__s3__tmp__next_state___0~4 := 3;
    ssl3_connect_~__cil_tmp59~4 := ssl3_connect_~s__s3__flags~4;
    assume ssl3_connect_~__cil_tmp59~4 + 2 == 0;
    ssl3_connect_~s__init_num~4 := 0;
    goto loc4;
  loc18_1:
    assume !(ssl3_connect_~s__state~4 == 4528);
  ...
  loc19_1:
    assume ssl3_connect_~s__state~4 == 4560;
    assume 0 <= ssl3_connect_#t~nondet43 + 2147483648 && ssl3_connect_#t~nondet43 <= 2147483647;
    ssl3_connect_~ret~4 := ssl3_connect_#t~nondet43;
    havoc ssl3_connect_#t~nondet43;
    assume !(ssl3_connect_~ret~4 <= 0);
    assume !(ssl3_connect_~s__hit~4 == 0);
    ssl3_connect_~s__state~4 := 4512;
    ssl3_connect_~s__init_num~4 := 0;
