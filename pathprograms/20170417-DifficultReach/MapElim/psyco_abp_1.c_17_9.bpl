...
modifies ;
{
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume !((if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == (if main_~this_expect~3 < 0 && !(main_~this_expect~3 % 2 == 0) then main_~this_expect~3 % 2 - 2 else main_~this_expect~3 % 2)) && (if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == 0;
    goto loc6;
  loc4_1:
    assume (if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == (if main_~this_expect~3 < 0 && !(main_~this_expect~3 % 2 == 0) then main_~this_expect~3 % 2 - 2 else main_~this_expect~3 % 2) && main_~this_buffer_empty~3 == 1;
    main_~q~3 := 3;
  ...
  loc7_1:
    ...
    assume main_~P1~4 == 1;
    main_~method_id~3 := 7;
    assume !(main_~this_buffer_empty~3 == 1) && main_~P9~4 == (if main_~this_expect~3 < 1 && !((main_~this_expect~3 + 1) % 2 == 0) then (main_~this_expect~3 + 1) % 2 - 2 else (main_~this_expect~3 + 1) % 2);
    main_~q~3 := 1;
    main_~this_expect~3 := main_~this_expect~3;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
