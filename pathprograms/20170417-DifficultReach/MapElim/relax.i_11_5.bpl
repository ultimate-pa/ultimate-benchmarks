...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume !(is_relaxed_prefix_~i~9 % 18446744073709551616 < is_relaxed_prefix_~a_length % 18446744073709551616);
    ...
    havoc main_#t~pre27;
    assume 1 < main_~differences~16 % 18446744073709551616 || !(1 < main_~differences~16 % 18446744073709551616);
    __VERIFIER_assert_#in~cond := (if 1 < main_~differences~16 % 18446744073709551616 then 1 else 0);
