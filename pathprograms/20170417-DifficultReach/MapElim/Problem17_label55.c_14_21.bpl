...
modifies ~a24, ~a21, ~a28, ~a26, ~a14;
{
  ...
  loc81_0:
    ...
    assume !(calculate_output_~input == 3);
    assume !(~a28 <= 134);
    assume ((((~a21 <= 127 && 300 < ~a28) && calculate_output_~input == 1) && ~a24 == 2) && ~a14 + 182 <= 0) && 217 < ~a26;
    assume ((!(5 * (~a14 % 14) % 14 == 0) && 5 * (~a14 % 14) < 490) && (((!(5 * (~a14 % 14) % 14 == 0) && (((!(~a14 % 14 == 0) && ~a14 < 0) || !(~a14 < 0)) || ~a14 % 14 == 0)) && 5 * (~a14 % 14) < 420) || ((!(5 * (~a14 % 14) < 420) || 5 * (~a14 % 14) % 14 == 0) && (((!(~a14 % 14 == 0) && ~a14 < 0) || !(~a14 < 0)) || ~a14 % 14 == 0)))) || ((((!(5 * (~a14 % 14) % 14 == 0) && (((!(~a14 % 14 == 0) && ~a14 < 0) || !(~a14 < 0)) || ~a14 % 14 == 0)) && 5 * (~a14 % 14) < 420) || ((!(5 * (~a14 % 14) < 420) || 5 * (~a14 % 14) % 14 == 0) && (((!(~a14 % 14 == 0) && ~a14 < 0) || !(~a14 < 0)) || ~a14 % 14 == 0))) && (!(5 * (~a14 % 14) < 490) || 5 * (~a14 % 14) % 14 == 0));
  ...
  loc81_1:
    ...
    assume ((!(~a14 % 299909 == 0) && ~a14 < 0) || !(~a14 < 0)) || ~a14 % 299909 == 0;
