...
modifies ~a24, ~a21, ~a28, ~a26, ~a14;
{
  ...
  loc4_2:
    ...
    goto loc5;
  loc5:
    goto loc5_0, loc5_1, loc5_2, loc5_3;
  loc5_0:
    assume !(~a28 <= 37);
    goto loc6;
  loc5_1:
  ...
  loc83_0:
    ...
    goto loc84;
  loc83_1:
    assume ((((~a21 <= 127 && ~a24 == 2) && ~a14 + 182 <= 0) && ~a28 <= 134) && calculate_output_~input == 6) && ~a26 + 68 <= 0;
    assume (((((!((~a14 * 9 / 10 + 1 + -48560) % 14 == 0) && ~a14 * 9 / 10 + 1 + -48560 < 0) || !(~a14 * 9 / 10 + 1 + -48560 < 0)) || (~a14 * 9 / 10 + 1 + -48560) % 14 == 0) && !(9 * ~a14 % 10 == 0)) && 9 * ~a14 < 0) || ((((!((~a14 * 9 / 10 + -48560) % 14 == 0) && ~a14 * 9 / 10 + -48560 < 0) || !(~a14 * 9 / 10 + -48560 < 0)) || (~a14 * 9 / 10 + -48560) % 14 == 0) && (!(9 * ~a14 < 0) || 9 * ~a14 % 10 == 0));
    ~a14 := (if (if 9 * ~a14 < 0 && !(9 * ~a14 % 10 == 0) then ~a14 * 9 / 10 + 1 else ~a14 * 9 / 10) + -48560 < 0 && !(((if 9 * ~a14 < 0 && !(9 * ~a14 % 10 == 0) then ~a14 * 9 / 10 + 1 else ~a14 * 9 / 10) + -48560) % 14 == 0) then ((if 9 * ~a14 < 0 && !(9 * ~a14 % 10 == 0) then ~a14 * 9 / 10 + 1 else ~a14 * 9 / 10) + -48560) % 14 - 14 else ((if 9 * ~a14 < 0 && !(9 * ~a14 % 10 == 0) then ~a14 * 9 / 10 + 1 else ~a14 * 9 / 10) + -48560) % 14) + -98;
    assume ((~a28 < 0 && !(~a28 % 82 == 0)) || !(~a28 < 0)) || ~a28 % 82 == 0;
    ~a28 := (if ~a28 < 0 && !(~a28 % 82 == 0) then ~a28 % 82 - 82 else ~a28 % 82) + 217;
  ...
  loc99_0:
    ...
    assume !(134 < ~a28);
    assume !(0 < ~a14 + 84);
    assume !(134 < ~a28) && !(~a26 + 68 <= 0);
    assume !(0 < ~a14 + 114);
    assume !(0 < ~a14 + 84);
    assume !(134 < ~a28) && !(0 < ~a14 + 114);
    assume !(37 < ~a28);
    assume !(~a26 + 68 <= 0);
    assume !(37 < ~a28);
    assume !(calculate_output_~input == 3);
    ...
    assume !(~a14 + 182 <= 0);
    assume !(~a26 + 68 <= 0);
    assume (((((0 < ~a14 + 182 && ~a14 + 114 <= 0) && calculate_output_~input == 1) && ~a24 == 2) && 217 < ~a26) && ~a21 <= 127) && ~a28 <= 37;
    ...
    goto loc85;
  loc99_1:
    assume (((((~a14 + 84 <= 0 && ~a26 + 68 <= 0) && 0 < ~a14 + 114) && ~a28 <= 300) && ~a21 <= 127) && calculate_output_~input == 4) && ~a24 == 2;
    assume ((!(~a14 % 5 == 0) && ~a14 < 0) || !(~a14 < 0)) || ~a14 % 5 == 0;
    ~a14 := (if ~a14 < 0 && !(~a14 % 5 == 0) then ~a14 / 5 + 1 else ~a14 / 5) - 46740 - -32098;
    assume ((!(~a26 % 46 == 0) && ~a26 < 0) || !(~a26 < 0)) || ~a26 % 46 == 0;
    ~a26 := (if ~a26 < 0 && !(~a26 % 46 == 0) then ~a26 % 46 - 46 else ~a26 % 46) - -199 + -16;
    assume ((9 * ~a28 < 0 && !(9 * ~a28 % 10 == 0)) || !(9 * ~a28 < 0)) || 9 * ~a28 % 10 == 0;
    ~a28 := (if 9 * ~a28 < 0 && !(9 * ~a28 % 10 == 0) then ~a28 * 9 / 10 + 1 else ~a28 * 9 / 10) + -35946 + -1966;
    calculate_output_#res := 25;
    goto loc85;
}
