...
modifies ;
{
    ...
    var ssl3_connect_~__cil_tmp59~4.base : int;
    ...
    var ssl3_connect_~__cil_tmp67~4 : int;
    ...
    var ssl3_connect_~__cil_tmp70~4 : int;
    ...
    var ssl3_connect_~__cil_tmp71~4 : int;
    ...
    var ssl3_connect_~__cil_tmp73~4 : int;
    ...
    var ssl3_connect_~__cil_tmp69~4 : int;
    var ssl3_connect_#t~nondet41 : int;
    var ssl3_connect_#t~nondet22 : int;
    var ssl3_connect_~__cil_tmp56~4.offset : int;
    var main_~s~148 : int;
    ...
    var ssl3_connect_~__cil_tmp56~4.base : int;
    var ssl3_connect_~__cil_tmp68~4 : int;
    ...
    var ssl3_connect_~__cil_tmp66~4 : int;
    ...
    var ssl3_connect_~__cil_tmp59~4.offset : int;
    ...
    var ssl3_connect_~__cil_tmp72~4 : int;
    ...
    var ssl3_connect_~__cil_tmp74~4 : int;
    var ssl3_connect_~s__hit~4 : int;
    var ssl3_connect_~s__ctx__info_callback~4 : int;

  loc0:
    havoc main_#res;
    havoc main_~s~148, main_#t~ret48;
    havoc main_~s~148;
    main_~s~148 := 12292;
    ssl3_connect_#in~initial_state := main_~s~148;
    havoc ssl3_connect_#res;
    havoc ssl3_connect_#t~nondet20, ssl3_connect_#t~nondet24, ssl3_connect_#t~nondet43, ssl3_connect_~__cil_tmp59~4.base, ssl3_connect_~s__s3__tmp__new_compression~4, ssl3_connect_~s__in_handshake~4, ssl3_connect_#t~nondet9, ssl3_connect_~s__session__compress_meth~4, ssl3_connect_~tmp___6~4, ssl3_connect_~s__ctx__stats__sess_hit~4, ssl3_connect_~buf~4, ssl3_connect_~s__s3__tmp__new_cipher__algorithms~4, ssl3_connect_~l~4, ssl3_connect_~__cil_tmp67~4, ssl3_connect_~__cil_tmp65~4, ssl3_connect_#t~nondet35, ssl3_connect_~s__new_session~4, ssl3_connect_#t~nondet12, ssl3_connect_#t~nondet0, ssl3_connect_#t~nondet39, ssl3_connect_#t~nondet16, ssl3_connect_#t~nondet4, ssl3_connect_~s__init_buf___0~4, ssl3_connect_~s__server~4, ssl3_connect_~s__s3__delay_buf_pop_ret~4, ssl3_connect_~__cil_tmp70~4, ssl3_connect_#t~post45, ssl3_connect_~s__version~4, ssl3_connect_~tmp___4~4, ssl3_connect_~initial_state, ssl3_connect_#t~nondet42, ssl3_connect_~__cil_tmp71~4, ssl3_connect_#t~nondet46, ssl3_connect_#t~nondet23, ssl3_connect_~__cil_tmp62~4, ssl3_connect_#t~nondet27, ssl3_connect_~state~4, ssl3_connect_~s__state~4, ssl3_connect_~ret~4, ssl3_connect_#t~nondet30, ssl3_connect_~tmp___7~4, ssl3_connect_~tmp___2~4, ssl3_connect_~num1~4, ssl3_connect_#t~nondet11, ssl3_connect_#t~nondet34, ssl3_connect_~__cil_tmp60~4, ssl3_connect_~__cil_tmp73~4, ssl3_connect_#t~nondet15, ssl3_connect_#t~nondet38, ssl3_connect_#t~nondet1, ssl3_connect_#t~post44, ssl3_connect_#t~nondet19, ssl3_connect_~cb~4, ssl3_connect_#t~nondet5, ssl3_connect_~s__rwstate~4, ssl3_connect_#t~post29, ssl3_connect_~s__type~4, ssl3_connect_~tmp___9~4, ssl3_connect_~s__wbio~4, ssl3_connect_~skip~4, ssl3_connect_~tmp___0~4, ssl3_connect_~__cil_tmp69~4, ssl3_connect_#t~nondet41, ssl3_connect_#t~nondet22, ssl3_connect_~__cil_tmp56~4.offset, ssl3_connect_~tmp___5~4, ssl3_connect_#t~nondet26, ssl3_connect_#t~post31, ssl3_connect_~tmp~4, ssl3_connect_~s__shutdown~4, ssl3_connect_~__cil_tmp56~4.base, ssl3_connect_~__cil_tmp68~4, ssl3_connect_~s__s3__tmp__new_cipher~4, ssl3_connect_#t~nondet7, ssl3_connect_~s__debug~4, ssl3_connect_~__cil_tmp58~4, ssl3_connect_~tmp___3~4, ssl3_connect_~s__ctx__stats__sess_connect~4, ssl3_connect_#t~nondet10, ssl3_connect_#t~nondet33, ssl3_connect_~s__bbio~4, ssl3_connect_~s__s3__change_cipher_spec~4, ssl3_connect_#t~nondet14, ssl3_connect_#t~nondet2, ssl3_connect_#t~nondet37, ssl3_connect_~s__s3__flags~4, ssl3_connect_~__cil_tmp66~4, ssl3_connect_#t~nondet18, ssl3_connect_#t~nondet6, ssl3_connect_~new_state~4, ssl3_connect_~s__session__cipher~4, ssl3_connect_#t~post28, ssl3_connect_~__cil_tmp64~4, ssl3_connect_#t~post47, ssl3_connect_~__cil_tmp59~4.offset, ssl3_connect_~s__s3__tmp__cert_req~4, ssl3_connect_~blastFlag~4, ssl3_connect_#t~nondet40, ssl3_connect_#t~nondet21, ssl3_connect_#t~nondet25, ssl3_connect_~__cil_tmp55~4, ssl3_connect_#t~nondet8, ssl3_connect_~s__ctx__stats__sess_connect_renegotiate~4, ssl3_connect_~s__init_num~4, ssl3_connect_~__cil_tmp72~4, ssl3_connect_~__cil_tmp63~4, ssl3_connect_~__cil_tmp57~4, ssl3_connect_#t~nondet13, ssl3_connect_#t~nondet32, ssl3_connect_~s__ctx__stats__sess_connect_good~4, ssl3_connect_~s__s3__tmp__new_compression__id~4, ssl3_connect_#t~nondet17, ssl3_connect_#t~nondet36, ssl3_connect_#t~nondet3, ssl3_connect_~s__s3__tmp__next_state___0~4, ssl3_connect_~s__info_callback~4, ssl3_connect_~s__s3__tmp__reuse_message~4, ssl3_connect_~tmp___1~4, ssl3_connect_~tmp___8~4, ssl3_connect_~__cil_tmp61~4, ssl3_connect_~__cil_tmp74~4, ssl3_connect_~s__hit~4, ssl3_connect_~s__ctx__info_callback~4;
    ...
    havoc ssl3_connect_~__cil_tmp56~4.offset, ssl3_connect_~__cil_tmp56~4.base;
    havoc ssl3_connect_~__cil_tmp57~4;
    havoc ssl3_connect_~__cil_tmp58~4;
    havoc ssl3_connect_~__cil_tmp59~4.base, ssl3_connect_~__cil_tmp59~4.offset;
    ...
    havoc ssl3_connect_~__cil_tmp66~4;
    havoc ssl3_connect_~__cil_tmp67~4;
    havoc ssl3_connect_~__cil_tmp68~4;
    havoc ssl3_connect_~__cil_tmp69~4;
    havoc ssl3_connect_~__cil_tmp70~4;
    havoc ssl3_connect_~__cil_tmp71~4;
    havoc ssl3_connect_~__cil_tmp72~4;
    havoc ssl3_connect_~__cil_tmp73~4;
    havoc ssl3_connect_~__cil_tmp74~4;
  ...
  loc2_1:
    ...
    ssl3_connect_~__cil_tmp56~4.offset, ssl3_connect_~__cil_tmp56~4.base := 0, 0;
    ssl3_connect_~__cil_tmp57~4 := ssl3_connect_~__cil_tmp56~4.base + ssl3_connect_~__cil_tmp56~4.offset;
    ssl3_connect_~__cil_tmp58~4 := ssl3_connect_~s__init_buf___0~4;
    assume !(ssl3_connect_~__cil_tmp58~4 % 18446744073709551616 == ssl3_connect_~__cil_tmp57~4 % 18446744073709551616);
  ...
  loc7_1:
    assume ssl3_connect_~s__state~4 == 4400;
    ssl3_connect_~__cil_tmp64~4 := ssl3_connect_~s__s3__tmp__new_cipher__algorithms~4;
    goto loc11;
  loc8:
    goto loc8_0, loc8_1;
  loc8_0:
  ...
  loc9:
    ...
    ssl3_connect_~s__init_num~4 := 0;
    ssl3_connect_~__cil_tmp62~4 := ssl3_connect_~s__wbio~4;
    ssl3_connect_~__cil_tmp63~4 := ssl3_connect_~s__bbio~4;
    assume !(ssl3_connect_~__cil_tmp63~4 % 18446744073709551616 == ssl3_connect_~__cil_tmp62~4 % 18446744073709551616);
    goto loc4;
  loc10:
  ...
  loc11_0:
    assume !((ssl3_connect_~__cil_tmp64~4 + 256) % 18446744073709551616 == 0);
    ssl3_connect_~skip~4 := 1;
    goto loc15;
  loc11_1:
    assume (ssl3_connect_~__cil_tmp64~4 + 256) % 18446744073709551616 == 0;
  ...
  loc22_0:
    ...
    ssl3_connect_~__cil_tmp65~4 := ssl3_connect_~s__s3__flags~4;
    ssl3_connect_~__cil_tmp66~4 := ssl3_connect_~__cil_tmp65~4 - 5;
    assume ssl3_connect_~__cil_tmp66~4 % 4294967296 <= 2147483647 || !(ssl3_connect_~__cil_tmp66~4 % 4294967296 <= 2147483647);
    ssl3_connect_~s__s3__flags~4 := (if ssl3_connect_~__cil_tmp66~4 % 4294967296 <= 2147483647 then ssl3_connect_~__cil_tmp66~4 % 4294967296 else ssl3_connect_~__cil_tmp66~4 % 4294967296 - 4294967296);
    assume ssl3_connect_~s__hit~4 == 0;
  ...
  loc22_1:
    ...
    ssl3_connect_~__cil_tmp70~4 := ssl3_connect_~num1~4;
    assume !(0 < ssl3_connect_~__cil_tmp70~4);
