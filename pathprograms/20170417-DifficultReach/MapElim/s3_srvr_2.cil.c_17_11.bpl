...
modifies ;
{
  ...
  loc2_1:
    assume ssl3_accept_~s__state~5 == 16384;
    ssl3_accept_~s__server~5 := 1;
    assume !(ssl3_accept_~cb~5 == 0);
    ssl3_accept_~__cil_tmp55~5 := ssl3_accept_~s__version~5 * 8;
    assume ssl3_accept_~__cil_tmp55~5 == 3;
    ssl3_accept_~s__type~5 := 8192;
    assume !(ssl3_accept_~s__init_buf___0~5 == 0);
    assume !(ssl3_accept_~tmp___4~5 == 0);
    ssl3_accept_~s__init_num~5 := 0;
    assume !(ssl3_accept_~s__state~5 == 12292);
    assume !(ssl3_accept_~tmp___5~5 == 0);
    ssl3_accept_~s__state~5 := 8464;
    ssl3_accept_#t~post30 := ssl3_accept_~s__ctx__stats__sess_accept~5;
    ssl3_accept_~s__ctx__stats__sess_accept~5 := ssl3_accept_#t~post30 + 1;
    havoc ssl3_accept_#t~post30;
    goto loc4;
  loc3:
    goto loc3_0, loc3_1;
  loc3_0:
