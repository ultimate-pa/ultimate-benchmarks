...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~x~9__1, main_~n~4, main_~element~4, main_~found~4, main_~x~9, main_#t~post2, main_#t~post1, main_#t~post0, v_rep_select_ULTIMATE.start_main_~vectorx~4__PLUS_ULTIMATE.start_main_~i~4_1___1, main_~i~4, v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~i~4__1, main_~pos~4;
    ...
    main_~found~4 := 0;
    havoc v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~x~9__1, v_rep_select_ULTIMATE.start_main_~vectorx~4__PLUS_ULTIMATE.start_main_~i~4_1___1, v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~i~4__1;
    main_~i~4 := 0;
  ...
  loc2_1:
    ...
    assume !(main_~found~4 == 0);
    havoc v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~x~9__1, main_~x~9;
    main_~x~9 := 0;
    havoc v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~x~9__1;
    assume main_~x~9 < main_~pos~4;
    assume !(v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~x~9__1 == main_~element~4) || v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~x~9__1 == main_~element~4;
    __VERIFIER_assert_#in~cond := (if !(v_rep_select_ULTIMATE.start_main_~vectorx~4_ULTIMATE.start_main_~x~9__1 == main_~element~4) then 1 else 0);
