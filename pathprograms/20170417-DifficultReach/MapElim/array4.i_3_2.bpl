...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~nondet1, main_#t~post2, v_rep_select_ULTIMATE.start_main_~A~5_ULTIMATE.start_main_~i~5__1, v_rep_select_ULTIMATE.start_main_~A~5_1023__1, main_#t~post0, main_~i~5;
    havoc v_rep_select_ULTIMATE.start_main_~A~5_ULTIMATE.start_main_~i~5__1, v_rep_select_ULTIMATE.start_main_~A~5_1023__1;
  ...
  loc2_0:
    ...
    assume main_~i~5 <= 1024 || !(main_~i~5 <= 1024);
    __VERIFIER_assert_#in~cond := (if main_~i~5 <= 1024 then 1 else 0);
