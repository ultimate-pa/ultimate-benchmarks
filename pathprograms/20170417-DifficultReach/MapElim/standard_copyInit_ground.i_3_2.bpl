...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc v_rep_select_ULTIMATE.start_main_~a~4_ULTIMATE.start_main_~i~4__1, main_~x~4, main_#t~post1, v_rep_select_ULTIMATE.start_main_~b~4_ULTIMATE.start_main_~x~4__1, main_#t~post0, main_~i~4, v_rep_select_ULTIMATE.start_main_~b~4_ULTIMATE.start_main_~i~4__1;
  ...
  loc4_1:
    ...
    assume v_rep_select_ULTIMATE.start_main_~b~4_ULTIMATE.start_main_~x~4__1 == 42 || !(v_rep_select_ULTIMATE.start_main_~b~4_ULTIMATE.start_main_~x~4__1 == 42);
    __VERIFIER_assert_#in~cond := (if v_rep_select_ULTIMATE.start_main_~b~4_ULTIMATE.start_main_~x~4__1 == 42 then 1 else 0);
