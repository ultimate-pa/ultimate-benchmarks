...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_0:
    ...
    assume main_#t~nondet5 % 256 <= 127 || !(main_#t~nondet5 % 256 <= 127);
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, main_~#x~9.base, (if main_#t~nondet5 % 256 <= 127 then main_#t~nondet5 % 256 else main_#t~nondet5 % 256 - 256), main_~i~9 + main_~#x~9.offset;
  ...
  loc4_0:
    assume !(main_~i~9 < 1000);
    assume ((0 <= main_~offset~9 && main_~offset~9 <= 1000) || !(0 <= main_~offset~9)) || !(main_~offset~9 <= 1000);
    __VERIFIER_assert_#in~cond := (if 0 <= main_~offset~9 && main_~offset~9 <= 1000 then 1 else 0);
