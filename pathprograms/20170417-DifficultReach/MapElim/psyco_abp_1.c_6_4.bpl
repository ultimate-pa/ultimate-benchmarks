...
modifies ;
{
  ...
  loc3_0:
    ...
    main_~method_id~3 := 2;
    assume (main_~this_buffer_empty~3 == 1 && (if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == 0) && (if main_~P1~4 < 0 && !(main_~P1~4 % 2 == 0) then main_~P1~4 % 2 - 2 else main_~P1~4 % 2) == (if main_~this_expect~3 < 0 && !(main_~this_expect~3 % 2 == 0) then main_~this_expect~3 % 2 - 2 else main_~this_expect~3 % 2);
    goto loc4;
  loc3_1:
    assume main_~q~3 == 1;
