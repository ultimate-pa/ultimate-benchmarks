...
modifies ;
{
  ...
  loc9_1:
    ...
    assume ((((ssl3_accept_~s__state~4 < 0 && !(ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0)) || !(ssl3_accept_~s__state~4 < 0)) || ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0) && ssl3_accept_~s__s3__tmp__next_state___0~4 < 0) || (!(ssl3_accept_~s__s3__tmp__next_state___0~4 < 0) && (((ssl3_accept_~s__state~4 < 0 && !(ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0)) || !(ssl3_accept_~s__state~4 < 0)) || ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0));
