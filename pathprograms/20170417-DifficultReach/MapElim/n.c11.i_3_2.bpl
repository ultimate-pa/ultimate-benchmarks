...
modifies ;
{
  ...
  loc2_0:
    ...
    assume ((main_~len~5 % 4294967296 < 5 && 0 <= main_~len~5 % 4294967296) || !(0 <= main_~len~5 % 4294967296)) || !(main_~len~5 % 4294967296 < 5);
    __VERIFIER_assert_#in~cond := (if 0 <= main_~len~5 % 4294967296 && main_~len~5 % 4294967296 < 5 then 1 else 0);
  ...
  loc2_1:
    assume !(main_#t~nondet0 % 256 == 0);
    havoc main_#t~nondet0;
    assume !(main_~len~5 % 4294967296 == 4);
