...
modifies ~cleanupTimeShifts, ~systemActive, ~pumpRunning, ~methaneLevelCritical, ~switchedOnBeforeTS, ~waterLevel;
{
  ...
  loc6_0:
    ...
    assume isHighWaterLevel_#t~ret9 <= 2147483647 && 0 <= isHighWaterLevel_#t~ret9 + 2147483648;
    ...
    assume processEnvironment__wrappee__highWaterSensor_#t~ret5 <= 2147483647 && 0 <= processEnvironment__wrappee__highWaterSensor_#t~ret5 + 2147483648;
  ...
  loc6_1:
    ...
    isLowWaterSensorDry_~retValue_acc~88 := (if ~waterLevel == 0 then 1 else 0);
