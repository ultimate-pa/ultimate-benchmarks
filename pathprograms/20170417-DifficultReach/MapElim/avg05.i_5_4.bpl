...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc4_0:
    assume !(avg_~i~3 < 5);
    assume ((((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647 && (((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0)) || (!((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647) && (((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0))) && avg_~ret~3 / 5 % 4294967296 <= 2147483647) || (!(avg_~ret~3 / 5 % 4294967296 <= 2147483647) && (((((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0) && (avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647) || ((((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0) && !((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647))));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 - 4294967296);
  ...
  loc6_0:
    assume !(avg_~i~3 < 5);
    assume ((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) && ((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647 || !((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647))) || ((avg_~ret~3 / 5 % 4294967296 <= 2147483647 || !(avg_~ret~3 / 5 % 4294967296 <= 2147483647)) && (!(avg_~ret~3 < 0) || avg_~ret~3 % 5 == 0));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 - 4294967296);
  ...
  loc10_1:
    assume !(avg_~i~3 < 5);
    assume ((((((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0) && avg_~ret~3 / 5 % 4294967296 <= 2147483647) || ((((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0) && !(avg_~ret~3 / 5 % 4294967296 <= 2147483647))) && (avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647) || (!((avg_~ret~3 / 5 + 1) % 4294967296 <= 2147483647) && (((((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0) && avg_~ret~3 / 5 % 4294967296 <= 2147483647) || ((((avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0)) || !(avg_~ret~3 < 0)) || avg_~ret~3 % 5 == 0) && !(avg_~ret~3 / 5 % 4294967296 <= 2147483647))));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 5 == 0) then avg_~ret~3 / 5 + 1 else avg_~ret~3 / 5) % 4294967296 - 4294967296);
