...
modifies ~N, #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_0:
    ...
    assume ((((((((rangesum_~ret~3 / rangesum_~cnt~3 + 1) % 4294967296 <= 2147483647 && (((rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647 && (rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0))) || ((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && !((rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647)))) || (!((rangesum_~ret~3 / rangesum_~cnt~3 + 1) % 4294967296 <= 2147483647) && (((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && (rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647) || ((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && !((rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647))))) && rangesum_~ret~3 < 0) && !(rangesum_~ret~3 % rangesum_~cnt~3 == 0)) || (((rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647 && (((rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647 && (rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0))) || (!((rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647) && (rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0))))) || ((((rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647 && (rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0))) || (!((rangesum_~ret~3 / rangesum_~cnt~3 - 1) % 4294967296 <= 2147483647) && (rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)))) && !(rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647))) && (!(rangesum_~ret~3 < 0) || rangesum_~ret~3 % rangesum_~cnt~3 == 0))) && rangesum_~ret~3 < 0) && !(rangesum_~ret~3 % rangesum_~cnt~3 == 0)) || (((((((rangesum_~ret~3 / rangesum_~cnt~3 + 1) % 4294967296 <= 2147483647 && ((rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647 && (rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0))) || ((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && !(rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647)))) || (!((rangesum_~ret~3 / rangesum_~cnt~3 + 1) % 4294967296 <= 2147483647) && ((rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647 && (rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0))) || ((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && !(rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647))))) && rangesum_~ret~3 < 0) && !(rangesum_~ret~3 % rangesum_~cnt~3 == 0)) || ((((((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647) || ((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && !(rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647))) && rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647) || ((((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647) || ((rangesum_~cnt~3 < 0 || !(rangesum_~cnt~3 < 0)) && !(rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647))) && !(rangesum_~ret~3 / rangesum_~cnt~3 % 4294967296 <= 2147483647))) && (!(rangesum_~ret~3 < 0) || rangesum_~ret~3 % rangesum_~cnt~3 == 0))) && (!(rangesum_~ret~3 < 0) || rangesum_~ret~3 % rangesum_~cnt~3 == 0));
    rangesum_#res := (if (if rangesum_~ret~3 < 0 && !(rangesum_~ret~3 % rangesum_~cnt~3 == 0) then (if rangesum_~cnt~3 < 0 then rangesum_~ret~3 / rangesum_~cnt~3 - 1 else rangesum_~ret~3 / rangesum_~cnt~3 + 1) else rangesum_~ret~3 / rangesum_~cnt~3) % 4294967296 <= 2147483647 then (if rangesum_~ret~3 < 0 && !(rangesum_~ret~3 % rangesum_~cnt~3 == 0) then (if rangesum_~cnt~3 < 0 then rangesum_~ret~3 / rangesum_~cnt~3 - 1 else rangesum_~ret~3 / rangesum_~cnt~3 + 1) else rangesum_~ret~3 / rangesum_~cnt~3) % 4294967296 else (if rangesum_~ret~3 < 0 && !(rangesum_~ret~3 % rangesum_~cnt~3 == 0) then (if rangesum_~cnt~3 < 0 then rangesum_~ret~3 / rangesum_~cnt~3 - 1 else rangesum_~ret~3 / rangesum_~cnt~3 + 1) else rangesum_~ret~3 / rangesum_~cnt~3) % 4294967296 - 4294967296);
  ...
  loc8_0:
    ...
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := main_~#x~7.base, 4 * main_~i~8 + main_~#x~7.offset + 4, 4;
    havoc v_rep_select__select_ULTIMATE.start_write~int_old_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1, v_rep_select__select_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1;
    havoc read~int_#value;
    assume read~int_#value == v_rep_select__select_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1;
    main_#t~mem12 := read~int_#value;
    v_rep_select__select_ULTIMATE.start_write~int_old_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_ULTIMATE.start_write~int_old_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1 := v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 4, main_~#x~7.base, main_#t~mem12, 4 * main_~i~8 + main_~#x~7.offset;
    havoc v_rep_select__select_ULTIMATE.start_write~int_old_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1;
    havoc v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1, v_rep_select__select_#memory_int_ULTIMATE.start_read~int_#ptr.base__ULTIMATE.start_read~int_#ptr.offset__1;
    assume v_rep_select__select_#memory_int_ULTIMATE.start_write~int_#ptr.base__ULTIMATE.start_write~int_#ptr.offset__1 == write~int_#value;
    havoc main_#t~mem12;
    main_#t~post10 := main_~i~8;
    main_~i~8 := main_#t~post10 + 1;
