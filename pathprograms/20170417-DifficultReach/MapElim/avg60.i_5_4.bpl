...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc4_0:
    assume !(avg_~i~3 < 60);
    assume ((avg_~ret~3 < 0 && ((avg_~ret~3 / 60 + 1) % 4294967296 <= 2147483647 || !((avg_~ret~3 / 60 + 1) % 4294967296 <= 2147483647))) && !(avg_~ret~3 % 60 == 0)) || ((avg_~ret~3 / 60 % 4294967296 <= 2147483647 || !(avg_~ret~3 / 60 % 4294967296 <= 2147483647)) && (!(avg_~ret~3 < 0) || avg_~ret~3 % 60 == 0));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 - 4294967296);
  ...
  loc6_0:
    assume !(avg_~i~3 < 60);
    assume ((avg_~ret~3 < 0 && ((avg_~ret~3 / 60 + 1) % 4294967296 <= 2147483647 || !((avg_~ret~3 / 60 + 1) % 4294967296 <= 2147483647))) && !(avg_~ret~3 % 60 == 0)) || ((!(avg_~ret~3 < 0) || avg_~ret~3 % 60 == 0) && (avg_~ret~3 / 60 % 4294967296 <= 2147483647 || !(avg_~ret~3 / 60 % 4294967296 <= 2147483647)));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 - 4294967296);
  ...
  loc10_0:
    assume !(avg_~i~3 < 60);
    assume ((avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0)) && ((avg_~ret~3 / 60 + 1) % 4294967296 <= 2147483647 || !((avg_~ret~3 / 60 + 1) % 4294967296 <= 2147483647))) || ((avg_~ret~3 / 60 % 4294967296 <= 2147483647 || !(avg_~ret~3 / 60 % 4294967296 <= 2147483647)) && (!(avg_~ret~3 < 0) || avg_~ret~3 % 60 == 0));
    avg_#res := (if (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 <= 2147483647 then (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 else (if avg_~ret~3 < 0 && !(avg_~ret~3 % 60 == 0) then avg_~ret~3 / 60 + 1 else avg_~ret~3 / 60) % 4294967296 - 4294967296);
