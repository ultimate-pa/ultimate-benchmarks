...
modifies ;
{
  ...
  loc5:
    goto loc5_0, loc5_1;
  loc5_0:
    assume !(main_~P3~4 == (if main_~this_expect~3 < 1 && !((main_~this_expect~3 + 1) % 2 == 0) then (main_~this_expect~3 + 1) % 2 - 2 else (main_~this_expect~3 + 1) % 2)) && main_~P3~4 == 0;
    goto loc7;
  loc5_1:
    assume main_~P3~4 == (if main_~this_expect~3 < 1 && !((main_~this_expect~3 + 1) % 2 == 0) then (main_~this_expect~3 + 1) % 2 - 2 else (main_~this_expect~3 + 1) % 2) && !(main_~this_buffer_empty~3 == 1);
    main_~q~3 := 4;
