...
modifies ;
{
  ...
  loc0:
    ...
    havoc ssl3_connect_#t~nondet20, ssl3_connect_#t~nondet24, ssl3_connect_#t~nondet28, ssl3_connect_~state~3, ssl3_connect_~blastFlag~3, ssl3_connect_#t~nondet9, ssl3_connect_#t~nondet31, ssl3_connect_#t~nondet35, ssl3_connect_#t~nondet12, ssl3_connect_#t~nondet0, ssl3_connect_#t~nondet39, ssl3_connect_#t~nondet16, ssl3_connect_~s__s3__tmp__new_compression__id~3, ssl3_connect_~cb~3, ssl3_connect_#t~nondet4, ssl3_connect_~s__rwstate~3, ssl3_connect_~s__info_callback~3, ssl3_connect_~tmp___1~3, ssl3_connect_~tmp___8~3, ssl3_connect_~s__type~3, ssl3_connect_~s__hit~3, ssl3_connect_~tmp___5~3, ssl3_connect_#t~nondet23, ssl3_connect_~s__s3__tmp__new_cipher~3, ssl3_connect_#t~nondet27, ssl3_connect_~tmp~3, ssl3_connect_~tmp___3~3, ssl3_connect_~s__s3__tmp__new_cipher__algorithms~3, ssl3_connect_~s__in_handshake~3, ssl3_connect_~buf~3, ssl3_connect_#t~nondet30, ssl3_connect_#t~nondet11, ssl3_connect_#t~nondet34, ssl3_connect_~s__new_session~3, ssl3_connect_#t~nondet15, ssl3_connect_#t~nondet38, ssl3_connect_~s__s3__flags~3, ssl3_connect_~s__session__cipher~3, ssl3_connect_~s__init_buf___0~3, ssl3_connect_#t~nondet1, ssl3_connect_#t~nondet19, ssl3_connect_#t~nondet5, ssl3_connect_~s__server~3, ssl3_connect_~s__version~3, ssl3_connect_~s__s3__tmp__cert_req~3, ssl3_connect_~ag_Y~3, ssl3_connect_#t~nondet22, ssl3_connect_#t~nondet26, ssl3_connect_~ag_X~3, ssl3_connect_~__retres60~3, ssl3_connect_#t~nondet7, ssl3_connect_~s__state~3, ssl3_connect_~s__init_num~3, ssl3_connect_~s__ctx__stats__sess_connect_renegotiate~3, ssl3_connect_~ret~3, ssl3_connect_~tmp___7~3, ssl3_connect_~tmp___2~3, ssl3_connect_~num1~3, ssl3_connect_#t~nondet10, ssl3_connect_#t~nondet33, ssl3_connect_#t~nondet14, ssl3_connect_#t~nondet2, ssl3_connect_#t~nondet37, ssl3_connect_~s__ctx__stats__sess_connect_good~3, ssl3_connect_#t~nondet18, ssl3_connect_#t~nondet6, ssl3_connect_~s__s3__tmp__next_state___0~3, ssl3_connect_~s__wbio~3, ssl3_connect_~s__s3__tmp__reuse_message~3, ssl3_connect_~skip~3, ssl3_connect_~tmp___0~3, ssl3_connect_~tmp___9~3, ssl3_connect_~s__ctx__info_callback~3, ssl3_connect_#t~nondet40, ssl3_connect_#t~nondet21, ssl3_connect_~tmp___4~3, ssl3_connect_#t~nondet25, ssl3_connect_#t~nondet29, ssl3_connect_~s__s3__tmp__new_compression~3, ssl3_connect_~s__shutdown~3, ssl3_connect_#t~nondet8, ssl3_connect_~s__debug~3, ssl3_connect_~s__session__compress_meth~3, ssl3_connect_~tmp___6~3, ssl3_connect_~s__ctx__stats__sess_hit~3, ssl3_connect_~s__ctx__stats__sess_connect~3, ssl3_connect_~l~3, ssl3_connect_#t~nondet13, ssl3_connect_#t~nondet32, ssl3_connect_~s__bbio~3, ssl3_connect_~s__s3__change_cipher_spec~3, ssl3_connect_#t~nondet17, ssl3_connect_#t~nondet36, ssl3_connect_#t~nondet3, ssl3_connect_~new_state~3, ssl3_connect_~ag_Z~3, ssl3_connect_~s__s3__delay_buf_pop_ret~3;
  ...
  loc16_1:
    ...
    assume (ssl3_connect_~s__s3__flags~3 + 4294967291) % 4294967296 <= 2147483647 || !((ssl3_connect_~s__s3__flags~3 + 4294967291) % 4294967296 <= 2147483647);
    ssl3_connect_~s__s3__flags~3 := (if (ssl3_connect_~s__s3__flags~3 + 4294967291) % 4294967296 <= 2147483647 then (ssl3_connect_~s__s3__flags~3 + 4294967291) % 4294967296 else (ssl3_connect_~s__s3__flags~3 + 4294967291) % 4294967296 - 4294967296);
    assume !(ssl3_connect_~s__hit~3 == 0);
    ssl3_connect_~s__s3__tmp__next_state___0~3 := 3;
    assume ssl3_connect_~s__s3__flags~3 + 2 == 0;
    ssl3_connect_~s__init_num~3 := 0;
    goto loc3;
}
