...
modifies ;
{
  ...
  loc4_1:
    ...
    ssl3_accept_~ret~6 := ssl3_accept_#t~nondet33;
  ...
  loc5_1:
    ...
    assume !(ssl3_accept_~__cil_tmp61~6 % 18446744073709551616 == 9021);
  ...
  loc6_0:
    ...
    assume ssl3_accept_#t~nondet49 <= 2147483647 && 0 <= ssl3_accept_#t~nondet49 + 2147483648;
    ssl3_accept_~ret~6 := ssl3_accept_#t~nondet49;
    havoc ssl3_accept_#t~nondet49;
    assume !(ssl3_accept_~blastFlag~6 == 11);
    assume !(ssl3_accept_~blastFlag~6 == 14);
    assume !(ssl3_accept_~blastFlag~6 == 17);
    assume !(ssl3_accept_~blastFlag~6 == 20);
    assume !(ssl3_accept_~ret~6 <= 0);
    ssl3_accept_~s__state~6 := 8448;
    assume !(ssl3_accept_~s__hit~6 == 0);
    ssl3_accept_~s__s3__tmp__next_state___0~6 := 8640;
    ssl3_accept_~s__init_num~6 := 0;
    goto loc3;
  loc6_1:
    assume ssl3_accept_~s__state~6 == 8656;
    ...
    assume 0 <= ssl3_accept_#t~nondet48 + 2147483648 && ssl3_accept_#t~nondet48 <= 2147483647;
    ssl3_accept_~ret~6 := ssl3_accept_#t~nondet48;
    havoc ssl3_accept_#t~nondet48;
    assume !(ssl3_accept_~blastFlag~6 == 10);
    assume !(ssl3_accept_~blastFlag~6 == 13);
    assume !(ssl3_accept_~blastFlag~6 == 16);
    assume !(ssl3_accept_~blastFlag~6 == 19);
    assume !(ssl3_accept_~ret~6 <= 0);
