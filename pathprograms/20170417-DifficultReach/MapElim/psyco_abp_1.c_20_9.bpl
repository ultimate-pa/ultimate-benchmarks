...
modifies ;
{
  ...
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume !((if main_~P6~4 < 0 && !(main_~P6~4 % 2 == 0) then main_~P6~4 % 2 - 2 else main_~P6~4 % 2) == (if main_~this_expect~3 < 0 && !(main_~this_expect~3 % 2 == 0) then main_~this_expect~3 % 2 - 2 else main_~this_expect~3 % 2)) && (if main_~P6~4 < 0 && !(main_~P6~4 % 2 == 0) then main_~P6~4 % 2 - 2 else main_~P6~4 % 2) == 1;
    goto loc7;
  loc6_1:
