...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_0:
    ...
    assume parse_expression_list_~j~6 < parse_expression_list_~start~6 + 1 || !(parse_expression_list_~j~6 < parse_expression_list_~start~6 + 1);
    __VERIFIER_assert_#in~cond := (if parse_expression_list_~j~6 < parse_expression_list_~start~6 + 1 then 1 else 0);
