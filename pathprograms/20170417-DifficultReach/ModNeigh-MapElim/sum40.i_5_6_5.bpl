...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_1:
    assume !(sum_~i~3 < 40);
    assume sum_~ret~3 % 4294967296 <= 2147483647 && sum_~ret~3 + 4294967296 < 0;
  ...
  loc3_1:
    assume !(sum_~i~3 < 40);
    assume 4294967296 <= sum_~ret~3 && sum_~ret~3 <= 6442450943;
    sum_#res := sum_~ret~3 - 4294967296;
  ...
  loc5_1:
    assume !(sum_~i~3 < 40);
    assume sum_~ret~3 % 4294967296 <= 2147483647 && 8589934592 <= sum_~ret~3;
    sum_#res := sum_~ret~3 % 4294967296;
