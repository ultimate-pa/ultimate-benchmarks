...
modifies ;
{
  ...
  loc5_0:
    ...
    ssl3_accept_~s__s3__tmp__new_cipher__algorithms~6 := ssl3_accept_#t~nondet34;
    ...
    ssl3_accept_~__cil_tmp56~6 := 256345;
  ...
  loc7_0:
    ...
    ssl3_accept_~s__s3__tmp__use_rsa_tmp~6 := 0;
    assume ssl3_accept_~s__s3__tmp__use_rsa_tmp~6 == 0;
    assume (ssl3_accept_~l~6 + 30) % 18446744073709551616 == 0;
    assume (ssl3_accept_~l~6 + 1) % 18446744073709551616 == 0;
    ssl3_accept_~skip~6 := 1;
  ...
  loc7_1:
    ...
    ssl3_accept_~s__s3__tmp__new_cipher__algorithms~6 := ssl3_accept_#t~nondet40;
