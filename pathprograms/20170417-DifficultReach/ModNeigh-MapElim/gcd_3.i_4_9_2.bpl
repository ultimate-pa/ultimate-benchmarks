...
modifies ;
{
  ...
  loc0:
    ...
    assume 0 <= 255 * gcd_test_~b + 256 && 255 * gcd_test_~b < 0;
  ...
  loc1_0:
    ...
    assume ((255 * gcd_test_~b + gcd_test_~a % gcd_test_~b < 256 && !(gcd_test_~a < 0)) && 0 <= 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b <= 127;
