...
modifies ;
{
  ...
  loc1_1:
    ...
    assume main_~x~5 < 131072 && 65536 <= main_~x~5;
    main_~xx~5 := main_~x~5 - 65536;
    assume main_~y~5 < 65536 && 0 <= main_~y~5;
    main_~yy~5 := main_~y~5;
    havoc main_~xx~5;
    havoc main_~xx~5;
    havoc main_~xx~5;
    havoc main_~xx~5;
    ...
    havoc main_~yy~5;
    havoc main_~zz~5;
    assume ((0 <= main_~z~5 + 4294967296 && !(main_~z~5 + 4294967296 == main_~zz~5 % 4294967296)) && 8589934592 <= main_~zz~5) && main_~z~5 < 0;
