...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_0:
    assume !(avg_~i~3 < 40);
    assume (avg_~ret~3 / 40 + 4294967296 <= 2147483647 && -4294967296 <= avg_~ret~3 / 40) && avg_~ret~3 % 40 == 0;
  ...
  loc3_0:
    assume !(avg_~i~3 < 40);
    assume (0 <= avg_~ret~3 / 40 + 1 && avg_~ret~3 % 40 == 0) && avg_~ret~3 / 40 <= 2147483647;
  ...
  loc5_0:
    assume !(avg_~i~3 < 40);
    assume (!(avg_~ret~3 % 40 == 0) && !(avg_~ret~3 / 40 + 1 + 4294967296 <= 2147483647)) && avg_~ret~3 / 40 + 4294967296 <= 2147483647;
