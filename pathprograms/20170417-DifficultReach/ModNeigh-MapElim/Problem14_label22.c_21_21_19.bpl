...
modifies ~a24, ~a12, ~a21, ~a15;
{
  ...
  loc54_1:
    ...
    goto loc55;
  loc54_2:
    assume ((((~a24 == 1 && ~a12 <= 80) && ~a15 == 8) && calculate_output_~input == 2) && ~a21 == 9) && 11 < ~a12;
    assume !(~a12 + 366333 < 0);
    ~a12 := (~a12 + 366333) / 5;
    ~a21 := 8;
  ...
  loc69_0:
    assume (((~a24 == 1 && 80 < ~a12) && ~a15 == 9) && calculate_output_~input == 2) && ~a21 == 8;
  ...
  loc87_0:
    assume ((((~a21 == 7 && ~a12 <= 11) && ~a24 == 1) && 0 < ~a12 + 43) && ~a15 == 8) && calculate_output_~input == 1;
    ~a21 := 9;
  ...
  loc122_0:
    assume ((((~a21 == 10 && 0 < ~a12 + 43) && ~a15 == 8) && ~a12 <= 11) && ~a24 == 1) && calculate_output_~input == 5;
    assume !(~a12 + 464909 < 0);
    ~a12 := (~a12 + 27) % 34 - -42;
    ~a21 := 9;
    calculate_output_#res := 25;
  ...
  loc122_1:
    assume !(~a12 <= 11) && !(~a21 == 6);
    assume !(~a12 <= 11);
    assume (((calculate_output_~input == 5 && ~a21 == 8) && ~a24 == 1) && ~a15 == 8) && 80 < ~a12;
