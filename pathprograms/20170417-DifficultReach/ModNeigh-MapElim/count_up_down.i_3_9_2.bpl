...
modifies ;
{
  ...
  loc1_0:
    ...
    goto loc1;
  loc1_1:
    assume !(0 < main_~x~5 + 4294967296) && 0 <= main_~x~5 + 4294967296;
    assume (((0 <= main_~n~5 + 4294967296 && main_~n~5 < 0) && 0 <= main_~y~5) && !(main_~y~5 == main_~n~5 + 4294967296)) && main_~y~5 < 4294967296;
