...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_1:
    assume !(avg_~i~3 < 60);
    assume (avg_~ret~3 / 60 + 1 + 4294967296 <= 2147483647 && -4294967296 <= avg_~ret~3 / 60) && !(avg_~ret~3 % 60 == 0);
  ...
  loc3_0:
    assume !(avg_~i~3 < 60);
    assume 8589934592 <= avg_~ret~3 / 60 && !(avg_~ret~3 / 60 % 4294967296 <= 2147483647);
  ...
  loc5_1:
    assume !(avg_~i~3 < 60);
    assume (avg_~ret~3 / 60 + 1 < -4294967296 && !(avg_~ret~3 / 60 % 4294967296 <= 2147483647)) && avg_~ret~3 % 60 == 0;
    avg_#res := avg_~ret~3 / 60 % 4294967296 - 4294967296;
