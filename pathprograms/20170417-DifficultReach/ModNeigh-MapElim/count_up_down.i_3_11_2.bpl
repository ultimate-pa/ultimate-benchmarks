...
modifies ;
{
  ...
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume main_~x~5 + 4294967296 < 0 && 0 < main_~x~5 % 4294967296;
    ...
    goto loc1;
  loc1_1:
    assume !(0 < main_~x~5 % 4294967296) && main_~x~5 + 4294967296 < 0;
    assume ((main_~n~5 + 4294967296 < 0 && !(main_~y~5 == main_~n~5 % 4294967296)) && 0 <= main_~y~5) && main_~y~5 < 4294967296;
