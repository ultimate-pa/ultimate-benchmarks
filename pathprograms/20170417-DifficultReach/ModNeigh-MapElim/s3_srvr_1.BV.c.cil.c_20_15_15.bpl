...
modifies ;
{
    ...
    var ssl3_accept_~__retres67~5 : int;
  ...
  loc0:
    ...
    havoc ssl3_accept_~s__ctx__stats__sess_accept_renegotiate~5;
    havoc ssl3_accept_~s__ctx__stats__sess_accept~5;
    assume 0 <= ssl3_accept_#t~nondet11 + 2147483648 && ssl3_accept_#t~nondet11 <= 2147483647;
    ssl3_accept_~s__ctx__stats__sess_accept_good~5 := ssl3_accept_#t~nondet11;
    ...
    ssl3_accept_~s__s3__tmp__reuse_message~5 := ssl3_accept_#t~nondet12;
    ...
    ssl3_accept_~s__s3__tmp__new_cipher~5 := ssl3_accept_#t~nondet13;
    havoc ssl3_accept_#t~nondet13;
    assume 0 <= ssl3_accept_#t~nondet14 + 2147483648 && ssl3_accept_#t~nondet14 <= 2147483647;
    ssl3_accept_~s__s3__tmp__new_cipher__algorithms~5 := ssl3_accept_#t~nondet14;
    ...
    ssl3_accept_~s__s3__tmp__new_cipher__algo_strength~5 := ssl3_accept_#t~nondet15;
    ...
    ssl3_accept_~buf~5 := ssl3_accept_#t~nondet16;
    havoc ssl3_accept_#t~nondet16;
    havoc ssl3_accept_~l~5;
    havoc ssl3_accept_~Time~5;
    ssl3_accept_~tmp~5 := ssl3_accept_#t~nondet17;
    ...
    havoc ssl3_accept_~tmp___3~5;
    havoc ssl3_accept_~tmp___4~5;
    havoc ssl3_accept_~tmp___5~5;
    havoc ssl3_accept_~tmp___6~5;
    havoc ssl3_accept_~tmp___7~5;
    assume ssl3_accept_#t~nondet20 <= 9223372036854775807 && 0 <= ssl3_accept_#t~nondet20 + 9223372036854775808;
    ssl3_accept_~tmp___8~5 := ssl3_accept_#t~nondet20;
    havoc ssl3_accept_#t~nondet20;
    havoc ssl3_accept_~tmp___9~5;
    havoc ssl3_accept_~tmp___10~5;
    havoc ssl3_accept_~blastFlag~5;
    havoc ssl3_accept_~__retres67~5;
    ...
    ssl3_accept_~s__in_handshake~5 := ssl3_accept_~s__in_handshake~5 + 1;
  ...
  loc2_1:
    ...
    ssl3_accept_~ret~5 := ssl3_accept_#t~nondet25;
  ...
  loc3_0:
    ...
    ssl3_accept_~ret~5 := ssl3_accept_#t~nondet26;
  ...
  loc6_1:
    ...
    ssl3_accept_~ret~5 := ssl3_accept_#t~nondet29;
  ...
  loc7_1:
    ...
    assume 0 <= ssl3_accept_#t~nondet30 + 2147483648 && ssl3_accept_#t~nondet30 <= 2147483647;
    ssl3_accept_~ret~5 := ssl3_accept_#t~nondet30;
  ...
  loc8_0:
    ...
    ssl3_accept_~num1~5 := ssl3_accept_#t~nondet32;
  ...
  loc14_0:
    ...
    ssl3_accept_~tmp___9~5 := ssl3_accept_#t~nondet38;
  ...
  loc18:
    ...
    ssl3_accept_~tmp___10~5 := ssl3_accept_#t~nondet40;
