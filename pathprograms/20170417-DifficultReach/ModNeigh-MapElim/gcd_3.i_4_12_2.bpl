...
modifies ;
{
  ...
  loc0:
    ...
    assume 255 * gcd_test_~b + 256 < 0 && 255 * gcd_test_~b % 256 <= 127;
  ...
  loc1_0:
    ...
    assume ((!((255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127) && !(gcd_test_~a < 0)) && 512 <= 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b <= 127;
