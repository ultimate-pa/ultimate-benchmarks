...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_0:
    assume !(max_~i~3 < 20);
    assume max_~ret~3 <= 6442450943 && 4294967296 <= max_~ret~3;
  ...
  loc3_1:
    assume !(max_~i~3 < 20);
    assume 0 <= max_~ret~3 + 4294967296 && max_~ret~3 + 2147483649 <= 0;
    max_#res := max_~ret~3 + 4294967296;
  ...
  loc5_0:
    assume !(max_~i~3 < 20);
    assume max_~ret~3 + 4294967296 < 0 && max_~ret~3 % 4294967296 <= 2147483647;
    max_#res := max_~ret~3 % 4294967296;
