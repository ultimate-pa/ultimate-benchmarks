...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc2_0:
    assume !(avg_~i~3 < 20);
    assume (!(avg_~ret~3 % 20 == 0) && !(avg_~ret~3 / 20 + 1 + 4294967296 <= 2147483647)) && avg_~ret~3 / 20 < 0;
  ...
  loc5_1:
    assume !(avg_~i~3 < 20);
    assume (avg_~ret~3 % 20 == 0 && avg_~ret~3 / 20 + 1 + 4294967296 <= 2147483647) && -4294967296 <= avg_~ret~3 / 20;
