...
modifies ;
{
  ...
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume !(0 < main_~x~5 % 4294967296) && 8589934592 <= main_~x~5;
    assume (((main_~n~5 < 8589934592 && 0 <= main_~y~5 + 4294967296) && 4294967296 <= main_~n~5) && !(main_~y~5 + 4294967296 == main_~n~5 - 4294967296)) && main_~y~5 < 0;
