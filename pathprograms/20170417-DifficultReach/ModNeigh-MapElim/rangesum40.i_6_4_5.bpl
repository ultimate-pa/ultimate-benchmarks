...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc1_0:
    ...
    assume (!(rangesum_~ret~2 / rangesum_~cnt~2 <= 2147483647) && !(rangesum_~ret~2 < 0)) && rangesum_~ret~2 / rangesum_~cnt~2 - 1 < 4294967296;
  ...
  loc7_1:
    assume !(rangesum_~i~2 < 40);
    assume !(rangesum_~cnt~2 == 0);
    assume ((!(rangesum_~cnt~2 < 0) && 8589934592 <= rangesum_~ret~2 / rangesum_~cnt~2) && rangesum_~ret~2 % rangesum_~cnt~2 == 0) && rangesum_~ret~2 / rangesum_~cnt~2 - 1 < 8589934592;
    rangesum_#res := rangesum_~ret~2 / rangesum_~cnt~2 % 4294967296;
