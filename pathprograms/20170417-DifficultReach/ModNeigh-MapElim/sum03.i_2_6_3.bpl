...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume (2 * main_~x~5 < 4294967296 && main_~sn~5 == 2 * main_~x~5) && 0 <= main_~sn~5;
    __VERIFIER_assert_#in~cond := 1;
    goto loc3;
  loc2_1:
    assume ((((main_~sn~5 < 4294967296 && !(main_~sn~5 == 2 * main_~x~5)) && 0 <= main_~sn~5) && 0 <= 2 * main_~x~5) && 2 * main_~x~5 < 4294967296) && !(main_~sn~5 == 0);
