...
modifies ~N, #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc1_1:
    assume !(sep_~i~4 < ~N);
    assume sep_~ret~3 <= 6442450943 && 4294967296 <= sep_~ret~3;
  ...
  loc2_0:
    assume !(sep_~i~4 < ~N);
    assume !(sep_~ret~3 % 4294967296 <= 2147483647) && 8589934592 <= sep_~ret~3;
  ...
  loc3_1:
    assume !(sep_~i~4 < ~N);
    assume 8589934592 <= sep_~ret~3 && sep_~ret~3 % 4294967296 <= 2147483647;
    sep_#res := sep_~ret~3 % 4294967296;
