...
modifies ~N, #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc1_1:
    assume !(avg_~i~3 < ~N);
    assume ((avg_~ret~3 % ~N == 0 && !(~N < 0)) && avg_~ret~3 / ~N < -4294967296) && avg_~ret~3 / ~N % 4294967296 <= 2147483647;
    ...
    avg_~i~3 := 0;
    assume !(avg_~i~3 < ~N);
    assume (!(avg_~ret~3 / ~N + 1 - 4294967296 <= 2147483647) && !(avg_~ret~3 < 0)) && avg_~ret~3 / ~N - 4294967296 <= 2147483647;
    avg_#res := avg_~ret~3 / ~N - 4294967296;
    ...
    avg_~i~3 := 0;
    assume !(avg_~i~3 < ~N);
    assume ((!(avg_~ret~3 < 0) && !(~N < 0)) && avg_~ret~3 / ~N + 1 <= 2147483647) && 0 <= avg_~ret~3 / ~N + 1;
