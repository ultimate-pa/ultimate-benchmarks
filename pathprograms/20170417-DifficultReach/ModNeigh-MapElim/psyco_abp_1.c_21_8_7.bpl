...
modifies ;
{
  ...
  loc6_0:
    ...
    assume main_~P1~4 == 0;
    main_~method_id~3 := 3;
    assume (main_~P3~4 == 0 && !(main_~this_buffer_empty~3 == 1)) && main_~P3~4 == (main_~this_expect~3 + 1) % 2;
    goto loc7;
  loc6_1:
    assume main_#t~nondet35 == 0;
    havoc main_#t~nondet35;
    ...
    assume main_~P1~4 == 1;
    main_~method_id~3 := 7;
    assume (!(main_~this_buffer_empty~3 == 1) && !(main_~this_expect~3 < 1)) && main_~P9~4 == (main_~this_expect~3 + 1) % 2;
    main_~q~3 := 1;
    main_~this_expect~3 := main_~this_expect~3;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
