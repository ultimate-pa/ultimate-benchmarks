...
modifies ;
{
  ...
  loc1_0:
    ...
    assume ((main_~i~6 < 512 && 256 <= main_~i~6) && main_~y~5 < 256) && 0 <= main_~y~5;
    main_~y~5 := main_~i~6 + main_~y~5 + -256;
    assume 0 <= main_~c~5 && main_~c~5 < 256;
    main_~c~5 := main_~c~5 + 1;
    goto loc1;
  loc1_1:
    assume main_~c~5 < 256 && !(main_~c~5 < 8);
    assume (main_~x~5 < 512 && main_~x~5 - 256 == main_~y~5 - 256) && 256 <= main_~y~5;
