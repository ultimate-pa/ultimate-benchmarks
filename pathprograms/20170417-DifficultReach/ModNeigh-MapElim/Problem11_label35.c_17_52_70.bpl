...
modifies ~a23, ~a8, ~a25, ~a4, ~a29, ~a3;
{
  ...
  loc55_0:
    assume (((((277 < ~a29 && ~a25 == 10) && ~a4 == 1) && ~a8 == 15) && 0 < ~a23 + 43) && ~a3 == 1) && ~a23 <= 138;
    goto loc56;
  loc55_1:
    assume !(~a23 <= 138);
    goto loc57;
  ...
  loc80_0:
    ...
    goto loc81;
  loc80_1:
    assume (((((~a8 == 15 && ~a4 == 1) && 277 < ~a29) && 306 < ~a23) && calculate_output_~input == 3) && ~a3 == 1) && ~a25 == 12;
    assume !(~a29 < 0);
    ~a29 := (~a29 / 5 + -137957) * 2;
    assume !(~a23 < 0);
  ...
  loc110_0:
    ...
    assume !(calculate_output_~input == 4);
    assume !(calculate_output_~input == 1);
    assume (((((~a8 == 15 && calculate_output_~input == 6) && ~a3 == 1) && 306 < ~a23) && ~a4 == 1) && ~a25 == 9) && 277 < ~a29;
    ~a29 := (~a29 - 600020) * 1 * 1;
    assume !(~a23 < 0);
