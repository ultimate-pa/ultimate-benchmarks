...
modifies ;
{
  ...
  loc3:
    goto loc3_0, loc3_1;
  loc3_0:
    assume (((gcd_test_~a < 0 && 256 <= gcd_test_~a % gcd_test_~b) && 512 <= gcd_test_~a % gcd_test_~b + 255 * gcd_test_~b) && (gcd_test_~a % gcd_test_~b + 255 * gcd_test_~b) % 256 <= 127) && gcd_test_~a % gcd_test_~b < 512;
    gcd_test_~b := (255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256;
    goto loc4;
  loc3_1:
    assume ((!(gcd_test_~a < 0) && 512 <= gcd_test_~a % gcd_test_~b) && 0 <= gcd_test_~b + gcd_test_~a % gcd_test_~b + 256) && gcd_test_~a % gcd_test_~b % 256 <= 127;
