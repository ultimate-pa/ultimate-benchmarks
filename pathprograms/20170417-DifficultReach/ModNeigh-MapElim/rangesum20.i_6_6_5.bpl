...
modifies #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc1_1:
    ...
    assume (rangesum_~ret~2 / rangesum_~cnt~2 <= 2147483647 && !(rangesum_~ret~2 < 0)) && 0 <= rangesum_~ret~2 / rangesum_~cnt~2;
  ...
  loc3_0:
    assume !(rangesum_~i~2 < 20);
    assume !(rangesum_~cnt~2 == 0);
    assume ((!((rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296 <= 2147483647) && rangesum_~ret~2 < 0) && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && rangesum_~ret~2 / rangesum_~cnt~2 + 1 < -4294967296;
  ...
  loc7_0:
    assume !(rangesum_~i~2 < 20);
    assume !(rangesum_~cnt~2 == 0);
    assume (!(rangesum_~ret~2 < 0) && rangesum_~ret~2 / rangesum_~cnt~2 + 1 - 4294967296 <= 2147483647) && 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 - 1;
