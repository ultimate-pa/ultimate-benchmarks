...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume 8589934592 <= main_~z~5 + main_~y~5 + main_~x~5 && !((main_~z~5 + main_~y~5 + main_~x~5) % 4294967296 == 1);
    __VERIFIER_assert_#in~cond := 1;
    goto loc3;
  loc2_1:
    assume main_~z~5 + main_~y~5 + main_~x~5 + 4294967296 < 0 && (main_~z~5 + main_~y~5 + main_~x~5) % 4294967296 == 1;
