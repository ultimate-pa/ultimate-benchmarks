...
modifies ~cleanupTimeShifts, ~systemActive, ~pumpRunning, ~switchedOnBeforeTS, ~methaneLevelCritical, ~waterLevel;
{
  ...
  loc11_1:
    assume ~waterLevel < 2;
    isHighWaterSensorDry_~retValue_acc~164 := 1;
    isHighWaterSensorDry_#res := isHighWaterSensorDry_~retValue_acc~164;
    goto loc13;
  loc12:
  ...
  loc15_1:
    assume !(isHighWaterLevel_~tmp~65 == 0);
    isHighWaterLevel_~tmp___0~65 := 0;
    goto loc17;
  loc16:
  ...
  loc17:
    ...
    assume processEnvironment__wrappee__methaneQuery_#t~ret0 <= 2147483647 && 0 <= processEnvironment__wrappee__methaneQuery_#t~ret0 + 2147483648;
