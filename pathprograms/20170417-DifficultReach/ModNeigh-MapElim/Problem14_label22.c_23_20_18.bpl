...
modifies ~a24, ~a12, ~a21, ~a15;
{
  ...
  loc7:
    goto loc7_0, loc7_1;
  loc7_0:
    assume ((~a21 == 9 && ~a15 == 6) && ~a24 == 1) && ~a12 + 43 <= 0;
    goto loc8;
  loc7_1:
    assume !(~a15 == 6);
    assume !(~a15 == 7);
  ...
  loc52_0:
    assume ((((~a12 <= 80 && 11 < ~a12) && ~a15 == 8) && ~a21 == 9) && calculate_output_~input == 2) && ~a24 == 1;
    assume (~a12 + 3) % 5 == 0;
    ~a12 := (~a12 + 366333) / 5;
    ~a21 := 8;
  ...
  loc58_2:
    ...
    goto loc59;
  loc58_3:
    assume ((((~a15 == 8 && ~a12 <= 11) && ~a24 == 1) && 0 < ~a12 + 43) && calculate_output_~input == 5) && ~a21 == 9;
    ~a21 := 10;
  ...
  loc68_2:
    ...
    assume ~a12 * 9 / 10 % 5 == 0 && 9 * ~a12 % 10 == 0;
    ~a12 := ~a12 * 9 / 10 / 5 * 10 / -3;
    ~a15 := 6;
    ~a21 := 9;
  ...
  loc80_0:
    assume (((~a15 == 8 && ~a24 == 1) && calculate_output_~input == 5) && ~a21 == 7) && ~a12 + 43 <= 0;
    ~a21 := 10;
    calculate_output_#res := 22;
    goto loc53;
  loc80_1:
  ...
  loc84_0:
    assume ((((~a21 == 7 && calculate_output_~input == 1) && 0 < ~a12 + 43) && ~a24 == 1) && ~a15 == 8) && ~a12 <= 11;
    ~a21 := 9;
  ...
  loc126_0:
    assume ((((calculate_output_~input == 5 && ~a24 == 1) && ~a12 <= 11) && ~a15 == 8) && 0 < ~a12 + 43) && ~a21 == 10;
    assume !(~a12 + 464909 < 0);
    ~a12 := (~a12 + 27) % 34 - -42;
    ~a21 := 9;
    calculate_output_#res := 25;
  ...
  loc126_1:
    assume !(~a21 == 10) && !(~a12 <= 80);
    assume !(calculate_output_~input == 6);
    assume (((~a24 == 1 && calculate_output_~input == 5) && ~a21 == 8) && ~a15 == 8) && 80 < ~a12;
