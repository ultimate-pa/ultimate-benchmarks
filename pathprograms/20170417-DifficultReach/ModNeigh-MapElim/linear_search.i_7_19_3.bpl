...
modifies ~SIZE, #NULL.offset, v_rep_select_#valid_0__1, #NULL.base;
{
  ...
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume (!(linear_search_~j~5 < linear_search_~n + 4294967296) && 0 <= linear_search_~n + 4294967296) && linear_search_~j~5 < 4294967296;
  ...
  loc3_1:
    ...
    havoc linear_search_#t~mem0;
    havoc linear_search_#t~short1;
    assume (linear_search_~j~5 < 4294967296 && !(linear_search_~j~5 < ~SIZE)) && 0 <= ~SIZE;
