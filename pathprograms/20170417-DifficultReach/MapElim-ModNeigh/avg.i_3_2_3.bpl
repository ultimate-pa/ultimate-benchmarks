...
modifies ~N, v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc1_1:
    assume !(avg_~i~3 < ~N);
    assume (((((4294967296 + 4294967296 <= avg_~ret~3 / ~N + 1 && !(~N < 0)) && 4294967296 + 4294967296 <= avg_~ret~3 / ~N) && 4294967296 + 4294967296 <= avg_~ret~3 / ~N - 1) && !((avg_~ret~3 / ~N + 1) % 4294967296 <= 2147483647)) && !(avg_~ret~3 / ~N % 4294967296 <= 2147483647)) && avg_~ret~3 % ~N == 0;
    avg_#res := avg_~ret~3 / ~N % 4294967296 - 4294967296;
    ...
    avg_~i~3 := 0;
    assume !(avg_~i~3 < ~N);
    assume (((avg_~ret~3 / ~N % 4294967296 <= 2147483647 && 4294967296 + 4294967296 <= avg_~ret~3 / ~N) && 4294967296 + 4294967296 <= avg_~ret~3 / ~N + 1) && !(avg_~ret~3 < 0)) && avg_~ret~3 / ~N - 1 < 4294967296 + 4294967296;
    ...
    avg_~i~3 := 0;
    assume !(avg_~i~3 < ~N);
    assume (((((avg_~ret~3 / ~N % 4294967296 <= 2147483647 && 4294967296 + 4294967296 <= avg_~ret~3 / ~N + 1) && !(~N < 0)) && 4294967296 + 4294967296 <= avg_~ret~3 / ~N) && (avg_~ret~3 / ~N + 1) % 4294967296 <= 2147483647) && !(avg_~ret~3 < 0)) && 4294967296 + 4294967296 <= avg_~ret~3 / ~N - 1;
    avg_#res := avg_~ret~3 / ~N % 4294967296;
