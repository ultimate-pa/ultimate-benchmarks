...
modifies ;
{
  ...
  loc4_1:
    ...
    assume main_~P1~4 == 0;
    main_~method_id~3 := 3;
    assume ((main_~this_expect~3 + 1) % 2 == 0 && !(main_~this_buffer_empty~3 == 1)) && main_~P3~4 == (main_~this_expect~3 + 1) % 2;
    main_~q~3 := 4;
  ...
  loc5_0:
    ...
    assume !(main_~P1~4 < 0) && main_~P1~4 % 2 == 1;
    main_~method_id~3 := 5;
    assume main_~P6~4 < 0;
    main_~q~3 := 5;
    main_~this_expect~3 := main_~this_expect~3 + 1;
  ...
  loc6_1:
    ...
    assume main_~P1~4 == 0;
    main_~method_id~3 := 3;
    assume (main_~P3~4 == (main_~this_expect~3 + 1) % 2 && !(main_~this_buffer_empty~3 == 1)) && main_~P3~4 == 0;
    goto loc7;
  loc7:
    assert false;
}
