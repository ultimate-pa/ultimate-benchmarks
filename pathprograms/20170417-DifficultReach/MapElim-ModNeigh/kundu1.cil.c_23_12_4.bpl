...
modifies ~timer, ~P_1_st, ~C_1_st, ~max_loop, ~data_0, ~P_1_pc, ~P_1_i, ~i, ~P_1_ev, ~C_1_pc, ~C_1_i, ~C_1_ev, ~num, ~e, ~data_1;
{
    ...
    var read_data_~__retres3~5 : int;
  ...
  loc5_1:
    ...
    assume ~C_1_pc == 2;
    assume ~C_1_ev == 1;
    is_C_1_triggered_~__retres1~50 := 1;
    is_C_1_triggered_#res := is_C_1_triggered_~__retres1~50;
    activate_threads_#t~ret5 := is_C_1_triggered_#res;
    assume 0 <= activate_threads_#t~ret5 + 2147483648 && activate_threads_#t~ret5 <= 2147483647;
    activate_threads_~tmp___1~105 := activate_threads_#t~ret5;
  ...
  loc8_1:
    ...
    havoc read_data_~c~5, read_data_~i___0, read_data_~__retres3~5;
    read_data_~i___0 := read_data_#in~i___0;
    havoc read_data_~c~5;
    havoc read_data_~__retres3~5;
    assume read_data_~i___0 == 0;
    read_data_~__retres3~5 := ~data_0;
    read_data_#res := read_data_~__retres3~5;
    C_1_#t~ret0 := read_data_#res;
    assume 0 <= C_1_#t~ret0 + 128 && C_1_#t~ret0 <= 127;
    C_1_~c~34 := C_1_#t~ret0;
    havoc C_1_#t~ret0;
    ~i := ~i + 1;
    ~C_1_pc := 2;
    ~C_1_st := 2;
