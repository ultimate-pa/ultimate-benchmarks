...
modifies ;
{
  ...
  loc16_0:
    ...
    assume (!(ssl3_connect_~s__s3__flags~3 <= 2147483652) && ssl3_connect_~s__s3__flags~3 + 4294967291 < 4294967296 + 4294967296) && 4294967296 <= ssl3_connect_~s__s3__flags~3 + 4294967291;
    ssl3_connect_~s__s3__flags~3 := ssl3_connect_~s__s3__flags~3 + 4294967291 - 4294967296 - 4294967296;
    assume !(ssl3_connect_~s__hit~3 == 0);
