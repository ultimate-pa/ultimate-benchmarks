...
modifies ~N, v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc1_1:
    ...
    assume (((((rangesum_~ret~3 < 0 && 4294967296 <= rangesum_~ret~3 / rangesum_~cnt~3) && !(rangesum_~ret~3 / rangesum_~cnt~3 + 1 - 4294967296 <= 2147483647)) && rangesum_~ret~3 / rangesum_~cnt~3 < 4294967296 + 4294967296) && !(rangesum_~ret~3 % rangesum_~cnt~3 == 0)) && rangesum_~ret~3 / rangesum_~cnt~3 + 1 < 4294967296 + 4294967296) && !(rangesum_~cnt~3 < 0);
    rangesum_#res := rangesum_~ret~3 / rangesum_~cnt~3 + 1 - 4294967296 - 4294967296;
