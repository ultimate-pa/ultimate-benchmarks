...
modifies ;
{
  ...
  loc0:
    ...
    ssl3_accept_~ag_X~4 := ssl3_accept_#t~nondet25;
    ...
    ssl3_accept_~tmp~4 := ssl3_accept_#t~nondet26;
  ...
  loc4_1:
    ...
    ssl3_accept_~ret~4 := ssl3_accept_#t~nondet30;
  ...
  loc9_0:
    ...
    ssl3_accept_~s__s3__tmp__use_rsa_tmp~4 := 0;
    assume ssl3_accept_~s__s3__tmp__use_rsa_tmp~4 == 0;
    assume (ssl3_accept_~l~4 + 30) % 18446744073709551616 == 0;
    assume (ssl3_accept_~l~4 + 1) % 18446744073709551616 == 0;
    ssl3_accept_~skip~4 := 1;
  ...
  loc11_0:
    assume ssl3_accept_~skip~4 == 0;
    assume ssl3_accept_~s__debug~4 == 0;
    assume !(ssl3_accept_~cb~4 == 0);
    goto loc13;
  loc11_1:
    assume !(ssl3_accept_~skip~4 == 0);
    goto loc14;
  ...
  loc12_1:
    ...
    ssl3_accept_~ret~4 := ssl3_accept_#t~nondet33;
  ...
  loc13_0:
    assume !(ssl3_accept_~s__state~4 == ssl3_accept_~state~4);
    ssl3_accept_~new_state~4 := ssl3_accept_~s__state~4;
    ssl3_accept_~s__state~4 := ssl3_accept_~state~4;
    ssl3_accept_~s__state~4 := ssl3_accept_~new_state~4;
    goto loc14;
  loc13_1:
    assume ssl3_accept_~s__state~4 == ssl3_accept_~state~4;
    goto loc14;
