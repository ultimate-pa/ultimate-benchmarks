...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc2_1:
    assume !(avg_~i~3 < 40);
    assume ((((avg_~ret~3 < 0 && -4294967296 <= avg_~ret~3 / 40) && avg_~ret~3 / 40 < 0) && -4294967296 <= avg_~ret~3 / 40 + 1) && !(avg_~ret~3 / 40 + 1 + 4294967296 <= 2147483647)) && !(avg_~ret~3 % 40 == 0);
  ...
  loc3_1:
    assume !(avg_~i~3 < 40);
    assume ((!(avg_~ret~3 / 40 % 4294967296 <= 2147483647) && avg_~ret~3 / 40 < -4294967296) && avg_~ret~3 % 40 == 0) && -4294967296 <= avg_~ret~3 / 40 + 1;
    avg_#res := avg_~ret~3 / 40 % 4294967296 - 4294967296;
  ...
  loc5_1:
    assume !(avg_~i~3 < 40);
    assume (((avg_~ret~3 < 0 && !(avg_~ret~3 % 40 == 0)) && avg_~ret~3 / 40 < 0) && -4294967296 <= avg_~ret~3 / 40) && !(avg_~ret~3 / 40 + 4294967296 <= 2147483647);
    avg_#res := avg_~ret~3 / 40 + 1 + 4294967296 - 4294967296;
