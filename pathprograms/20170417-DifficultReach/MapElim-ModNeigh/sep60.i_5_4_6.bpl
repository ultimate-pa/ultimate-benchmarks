...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc2_0:
    assume !(sep_~i~4 < 60);
    assume (sep_~ret~3 <= 6442450943 && 4294967296 <= sep_~ret~3) && sep_~ret~3 < 4294967296 + 4294967296;
  ...
  loc3_1:
    assume !(sep_~i~4 < 60);
    assume (sep_~ret~3 < 0 && sep_~ret~3 + 2147483649 <= 0) && -4294967296 <= sep_~ret~3;
    sep_#res := sep_~ret~3 + 4294967296;
  ...
  loc5_0:
    assume !(sep_~i~4 < 60);
    assume 4294967296 + 4294967296 <= sep_~ret~3 && sep_~ret~3 % 4294967296 <= 2147483647;
    sep_#res := sep_~ret~3 % 4294967296;
