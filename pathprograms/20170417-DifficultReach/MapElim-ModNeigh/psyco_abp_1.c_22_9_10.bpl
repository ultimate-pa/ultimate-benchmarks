...
modifies ;
{
  ...
  loc6_0:
    ...
    goto loc1;
  loc6_1:
    assume main_~P9~4 == 1 && !(main_~P9~4 == (main_~this_expect~3 + 1) % 2);
    goto loc8;
  loc7:
    goto loc7_0, loc7_1;
  loc7_0:
    ...
    goto loc9;
  loc7_1:
    assume ((main_~this_buffer_empty~3 == 1 && main_~P6~4 % 2 == 0) && main_~P6~4 % 2 == main_~this_expect~3 % 2) && !(main_~this_expect~3 < 0);
    goto loc9;
  loc8:
    assert false;
  loc9:
