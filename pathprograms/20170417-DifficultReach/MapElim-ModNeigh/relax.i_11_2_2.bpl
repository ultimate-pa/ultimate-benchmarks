...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc0:
    ...
    assume (4 * main_~pat_len~11 < 4294967296 && 0 <= 4 * main_~pat_len~11) && 4 * main_~pat_len~11 <= 2147483647;
  ...
  loc1_1:
    ...
    assume is_relaxed_prefix_~shift~8 == 1 && is_relaxed_prefix_~a_length % 18446744073709551616 < is_relaxed_prefix_~pat_length % 18446744073709551616;
