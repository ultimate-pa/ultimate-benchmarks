...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc2_0:
    assume !(avg_~i~3 < 10);
    assume ((avg_~ret~3 / 10 < 4294967296 && 0 <= avg_~ret~3 / 10 + 1) && avg_~ret~3 % 10 == 0) && avg_~ret~3 / 10 <= 2147483647;
    avg_#res := avg_~ret~3 / 10;
  ...
  loc3_1:
    assume !(avg_~i~3 < 10);
    assume (0 <= avg_~ret~3 / 10 && avg_~ret~3 / 10 <= 2147483647) && avg_~ret~3 / 10 < 4294967296;
    avg_#res := avg_~ret~3 / 10;
  ...
  loc5_1:
    assume !(avg_~i~3 < 10);
    assume ((-4294967296 <= avg_~ret~3 / 10 + 1 && avg_~ret~3 / 10 % 4294967296 <= 2147483647) && 4294967296 + 4294967296 <= avg_~ret~3 / 10) && avg_~ret~3 % 10 == 0;
