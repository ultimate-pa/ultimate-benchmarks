...
modifies ;
{
  ...
  loc3_0:
    ...
    assume main_~P1~4 == 0;
    main_~method_id~3 := 3;
    assume main_~this_buffer_empty~3 == 1 && main_~P3~4 == 0;
    goto loc4;
  loc3_1:
    assume main_~q~3 == 1;
    ...
    main_~method_id~3 := 2;
    assume ((main_~this_buffer_empty~3 == 1 && !(main_~P1~4 < 0)) && main_~P1~4 % 2 == main_~this_expect~3 % 2) && main_~this_expect~3 % 2 == 0;
    main_~q~3 := 3;
