...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc2_0:
    assume !(avg_~i~3 < 20);
    assume ((((avg_~ret~3 / 20 + 1 < -4294967296 && avg_~ret~3 / 20 % 4294967296 <= 2147483647) && avg_~ret~3 < 0) && !((avg_~ret~3 / 20 + 1) % 4294967296 <= 2147483647)) && avg_~ret~3 / 20 < -4294967296) && !(avg_~ret~3 % 20 == 0);
  ...
  loc3_1:
    assume !(avg_~i~3 < 20);
    assume ((-4294967296 <= avg_~ret~3 / 20 + 1 && avg_~ret~3 / 20 < -4294967296) && !(avg_~ret~3 / 20 % 4294967296 <= 2147483647)) && avg_~ret~3 % 20 == 0;
    avg_#res := avg_~ret~3 / 20 % 4294967296 - 4294967296;
  ...
  loc5_1:
    assume !(avg_~i~3 < 20);
    assume ((avg_~ret~3 / 20 % 4294967296 <= 2147483647 && (avg_~ret~3 / 20 + 1) % 4294967296 <= 2147483647) && avg_~ret~3 % 20 == 0) && avg_~ret~3 / 20 + 1 < -4294967296;
