...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc2_1:
    assume !(sum_~i~3 < 10);
    assume (sum_~ret~3 < 4294967296 && 0 <= sum_~ret~3) && !(sum_~ret~3 <= 2147483647);
  ...
  loc3_0:
    assume !(sum_~i~3 < 10);
    assume (0 <= sum_~ret~3 && sum_~ret~3 < 4294967296) && sum_~ret~3 <= 2147483647;
    sum_#res := sum_~ret~3;
  ...
  loc5_1:
    assume !(sum_~i~3 < 10);
    assume 4294967296 + 4294967296 <= sum_~ret~3 && !(sum_~ret~3 % 4294967296 <= 2147483647);
