...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc2_0:
    assume !(avg_~i~3 < 5);
    assume ((!(avg_~ret~3 / 5 <= 2147483647) && avg_~ret~3 % 5 == 0) && 0 <= avg_~ret~3 / 5) && avg_~ret~3 / 5 < 4294967296;
    avg_#res := avg_~ret~3 / 5 - 4294967296;
  ...
  loc3_0:
    assume !(avg_~i~3 < 5);
    assume (!(avg_~ret~3 / 5 - 4294967296 <= 2147483647) && avg_~ret~3 / 5 < 4294967296 + 4294967296) && 4294967296 <= avg_~ret~3 / 5 + 1;
  ...
  loc5_1:
    assume !(avg_~i~3 < 5);
    assume ((avg_~ret~3 / 5 <= 2147483647 && avg_~ret~3 % 5 == 0) && 0 <= avg_~ret~3 / 5 + 1) && avg_~ret~3 / 5 < 4294967296;
    avg_#res := avg_~ret~3 / 5;
