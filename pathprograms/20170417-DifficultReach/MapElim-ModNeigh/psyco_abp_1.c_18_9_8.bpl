...
modifies ;
{
  ...
  loc5_1:
    ...
    main_~method_id~3 := 5;
    assume ((main_~this_buffer_empty~3 == 1 && !(main_~P6~4 < 0)) && !(main_~this_expect~3 < 0)) && main_~P6~4 % 2 == main_~this_expect~3 % 2;
    main_~q~3 := 5;
    main_~this_expect~3 := main_~this_expect~3 + 1;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume main_~P3~4 == 0 && !(main_~P3~4 == (main_~this_expect~3 + 1) % 2);
    goto loc7;
  loc6_1:
    assume (!(main_~this_buffer_empty~3 == 1) && (main_~this_expect~3 + 1) % 2 == 0) && main_~P3~4 == (main_~this_expect~3 + 1) % 2;
    main_~q~3 := 4;
    main_~this_expect~3 := main_~this_expect~3;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
