...
modifies ~a24, ~a12, ~a21, ~a15;
{
  ...
  loc53_0:
    ...
    goto loc54;
  loc53_1:
    assume ((((~a15 == 8 && ~a12 <= 80) && ~a21 == 9) && calculate_output_~input == 2) && 11 < ~a12) && ~a24 == 1;
    assume (~a12 + 3) % 5 == 0;
    ~a12 := (~a12 + 366333) / 5;
    ~a21 := 8;
  ...
  loc59_2:
    ...
    goto loc60;
  loc59_3:
    assume ((((calculate_output_~input == 5 && ~a15 == 8) && 0 < ~a12 + 43) && ~a21 == 9) && ~a24 == 1) && ~a12 <= 11;
    ~a21 := 10;
  ...
  loc69_0:
    ...
    goto loc70;
  loc69_1:
    assume (((calculate_output_~input == 2 && ~a24 == 1) && ~a15 == 9) && ~a21 == 8) && 80 < ~a12;
    assume ((~a12 * 9 / 10 / 5 + 1) * 10 % -3 == 0 && 9 * ~a12 % 10 == 0) && !(~a12 * 9 / 10 < 0);
    ~a12 := ~a12 * 9 / 10 / 5 * 10 / -3;
    ~a15 := 6;
    ~a21 := 9;
  ...
  loc80_0:
    ...
    goto loc81;
  loc80_1:
    assume (((~a21 == 10 && ~a24 == 1) && ~a12 + 43 <= 0) && calculate_output_~input == 6) && ~a15 == 8;
    assume (~a12 % 26 < 1 && !((~a12 % 26 + -27) / 5 % 5 == 0)) && ((~a12 % 26 + -27) / 5 + 1) % 5 == 0;
    ~a12 := ((~a12 % 26 + -1) / 5 + 1) / 5;
    ~a21 := 7;
  ...
  loc83_0:
    ...
    goto loc84;
  loc83_1:
    assume ((((~a12 <= 11 && ~a15 == 8) && ~a24 == 1) && 0 < ~a12 + 43) && ~a21 == 7) && calculate_output_~input == 1;
    ~a21 := 9;
  ...
  loc113_0:
    assume ((((~a21 == 10 && calculate_output_~input == 5) && 0 < ~a12 + 43) && ~a24 == 1) && ~a15 == 8) && ~a12 <= 11;
    assume (~a12 + 27) % 34 == 0;
    ~a12 := (~a12 + 27) % 34 - -42;
    ~a21 := 9;
    calculate_output_#res := 25;
  ...
  loc113_1:
    assume !(~a12 <= 80);
    assume !(~a12 <= 11);
    assume (((~a15 == 8 && calculate_output_~input == 5) && ~a24 == 1) && ~a21 == 8) && 80 < ~a12;
