...
modifies ;
{
  ...
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume main_~x~5 < 0 && !(main_~x~5 + 4294967197 < 0);
    assume (((!(main_~y~5 % 4294967296 < 0) && main_~y~5 < -4294967296) && !(main_~x~5 % 2 == main_~y~5 % 2)) && main_~x~5 < 0) && !(main_~x~5 + 4294967296 < 0);
