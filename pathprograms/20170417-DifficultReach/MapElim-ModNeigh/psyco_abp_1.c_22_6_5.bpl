...
modifies ;
{
  ...
  loc3_0:
    ...
    main_~method_id~3 := 2;
    assume ((main_~this_buffer_empty~3 == 1 && main_~P1~4 % 2 == main_~this_expect~3 % 2) && main_~P1~4 % 2 == 0) && main_~this_expect~3 % 2 == 0;
    main_~q~3 := 3;
  ...
  loc5_0:
    ...
    main_~method_id~3 := 5;
    assume ((main_~this_buffer_empty~3 == 1 && main_~P6~4 % 2 == 0) && main_~this_expect~3 % 2 == 0) && main_~P6~4 % 2 == main_~this_expect~3 % 2;
    main_~q~3 := 5;
    main_~this_expect~3 := main_~this_expect~3 + 1;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
