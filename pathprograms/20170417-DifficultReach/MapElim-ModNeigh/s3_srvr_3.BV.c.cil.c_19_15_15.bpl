...
modifies ;
{
  ...
  loc14_1:
    assume ssl3_accept_~blastFlag~4 == 3;
    assume !(ssl3_accept_~s__s3__tmp__next_state___0~4 < 0) && ssl3_accept_~s__state~4 % ssl3_accept_~s__s3__tmp__next_state___0~4 == 0;
    ssl3_accept_~blastFlag~4 := ssl3_accept_~blastFlag~4 + ssl3_accept_~s__state~4 / ssl3_accept_~s__s3__tmp__next_state___0~4;
    goto loc17;
  loc15:
