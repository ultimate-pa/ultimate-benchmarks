...
modifies ;
{
  ...
  loc5:
    goto loc5_0, loc5_1;
  loc5_0:
    assume ((main_~this_buffer_empty~3 == 1 && !(main_~P1~4 < 0)) && main_~this_expect~3 % 2 == 0) && main_~P1~4 % 2 == main_~this_expect~3 % 2;
    main_~q~3 := 3;
    main_~this_expect~3 := main_~this_expect~3 + 1;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
  loc5_1:
    assume !(main_~P1~4 % 2 == main_~this_expect~3 % 2) && main_~P1~4 % 2 == 0;
    goto loc7;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    ...
    assume main_~P1~4 == 1;
    main_~method_id~3 := 7;
    assume (!(main_~this_buffer_empty~3 == 1) && main_~P9~4 == (main_~this_expect~3 + 1) % 2) && !(main_~this_expect~3 < 1);
    main_~q~3 := 1;
    main_~this_expect~3 := main_~this_expect~3;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
  ...
  loc8:
    goto loc8_0, loc8_1;
  loc8_0:
    assume ((main_~this_buffer_empty~3 == 1 && !(main_~P6~4 < 0)) && main_~P6~4 % 2 == main_~this_expect~3 % 2) && !(main_~this_expect~3 < 0);
    goto loc9;
  loc8_1:
    assume ((main_~this_buffer_empty~3 == 1 && main_~P6~4 % 2 == 0) && main_~P6~4 % 2 == main_~this_expect~3 % 2) && main_~this_expect~3 % 2 == 0;
    goto loc9;
  loc9:
    main_~q~3 := 5;
    main_~this_expect~3 := main_~this_expect~3 + 1;
