...
modifies ;
{
  ...
  loc1_0:
    ...
    assume (((((255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127 && gcd_test_~a % gcd_test_~b < 256) && gcd_test_~a % gcd_test_~b <= 127) && 256 + 256 <= 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) && 0 <= gcd_test_~b + gcd_test_~a % gcd_test_~b) && !(gcd_test_~a < 0);
