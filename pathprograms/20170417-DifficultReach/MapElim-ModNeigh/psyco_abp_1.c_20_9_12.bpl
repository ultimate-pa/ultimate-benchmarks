...
modifies ;
{
  ...
  loc3_0:
    ...
    main_~method_id~3 := 2;
    assume ((main_~this_buffer_empty~3 == 1 && main_~P1~4 % 2 == main_~this_expect~3 % 2) && !(main_~this_expect~3 < 0)) && main_~P1~4 % 2 == 0;
    main_~q~3 := 3;
  ...
  loc4_1:
    ...
    assume main_~P1~4 == 0;
    main_~method_id~3 := 3;
    assume (!(main_~this_expect~3 < 1) && !(main_~this_buffer_empty~3 == 1)) && main_~P3~4 == (main_~this_expect~3 + 1) % 2;
    main_~q~3 := 4;
  ...
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume ((main_~P6~4 % 2 == main_~this_expect~3 % 2 && !(main_~this_expect~3 < 0)) && main_~this_buffer_empty~3 == 1) && !(main_~P6~4 < 0);
    main_~q~3 := 5;
    main_~this_expect~3 := main_~this_expect~3 + 1;
    main_~this_buffer_empty~3 := 1 - main_~this_buffer_empty~3;
    goto loc1;
  loc6_1:
    assume (!(main_~P6~4 < 0) && !(main_~P6~4 % 2 == main_~this_expect~3 % 2)) && main_~P6~4 % 2 == 1;
    goto loc8;
  loc7:
    goto loc7_0, loc7_1;
  loc7_0:
    assume (main_~P9~4 == (main_~this_expect~3 + 1) % 2 && (main_~this_expect~3 + 1) % 2 == 0) && !(main_~this_buffer_empty~3 == 1);
    goto loc9;
  loc7_1:
    assume (main_~P9~4 == (main_~this_expect~3 + 1) % 2 && !(main_~this_expect~3 < 1)) && !(main_~this_buffer_empty~3 == 1);
    goto loc9;
  loc8:
    assert false;
  loc9:
