...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc0:
    ...
    havoc main_#res;
    havoc main_#t~post10, main_~n~7, main_#t~mem12, main_#t~mem13, main_#t~post11, v_rep_select_ULTIMATE.start_main_~values~7_ULTIMATE.start_main_~v~7__1, main_~x~7, main_#t~post3, main_#t~post7, main_#t~post4, main_~#set~7.base, main_~y~7, main_~v~7, main_#t~ret9, main_#t~ret8, main_~#set~7.offset, main_#t~mem6, main_#t~mem5;
    main_~n~7 := 0;
  ...
  loc1_0:
    ...
    assume main_#t~mem12 == main_#t~mem13;
