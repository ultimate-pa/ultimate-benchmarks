...
modifies v_rep_select_#valid_0__1, #NULL.offset, #NULL.base;
{
  ...
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume rangesum_~i~2 < 20;
    goto loc2;
  loc1_1:
    assume !(rangesum_~i~2 < 20);
    assume !(rangesum_~cnt~2 == 0);
    assume (((((rangesum_~ret~2 < 0 && !(rangesum_~ret~2 / rangesum_~cnt~2 % 4294967296 <= 2147483647)) && (rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296 <= 2147483647) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 - 1) && !(rangesum_~cnt~2 < 0)) && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && 4294967296 + 4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 + 1;
  ...
  loc3_0:
    assume !(rangesum_~i~2 < 20);
    assume !(rangesum_~cnt~2 == 0);
    assume ((((((!(rangesum_~cnt~2 < 0) && rangesum_~ret~2 / rangesum_~cnt~2 + 1 < -4294967296) && (rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296 <= 2147483647) && rangesum_~ret~2 < 0) && rangesum_~ret~2 / rangesum_~cnt~2 < -4294967296) && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && rangesum_~ret~2 / rangesum_~cnt~2 % 4294967296 <= 2147483647) && rangesum_~ret~2 / rangesum_~cnt~2 - 1 < 4294967296 + 4294967296;
    rangesum_#res := (rangesum_~ret~2 / rangesum_~cnt~2 + 1) % 4294967296;
  ...
  loc7_1:
    assume !(rangesum_~i~2 < 20);
    assume !(rangesum_~cnt~2 == 0);
    assume (((((-4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2 + 1 && !(rangesum_~ret~2 % rangesum_~cnt~2 == 0)) && rangesum_~ret~2 < 0) && !(rangesum_~ret~2 / rangesum_~cnt~2 + 1 + 4294967296 <= 2147483647)) && -4294967296 <= rangesum_~ret~2 / rangesum_~cnt~2) && !(rangesum_~cnt~2 < 0)) && rangesum_~ret~2 / rangesum_~cnt~2 + 1 < 0;
