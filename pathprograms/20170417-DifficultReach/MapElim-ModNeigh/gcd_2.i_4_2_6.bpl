...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume (((((((256 <= gcd_test_~a % gcd_test_~b && gcd_test_~b < 0) && 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b < -256) && !(gcd_test_~a % gcd_test_~b == 0)) && !((255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127)) && gcd_test_~a < 0) && gcd_test_~b + gcd_test_~a % gcd_test_~b + 129 <= 0) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b < 256 + 256;
    gcd_test_~b := gcd_test_~b + gcd_test_~a % gcd_test_~b + 256;
    goto loc4;
  loc2_1:
    assume ((!(gcd_test_~a < 0) && 256 + 256 <= gcd_test_~a % gcd_test_~b) && !(gcd_test_~a % gcd_test_~b % 256 <= 127)) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b;
    gcd_test_~b := gcd_test_~a % gcd_test_~b % 256 - 256;
    goto loc4;
  loc3:
    assert false;
  loc4:
