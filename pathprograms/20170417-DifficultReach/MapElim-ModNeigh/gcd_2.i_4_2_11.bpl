...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume (((gcd_test_~a % gcd_test_~b < 256 && 0 <= gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b == 0) && gcd_test_~a % gcd_test_~b <= 127) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b;
    gcd_test_~b := gcd_test_~a % gcd_test_~b;
    goto loc4;
  loc2_1:
    assume (((gcd_test_~a % gcd_test_~b < 256 && !(gcd_test_~a < 0)) && 0 <= gcd_test_~a % gcd_test_~b) && gcd_test_~a % gcd_test_~b <= 127) && -256 <= gcd_test_~b + gcd_test_~a % gcd_test_~b;
    gcd_test_~b := gcd_test_~a % gcd_test_~b;
    goto loc4;
  loc3:
    assert false;
