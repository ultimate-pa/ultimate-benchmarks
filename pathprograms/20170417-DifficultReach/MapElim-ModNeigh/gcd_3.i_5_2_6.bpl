...
modifies ;
{
  ...
  loc1_0:
    ...
    assume ((gcd_test_~a % gcd_test_~b == 0 && gcd_test_~a % gcd_test_~b < 256) && 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b < 256 + 256) && 256 <= 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b;
