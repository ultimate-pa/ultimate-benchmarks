...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc v_rep_select_ULTIMATE.start_main_~a~4_ULTIMATE.start_main_~i~4__1, main_~min~4, main_~x~4, v_rep_select_ULTIMATE.start_main_~a~4_ULTIMATE.start_main_~x~4__1, main_#t~post0, main_~i~4;
  ...
  loc1_0:
    ...
    assume main_~min~4 < v_rep_select_ULTIMATE.start_main_~a~4_ULTIMATE.start_main_~x~4__1;
