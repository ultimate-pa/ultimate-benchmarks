...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    ~y~8.base, ~y~8.offset := #t~mem16.base, #t~mem16.offset;
    havoc #t~mem16.base, #t~mem16.offset;
    call #t~malloc17.base, #t~malloc17.offset := #Ultimate.alloc(12);
    call write~$Pointer$(#t~malloc17.base, #t~malloc17.offset, ~x~5.base, ~x~5.offset + 0, 8);
