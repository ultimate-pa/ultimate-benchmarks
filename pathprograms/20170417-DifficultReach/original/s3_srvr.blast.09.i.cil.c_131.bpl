...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc14_0:
    ...
    havoc #t~mem48;
    assume !(~num1~11 > 0);
    call #t~mem151.base, #t~mem151.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call #t~mem153 := read~int(#t~mem151.base, #t~mem151.offset + 652 + 252, 4);
    call write~int(#t~mem153, ~s.base, ~s.offset + 72, 4);
    havoc #t~mem151.base, #t~mem151.offset;
    havoc #t~mem153;
    goto loc6;
  loc14_1:
    assume !(#t~mem48 == 8448);
