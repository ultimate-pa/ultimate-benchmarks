...
implementation getClientPrivateKey(#in~handle : int) returns (#res : int){
  ...
  loc12_0:
    assume ~handle == 2;
    ~retValue_acc~347 := ~__ste_client_privateKey1;
