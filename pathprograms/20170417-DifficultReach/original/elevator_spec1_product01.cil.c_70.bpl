...
implementation isPersonOnFloor(#in~person : int, #in~floor : int) returns (#res : int){
  ...
  loc36_0:
    assume ~person == 0;
    ~retValue_acc~440 := ~personOnFloor_0_0;
    #res := ~retValue_acc~440;
    goto loc37;
  loc36_1:
    assume !(~person == 0);
  ...
  loc38_0:
    assume ~person == 1;
    ~retValue_acc~440 := ~personOnFloor_1_0;
    #res := ~retValue_acc~440;
    goto loc37;
  loc38_1:
    assume !(~person == 1);
  ...
  loc39_0:
    assume ~person == 2;
    ~retValue_acc~440 := ~personOnFloor_2_0;
    #res := ~retValue_acc~440;
    goto loc37;
  loc39_1:
    assume !(~person == 2);
    assume ~person == 3;
    ~retValue_acc~440 := ~personOnFloor_3_0;
    #res := ~retValue_acc~440;
    goto loc37;
}
...
implementation processWaitingOnFloor(#in~floorID : int) returns (){
  ...
  loc46:
    ...
    havoc ~tmp___9~279;
    havoc ~tmp___10~279;
    call #t~ret20 := isPersonOnFloor(0, ~floorID);
    assume -2147483648 <= #t~ret20 && #t~ret20 <= 2147483647;
    ~tmp___0~279 := #t~ret20;
    havoc #t~ret20;
    assume !(~tmp___0~279 != 0);
    call #t~ret22 := isPersonOnFloor(1, ~floorID);
    assume -2147483648 <= #t~ret22 && #t~ret22 <= 2147483647;
    ~tmp___2~279 := #t~ret22;
    havoc #t~ret22;
    assume !(~tmp___2~279 != 0);
    call #t~ret24 := isPersonOnFloor(2, ~floorID);
    assume -2147483648 <= #t~ret24 && #t~ret24 <= 2147483647;
    ~tmp___4~279 := #t~ret24;
    havoc #t~ret24;
    assume !(~tmp___4~279 != 0);
    call #t~ret26 := isPersonOnFloor(3, ~floorID);
    assume -2147483648 <= #t~ret26 && #t~ret26 <= 2147483647;
    ~tmp___6~279 := #t~ret26;
    havoc #t~ret26;
    assume !(~tmp___6~279 != 0);
    call #t~ret28 := isPersonOnFloor(4, ~floorID);
    assume -2147483648 <= #t~ret28 && #t~ret28 <= 2147483647;
    ~tmp___8~279 := #t~ret28;
    havoc #t~ret28;
    assume !(~tmp___8~279 != 0);
    call #t~ret30 := isPersonOnFloor(5, ~floorID);
    assume -2147483648 <= #t~ret30 && #t~ret30 <= 2147483647;
    ~tmp___10~279 := #t~ret30;
    havoc #t~ret30;
    assume !(~tmp___10~279 != 0);
