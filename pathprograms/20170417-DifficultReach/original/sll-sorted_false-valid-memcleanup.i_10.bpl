...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    #t~short18 := #t~mem16.base != 0 || #t~mem16.offset != 0;
    assume !#t~short18;
    assume !#t~short18;
    havoc #t~mem16.base, #t~mem16.offset;
    havoc #t~nondet17;
    havoc #t~short18;
    call #t~malloc21.base, #t~malloc21.offset := #Ultimate.alloc(12);
    ~tmp~5.base, ~tmp~5.offset := #t~malloc21.base, #t~malloc21.offset;
    call write~int(1, ~tmp~5.base, ~tmp~5.offset + 8, 4);
    call write~$Pointer$(0, 0, ~tmp~5.base, ~tmp~5.offset + 0, 8);
    call #t~mem24.base, #t~mem24.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 0, 8);
    assume #t~mem24.base == 0 && #t~mem24.offset == 0;
    havoc #t~mem24.base, #t~mem24.offset;
    call write~$Pointer$(~tmp~5.base, ~tmp~5.offset, ~x~5.base, ~x~5.offset + 0, 8);
    ~marked~5 := 0;
    ~x~5.base, ~x~5.offset := ~head~5.base, ~head~5.offset;
    assume true;
    #t~short30 := ~x~5.base != 0 || ~x~5.offset != 0;
    assume #t~short30;
    call #t~mem29 := read~int(~x~5.base, ~x~5.offset + 8, 4);
    #t~short30 := #t~mem29 != 1;
    assume !!#t~short30;
    havoc #t~mem29;
    havoc #t~short30;
    call #t~mem31 := read~int(~x~5.base, ~x~5.offset + 8, 4);
    ~marked~5 := #t~mem31;
    havoc #t~mem31;
    assume true;
    call #t~mem32 := read~int(~x~5.base, ~x~5.offset + 8, 4);
    assume !(#t~mem32 == 0);
    havoc #t~mem32;
    assume !false;
    goto loc5;
