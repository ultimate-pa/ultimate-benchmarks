...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc6_0:
    ...
    ~a29 := (if (if ~a29 < 0 && ~a29 % 52 != 0 then ~a29 % 52 - 52 else ~a29 % 52) + 192 < 0 && ((if ~a29 < 0 && ~a29 % 52 != 0 then ~a29 % 52 - 52 else ~a29 % 52) + 192) % 5 != 0 then ((if ~a29 < 0 && ~a29 % 52 != 0 then ~a29 % 52 - 52 else ~a29 % 52) + 192) / 5 + 1 else ((if ~a29 < 0 && ~a29 % 52 != 0 then ~a29 % 52 - 52 else ~a29 % 52) + 192) / 5) - -183;
    ~a23 := (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) - -232517 + 138613;
    ~a4 := 1;
    ~a25 := 13;
    #res := 25;
    goto loc5;
