...
implementation rjhKeyChange() returns (){
  loc10:
    call generateKeyPair(~rjh, 666);
    assume true;
    return;
}

procedure rjhKeyChange() returns ();
...
implementation findPublicKey(#in~handle : int, #in~userid : int) returns (#res : int){
  ...
  loc11:
    ...
    assume !(~userid == ~__ste_Client_Keyring0_User1);
    ~retValue_acc~314 := 0;
...
implementation test() returns (){
  ...
  loc27_1:
    ...
    ~tmp___6~459 := #t~nondet26;
    havoc #t~nondet26;
    assume !(~tmp___6~459 != 0);
    assume ~op5~459 == 0;
    assume -2147483648 <= #t~nondet27 && #t~nondet27 <= 2147483647;
    ~tmp___5~459 := #t~nondet27;
    havoc #t~nondet27;
    assume !(~tmp___5~459 != 0);
    assume ~op6~459 == 0;
    assume -2147483648 <= #t~nondet28 && #t~nondet28 <= 2147483647;
    ~tmp___4~459 := #t~nondet28;
    havoc #t~nondet28;
    assume !(~tmp___4~459 != 0);
    assume ~op7~459 == 0;
    assume -2147483648 <= #t~nondet29 && #t~nondet29 <= 2147483647;
    ~tmp___3~459 := #t~nondet29;
    havoc #t~nondet29;
    assume ~tmp___3~459 != 0;
    call rjhKeyChange();
    ~op7~459 := 1;
    goto loc24;
}
...
implementation generateKeyPair(#in~client : int, #in~seed : int) returns (){
    var ~client : int;
    var ~seed : int;
  ...
  loc35:
    ~client := #in~client;
    ~seed := #in~seed;
    call setClientPrivateKey(~client, ~seed);
    assume true;
    return;
}

procedure generateKeyPair(#in~client : int, #in~seed : int) returns ();
modifies ~__ste_client_privateKey0, ~__ste_client_privateKey1, ~__ste_client_privateKey2;
