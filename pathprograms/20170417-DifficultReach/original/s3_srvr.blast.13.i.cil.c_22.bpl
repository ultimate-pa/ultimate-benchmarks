...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc3:
    ...
    call #t~mem23.base, #t~mem23.offset := read~$Pointer$(~s.base, ~s.offset + 272, 8);
    ~cb~11.base, ~cb~11.offset := #t~mem23.base, #t~mem23.offset;
  ...
  loc13_1:
    ...
    assume !(#t~mem59 == 8672);
    havoc #t~mem59;
    call #t~mem60 := read~int(~s.base, ~s.offset + 72, 4);
    assume #t~mem60 == 8673;
    havoc #t~mem60;
