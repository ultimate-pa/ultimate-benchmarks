...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc5_0:
    ...
    call #t~mem59 := read~int(~s.base, ~s.offset + 0, 4);
    assume !(~shiftRight(#t~mem59, 8) != 3);
    havoc #t~mem59;
    call write~int(8192, ~s.base, ~s.offset + 4, 4);
    call #t~mem61.base, #t~mem61.offset := read~$Pointer$(~s.base, ~s.offset + 80, 8);
    assume !((#t~mem61.base + #t~mem61.offset) % 18446744073709551616 == 0);
    havoc #t~mem61.base, #t~mem61.offset;
    assume -2147483648 <= #t~nondet64 && #t~nondet64 <= 2147483647;
    ~tmp___4~11 := #t~nondet64;
    havoc #t~nondet64;
    assume !(~tmp___4~11 == 0);
    call write~int(0, ~s.base, ~s.offset + 88, 4);
    call #t~mem66 := read~int(~s.base, ~s.offset + 72, 4);
    assume #t~mem66 != 12292;
    havoc #t~mem66;
    assume -2147483648 <= #t~nondet67 && #t~nondet67 <= 2147483647;
    ~tmp___5~11 := #t~nondet67;
    havoc #t~nondet67;
    assume !(~tmp___5~11 == 0);
    call write~int(8464, ~s.base, ~s.offset + 72, 4);
    call #t~mem69.base, #t~mem69.offset := read~$Pointer$(~s.base, ~s.offset + 288, 8);
    call #t~mem70 := read~int(#t~mem69.base, #t~mem69.offset + 116 + 12, 4);
    call write~int(#t~mem70 + 1, #t~mem69.base, #t~mem69.offset + 116 + 12, 4);
    havoc #t~mem69.base, #t~mem69.offset;
    havoc #t~mem70;
    goto loc6;
  loc5_1:
    assume !(#t~mem22 == 12292);
