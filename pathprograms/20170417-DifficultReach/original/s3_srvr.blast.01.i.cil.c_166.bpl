...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc9_0:
    ...
    havoc #t~nondet147;
    assume !(~num1~11 > 0);
    call #t~mem150.base, #t~mem150.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call #t~mem152 := read~int(#t~mem150.base, #t~mem150.offset + 652 + 252, 4);
    call write~int(#t~mem152, ~s.base, ~s.offset + 72, 4);
