...
implementation isAnyLiftButtonPressed() returns (#res : int){
    var ~retValue_acc~290 : int;

  loc16:
    havoc ~retValue_acc~290;
    assume !(~floorButtons_0 != 0);
    assume !(~floorButtons_1 != 0);
    assume ~floorButtons_2 != 0;
    ~retValue_acc~290 := 1;
    #res := ~retValue_acc~290;
    assume true;
    return;
}
...
implementation stopRequestedInDirection(#in~dir : int, #in~respectFloorCalls : int, #in~respectInLiftCalls : int) returns (#res : int){
  ...
  loc24_1:
    assume !(~tmp___0~283 != 0);
    call #t~ret25 := stopRequestedInDirection__wrappee__twothirdsfull(~dir, ~respectFloorCalls, ~respectInLiftCalls);
    assume -2147483648 <= #t~ret25 && #t~ret25 <= 2147483647;
    ~retValue_acc~283 := #t~ret25;
    havoc #t~ret25;
    #res := ~retValue_acc~283;
    goto loc25;
  loc25:
...
implementation stopRequestedInDirection__wrappee__twothirdsfull(#in~dir : int, #in~respectFloorCalls : int, #in~respectInLiftCalls : int) returns (#res : int){
    ...
    var ~respectFloorCalls : int;
    var ~respectInLiftCalls : int;
    var ~retValue_acc~273 : int;
    var ~overload~273 : int;
    var ~buttonPressed~273 : int;
    var ~tmp~273 : int;
    var ~__cil_tmp8~273 : int;
    var ~__cil_tmp9~273 : int;

  loc26:
    ~dir := #in~dir;
    ~respectFloorCalls := #in~respectFloorCalls;
    ~respectInLiftCalls := #in~respectInLiftCalls;
    havoc ~retValue_acc~273;
    havoc ~overload~273;
    havoc ~buttonPressed~273;
    havoc ~tmp~273;
    havoc ~__cil_tmp8~273;
    havoc ~__cil_tmp9~273;
    ~__cil_tmp8~273 := ~maximumWeight * 2;
    ~__cil_tmp9~273 := (if ~__cil_tmp8~273 < 0 && ~__cil_tmp8~273 % 3 != 0 then ~__cil_tmp8~273 / 3 + 1 else ~__cil_tmp8~273 / 3);
    ~overload~273 := (if ~weight > ~__cil_tmp9~273 then 1 else 0);
    call #t~ret19 := isAnyLiftButtonPressed();
    assume -2147483648 <= #t~ret19 && #t~ret19 <= 2147483647;
    ~tmp~273 := #t~ret19;
    havoc #t~ret19;
    ~buttonPressed~273 := ~tmp~273;
    assume !(~overload~273 != 0);
    call #t~ret22 := stopRequestedInDirection__wrappee__weight(~dir, ~respectFloorCalls, ~respectInLiftCalls);
    assume -2147483648 <= #t~ret22 && #t~ret22 <= 2147483647;
    ~retValue_acc~273 := #t~ret22;
    havoc #t~ret22;
    #res := ~retValue_acc~273;
    assume true;
    return;
}
...
implementation timeShift__wrappee__executivefloor() returns (){
  ...
  loc49:
    ...
    call #t~ret56 := getReverseHeading(~currentHeading);
    assume -2147483648 <= #t~ret56 && #t~ret56 <= 2147483647;
    ~tmp___6~369 := #t~ret56;
    havoc #t~ret56;
    call #t~ret57 := stopRequestedInDirection(~tmp___6~369, 1, 1);
    assume -2147483648 <= #t~ret57 && #t~ret57 <= 2147483647;
    ~tmp___7~369 := #t~ret57;
    havoc #t~ret57;
    assume ~tmp___7~369 != 0;
    call #t~ret58 := getReverseHeading(~currentHeading);
    assume -2147483648 <= #t~ret58 && #t~ret58 <= 2147483647;
    ~tmp___5~369 := #t~ret58;
    havoc #t~ret58;
    call continueInDirection(~tmp___5~369);
    assume true;
    return;
}
