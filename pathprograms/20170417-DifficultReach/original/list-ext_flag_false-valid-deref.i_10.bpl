...
implementation main() returns (#res : int){
  ...
  loc5:
    assume true;
    call #t~mem13 := read~int(~p~7.base, ~p~7.offset + 0, 4);
    goto loc6;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
  ...
  loc6_1:
    assume !!(#t~mem13 != 3);
    havoc #t~mem13;
    call #t~mem14 := read~int(~p~7.base, ~p~7.offset + 4, 4);
    assume #t~mem14 != 0;
    havoc #t~mem14;
    call #t~mem15 := read~int(~p~7.base, ~p~7.offset + 0, 4);
    assume !(#t~mem15 != 1);
    havoc #t~mem15;
    call #t~mem17.base, #t~mem17.offset := read~$Pointer$(~p~7.base, ~p~7.offset + 8, 8);
    ~p~7.base, ~p~7.offset := #t~mem17.base, #t~mem17.offset;
