...
implementation main() returns (#res : int){
  ...
  loc5:
    assume true;
    assume !!(0 != ~end~5.base || 0 != ~end~5.offset);
    call #t~mem24 := read~int(~end~5.base, ~end~5.offset + 16, 4);
    goto loc6;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume ~unnamed0~RED == #t~mem24;
    havoc #t~mem24;
    call #t~mem25.base, #t~mem25.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 0, 8);
    ~end~5.base, ~end~5.offset := #t~mem25.base, #t~mem25.offset;
  ...
  loc6_1:
    assume !(~unnamed0~RED == #t~mem24);
    havoc #t~mem24;
    call #t~mem27.base, #t~mem27.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 0, 8);
    ~end~5.base, ~end~5.offset := #t~mem27.base, #t~mem27.offset;
