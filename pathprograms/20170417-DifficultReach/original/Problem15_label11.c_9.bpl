...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a4 := (if ~a4 - 0 - -490407 < 0 && (~a4 - 0 - -490407) % 21 != 0 then (~a4 - 0 - -490407) % 21 - 21 else (~a4 - 0 - -490407) % 21) + -62;
    ~a0 := (if (~a0 - 153310) * 1 < 0 && (~a0 - 153310) * 1 % 299926 != 0 then (~a0 - 153310) * 1 % 299926 - 299926 else (~a0 - 153310) * 1 % 299926) - 300072;
    ~a29 := (if ~a29 < 0 && ~a29 % 299978 != 0 then ~a29 % 299978 - 299978 else ~a29 % 299978) + 300021 + 1 - 0;
    ~a2 := 4;
    #res := 22;
    goto loc5;
  loc4_1:
  ...
  loc6_0:
    ...
    ~a29 := (if ~a29 * 5 - -271226 < 0 && (~a29 * 5 - -271226) % 5 != 0 then (~a29 * 5 - -271226) / 5 + 1 else (~a29 * 5 - -271226) / 5);
    ~a2 := 5;
    #res := 21;
    goto loc5;
  loc6_1:
