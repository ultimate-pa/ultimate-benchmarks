...
implementation main() returns (#res : int){
  ...
  loc6_0:
    assume !(0 != ~end~5.base || 0 != ~end~5.offset);
    call #t~mem41.base, #t~mem41.offset := read~$Pointer$(~list~5.base, ~list~5.offset + 0, 8);
    ~end~5.base, ~end~5.offset := #t~mem41.base, #t~mem41.offset;
    havoc #t~mem41.base, #t~mem41.offset;
