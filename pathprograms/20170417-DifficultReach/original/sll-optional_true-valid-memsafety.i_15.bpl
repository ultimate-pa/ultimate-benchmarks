...
implementation main() returns (#res : int){
  ...
  loc2:
    ...
    assume #t~nondet2 != 0;
    havoc #t~nondet2;
    call write~int(2, ~head~5.base, ~head~5.offset + 16, 4);
    call #t~malloc4.base, #t~malloc4.offset := #Ultimate.alloc(20);
    call write~$Pointer$(#t~malloc4.base, #t~malloc4.offset, ~head~5.base, ~head~5.offset + 8, 8);
    call #t~mem6.base, #t~mem6.offset := read~$Pointer$(~head~5.base, ~head~5.offset + 8, 8);
  ...
  loc4_0:
    ...
    #t~short31 := #t~mem29 == 2;
    assume #t~short31;
    call #t~mem30.base, #t~mem30.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 8, 8);
    #t~short31 := #t~mem30.base != ~x~5.base || #t~mem30.offset != ~x~5.offset;
    #t~short34 := #t~short31;
    assume #t~short34;
    call #t~mem32.base, #t~mem32.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 8, 8);
    call #t~mem33.base, #t~mem33.offset := read~$Pointer$(#t~mem32.base, #t~mem32.offset + 0, 8);
    #t~short34 := #t~mem33.base == 0 && #t~mem33.offset == 0;
    #t~short36 := #t~short34;
    assume !#t~short36;
  ...
  loc4_1:
    ...
    call #t~malloc20.base, #t~malloc20.offset := #Ultimate.alloc(20);
    call write~$Pointer$(#t~malloc20.base, #t~malloc20.offset, ~x~5.base, ~x~5.offset + 8, 8);
    call #t~mem22.base, #t~mem22.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 8, 8);
