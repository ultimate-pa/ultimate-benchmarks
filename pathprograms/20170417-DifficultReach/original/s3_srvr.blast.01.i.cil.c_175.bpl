...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc9_0:
    assume #t~mem41 == 8560;
    havoc #t~mem41;
    assume -2147483648 <= #t~nondet142 && #t~nondet142 <= 2147483647;
    ~ret~11 := #t~nondet142;
    havoc #t~nondet142;
    assume !(~ret~11 <= 0);
    call #t~mem143.base, #t~mem143.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call write~int(8576, #t~mem143.base, #t~mem143.offset + 652 + 252, 4);
