...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a1 := (if ((if ~a1 < 0 && ~a1 % 25 != 0 then ~a1 % 25 - 25 else ~a1 % 25) + -8) * 5 < 0 && ((if ~a1 < 0 && ~a1 % 25 != 0 then ~a1 % 25 - 25 else ~a1 % 25) + -8) * 5 % 25 != 0 then ((if ~a1 < 0 && ~a1 % 25 != 0 then ~a1 % 25 - 25 else ~a1 % 25) + -8) * 5 % 25 - 25 else ((if ~a1 < 0 && ~a1 % 25 != 0 then ~a1 % 25 - 25 else ~a1 % 25) + -8) * 5 % 25) + 13;
    ~a10 := 1;
    ~a19 := 7;
    #res := -1;
    goto loc5;
  ...
  loc6_0:
    ...
    ~a1 := (if (if (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) < 0 && (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 != 0 then (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 - 299993 else (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993) + -300005 < 0 && ((if (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) < 0 && (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 != 0 then (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 - 299993 else (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993) + -300005) % 5 != 0 then ((if (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) < 0 && (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 != 0 then (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 - 299993 else (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993) + -300005) / 5 + 1 else ((if (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) < 0 && (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 != 0 then (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993 - 299993 else (if ~a1 * 9 < 0 && ~a1 * 9 % 10 != 0 then ~a1 * 9 / 10 + 1 else ~a1 * 9 / 10) % 299993) + -300005) / 5) + -75819;
    ~a10 := 4;
    #res := 26;
    goto loc5;
  loc6_1:
