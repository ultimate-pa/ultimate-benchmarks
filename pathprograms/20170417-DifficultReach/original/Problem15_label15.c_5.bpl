...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a29 := (if (if ~a29 < 0 && ~a29 % 29 != 0 then ~a29 % 29 - 29 else ~a29 % 29) - -15 < 0 && ((if ~a29 < 0 && ~a29 % 29 != 0 then ~a29 % 29 - 29 else ~a29 % 29) - -15) % 5 != 0 then ((if ~a29 < 0 && ~a29 % 29 != 0 then ~a29 % 29 - 29 else ~a29 % 29) - -15) / 5 + 1 else ((if ~a29 < 0 && ~a29 % 29 != 0 then ~a29 % 29 - 29 else ~a29 % 29) - -15) / 5) + -16;
    ~a2 := 5;
    #res := -1;
    goto loc5;
  loc4_1:
