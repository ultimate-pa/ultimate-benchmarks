...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    #t~short34 := #t~mem32 == 2;
    assume #t~short34;
    call #t~mem33.base, #t~mem33.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 16, 8);
    #t~short34 := #t~mem33.base != ~x~5.base || #t~mem33.offset != ~x~5.offset;
    #t~short37 := #t~short34;
    assume #t~short37;
    call #t~mem35.base, #t~mem35.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 16, 8);
    call #t~mem36.base, #t~mem36.offset := read~$Pointer$(#t~mem35.base, #t~mem35.offset + 0, 8);
    #t~short37 := #t~mem36.base == 0 && #t~mem36.offset == 0;
    #t~short39 := #t~short37;
    assume !#t~short39;
  ...
  loc4_1:
    ...
    assume #t~nondet21 != 0;
    havoc #t~nondet21;
    call write~int(2, ~x~5.base, ~x~5.offset + 24, 4);
    call #t~malloc23.base, #t~malloc23.offset := #Ultimate.alloc(28);
    call write~$Pointer$(#t~malloc23.base, #t~malloc23.offset, ~x~5.base, ~x~5.offset + 16, 8);
    call #t~mem25.base, #t~mem25.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 16, 8);
    call write~$Pointer$(0, 0, #t~mem25.base, #t~mem25.offset + 0, 8);
