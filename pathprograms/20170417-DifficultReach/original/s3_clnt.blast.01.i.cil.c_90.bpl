...
implementation ssl3_connect(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc3_0:
    ...
    call #t~mem61.base, #t~mem61.offset := read~$Pointer$(~s.base, ~s.offset + 288, 8);
    call #t~mem62 := read~int(#t~mem61.base, #t~mem61.offset + 116 + 4, 4);
    call write~int(#t~mem62 + 1, #t~mem61.base, #t~mem61.offset + 116 + 4, 4);
  ...
  loc4:
    ...
    assume (~cb~10.base + ~cb~10.offset) % 18446744073709551616 != 0;
    call #t~mem64 := read~int(~s.base, ~s.offset + 0, 4);
    assume !(~bitwiseAnd(#t~mem64, 65280) != 768);
    havoc #t~mem64;
    ...
    ~tmp___4~10 := #t~nondet69;
    havoc #t~nondet69;
    assume !(~tmp___4~10 == 0);
    assume -2147483648 <= #t~nondet70 && #t~nondet70 <= 2147483647;
    ~tmp___5~10 := #t~nondet70;
    havoc #t~nondet70;
    assume !(~tmp___5~10 == 0);
    call write~int(4368, ~s.base, ~s.offset + 72, 4);
    call #t~mem72.base, #t~mem72.offset := read~$Pointer$(~s.base, ~s.offset + 288, 8);
    call #t~mem73 := read~int(#t~mem72.base, #t~mem72.offset + 116 + 0, 4);
    call write~int(#t~mem73 + 1, #t~mem72.base, #t~mem72.offset + 116 + 0, 4);
  ...
  loc8_0:
    ...
    havoc #t~mem184;
    assume ~skip~10 == 0;
    call #t~mem185 := read~int(~s.base, ~s.offset + 296, 4);
    assume !(#t~mem185 != 0);
    havoc #t~mem185;
    assume (~cb~10.base + ~cb~10.offset) % 18446744073709551616 != 0;
    call #t~mem187 := read~int(~s.base, ~s.offset + 72, 4);
    assume #t~mem187 != ~state~10;
    havoc #t~mem187;
    call #t~mem188 := read~int(~s.base, ~s.offset + 72, 4);
    ~new_state~10 := #t~mem188;
    havoc #t~mem188;
    call write~int(~state~10, ~s.base, ~s.offset + 72, 4);
    call write~int(~new_state~10, ~s.base, ~s.offset + 72, 4);
    goto loc10;
  loc8_1:
    assume !(#t~mem184 == 0);
    havoc #t~mem183.base, #t~mem183.offset;
