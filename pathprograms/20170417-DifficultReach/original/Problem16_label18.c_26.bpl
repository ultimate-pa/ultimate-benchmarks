...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc5_0:
    ...
    ~a18 := (if ~a18 < 0 && ~a18 % 106 != 0 then ~a18 % 106 - 106 else ~a18 % 106) - -28 + 468168 - 468167;
    ~a12 := 7;
    #res := 21;
    goto loc6;
  loc5_1:
  ...
  loc10_0:
    ...
    ~a18 := (if (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) < 0 && (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) % 38 != 0 then (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) % 38 - 38 else (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) % 38) + -117 - 511801 - -511801;
    ~a12 := 9;
    #res := 21;
    goto loc6;
  loc10_1:
