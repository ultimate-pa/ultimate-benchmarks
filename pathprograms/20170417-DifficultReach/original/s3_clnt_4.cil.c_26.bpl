...
implementation ssl3_connect(#in~initial_state : int) returns (#res : int){
  ...
  loc7_0:
    ...
    ~__cil_tmp56~4 := ~s__s3__tmp__new_cipher__algorithms~4;
    assume !((~__cil_tmp56~4 + 256) % 18446744073709551616 != 0);
  ...
  loc19_0:
    ...
    assume !(~ret~4 <= 0);
    ~s__state~4 := 4352;
    ~__cil_tmp57~4 := ~s__s3__flags~4;
    ~__cil_tmp58~4 := ~__cil_tmp57~4 - 5;
    ~s__s3__flags~4 := (if ~__cil_tmp58~4 % 4294967296 <= 2147483647 then ~__cil_tmp58~4 % 4294967296 else ~__cil_tmp58~4 % 4294967296 - 4294967296);
    assume ~s__hit~4 != 0;
    ~s__s3__tmp__next_state___0~4 := 3;
    ~__cil_tmp59~4 := ~s__s3__flags~4;
    assume !(~__cil_tmp59~4 + 2 != 0);
    ~s__init_num~4 := 0;
    goto loc4;
  loc19_1:
    assume !(~s__state~4 == 4528);
  ...
  loc20_1:
    ...
    ~__cil_tmp62~4 := ~num1~4;
    assume !(~__cil_tmp62~4 > 0);
