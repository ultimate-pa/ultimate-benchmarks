...
implementation main() returns (#res : int){
  ...
  loc6_1:
    ...
    call #t~malloc40.base, #t~malloc40.offset := #Ultimate.alloc(12);
    ~t~7.base, ~t~7.offset := #t~malloc40.base, #t~malloc40.offset;
    assume !(~t~7.base == 0 && ~t~7.offset == 0);
    call write~$Pointer$(~t~7.base, ~t~7.offset, ~p~7.base, ~p~7.offset + 4, 8);
    call #t~mem42.base, #t~mem42.offset := read~$Pointer$(~p~7.base, ~p~7.offset + 4, 8);
    ~p~7.base, ~p~7.offset := #t~mem42.base, #t~mem42.offset;
  ...
  loc8_1:
    assume !!(#t~mem49 == 2);
    havoc #t~mem49;
    call #t~mem50.base, #t~mem50.offset := read~$Pointer$(~p~7.base, ~p~7.offset + 4, 8);
    ~p~7.base, ~p~7.offset := #t~mem50.base, #t~mem50.offset;
    havoc #t~mem50.base, #t~mem50.offset;
    goto loc7;
  loc9:
    assert false;
}
