...
implementation main() returns (#res : int){
  ...
  loc2:
    ...
    havoc ~tmp~198;
    ~s~198 := 8464;
    call #t~ret49 := ssl3_accept(~s~198);
    return;
}
...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc27_0:
    assume ~blastFlag~5 == 18;
    ~blastFlag~5 := 19;
    goto loc18;
  loc27_1:
    assume !(~blastFlag~5 == 18);
    assume ~blastFlag~5 == 21;
    assume !false;
    goto loc30;
  loc28:
    goto loc28_0, loc28_1;
  loc28_0:
    assume ~blastFlag~5 == 16;
    ~blastFlag~5 := 17;
    goto loc23;
  loc28_1:
    assume !(~blastFlag~5 == 16);
    assume ~blastFlag~5 == 19;
    ~blastFlag~5 := 20;
    goto loc23;
  loc29:
    goto loc29_0, loc29_1;
  loc29_0:
    assume ~blastFlag~5 == 17;
    ~blastFlag~5 := 18;
    goto loc25;
  loc29_1:
    assume !(~blastFlag~5 == 17);
    assume ~blastFlag~5 == 20;
    ~blastFlag~5 := 21;
    goto loc25;
  loc30:
    assert false;
