...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a1 := (if (if ~a1 < 0 && ~a1 % 5 != 0 then ~a1 / 5 + 1 else ~a1 / 5) * 5 < 0 && (if ~a1 < 0 && ~a1 % 5 != 0 then ~a1 / 5 + 1 else ~a1 / 5) * 5 % 5 != 0 then (if ~a1 < 0 && ~a1 % 5 != 0 then ~a1 / 5 + 1 else ~a1 / 5) * 5 / 5 + 1 else (if ~a1 < 0 && ~a1 % 5 != 0 then ~a1 / 5 + 1 else ~a1 / 5) * 5 / 5) + 505228;
    ~a10 := 1;
    #res := 25;
    goto loc5;
  loc4_1:
    ...
    ~a1 := (if ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) - -93) * 5 < 0 && ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) - -93) * 5 % 89 != 0 then ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) - -93) * 5 % 89 - 89 else ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) - -93) * 5 % 89) - -56;
    ~a10 := 4;
    ~a19 := 8;
    #res := -1;
    goto loc5;
