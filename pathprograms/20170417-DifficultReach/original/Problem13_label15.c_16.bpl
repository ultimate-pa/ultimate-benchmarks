...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc6_0:
    ...
    ~a12 := (if ~a12 < 0 && ~a12 % 22 != 0 then ~a12 % 22 - 22 else ~a12 % 22) + 397 - 1 - 0;
    ~a23 := ((if ~a23 < 0 && ~a23 % 299761 != 0 then ~a23 % 299761 - 299761 else ~a23 % 299761) + 300237) * 1 - 0;
    ~a1 := 3;
    ~a19 := 12;
    ~a13 := 1;
    #res := 22;
  ...
  loc6_1:
    ...
    assume !(~a13 == 1);
    ~a12 := ~a12 + 0 - 600306 + -21;
    ~a23 := ((if ~a23 < 0 && ~a23 % 299761 != 0 then ~a23 % 299761 - 299761 else ~a23 % 299761) + 300237) * 1 + 1;
    ~a1 := 2;
    ~a19 := 13;
    #res := -1;
    goto loc5;
