...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    assume true;
    assume true;
    call #t~mem12 := read~int(~x~5.base, ~x~5.offset + 8, 4);
    assume !!(#t~mem12 != 0);
    havoc #t~mem12;
    assume true;
    call #t~mem13.base, #t~mem13.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 0, 8);
    call #t~mem14 := read~int(#t~mem13.base, #t~mem13.offset + 8, 4);
    #t~short18 := #t~mem14 == 0;
    assume !#t~short18;
    call #t~mem16 := read~int(~x~5.base, ~x~5.offset + 8, 4);
    call #t~mem15.base, #t~mem15.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 0, 8);
    call #t~mem17 := read~int(#t~mem15.base, #t~mem15.offset + 8, 4);
    #t~short18 := #t~mem16 <= #t~mem17;
    assume !#t~short18;
