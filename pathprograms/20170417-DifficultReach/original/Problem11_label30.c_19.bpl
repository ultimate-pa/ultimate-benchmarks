...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a29 := (if (if (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) < 0 && (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) % 5 != 0 then (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5 + 1 else (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5) < 0 && (if (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) < 0 && (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) % 5 != 0 then (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5 + 1 else (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5) % 52 != 0 then (if (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) < 0 && (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) % 5 != 0 then (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5 + 1 else (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5) % 52 - 52 else (if (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) < 0 && (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) % 5 != 0 then (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5 + 1 else (if ~a29 * 9 < 0 && ~a29 * 9 % 10 != 0 then ~a29 * 9 / 10 + 1 else ~a29 * 9 / 10) / 5) % 52) + 193;
    ~a23 := (if ((if ~a23 < 0 && ~a23 % 299846 != 0 then ~a23 % 299846 - 299846 else ~a23 % 299846) - -300152 + 67658) * 10 < 0 && ((if ~a23 < 0 && ~a23 % 299846 != 0 then ~a23 % 299846 - 299846 else ~a23 % 299846) - -300152 + 67658) * 10 % 9 != 0 then ((if ~a23 < 0 && ~a23 % 299846 != 0 then ~a23 % 299846 - 299846 else ~a23 % 299846) - -300152 + 67658) * 10 / 9 + 1 else ((if ~a23 < 0 && ~a23 % 299846 != 0 then ~a23 % 299846 - 299846 else ~a23 % 299846) - -300152 + 67658) * 10 / 9);
    ~a4 := 1;
    ~a25 := 13;
    #res := 25;
    goto loc5;
