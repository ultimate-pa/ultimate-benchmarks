...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc12_0:
    ...
    ~a18 := (if ~a18 < 0 && ~a18 % 106 != 0 then ~a18 % 106 - 106 else ~a18 % 106) + 27 - 0 - 0;
    ~a12 := 8;
    #res := 21;
    goto loc5;
  loc12_1:
  ...
  loc14_0:
    ...
    ~a18 := (if (if ~a18 < 0 && ~a18 % 5 != 0 then ~a18 / 5 + 1 else ~a18 / 5) < 0 && (if ~a18 < 0 && ~a18 % 5 != 0 then ~a18 / 5 + 1 else ~a18 / 5) % 106 != 0 then (if ~a18 < 0 && ~a18 % 5 != 0 then ~a18 / 5 + 1 else ~a18 / 5) % 106 - 106 else (if ~a18 < 0 && ~a18 % 5 != 0 then ~a18 / 5 + 1 else ~a18 / 5) % 106) + 28 - -1;
    ~a12 := 9;
    #res := 24;
    goto loc5;
  loc14_1:
  ...
  loc16_1:
    ...
    ~a18 := (if (~a18 + -58296 - -119457) * 10 < 0 && (~a18 + -58296 - -119457) * 10 % 9 != 0 then (~a18 + -58296 - -119457) * 10 / 9 + 1 else (~a18 + -58296 - -119457) * 10 / 9);
    ~a16 := 8;
    ~a15 := 4;
    ~a12 := 5;
    #res := 22;
