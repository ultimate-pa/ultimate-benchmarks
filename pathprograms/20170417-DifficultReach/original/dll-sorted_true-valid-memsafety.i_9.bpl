...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    havoc #t~nondet20;
    havoc #t~short21;
    call #t~malloc24.base, #t~malloc24.offset := #Ultimate.alloc(20);
    ~tmp~5.base, ~tmp~5.offset := #t~malloc24.base, #t~malloc24.offset;
    call write~int(1, ~tmp~5.base, ~tmp~5.offset + 16, 4);
    call write~$Pointer$(0, 0, ~tmp~5.base, ~tmp~5.offset + 0, 8);
    call write~$Pointer$(~x~5.base, ~x~5.offset, ~tmp~5.base, ~tmp~5.offset + 8, 8);
    call #t~mem28.base, #t~mem28.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 0, 8);
    ...
    ~x~5.base, ~x~5.offset := ~head~5.base, ~head~5.offset;
    assume true;
    #t~short36 := ~x~5.base != 0 || ~x~5.offset != 0;
    assume #t~short36;
    call #t~mem35 := read~int(~x~5.base, ~x~5.offset + 16, 4);
    #t~short36 := #t~mem35 != 1;
    assume !!#t~short36;
    havoc #t~mem35;
    havoc #t~short36;
    call #t~mem37 := read~int(~x~5.base, ~x~5.offset + 16, 4);
    ~marked~5 := #t~mem37;
    havoc #t~mem37;
    assume true;
    call #t~mem38 := read~int(~x~5.base, ~x~5.offset + 16, 4);
    assume !(#t~mem38 == 0);
    havoc #t~mem38;
    assume !false;
    goto loc5;
