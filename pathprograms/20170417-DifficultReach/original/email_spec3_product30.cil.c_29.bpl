...
implementation sign(#in~client : int, #in~msg : int) returns (){
  ...
  loc6:
    ...
    call setEmailSignKey(~msg, ~privkey~357);
    assume true;
    return;
}
