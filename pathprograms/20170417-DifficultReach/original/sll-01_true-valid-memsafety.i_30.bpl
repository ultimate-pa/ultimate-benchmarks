...
implementation main() returns (#res : int){
  ...
  loc4_1:
    ...
    assume #t~nondet18 != 0;
    havoc #t~nondet18;
    call write~$Pointer$(0, 0, ~end~5.base, ~end~5.offset + 8, 8);
    assume true;
    call #t~mem26.base, #t~mem26.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 8, 8);
    #t~short28 := #t~mem26.base != 0 || #t~mem26.offset != 0;
    assume !#t~short28;
    call #t~mem27.base, #t~mem27.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 8, 8);
    #t~short28 := #t~mem27.base == 0 && #t~mem27.offset == 0;
    assume !!#t~short28;
