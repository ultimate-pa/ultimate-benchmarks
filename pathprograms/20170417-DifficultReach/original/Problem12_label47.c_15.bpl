...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc6_0:
    ...
    ~a17 := (if (if ~a17 < 0 && ~a17 % 5 != 0 then ~a17 / 5 + 1 else ~a17 / 5) + 383422 + -411251 < 0 && ((if ~a17 < 0 && ~a17 % 5 != 0 then ~a17 / 5 + 1 else ~a17 / 5) + 383422 + -411251) % 71 != 0 then ((if ~a17 < 0 && ~a17 % 5 != 0 then ~a17 / 5 + 1 else ~a17 / 5) + 383422 + -411251) % 71 - 71 else ((if ~a17 < 0 && ~a17 % 5 != 0 then ~a17 / 5 + 1 else ~a17 / 5) + 383422 + -411251) % 71) - -233;
    ~a7 := 14;
    ~a24 := 14;
    ~a5 := 6;
    #res := 21;
