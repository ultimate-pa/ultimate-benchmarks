...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc6_0:
    ...
    ~a29 := (if (if ~a29 * 12 < 0 && ~a29 * 12 % 10 != 0 then ~a29 * 12 / 10 + 1 else ~a29 * 12 / 10) < 0 && (if ~a29 * 12 < 0 && ~a29 * 12 % 10 != 0 then ~a29 * 12 / 10 + 1 else ~a29 * 12 / 10) % 5 != 0 then (if ~a29 * 12 < 0 && ~a29 * 12 % 10 != 0 then ~a29 * 12 / 10 + 1 else ~a29 * 12 / 10) / 5 + 1 else (if ~a29 * 12 < 0 && ~a29 * 12 % 10 != 0 then ~a29 * 12 / 10 + 1 else ~a29 * 12 / 10) / 5) + 99853;
    ~a23 := (if (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) * 4 < 0 && (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) * 4 % 83 != 0 then (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) * 4 % 83 - 83 else (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) * 4 % 83) - -180;
    ~a25 := 13;
    #res := -1;
    goto loc5;
  loc6_1:
