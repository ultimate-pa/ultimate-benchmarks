...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    call #t~malloc12.base, #t~malloc12.offset := #Ultimate.alloc(20);
    call write~$Pointer$(#t~malloc12.base, #t~malloc12.offset, ~x~5.base, ~x~5.offset + 0, 8);
    call #t~mem14.base, #t~mem14.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 0, 8);
    call write~$Pointer$(~x~5.base, ~x~5.offset, #t~mem14.base, #t~mem14.offset + 8, 8);
    havoc #t~mem14.base, #t~mem14.offset;
    call #t~mem16.base, #t~mem16.offset := read~$Pointer$(~x~5.base, ~x~5.offset + 0, 8);
    call write~int(2, #t~mem16.base, #t~mem16.offset + 16, 4);
  ...
  loc5:
    assume true;
    call #t~mem18 := read~int(~x~5.base, ~x~5.offset + 16, 4);
    assume !!(1 != #t~mem18);
    havoc #t~mem18;
    assume true;
  ...
  loc6_1:
    ...
    ~x~5.base, ~x~5.offset := #t~mem20.base, #t~mem20.offset;
