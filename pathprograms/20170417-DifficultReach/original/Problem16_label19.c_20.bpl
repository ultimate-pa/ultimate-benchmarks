...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc10_0:
    ...
    ~a18 := (if (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) * 1 < 0 && (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) * 1 % 106 != 0 then (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) * 1 % 106 - 106 else (if ~a18 * 9 < 0 && ~a18 * 9 % 10 != 0 then ~a18 * 9 / 10 + 1 else ~a18 * 9 / 10) * 1 % 106) - -27;
    ~a16 := 8;
    ~a15 := 4;
    ~a12 := 6;
    #res := 22;
