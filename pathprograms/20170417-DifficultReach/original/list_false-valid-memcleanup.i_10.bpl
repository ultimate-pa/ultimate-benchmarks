...
implementation main() returns (#res : int){
  ...
  loc6_1:
    assume !!(#t~mem12 == 2);
    havoc #t~mem12;
    call #t~mem13.base, #t~mem13.offset := read~$Pointer$(~p~6.base, ~p~6.offset + 4, 8);
    ~p~6.base, ~p~6.offset := #t~mem13.base, #t~mem13.offset;
  ...
  loc8_1:
    assume !!(#t~mem14 == 1);
    havoc #t~mem14;
    call #t~mem15.base, #t~mem15.offset := read~$Pointer$(~p~6.base, ~p~6.offset + 4, 8);
    ~p~6.base, ~p~6.offset := #t~mem15.base, #t~mem15.offset;
