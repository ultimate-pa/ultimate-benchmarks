...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc15_0:
    ...
    ~s__s3__tmp__use_rsa_tmp~4 := 0;
    assume !(~s__s3__tmp__use_rsa_tmp~4 != 0);
    assume !((~l~4 + 30) % 18446744073709551616 != 0);
    assume !((~l~4 + 1) % 18446744073709551616 != 0);
    ~skip~4 := 1;
    ~s__state~4 := 8544;
    ~s__init_num~4 := 0;
    goto loc13;
  ...
  loc18_0:
    assume ~s__state~4 != ~state~4;
    ~new_state~4 := ~s__state~4;
    ~s__state~4 := ~state~4;
    ~s__state~4 := ~new_state~4;
    goto loc19;
  loc18_1:
    assume !(~s__state~4 != ~state~4);
    goto loc19;
