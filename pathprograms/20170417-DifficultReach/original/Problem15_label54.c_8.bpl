...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc6_0:
    ...
    assume !(~a2 == 4);
    ~a4 := (if (if ~a4 * 5 < 0 && ~a4 * 5 % 5 != 0 then ~a4 * 5 / 5 + 1 else ~a4 * 5 / 5) * 10 < 0 && (if ~a4 * 5 < 0 && ~a4 * 5 % 5 != 0 then ~a4 * 5 / 5 + 1 else ~a4 * 5 / 5) * 10 % 4 != 0 then (if ~a4 * 5 < 0 && ~a4 * 5 % 5 != 0 then ~a4 * 5 / 5 + 1 else ~a4 * 5 / 5) * 10 / 4 + 1 else (if ~a4 * 5 < 0 && ~a4 * 5 % 5 != 0 then ~a4 * 5 / 5 + 1 else ~a4 * 5 / 5) * 10 / 4);
    ~a0 := (if ~a0 * 5 < 0 && ~a0 * 5 % 24 != 0 then ~a0 * 5 % 24 - 24 else ~a0 * 5 % 24) - 121 + -360939 + 360945;
    ~a29 := (if ~a29 < 0 && ~a29 % 63 != 0 then ~a29 % 63 - 63 else ~a29 % 63) + -79 + -2 - -160900 - 160899;
    ~a2 := 4;
    #res := -1;
    goto loc5;
  loc6_1:
