...
implementation main() returns (#res : int){
  ...
  loc4_1:
    ...
    assume !(#t~nondet8 != 0);
    havoc #t~nondet8;
    call write~int(~unnamed0~RED, ~end~5.base, ~end~5.offset + 8, 4);
    call #t~malloc11.base, #t~malloc11.offset := #Ultimate.alloc(12);
    call write~$Pointer$(#t~malloc11.base, #t~malloc11.offset, ~end~5.base, ~end~5.offset + 0, 8);
    call #t~mem13.base, #t~mem13.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 0, 8);
    ~end~5.base, ~end~5.offset := #t~mem13.base, #t~mem13.offset;
