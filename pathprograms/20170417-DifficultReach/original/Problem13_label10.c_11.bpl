...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc7_0:
    ...
    ~a12 := (if (if ~a12 < 0 && ~a12 % 22 != 0 then ~a12 % 22 - 22 else ~a12 % 22) + 399 + -3 < 0 && ((if ~a12 < 0 && ~a12 % 22 != 0 then ~a12 % 22 - 22 else ~a12 % 22) + 399 + -3) % 5 != 0 then ((if ~a12 < 0 && ~a12 % 22 != 0 then ~a12 % 22 - 22 else ~a12 % 22) + 399 + -3) / 5 + 1 else ((if ~a12 < 0 && ~a12 % 22 != 0 then ~a12 % 22 - 22 else ~a12 % 22) + 399 + -3) / 5) - -317;
    ~a23 := (if ((if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -369 - 292738) * 2 < 0 && ((if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -369 - 292738) * 2 % 105 != 0 then ((if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -369 - 292738) * 2 % 105 - 105 else ((if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -369 - 292738) * 2 % 105) + 381;
    ~a19 := 13;
    ~a13 := 1;
    #res := 26;
    goto loc5;
  loc7_1:
    ...
    assume !(~a19 == 9);
    ~a12 := (if ~a12 + -172708 < 0 && (~a12 + -172708) % 5 != 0 then (~a12 + -172708) / 5 + 1 else (~a12 + -172708) / 5) + -151556;
    ~a23 := (if (~a23 + -188548) * 1 - -73849 < 0 && ((~a23 + -188548) * 1 - -73849) % 84 != 0 then ((~a23 + -188548) * 1 - -73849) % 84 - 84 else ((~a23 + -188548) * 1 - -73849) % 84) + 180;
    ~a1 := 2;
    #res := 24;
    goto loc5;
}
