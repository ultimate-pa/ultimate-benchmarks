...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a4 := (if (~a4 + -149009 - -316415) * 3 * -1 < 0 && (~a4 + -149009 - -316415) * 3 * -1 % 10 != 0 then (~a4 + -149009 - -316415) * 3 * -1 / 10 + 1 else (~a4 + -149009 - -316415) * 3 * -1 / 10);
    ~a0 := (if ~a0 - 0 < 0 && (~a0 - 0) % 24 != 0 then (~a0 - 0) % 24 - 24 else (~a0 - 0) % 24) - 121 + -1;
    ~a29 := (if (if ~a29 < 0 && ~a29 % 299978 != 0 then ~a29 % 299978 - 299978 else ~a29 % 299978) - -300021 < 0 && ((if ~a29 < 0 && ~a29 % 299978 != 0 then ~a29 % 299978 - 299978 else ~a29 % 299978) - -300021) % 5 != 0 then ((if ~a29 < 0 && ~a29 % 299978 != 0 then ~a29 % 299978 - 299978 else ~a29 % 299978) - -300021) / 5 + 1 else ((if ~a29 < 0 && ~a29 % 299978 != 0 then ~a29 % 299978 - 299978 else ~a29 % 299978) - -300021) / 5) - -378565;
    ~a2 := 3;
    #res := -1;
    goto loc5;
  loc4_1:
