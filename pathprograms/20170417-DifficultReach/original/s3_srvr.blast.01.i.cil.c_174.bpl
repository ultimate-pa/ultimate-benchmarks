...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc8_0:
    ...
    havoc #t~mem193;
    assume ~skip~11 == 0;
    call #t~mem194 := read~int(~s.base, ~s.offset + 296, 4);
    assume !(#t~mem194 != 0);
    havoc #t~mem194;
    assume (~cb~11.base + ~cb~11.offset) % 18446744073709551616 != 0;
    call #t~mem196 := read~int(~s.base, ~s.offset + 72, 4);
    assume #t~mem196 != ~state~11;
    havoc #t~mem196;
    call #t~mem197 := read~int(~s.base, ~s.offset + 72, 4);
    ~new_state~11 := #t~mem197;
    havoc #t~mem197;
  ...
  loc9_0:
    assume #t~mem40 == 8545;
    havoc #t~mem40;
    call #t~mem118 := read~int(~s.base, ~s.offset + 256, 4);
    assume ~bitwiseAnd(#t~mem118, 1) != 0;
    havoc #t~mem118;
    call #t~mem119.base, #t~mem119.offset := read~$Pointer$(~s.base, ~s.offset + 248, 8);
    call #t~mem120.base, #t~mem120.offset := read~$Pointer$(#t~mem119.base, #t~mem119.offset + 152, 8);
    assume !((#t~mem120.base + #t~mem120.offset) % 18446744073709551616 != 0);
    havoc #t~mem119.base, #t~mem119.offset;
    havoc #t~mem120.base, #t~mem120.offset;
    call #t~mem125.base, #t~mem125.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call #t~mem126.base, #t~mem126.offset := read~$Pointer$(#t~mem125.base, #t~mem125.offset + 652 + 236, 8);
    call #t~mem127 := read~int(#t~mem126.base, #t~mem126.offset + 20, 8);
    assume !(~bitwiseAnd(#t~mem127, 256) % 18446744073709551616 != 0);
    havoc #t~mem125.base, #t~mem125.offset;
    havoc #t~mem126.base, #t~mem126.offset;
    havoc #t~mem127;
    call #t~mem132.base, #t~mem132.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call write~int(1, #t~mem132.base, #t~mem132.offset + 652 + 323, 4);
    ...
    call #t~mem136.base, #t~mem136.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call write~int(8576, #t~mem136.base, #t~mem136.offset + 652 + 252, 4);
