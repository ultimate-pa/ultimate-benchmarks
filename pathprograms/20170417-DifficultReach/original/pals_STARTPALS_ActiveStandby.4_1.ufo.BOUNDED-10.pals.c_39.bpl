...
implementation Side1_activestandby_task_each_pals_period() returns (){
  ...
  loc3_1:
    ...
    ~side2~60 := ~s2s1_old;
    ~s2s1_old := ~nomsg;
    ~manual_selection~60 := ~cs1_old;
    ~cs1_old := ~nomsg;
    assume !(~side1~60 == ~side2~60);
    assume ~side1~60 == ~nomsg;
    assume ~side2~60 != ~nomsg;
    ~next_state~60 := 0;
    assume ~next_state~60 != ~nomsg && ~s1s1_new == ~nomsg;
    #t~ite8 := ~next_state~60;
    ~s1s1_new := (if #t~ite8 % 256 <= 127 then #t~ite8 % 256 else #t~ite8 % 256 - 256);
    havoc #t~ite8;
    assume ~next_state~60 != ~nomsg && ~s1s2_new == ~nomsg;
    #t~ite9 := ~next_state~60;
    ~s1s2_new := (if #t~ite9 % 256 <= 127 then #t~ite9 % 256 else #t~ite9 % 256 - 256);
    havoc #t~ite9;
    assume ~next_state~60 != ~nomsg && ~s1p_new == ~nomsg;
    #t~ite10 := ~next_state~60;
    ~s1p_new := (if #t~ite10 % 256 <= 127 then #t~ite10 % 256 else #t~ite10 % 256 - 256);
    havoc #t~ite10;
    ~side1_written := ~next_state~60;
    goto loc4;
  loc4:
    assume true;
    return;
...
implementation Side2_activestandby_task_each_pals_period() returns (){
  ...
  loc7_0:
    ...
    assume !(~nomsg != ~nomsg && ~s2s1_new == ~nomsg);
    #t~ite12 := ~s2s1_new;
    ~s2s1_new := (if #t~ite12 % 256 <= 127 then #t~ite12 % 256 else #t~ite12 % 256 - 256);
    havoc #t~ite12;
    assume !(~nomsg != ~nomsg && ~s2s2_new == ~nomsg);
    #t~ite13 := ~s2s2_new;
    ~s2s2_new := (if #t~ite13 % 256 <= 127 then #t~ite13 % 256 else #t~ite13 % 256 - 256);
    havoc #t~ite13;
    assume !(~nomsg != ~nomsg && ~s2p_new == ~nomsg);
    #t~ite14 := ~s2p_new;
    ~s2p_new := (if #t~ite14 % 256 <= 127 then #t~ite14 % 256 else #t~ite14 % 256 - 256);
    havoc #t~ite14;
    ~side2_written := ~nomsg;
    goto loc8;
  loc7_1:
