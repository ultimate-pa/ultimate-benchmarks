...
implementation ssl3_connect(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc3_0:
    ...
    havoc #t~mem32;
    call write~int(1, ~s.base, ~s.offset + 60, 4);
    call write~int(4096, ~s.base, ~s.offset + 72, 4);
    call #t~mem67.base, #t~mem67.offset := read~$Pointer$(~s.base, ~s.offset + 288, 8);
    call #t~mem68 := read~int(#t~mem67.base, #t~mem67.offset + 116 + 4, 4);
    call write~int(#t~mem68 + 1, #t~mem67.base, #t~mem67.offset + 116 + 4, 4);
    havoc #t~mem67.base, #t~mem67.offset;
    havoc #t~mem68;
    call write~int(0, ~s.base, ~s.offset + 56, 4);
    assume (~cb~11.base + ~cb~11.offset) % 18446744073709551616 != 0;
    call #t~mem70 := read~int(~s.base, ~s.offset + 0, 4);
    assume !(~bitwiseAnd(#t~mem70, 65280) != 768);
    havoc #t~mem70;
    call write~int(4096, ~s.base, ~s.offset + 4, 4);
    call #t~mem72.base, #t~mem72.offset := read~$Pointer$(~s.base, ~s.offset + 80, 8);
    assume !((#t~mem72.base + #t~mem72.offset) % 18446744073709551616 == 0);
    havoc #t~mem72.base, #t~mem72.offset;
    assume !(~tmp___4~11 == 0);
    assume !(~tmp___5~11 == 0);
    call write~int(4368, ~s.base, ~s.offset + 72, 4);
    call #t~mem76.base, #t~mem76.offset := read~$Pointer$(~s.base, ~s.offset + 288, 8);
    call #t~mem77 := read~int(#t~mem76.base, #t~mem76.offset + 116 + 0, 4);
    call write~int(#t~mem77 + 1, #t~mem76.base, #t~mem76.offset + 116 + 0, 4);
    havoc #t~mem76.base, #t~mem76.offset;
    havoc #t~mem77;
  ...
  loc6_0:
    ...
    havoc #t~mem183;
    assume ~skip~11 == 0;
    call #t~mem184 := read~int(~s.base, ~s.offset + 296, 4);
    assume !(#t~mem184 != 0);
    havoc #t~mem184;
    assume (~cb~11.base + ~cb~11.offset) % 18446744073709551616 != 0;
    call #t~mem186 := read~int(~s.base, ~s.offset + 72, 4);
    assume #t~mem186 != ~state~11;
    havoc #t~mem186;
    call #t~mem187 := read~int(~s.base, ~s.offset + 72, 4);
    ~new_state~11 := #t~mem187;
    havoc #t~mem187;
  ...
  loc13_1:
    ...
    call #t~mem104 := read~int(#t~mem103.base, #t~mem103.offset + 652 + 260, 4);
    assume #t~mem104 != 0;
