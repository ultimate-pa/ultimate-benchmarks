...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a23 := (if (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) < 0 && (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) % 90 != 0 then (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) % 90 - 90 else (if ~a23 < 0 && ~a23 % 5 != 0 then ~a23 / 5 + 1 else ~a23 / 5) % 90) - -47 - -159208 - 159206;
    ~a4 := 1;
    ~a25 := 11;
    #res := -1;
    goto loc5;
