...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a1 := ((if ~a1 < 0 && ~a1 % 5 != 0 then ~a1 / 5 + 1 else ~a1 / 5) - -367248) * 1 - 890938;
    ~a10 := 0;
    ~a19 := 10;
    #res := 26;
    goto loc5;
  loc4_1:
    ...
    assume !((~a12 == 0 && ((~input == 5 && ~a19 == 10) && 38 < ~a1 && 218 >= ~a1) && ~a4 == 14) && ~a10 == 1);
    assume !(~a19 == 9 && ~a4 == 14 && ((((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1)) && ~input == 3) && ~a10 == 1) && ~a12 == 0);
    goto loc6;
  loc5:
    assume true;
    return;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume ~a10 == 0 && ~a12 == 0 && ((~input == 5 && (~a1 <= -13 || (-13 < ~a1 && 38 >= ~a1))) && ~a19 == 10) && ~a4 == 14;
    ~a1 := (if ~a1 < 0 && ~a1 % 299890 != 0 then ~a1 % 299890 - 299890 else ~a1 % 299890) + 300108 - -1 + -309315 - -309317;
    ~a10 := 1;
    ~a19 := 7;
    #res := -1;
    goto loc5;
  loc6_1:
    assume !(~a10 == 0 && ~a12 == 0 && ((~input == 5 && (~a1 <= -13 || (-13 < ~a1 && 38 >= ~a1))) && ~a19 == 10) && ~a4 == 14);
    assume !(218 < ~a1 && (((~input == 3 && ~a10 == 1) && ~a12 == 0) && ~a4 == 14) && ~a19 == 10);
    assume !((~a12 == 0 && ~a19 == 9 && (~input == 3 && ((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1))) && ~a4 == 14) && ~a10 == 3);
    assume !((((~a4 == 14 && (38 < ~a1 && 218 >= ~a1) && ~input == 2) && ~a12 == 0) && ~a10 == 1) && ~a19 == 10);
    assume !((~a19 == 10 && ~a10 == 1 && ~a12 == 0 && (-13 < ~a1 && 38 >= ~a1) && ~input == 5) && ~a4 == 14);
    assume !(((~a10 == 1 && (~input == 5 && 218 < ~a1) && ~a4 == 14) && ~a19 == 10) && ~a12 == 0);
    assume !((~a4 == 14 && ~a19 == 9 && ~input == 2 && ((~a10 == 3 && 218 < ~a1) || (~a10 == 4 && ~a1 <= -13))) && ~a12 == 0);
    assume !((~a4 == 14 && (~a19 == 9 && ((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1)) && ~input == 2) && ~a12 == 0) && ~a10 == 4);
    assume !(~a4 == 14 && (~a19 == 9 && (((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1)) && ~input == 6) && ~a10 == 3) && ~a12 == 0);
    assume !((~a4 == 14 && ((~input == 6 && (~a1 <= -13 || (-13 < ~a1 && 38 >= ~a1))) && ~a19 == 10) && ~a12 == 0) && ~a10 == 0);
    assume !(~a12 == 0 && ~a4 == 14 && (((~a1 <= -13 && ~a10 == 1) || (~a10 == 0 && 38 < ~a1 && 218 >= ~a1) || (218 < ~a1 && ~a10 == 0)) && ~input == 2) && ~a19 == 10);
    assume !((~a12 == 0 && ~a19 == 9 && ~a10 == 2 && ~input == 6 && (~a1 <= -13 || (-13 < ~a1 && 38 >= ~a1))) && ~a4 == 14);
    assume !(~a4 == 14 && ~a19 == 9 && ~a12 == 0 && (~input == 2 && ((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1))) && ~a10 == 0);
    assume !(~a19 == 9 && (~a10 == 1 && ~a12 == 0 && ~input == 2 && ((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1))) && ~a4 == 14);
    assume !(~a19 == 9 && ~a4 == 14 && ~a10 == 1 && (~input == 5 && ((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1))) && ~a12 == 0);
    assume ~a12 == 0 && (((~input == 6 && ((-13 < ~a1 && 38 >= ~a1) || (38 < ~a1 && 218 >= ~a1))) && ~a19 == 9) && ~a4 == 14) && ~a10 == 0;
    ~a1 := (if ~a1 + -272193 - -47605 - -570122 < 0 && (~a1 + -272193 - -47605 - -570122) % 89 != 0 then (~a1 + -272193 - -47605 - -570122) % 89 - 89 else (~a1 + -272193 - -47605 - -570122) % 89) + 110;
    ~a10 := 1;
    #res := 25;
    goto loc5;
}
