...
implementation main() returns (#res : int){
  ...
  loc6_0:
    ...
    assume !((if ~P1~4 < 0 && ~P1~4 % 2 != 0 then ~P1~4 % 2 - 2 else ~P1~4 % 2) != 0);
    ~method_id~3 := 2;
    assume ((if ~P1~4 < 0 && ~P1~4 % 2 != 0 then ~P1~4 % 2 - 2 else ~P1~4 % 2) == (if ~this_expect~3 < 0 && ~this_expect~3 % 2 != 0 then ~this_expect~3 % 2 - 2 else ~this_expect~3 % 2) && ~this_buffer_empty~3 == 1) && !((if ~P1~4 < 0 && ~P1~4 % 2 != 0 then ~P1~4 % 2 - 2 else ~P1~4 % 2) != 0);
    assume !false;
    goto loc7;
  loc6_1:
    assume ~q~3 == 3;
