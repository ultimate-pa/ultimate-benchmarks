...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    assume !(~a1 == 6);
    ~a23 := (if (if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -371 < 0 && ((if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -371) % 5 != 0 then ((if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -371) / 5 + 1 else ((if ~a23 < 0 && ~a23 % 105 != 0 then ~a23 % 105 - 105 else ~a23 % 105) - -371) / 5) - -281;
    ~a1 := 2;
    ~a19 := 13;
    ~a13 := 0;
    #res := 24;
