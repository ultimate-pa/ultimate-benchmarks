...
implementation main() returns (#res : int){
  ...
  loc5:
    assume true;
    call #t~mem11 := read~int(~p~6.base, ~p~6.offset + 0, 4);
    goto loc6;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
  ...
  loc6_1:
    assume !!(#t~mem11 == 2);
    havoc #t~mem11;
    call #t~mem12.base, #t~mem12.offset := read~$Pointer$(~p~6.base, ~p~6.offset + 4, 8);
    ~p~6.base, ~p~6.offset := #t~mem12.base, #t~mem12.offset;
