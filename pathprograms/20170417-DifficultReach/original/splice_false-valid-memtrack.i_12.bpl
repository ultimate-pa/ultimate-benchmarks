...
implementation main() returns (#res : int){
  ...
  loc7_0:
    ...
    ~p~6.base, ~p~6.offset := ~l2~6.base, ~l2~6.offset;
    assume true;
    assume !!(~p~6.base != 0 || ~p~6.offset != 0);
    call #t~mem15 := read~int(~p~6.base, ~p~6.offset + 0, 4);
    assume #t~mem15 != 2;
    havoc #t~mem15;
    assume !false;
    goto loc9;
  ...
  loc10_1:
    assume !(~flag~6 != 0);
    call write~$Pointer$(~l2~6.base, ~l2~6.offset, ~t~6.base, ~t~6.offset + 4, 8);
    ~l2~6.base, ~l2~6.offset := ~t~6.base, ~t~6.offset;
    ~flag~6 := 1;
    goto loc5;
}
