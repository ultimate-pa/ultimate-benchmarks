...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc11_0:
    ...
    ~s__s3__tmp__new_cipher__algorithms~6 := #t~nondet40;
    havoc #t~nondet40;
  ...
  loc11_1:
    ...
    ~s__s3__tmp__use_rsa_tmp~6 := 0;
    assume !(~s__s3__tmp__use_rsa_tmp~6 != 0);
    assume !((~l~6 + 30) % 18446744073709551616 != 0);
    assume !((~l~6 + 1) % 18446744073709551616 != 0);
    ~skip~6 := 1;
    ~s__state~6 := 8544;
    ~s__init_num~6 := 0;
    goto loc6;
