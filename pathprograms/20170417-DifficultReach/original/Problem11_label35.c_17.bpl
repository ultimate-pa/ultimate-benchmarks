...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a23 := (if (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) < 0 && (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) % 5 != 0 then (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) / 5 + 1 else (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) / 5) + -127612;
    ~a4 := 1;
    ~a25 := 10;
    #res := -1;
    goto loc5;
  ...
  loc6_0:
    ...
    ~a29 := (if ~a29 + 161077 + -91920 < 0 && (~a29 + 161077 + -91920) % 299861 != 0 then (~a29 + 161077 + -91920) % 299861 - 299861 else (~a29 + 161077 + -91920) % 299861) - -300138;
    ~a25 := 9;
    #res := 26;
    goto loc5;
  loc6_1:
