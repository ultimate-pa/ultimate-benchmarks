...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a17 := (if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) + -11 - 547674 + -15873 - -563482;
    ~a7 := 12;
    #res := -1;
    goto loc5;
  loc4_1:
  ...
  loc7_1:
    ...
    ~a2 := (if ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) - -234) * 5 < 0 && ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) - -234) * 5 % 45 != 0 then ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) - -234) * 5 % 45 - 45 else ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) - -234) * 5 % 45) + 227;
    ~a17 := (if (if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) * 1 + -14728 < 0 && ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) * 1 + -14728) % 109 != 0 then ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) * 1 + -14728) % 109 - 109 else ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) * 1 + -14728) % 109) - -22;
    ~a24 := 14;
    ~a5 := 4;
    #res := 23;
    goto loc5;
