...
implementation remove(#in~x.base : int, #in~x.offset : int) returns (){
  ...
  loc8:
    ...
    call #t~mem6.base, #t~mem6.offset := read~$Pointer$(~x.base, ~x.offset + 0, 8);
    call #t~mem8.base, #t~mem8.offset := read~$Pointer$(~x.base, ~x.offset + 8, 8);
    call write~$Pointer$(#t~mem8.base, #t~mem8.offset, #t~mem6.base, #t~mem6.offset + 8, 8);
