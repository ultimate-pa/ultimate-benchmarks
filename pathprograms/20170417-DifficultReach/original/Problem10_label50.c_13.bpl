...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc6_0:
    ...
    ~a1 := (if (if (~a1 - 0) * 9 < 0 && (~a1 - 0) * 9 % 10 != 0 then (~a1 - 0) * 9 / 10 + 1 else (~a1 - 0) * 9 / 10) < 0 && (if (~a1 - 0) * 9 < 0 && (~a1 - 0) * 9 % 10 != 0 then (~a1 - 0) * 9 / 10 + 1 else (~a1 - 0) * 9 / 10) % 25 != 0 then (if (~a1 - 0) * 9 < 0 && (~a1 - 0) * 9 % 10 != 0 then (~a1 - 0) * 9 / 10 + 1 else (~a1 - 0) * 9 / 10) % 25 - 25 else (if (~a1 - 0) * 9 < 0 && (~a1 - 0) * 9 % 10 != 0 then (~a1 - 0) * 9 / 10 + 1 else (~a1 - 0) * 9 / 10) % 25) - -12;
    ~a10 := 2;
    ~a19 := 8;
    #res := -1;
    goto loc5;
