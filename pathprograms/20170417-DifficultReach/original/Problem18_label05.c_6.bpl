...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a3 := (if (if ~a3 - 473859 < 0 && (~a3 - 473859) % 55 != 0 then (~a3 - 473859) % 55 - 55 else (~a3 - 473859) % 55) - -361 < 0 && ((if ~a3 - 473859 < 0 && (~a3 - 473859) % 55 != 0 then (~a3 - 473859) % 55 - 55 else (~a3 - 473859) % 55) - -361) % 5 != 0 then ((if ~a3 - 473859 < 0 && (~a3 - 473859) % 55 != 0 then (~a3 - 473859) % 55 - 55 else (~a3 - 473859) % 55) - -361) / 5 + 1 else ((if ~a3 - 473859 < 0 && (~a3 - 473859) % 55 != 0 then (~a3 - 473859) % 55 - 55 else (~a3 - 473859) % 55) - -361) / 5) + 288;
    ~a24 := 2;
    ~a18 := 11;
    ~a15 := 4;
    #res := -1;
