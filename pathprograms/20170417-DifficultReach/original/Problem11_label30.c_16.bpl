...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a29 := (if (if ~a29 < 0 && ~a29 % 5 != 0 then ~a29 / 5 + 1 else ~a29 / 5) < 0 && (if ~a29 < 0 && ~a29 % 5 != 0 then ~a29 / 5 + 1 else ~a29 / 5) % 5 != 0 then (if ~a29 < 0 && ~a29 % 5 != 0 then ~a29 / 5 + 1 else ~a29 / 5) / 5 + 1 else (if ~a29 < 0 && ~a29 % 5 != 0 then ~a29 / 5 + 1 else ~a29 / 5) / 5) + -580303;
    ~a23 := (if ~a23 - 600264 + -12 < 0 && (~a23 - 600264 + -12) % 5 != 0 then (~a23 - 600264 + -12) / 5 + 1 else (~a23 - 600264 + -12) / 5);
    ~a4 := 0;
    ~a25 := 12;
    #res := -1;
    goto loc5;
