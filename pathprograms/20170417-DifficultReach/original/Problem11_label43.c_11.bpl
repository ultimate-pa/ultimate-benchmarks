...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    assume !(~a8 == 17);
    ~a29 := (if (~a29 - 520725) * 10 < 0 && (~a29 - 520725) * 10 % 9 != 0 then (~a29 - 520725) * 10 / 9 + 1 else (~a29 - 520725) * 10 / 9) + -10894;
    ~a23 := (if (~a23 + 0 + 435838) * 1 < 0 && (~a23 + 0 + 435838) * 1 % 299846 != 0 then (~a23 + 0 + 435838) * 1 % 299846 - 299846 else (~a23 + 0 + 435838) * 1 % 299846) - -300152;
    ~a4 := 1;
    ~a25 := 13;
    #res := 21;
    goto loc5;
