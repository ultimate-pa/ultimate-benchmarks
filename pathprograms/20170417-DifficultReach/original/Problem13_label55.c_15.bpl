...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a12 := (if (if (~a12 + 0 + 0) * 9 < 0 && (~a12 + 0 + 0) * 9 % 10 != 0 then (~a12 + 0 + 0) * 9 / 10 + 1 else (~a12 + 0 + 0) * 9 / 10) < 0 && (if (~a12 + 0 + 0) * 9 < 0 && (~a12 + 0 + 0) * 9 % 10 != 0 then (~a12 + 0 + 0) * 9 / 10 + 1 else (~a12 + 0 + 0) * 9 / 10) % 108 != 0 then (if (~a12 + 0 + 0) * 9 < 0 && (~a12 + 0 + 0) * 9 % 10 != 0 then (~a12 + 0 + 0) * 9 / 10 + 1 else (~a12 + 0 + 0) * 9 / 10) % 108 - 108 else (if (~a12 + 0 + 0) * 9 < 0 && (~a12 + 0 + 0) * 9 % 10 != 0 then (~a12 + 0 + 0) * 9 / 10 + 1 else (~a12 + 0 + 0) * 9 / 10) % 108) - -286;
    ~a23 := (if (if ~a23 * 10 < 0 && ~a23 * 10 % 5 != 0 then ~a23 * 10 / 5 + 1 else ~a23 * 10 / 5) * 5 * 10 < 0 && (if ~a23 * 10 < 0 && ~a23 * 10 % 5 != 0 then ~a23 * 10 / 5 + 1 else ~a23 * 10 / 5) * 5 * 10 % 9 != 0 then (if ~a23 * 10 < 0 && ~a23 * 10 % 5 != 0 then ~a23 * 10 / 5 + 1 else ~a23 * 10 / 5) * 5 * 10 / 9 + 1 else (if ~a23 * 10 < 0 && ~a23 * 10 % 5 != 0 then ~a23 * 10 / 5 + 1 else ~a23 * 10 / 5) * 5 * 10 / 9);
    ~a19 := 12;
    ~a13 := 1;
    #res := -1;
    goto loc5;
  ...
  loc6_1:
    ...
    ~a12 := (if (if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) - -36573 < 0 && ((if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) - -36573) % 22 != 0 then ((if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) - -36573) % 22 - 22 else ((if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) - -36573) % 22) + 408;
    ~a23 := (if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) - -137 - 264705 - -264718;
    ~a1 := 2;
    ~a13 := 1;
    #res := -1;
    goto loc5;
