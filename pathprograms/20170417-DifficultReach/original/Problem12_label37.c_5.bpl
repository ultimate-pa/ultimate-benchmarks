...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a2 := (if (~a2 + -131864) * 10 < 0 && (~a2 + -131864) * 10 % 9 != 0 then (~a2 + -131864) * 10 / 9 + 1 else (~a2 + -131864) * 10 / 9) - 73578;
    ~a17 := ((if ~a17 - 0 < 0 && (~a17 - 0) % 299946 != 0 then (~a17 - 0) % 299946 - 299946 else (~a17 - 0) % 299946) + -300053) * 1;
    ~a7 := 13;
    ~a5 := 4;
    #res := -1;
    goto loc5;
