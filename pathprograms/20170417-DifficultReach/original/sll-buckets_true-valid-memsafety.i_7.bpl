...
implementation main() returns (#res : int){
  ...
  loc3:
    ...
    call #t~mem31.base, #t~mem31.offset := read~$Pointer$(~bcki~5.base, ~bcki~5.offset + 8, 8);
    ~item~5.base, ~item~5.offset := #t~mem31.base, #t~mem31.offset;
  ...
  loc4_0:
    ...
    assume !!(~item~5.base == 0 && ~item~5.offset == 0);
    assume true;
    ~bucket~5.base, ~bucket~5.offset := ~bcki~5.base, ~bcki~5.offset;
    call #t~mem36.base, #t~mem36.offset := read~$Pointer$(~bcki~5.base, ~bcki~5.offset + 0, 8);
    ~bcki~5.base, ~bcki~5.offset := #t~mem36.base, #t~mem36.offset;
    havoc #t~mem36.base, #t~mem36.offset;
    call ULTIMATE.free(~bucket~5.base, ~bucket~5.offset);
    ~bucket~5.base, ~bucket~5.offset := 0, 0;
    goto loc3;
  loc4_1:
    assume !!(~item~5.base != 0 || ~item~5.offset != 0);
    ~itr~5.base, ~itr~5.offset := ~item~5.base, ~item~5.offset;
    ...
    assume true;
    call #t~mem34 := read~int(~itr~5.base, ~itr~5.offset + 8, 4);
    call #t~mem35 := read~int(~bcki~5.base, ~bcki~5.offset + 16, 4);
    assume !(#t~mem34 == #t~mem35);
    havoc #t~mem34;
    havoc #t~mem35;
    assume !false;
    goto loc5;
