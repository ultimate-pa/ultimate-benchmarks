...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a14 := (if ~a14 * 9 < 0 && ~a14 * 9 % 10 != 0 then ~a14 * 9 / 10 + 1 else ~a14 * 9 / 10) - -57076 + -651983;
    ~a26 := (if ~a26 * -6 < 0 && ~a26 * -6 % 10 != 0 then ~a26 * -6 / 10 + 1 else ~a26 * -6 / 10) * 5 - 355073;
    ~a28 := (if ~a28 < 0 && ~a28 % 5 != 0 then ~a28 / 5 + 1 else ~a28 / 5) - -352351 - 552393;
    ~a24 := 1;
    #res := -1;
    goto loc5;
  loc4_1:
