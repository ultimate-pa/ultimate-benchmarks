...
implementation calculate_output2(#in~input : int) returns (#res : int){
  ...
  loc1:
    ...
    ~a23 := (if (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) * 4 < 0 && (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) * 4 % 299761 != 0 then (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) * 4 % 299761 - 299761 else (if ~a23 - 0 < 0 && (~a23 - 0) % 5 != 0 then (~a23 - 0) / 5 + 1 else (~a23 - 0) / 5) * 4 % 299761) + 300237;
    ~a1 := 2;
    ~a19 := 11;
    #res := 26;
    assume true;
...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc5_0:
    ...
    assume !(~a13 == 1);
    ~a23 := (if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 179 + -104349 + 104349;
    ~a19 := 12;
    ~a13 := 1;
    #res := -1;
    goto loc6;
