...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc7_0:
    ...
    ~a12 := (if (if (if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039 < 0 && ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) % 5 != 0 then ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5 + 1 else ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5) < 0 && (if (if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039 < 0 && ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) % 5 != 0 then ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5 + 1 else ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5) % 5 != 0 then (if (if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039 < 0 && ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) % 5 != 0 then ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5 + 1 else ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5) / 5 + 1 else (if (if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039 < 0 && ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) % 5 != 0 then ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5 + 1 else ((if ~a12 < 0 && ~a12 % 299959 != 0 then ~a12 % 299959 - 299959 else ~a12 % 299959) - -300039) / 5) / 5) + 204292;
    ~a24 := 1;
    ~a15 := 9;
    ~a21 := 9;
    #res := -1;
  ...
  loc7_1:
    ...
    ~a12 := (if ~a12 + 0 + -318749 < 0 && (~a12 + 0 + -318749) % 34 != 0 then (~a12 + 0 + -318749) % 34 - 34 else (~a12 + 0 + -318749) % 34) + 45;
    ~a15 := 5;
    #res := -1;
    goto loc5;
}
