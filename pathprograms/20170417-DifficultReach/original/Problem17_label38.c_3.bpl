...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a26 := (if ~a26 * 9 < 0 && ~a26 * 9 % 10 != 0 then ~a26 * 9 / 10 + 1 else ~a26 * 9 / 10) + 599163 - -451;
    ~a28 := (if ((if ~a28 < 0 && ~a28 % 48 != 0 then ~a28 % 48 - 48 else ~a28 % 48) - -77) * 5 - -355922 < 0 && (((if ~a28 < 0 && ~a28 % 48 != 0 then ~a28 % 48 - 48 else ~a28 % 48) - -77) * 5 - -355922) % 48 != 0 then (((if ~a28 < 0 && ~a28 % 48 != 0 then ~a28 % 48 - 48 else ~a28 % 48) - -77) * 5 - -355922) % 48 - 48 else (((if ~a28 < 0 && ~a28 % 48 != 0 then ~a28 % 48 - 48 else ~a28 % 48) - -77) * 5 - -355922) % 48) + 68;
    ~a24 := 2;
    #res := 21;
    goto loc5;
  loc4_1:
