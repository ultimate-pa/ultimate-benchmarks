...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a17 := (if ((if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) + 16) * 5 < 0 && ((if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) + 16) * 5 % 109 != 0 then ((if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) + 16) * 5 % 109 - 109 else ((if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) + 16) * 5 % 109) - -2;
    ~a7 := 14;
    ~a24 := 13;
    #res := -1;
    goto loc5;
  ...
  loc6_0:
    ...
    ~a2 := (if (if ~a2 < 0 && ~a2 % 5 != 0 then ~a2 / 5 + 1 else ~a2 / 5) + 158559 < 0 && ((if ~a2 < 0 && ~a2 % 5 != 0 then ~a2 / 5 + 1 else ~a2 / 5) + 158559) % 45 != 0 then ((if ~a2 < 0 && ~a2 % 5 != 0 then ~a2 / 5 + 1 else ~a2 / 5) + 158559) % 45 - 45 else ((if ~a2 < 0 && ~a2 % 5 != 0 then ~a2 / 5 + 1 else ~a2 / 5) + 158559) % 45) + 204;
    ~a17 := (if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) + 75 - 24 + 175099 - 175127;
    ~a24 := 15;
    ~a5 := 5;
    #res := 23;
    goto loc5;
  ...
  loc7_1:
    ...
    ~a17 := (if ~a17 < 0 && ~a17 % 71 != 0 then ~a17 % 71 - 71 else ~a17 % 71) - -184 - 1 + -591569 + 591570;
    ~a7 := 14;
    ~a5 := 4;
    #res := -1;
    goto loc5;
