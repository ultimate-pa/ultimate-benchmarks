...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a12 := (if (if ~a12 < 0 && ~a12 % 5 != 0 then ~a12 / 5 + 1 else ~a12 / 5) < 0 && (if ~a12 < 0 && ~a12 % 5 != 0 then ~a12 / 5 + 1 else ~a12 / 5) % 5 != 0 then (if ~a12 < 0 && ~a12 % 5 != 0 then ~a12 / 5 + 1 else ~a12 / 5) / 5 + 1 else (if ~a12 < 0 && ~a12 % 5 != 0 then ~a12 / 5 + 1 else ~a12 / 5) / 5) - -264889 - 315629;
    ~a23 := (if (if ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 < 0 && ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 % 9 != 0 then ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9 + 1 else ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9) * 9 < 0 && (if ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 < 0 && ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 % 9 != 0 then ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9 + 1 else ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9) * 9 % 10 != 0 then (if ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 < 0 && ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 % 9 != 0 then ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9 + 1 else ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9) * 9 / 10 + 1 else (if ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 < 0 && ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 % 9 != 0 then ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9 + 1 else ((if ~a23 < 0 && ~a23 % 84 != 0 then ~a23 % 84 - 84 else ~a23 % 84) + 136) * 10 / 9) * 9 / 10);
    ~a19 := 13;
    #res := -1;
    goto loc5;
  loc4_1:
