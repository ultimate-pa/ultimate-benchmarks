...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a2 := (if ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) + 236) * 5 < 0 && ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) + 236) * 5 % 45 != 0 then ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) + 236) * 5 % 45 - 45 else ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) + 236) * 5 % 45) - -199;
    ~a7 := 13;
    ~a24 := 14;
    #res := 26;
    goto loc5;
  ...
  loc8_0:
    ...
    ~a2 := ((if ~a2 < 0 && ~a2 % 45 != 0 then ~a2 % 45 - 45 else ~a2 % 45) - -234) * 1 + 447091 + -447090;
    ~a7 := 13;
    ~a5 := 3;
    #res := 23;
    goto loc5;
  loc8_1:
    ...
    ~a17 := (if (if (if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989 < 0 && ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) % 5 != 0 then ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5 + 1 else ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5) < 0 && (if (if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989 < 0 && ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) % 5 != 0 then ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5 + 1 else ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5) % 71 != 0 then (if (if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989 < 0 && ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) % 5 != 0 then ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5 + 1 else ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5) % 71 - 71 else (if (if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989 < 0 && ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) % 5 != 0 then ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5 + 1 else ((if ~a17 * 9 < 0 && ~a17 * 9 % 10 != 0 then ~a17 * 9 / 10 + 1 else ~a17 * 9 / 10) - 302989) / 5) % 71) + 184;
    ~a7 := 14;
    ~a24 := 14;
    ~a5 := 7;
    #res := -1;
