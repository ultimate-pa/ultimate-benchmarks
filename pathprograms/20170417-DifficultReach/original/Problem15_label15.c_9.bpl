...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc6_0:
    ...
    assume !(~a2 == 1);
    ~a4 := (if ~a4 + 0 - -403065 < 0 && (~a4 + 0 - -403065) % 21 != 0 then (~a4 + 0 - -403065) % 21 - 21 else (~a4 + 0 - -403065) % 21) + -62;
    ~a0 := (if ~a0 + 0 < 0 && (~a0 + 0) % 299926 != 0 then (~a0 + 0) % 299926 - 299926 else (~a0 + 0) % 299926) + -300072 - 3;
    ~a2 := 1;
    #res := 26;
    goto loc5;
  loc6_1:
