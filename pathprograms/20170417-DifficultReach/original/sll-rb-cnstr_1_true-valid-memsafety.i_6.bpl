...
implementation main() returns (#res : int){
  ...
  loc3:
    assume true;
    assume !!(0 != ~end~5.base || 0 != ~end~5.offset);
    call #t~mem17 := read~int(~end~5.base, ~end~5.offset + 8, 4);
    goto loc4;
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume !(~unnamed0~RED == #t~mem17);
    havoc #t~mem17;
    call #t~mem20.base, #t~mem20.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 0, 8);
    ~end~5.base, ~end~5.offset := #t~mem20.base, #t~mem20.offset;
    havoc #t~mem20.base, #t~mem20.offset;
    goto loc3;
  loc4_1:
    assume ~unnamed0~RED == #t~mem17;
    havoc #t~mem17;
    call #t~mem18.base, #t~mem18.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 0, 8);
    ~end~5.base, ~end~5.offset := #t~mem18.base, #t~mem18.offset;
