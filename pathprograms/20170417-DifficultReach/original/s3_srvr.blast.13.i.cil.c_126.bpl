...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc3:
    ...
    call write~int(#t~nondet18, ~s.base, ~s.offset + 128, 4);
    havoc #t~nondet18;
    call write~int(8464, ~s.base, ~s.offset + 72, 4);
  ...
  loc5_0:
    ...
    havoc #t~mem30;
    call write~int(1, ~s.base, ~s.offset + 56, 4);
    assume (~cb~11.base + ~cb~11.offset) % 18446744073709551616 != 0;
    call #t~mem64 := read~int(~s.base, ~s.offset + 0, 4);
    assume !(~shiftRight(#t~mem64, 8) != 3);
    havoc #t~mem64;
    call write~int(8192, ~s.base, ~s.offset + 4, 4);
    call #t~mem66.base, #t~mem66.offset := read~$Pointer$(~s.base, ~s.offset + 80, 8);
    assume !((#t~mem66.base + #t~mem66.offset) % 18446744073709551616 == 0);
    havoc #t~mem66.base, #t~mem66.offset;
    assume !(~tmp___4~11 == 0);
    call write~int(0, ~s.base, ~s.offset + 88, 4);
    call #t~mem70 := read~int(~s.base, ~s.offset + 72, 4);
    assume #t~mem70 != 12292;
    havoc #t~mem70;
    assume !(~tmp___5~11 == 0);
    call write~int(8464, ~s.base, ~s.offset + 72, 4);
    call #t~mem72.base, #t~mem72.offset := read~$Pointer$(~s.base, ~s.offset + 288, 8);
    call #t~mem73 := read~int(#t~mem72.base, #t~mem72.offset + 116 + 12, 4);
    call write~int(#t~mem73 + 1, #t~mem72.base, #t~mem72.offset + 116 + 12, 4);
  ...
  loc8_1:
    ...
    havoc #t~mem192;
    assume ~skip~11 == 0;
    call #t~mem193 := read~int(~s.base, ~s.offset + 296, 4);
    assume !(#t~mem193 != 0);
    havoc #t~mem193;
    assume (~cb~11.base + ~cb~11.offset) % 18446744073709551616 != 0;
    call #t~mem195 := read~int(~s.base, ~s.offset + 72, 4);
    assume #t~mem195 != ~state~11;
    havoc #t~mem195;
    call #t~mem196 := read~int(~s.base, ~s.offset + 72, 4);
    ~new_state~11 := #t~mem196;
    havoc #t~mem196;
    call write~int(~state~11, ~s.base, ~s.offset + 72, 4);
    call write~int(~new_state~11, ~s.base, ~s.offset + 72, 4);
    goto loc11;
  loc9:
    goto loc9_0, loc9_1;
  loc9_0:
  ...
  loc10_0:
    ...
    assume !(#t~mem89 != 0);
    havoc #t~mem89;
    call write~int(8512, ~s.base, ~s.offset + 72, 4);
    call write~int(0, ~s.base, ~s.offset + 88, 4);
    goto loc6;
  loc10_1:
    assume !(#t~mem38 == 8496);
  ...
  loc13_0:
    assume #t~mem40 == 8512;
    havoc #t~mem40;
    call #t~mem93.base, #t~mem93.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call #t~mem94.base, #t~mem94.offset := read~$Pointer$(#t~mem93.base, #t~mem93.offset + 652 + 236, 8);
    call #t~mem95 := read~int(#t~mem94.base, #t~mem94.offset + 20, 8);
    assume !(~bitwiseAnd(#t~mem95, 256) % 18446744073709551616 != 0);
    ...
    ~blastFlag~11 := 6;
    assume !(~ret~11 <= 0);
    call write~int(8528, ~s.base, ~s.offset + 72, 4);
    call write~int(0, ~s.base, ~s.offset + 88, 4);
    goto loc6;
  loc13_1:
    assume !(#t~mem40 == 8512);
  ...
  loc14_0:
    ...
    havoc #t~mem102;
    call #t~mem103.base, #t~mem103.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call write~int(1, #t~mem103.base, #t~mem103.offset + 652 + 283, 4);
    havoc #t~mem103.base, #t~mem103.offset;
  ...
  loc15_0:
    assume #t~mem44 == 8544;
    havoc #t~mem44;
    call #t~mem120 := read~int(~s.base, ~s.offset + 256, 4);
    assume ~bitwiseAnd(#t~mem120, 1) != 0;
    havoc #t~mem120;
    call #t~mem121.base, #t~mem121.offset := read~$Pointer$(~s.base, ~s.offset + 248, 8);
    call #t~mem122.base, #t~mem122.offset := read~$Pointer$(#t~mem121.base, #t~mem121.offset + 152, 8);
    assume !((#t~mem122.base + #t~mem122.offset) % 18446744073709551616 != 0);
    havoc #t~mem121.base, #t~mem121.offset;
    havoc #t~mem122.base, #t~mem122.offset;
    call #t~mem127.base, #t~mem127.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call #t~mem128.base, #t~mem128.offset := read~$Pointer$(#t~mem127.base, #t~mem127.offset + 652 + 236, 8);
    call #t~mem129 := read~int(#t~mem128.base, #t~mem128.offset + 20, 8);
    assume !(~bitwiseAnd(#t~mem129, 256) % 18446744073709551616 != 0);
    havoc #t~mem127.base, #t~mem127.offset;
    havoc #t~mem128.base, #t~mem128.offset;
    havoc #t~mem129;
    call #t~mem134.base, #t~mem134.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call write~int(1, #t~mem134.base, #t~mem134.offset + 652 + 323, 4);
    havoc #t~mem134.base, #t~mem134.offset;
    assume -2147483648 <= #t~nondet136 && #t~nondet136 <= 2147483647;
    ~ret~11 := #t~nondet136;
    havoc #t~nondet136;
    goto loc16;
  loc15_1:
  ...
  loc16_1:
    ...
    call #t~mem138.base, #t~mem138.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call write~int(8576, #t~mem138.base, #t~mem138.offset + 652 + 252, 4);
