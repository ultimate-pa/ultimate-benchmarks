...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    assume true;
    assume true;
    call #t~mem15.base, #t~mem15.offset := read~$Pointer$(~head~5.base, ~head~5.offset + 0, 8);
    assume !!(#t~mem15.base != 0 || #t~mem15.offset != 0);
    havoc #t~mem15.base, #t~mem15.offset;
    assume true;
    assume true;
    call #t~mem16.base, #t~mem16.offset := read~$Pointer$(~head~5.base, ~head~5.offset + 0, 8);
    call #t~mem17.base, #t~mem17.offset := read~$Pointer$(#t~mem16.base, #t~mem16.offset + 0, 8);
    ...
    call #t~mem19.base, #t~mem19.offset := read~$Pointer$(#t~mem18.base, #t~mem18.offset + 0, 8);
    ...
    call #t~mem24 := read~int(#t~mem23.base, #t~mem23.offset + 8, 4);
    assume !(#t~mem24 == 3);
  ...
  loc8_0:
    assume ~status~5 == 1;
    call write~int(2, ~item~5.base, ~item~5.offset + 8, 4);
    ~status~5 := 2;
    goto loc7;
  loc8_1:
    assume !(~status~5 == 1);
    assume ~status~5 >= 2;
    call write~int(3, ~item~5.base, ~item~5.offset + 8, 4);
    ~status~5 := 3;
    goto loc7;
}
