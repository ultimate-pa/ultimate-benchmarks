...
implementation ssl3_connect(#in~initial_state : int) returns (#res : int){
  ...
  loc7_0:
    ...
    assume !(~s__s3__tmp__new_cipher__algorithms~4 - 256 != 0);
  ...
  loc15_0:
    ...
    assume !(~ret~4 <= 0);
    ~s__state~4 := 4352;
    ~__cil_tmp56~4 := ~s__s3__flags~4;
    ~__cil_tmp57~4 := ~__cil_tmp56~4 + 5;
    ~s__s3__flags~4 := (if ~__cil_tmp57~4 % 4294967296 <= 2147483647 then ~__cil_tmp57~4 % 4294967296 else ~__cil_tmp57~4 % 4294967296 - 4294967296);
    assume ~s__hit~4 != 0;
    ~s__s3__tmp__next_state___0~4 := 3;
    ~__cil_tmp58~4 := ~s__s3__flags~4;
    assume !(~__cil_tmp58~4 - 2 != 0);
    ~s__init_num~4 := 0;
    goto loc4;
  loc15_1:
    assume !(~s__state~4 == 4528);
  ...
  loc16_1:
    ...
    ~__cil_tmp61~4 := ~num1~4;
    assume !(~__cil_tmp61~4 > 0);
...
implementation main() returns (#res : int){
  ...
  loc18:
    havoc ~s~143;
    ~s~143 := 12292;
    call #t~ret48 := ssl3_connect(12292);
    return;
}
