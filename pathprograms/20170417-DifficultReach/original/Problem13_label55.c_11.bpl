...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_1:
    ...
    ~a12 := (if (if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) < 0 && (if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) % 108 != 0 then (if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) % 108 - 108 else (if ~a12 * 9 < 0 && ~a12 * 9 % 10 != 0 then ~a12 * 9 / 10 + 1 else ~a12 * 9 / 10) % 108) + 286 + 237951 + -237950;
    ~a23 := (if ((if ~a23 * 9 < 0 && ~a23 * 9 % 10 != 0 then ~a23 * 9 / 10 + 1 else ~a23 * 9 / 10) - 22348) * 1 < 0 && ((if ~a23 * 9 < 0 && ~a23 * 9 % 10 != 0 then ~a23 * 9 / 10 + 1 else ~a23 * 9 / 10) - 22348) * 1 % 84 != 0 then ((if ~a23 * 9 < 0 && ~a23 * 9 % 10 != 0 then ~a23 * 9 / 10 + 1 else ~a23 * 9 / 10) - 22348) * 1 % 84 - 84 else ((if ~a23 * 9 < 0 && ~a23 * 9 % 10 != 0 then ~a23 * 9 / 10 + 1 else ~a23 * 9 / 10) - 22348) * 1 % 84) + 180;
    ~a1 := 2;
    ~a19 := 12;
    ~a13 := 1;
    #res := -1;
