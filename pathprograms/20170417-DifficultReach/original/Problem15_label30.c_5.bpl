...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a4 := (if (if ~a4 - -446919 < 0 && (~a4 - -446919) % 21 != 0 then (~a4 - -446919) % 21 - 21 else (~a4 - -446919) % 21) + -64 < 0 && ((if ~a4 - -446919 < 0 && (~a4 - -446919) % 21 != 0 then (~a4 - -446919) % 21 - 21 else (~a4 - -446919) % 21) + -64) % 5 != 0 then ((if ~a4 - -446919 < 0 && (~a4 - -446919) % 21 != 0 then (~a4 - -446919) % 21 - 21 else (~a4 - -446919) % 21) + -64) / 5 + 1 else ((if ~a4 - -446919 < 0 && (~a4 - -446919) % 21 != 0 then (~a4 - -446919) % 21 - 21 else (~a4 - -446919) % 21) + -64) / 5) + -48;
    ~a0 := (if ~a0 - 0 < 0 && (~a0 - 0) % 24 != 0 then (~a0 - 0) % 24 - 24 else (~a0 - 0) % 24) - 122 - 24975 - -24975;
