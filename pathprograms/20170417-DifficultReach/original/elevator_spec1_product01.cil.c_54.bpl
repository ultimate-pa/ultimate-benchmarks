...
implementation timeShift() returns (){
  ...
  loc28:
    ...
    call #t~ret40 := getReverseHeading(~currentHeading);
    assume -2147483648 <= #t~ret40 && #t~ret40 <= 2147483647;
    ~tmp___6~307 := #t~ret40;
    havoc #t~ret40;
    call #t~ret41 := stopRequestedInDirection(~tmp___6~307, 1, 1);
    assume -2147483648 <= #t~ret41 && #t~ret41 <= 2147483647;
    ~tmp___7~307 := #t~ret41;
    havoc #t~ret41;
    assume !(~tmp___7~307 != 0);
