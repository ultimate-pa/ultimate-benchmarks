...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a1 := (if ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) + 74 - -21) * 5 < 0 && ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) + 74 - -21) * 5 % 89 != 0 then ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) + 74 - -21) * 5 % 89 - 89 else ((if ~a1 < 0 && ~a1 % 89 != 0 then ~a1 % 89 - 89 else ~a1 % 89) + 74 - -21) * 5 % 89) - -118;
    ~a19 := 10;
    #res := 25;
    goto loc5;
  loc4_1:
