...
implementation ssl3_accept(#in~s.base : int, #in~s.offset : int) returns (#res : int){
  ...
  loc9_0:
    assume #t~mem37 == 8528;
    havoc #t~mem37;
    call #t~mem96.base, #t~mem96.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call #t~mem97.base, #t~mem97.offset := read~$Pointer$(#t~mem96.base, #t~mem96.offset + 652 + 236, 8);
    call #t~mem98 := read~int(#t~mem97.base, #t~mem97.offset + 20, 8);
    ~l~11 := #t~mem98;
    havoc #t~mem96.base, #t~mem96.offset;
    havoc #t~mem97.base, #t~mem97.offset;
    havoc #t~mem98;
    call #t~mem99 := read~int(~s.base, ~s.offset + 332, 8);
    assume ~bitwiseAnd(#t~mem99, 2097152) % 18446744073709551616 != 0;
    havoc #t~mem99;
    call #t~mem100.base, #t~mem100.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call write~int(1, #t~mem100.base, #t~mem100.offset + 652 + 283, 4);
    havoc #t~mem100.base, #t~mem100.offset;
    call #t~mem104.base, #t~mem104.offset := read~$Pointer$(~s.base, ~s.offset + 116, 8);
    call #t~mem105 := read~int(#t~mem104.base, #t~mem104.offset + 652 + 283, 4);
    assume #t~mem105 != 0;
