...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc3:
    ...
    assume !(~bitwiseAnd(~tmp___1~4, 12288) != 0);
    assume !(~s__cert~4 == 0);
    goto loc4;
  loc4:
    assume true;
  ...
  loc8_0:
    ...
    assume ~bitwiseAnd(~s__s3__tmp__new_cipher__algorithms~4, 256) % 18446744073709551616 != 0;
    ~skip~4 := 1;
    ~s__state~4 := 8528;
    ~s__init_num~4 := 0;
    goto loc6;
  ...
  loc9_0:
    ...
    assume ~bitwiseAnd(~s__options~4, 2097152) % 18446744073709551616 != 0;
  ...
  loc10_0:
    ...
    assume ~bitwiseAnd(~s__verify_mode~4, 1) != 0;
  ...
  loc14_0:
    ...
    ~s__s3__tmp__next_state___0~4 := #t~nondet38;
    havoc #t~nondet38;
    ~s__init_num~4 := 0;
    goto loc6;
  loc14_1:
  ...
  loc16_0:
    ...
    ~blastFlag~4 := ~blastFlag~4 + (if ~s__state~4 < 0 && ~s__state~4 % ~s__s3__tmp__next_state___0~4 != 0 then (if ~s__s3__tmp__next_state___0~4 < 0 then ~s__state~4 / ~s__s3__tmp__next_state___0~4 - 1 else ~s__state~4 / ~s__s3__tmp__next_state___0~4 + 1) else ~s__state~4 / ~s__s3__tmp__next_state___0~4);
    goto loc18;
  loc16_1:
    assume !(~blastFlag~4 == 3);
    goto loc18;
