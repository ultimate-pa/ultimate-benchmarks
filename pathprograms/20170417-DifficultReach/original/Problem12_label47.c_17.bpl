...
implementation calculate_output2(#in~input : int) returns (#res : int){
  ...
  loc1:
    ...
    ~a17 := (if ~a17 - 567803 < 0 && (~a17 - 567803) % 71 != 0 then (~a17 - 567803) % 71 - 71 else (~a17 - 567803) % 71) + 187 - 424769 - -424798;
    ~a24 := 15;
    ~a5 := 6;
    #res := 23;
    assume true;
...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc8_0:
    ...
    ~a17 := (if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) + 1 + 493840 - 420141 + -73780;
    ~a7 := 12;
    ~a24 := 14;
    ~a5 := 4;
    #res := -1;
