...
implementation main() returns (#res : int){
  ...
  loc2:
    ...
    havoc ~tmp~181;
    ~s~181 := 8464;
    call #t~ret55 := ssl3_accept(~s~181);
    return;
}
...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc3:
    ...
    havoc ~tmp~6;
    havoc ~cb~6;
    assume -9223372036854775808 <= #t~nondet16 && #t~nondet16 <= 9223372036854775807;
    ~num1~6 := #t~nondet16;
    havoc #t~nondet16;
    havoc ~ret~6;
    havoc ~new_state~6;
    ...
    #t~post29 := ~s__in_handshake~6;
    ~s__in_handshake~6 := #t~post29 + 1;
    havoc #t~post29;
    assume ~tmp___1~6 + 12288 != 0;
    assume ~tmp___2~6 + 16384 != 0;
    assume !(~s__cert~6 == 0);
    goto loc4;
  loc4:
    assume true;
  ...
  loc8_0:
    ...
    assume ~tmp___1~6 != -12288;
    assume ~tmp___2~6 != -16384;
    assume ~__cil_tmp56~6 % 18446744073709551616 != 4294967040;
    assume ~__cil_tmp58~6 % 18446744073709551616 != 4294967294;
    assume ~tmp___7~6 != 1024;
    assume ~tmp___7~6 != 512;
    assume !false;
    goto loc10;
  loc8_1:
    assume !(~state~6 == 8576);
  ...
  loc9_0:
    ...
    ~s__s3__tmp__new_cipher__algorithms~6 := #t~nondet36;
    havoc #t~nondet36;
  ...
  loc11_1:
    ...
    ~s__s3__tmp__new_cipher__algorithms~6 := #t~nondet38;
    havoc #t~nondet38;
  ...
  loc12_0:
    ...
    ~s__s3__tmp__new_cipher__algorithms~6 := #t~nondet42;
    havoc #t~nondet42;
