...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc9_0:
    ...
    ~ret~6 := #t~nondet48;
    havoc #t~nondet48;
    assume !(~blastFlag~6 == 10);
    assume !(~blastFlag~6 == 13);
    assume !(~blastFlag~6 == 16);
    assume !(~blastFlag~6 == 19);
    assume !(~ret~6 <= 0);
    ~s__state~6 := 8672;
    ~s__init_num~6 := 0;
    assume !(~tmp___10~6 == 0);
  ...
  loc9_1:
    ...
    ~ret~6 := #t~nondet49;
    havoc #t~nondet49;
    assume !(~blastFlag~6 == 11);
    assume !(~blastFlag~6 == 14);
    assume !(~blastFlag~6 == 17);
    assume !(~blastFlag~6 == 20);
    assume !(~ret~6 <= 0);
    ~s__state~6 := 8448;
    assume ~s__hit~6 != 0;
    ~s__s3__tmp__next_state___0~6 := 8640;
    ~s__init_num~6 := 0;
    goto loc6;
  loc10:
    assert false;
