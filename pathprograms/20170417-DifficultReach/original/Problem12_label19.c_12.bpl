...
implementation calculate_output(#in~input : int) returns (#res : int){
  ...
  loc4_0:
    ...
    ~a17 := (if (~a17 - 135275) * 10 < 0 && (~a17 - 135275) * 10 % 9 != 0 then (~a17 - 135275) * 10 / 9 + 1 else (~a17 - 135275) * 10 / 9) * 3;
    ~a7 := 13;
    ~a5 := 5;
    #res := 23;
    goto loc5;
  ...
  loc6_0:
    ...
    ~a2 := (if (if ~a2 * 9 < 0 && ~a2 * 9 % 10 != 0 then ~a2 * 9 / 10 + 1 else ~a2 * 9 / 10) + -20706 + -31885 < 0 && ((if ~a2 * 9 < 0 && ~a2 * 9 % 10 != 0 then ~a2 * 9 / 10 + 1 else ~a2 * 9 / 10) + -20706 + -31885) % 45 != 0 then ((if ~a2 * 9 < 0 && ~a2 * 9 % 10 != 0 then ~a2 * 9 / 10 + 1 else ~a2 * 9 / 10) + -20706 + -31885) % 45 - 45 else ((if ~a2 * 9 < 0 && ~a2 * 9 % 10 != 0 then ~a2 * 9 / 10 + 1 else ~a2 * 9 / 10) + -20706 + -31885) % 45) - -245;
    ~a17 := (if (if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) - -26 < 0 && ((if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) - -26) % 5 != 0 then ((if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) - -26) / 5 + 1 else ((if ~a17 < 0 && ~a17 % 109 != 0 then ~a17 % 109 - 109 else ~a17 % 109) - -26) / 5) * 5;
    ~a5 := 3;
    #res := 23;
    goto loc5;
  loc6_1:
