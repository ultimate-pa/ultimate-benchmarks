...
implementation main() returns (#res : int){
  ...
  loc2:
    ...
    assume #t~nondet3 != 0;
    havoc #t~nondet3;
    call write~$Pointer$(0, 0, ~list~5.base, ~list~5.offset + 16, 8);
    assume true;
    call #t~mem11.base, #t~mem11.offset := read~$Pointer$(~list~5.base, ~list~5.offset + 16, 8);
    #t~short13 := #t~mem11.base != 0 || #t~mem11.offset != 0;
    assume !#t~short13;
    call #t~mem12.base, #t~mem12.offset := read~$Pointer$(~list~5.base, ~list~5.offset + 16, 8);
    #t~short13 := #t~mem12.base == 0 && #t~mem12.offset == 0;
    assume !!#t~short13;
  ...
  loc4_1:
    assume !!(#t~nondet14 != 0);
    havoc #t~nondet14;
    call #t~malloc15.base, #t~malloc15.offset := #Ultimate.alloc(24);
    call write~$Pointer$(#t~malloc15.base, #t~malloc15.offset, ~end~5.base, ~end~5.offset + 0, 8);
    call #t~mem17.base, #t~mem17.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 0, 8);
    call write~$Pointer$(~end~5.base, ~end~5.offset, #t~mem17.base, #t~mem17.offset + 8, 8);
    havoc #t~mem17.base, #t~mem17.offset;
    call #t~mem19.base, #t~mem19.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 0, 8);
    ~end~5.base, ~end~5.offset := #t~mem19.base, #t~mem19.offset;
    ...
    assume #t~nondet21 != 0;
    havoc #t~nondet21;
    call write~$Pointer$(0, 0, ~end~5.base, ~end~5.offset + 16, 8);
    assume true;
    call #t~mem29.base, #t~mem29.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 16, 8);
    #t~short31 := #t~mem29.base != 0 || #t~mem29.offset != 0;
    assume !#t~short31;
    call #t~mem30.base, #t~mem30.offset := read~$Pointer$(~end~5.base, ~end~5.offset + 16, 8);
    #t~short31 := #t~mem30.base == 0 && #t~mem30.offset == 0;
    assume !!#t~short31;
