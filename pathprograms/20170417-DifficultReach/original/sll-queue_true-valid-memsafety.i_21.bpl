...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    assume true;
    assume true;
    call #t~mem12.base, #t~mem12.offset := read~$Pointer$(~head~5.base, ~head~5.offset + 0, 8);
    assume !!(#t~mem12.base != 0 || #t~mem12.offset != 0);
    havoc #t~mem12.base, #t~mem12.offset;
    assume true;
    assume true;
    call #t~mem13.base, #t~mem13.offset := read~$Pointer$(~head~5.base, ~head~5.offset + 0, 8);
    call #t~mem14.base, #t~mem14.offset := read~$Pointer$(#t~mem13.base, #t~mem13.offset + 0, 8);
