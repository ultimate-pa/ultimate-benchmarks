...
implementation main() returns (#res : int){
  ...
  loc2:
    ...
    havoc ~tmp~172;
    ~s~172 := 8464;
    call #t~ret49 := ssl3_accept(~s~172);
    return;
}
...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc5_0:
    ...
    ~s__server~5 := 1;
    assume ~cb~5 != 0;
    ~__cil_tmp55~5 := ~s__version~5 * 8;
    assume !(~__cil_tmp55~5 != 3);
    ~s__type~5 := 8192;
    assume !(~s__init_buf___0~5 == 0);
    assume !(~tmp___4~5 == 0);
    ~s__init_num~5 := 0;
    assume ~s__state~5 != 12292;
    assume !(~tmp___5~5 == 0);
    ~s__state~5 := 8464;
    #t~post30 := ~s__ctx__stats__sess_accept~5;
    ~s__ctx__stats__sess_accept~5 := #t~post30 + 1;
    havoc #t~post30;
    goto loc6;
  loc5_1:
    assume !(~s__state~5 == 16384);
  ...
  loc16_1:
    ...
    ~s__state~5 := 8448;
    assume ~s__hit~5 != 0;
    ~s__s3__tmp__next_state___0~5 := 8640;
    ~s__init_num~5 := 0;
    goto loc6;
  loc17:
    assume !(~ret~5 <= 0);
