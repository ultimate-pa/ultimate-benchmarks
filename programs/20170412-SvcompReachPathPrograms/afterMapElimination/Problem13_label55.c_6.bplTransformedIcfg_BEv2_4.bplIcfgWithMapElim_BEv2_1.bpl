...
modifies ~a13, ~a23, ~a12, ~a26, ~a1, ~a19;
{
  ...
  loc4_0:
    ...
    assume !(~a13 == 1);
    assume !(~a19 == 9);
    assume ((((((~a12 <= 395 && 178 < ~a12) && calculate_output_~input == 4) && ~a23 <= 264) && ~a19 == 13) && ~a26 == 1) && !(~a13 == 1)) && ~a1 == 2;
    ~a12 := (~a12 + -441193) * 1 * 1;
    assume ~a23 < 300047 && 0 <= ~a23;
    ~a23 := (~a23 + -299951) * 1 - 2;
    ~a19 := 9;
    ~a13 := 1;
    ...
    goto loc1;
  loc4_1:
    assume (((((~a13 == 1 && ~a23 <= 95) && ~a26 == 1) && ~a19 == 13) && ~a1 == 2) && 178 < ~a12) && ~a12 <= 395;
    goto loc5;
  loc5:
    assert false;
}
