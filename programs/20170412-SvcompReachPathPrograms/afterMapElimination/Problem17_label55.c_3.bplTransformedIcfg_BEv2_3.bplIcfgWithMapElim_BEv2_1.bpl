...
modifies ~a24, ~a21, ~a28, ~a26, ~a14;
{
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume ((((~a24 == 1 && 0 < ~a14 + 114) && ~a14 + 84 <= 0) && ~a28 <= 37) && 217 < ~a26) && ~a21 <= 127;
    goto loc5;
  loc4_1:
    assume !(~a28 <= 37);
    assume !(~a26 + 68 <= 0);
    ...
    assume !(300 < ~a28) && !(~a14 + 114 <= 0);
    assume !(~a26 + 68 <= 0);
    assume !(~a24 == 2);
    assume !(~a24 == 3);
    assume ((((calculate_output_~input == 4 && ~a24 == 1) && 217 < ~a26) && 37 < ~a28) && 0 < ~a14 + 84) && ~a21 <= 127;
    assume 599818 <= ~a14;
    ~a14 := ~a14 % 299909 + -300090 - 0;
    assume 8 <= ~a26 && (~a26 + 2) % 5 == 0;
