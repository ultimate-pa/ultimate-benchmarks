...
modifies ;
{
  ...
  loc1_0:
    ...
    assume 0 <= main_~x~5 && main_~x~5 < 65536;
    main_~xx~5 := main_~x~5;
    assume 0 <= main_~y~5 + 65536 && main_~y~5 < 0;
    ...
    havoc main_~yy~5;
    havoc main_~zz~5;
    assume (((0 <= main_~z~5 && !(main_~z~5 == main_~zz~5 + 4294967296)) && main_~zz~5 < 0) && main_~z~5 < 4294967296) && 0 <= main_~zz~5 + 4294967296;
