...
modifies ~ldv_mutex, ~open_called;
{
    ...
    var mutex_unlock_#t~ite1 : int;
    var main_#t~nondet6 : int;
    var main_#t~post13 : int;
    var mutex_lock_#t~ite0 : int;
  ...
  loc3_0:
    ...
    main_#t~switch7 := false;
    assume !main_#t~switch7;
    assume !main_#t~switch7 && !(main_#t~nondet6 == 2);
    main_#t~switch7 := false;
    assume !main_#t~switch7;
    assume main_#t~nondet6 == 3;
    main_#t~switch7 := true;
    assume main_#t~switch7;
    assume main_~ldv_s_misc_fops_file_operations~16 == 3;
    havoc misc_release_#res;
    assume !(~open_called == 0);
    havoc mutex_lock_#t~ite0;
    assume ~ldv_mutex == 1;
    mutex_lock_#t~ite0 := 0;
    havoc mutex_lock_#t~ite0;
    ~ldv_mutex := 2;
    havoc mutex_unlock_#t~ite1;
    assume !(~ldv_mutex == 2);
    goto loc4;
  loc3_1:
    assume main_#t~switch7;
