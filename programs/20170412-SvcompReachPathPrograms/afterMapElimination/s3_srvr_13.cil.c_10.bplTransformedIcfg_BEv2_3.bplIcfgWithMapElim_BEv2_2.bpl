...
modifies ;
{
  ...
  loc4_0:
    ...
    assume !(ssl3_accept_~__cil_tmp58~5 % 18446744073709551616 == 4294967294) && ssl3_accept_~__cil_tmp58~5 + 18446744073709551616 < 0;
    assume 36893488147419103232 <= ssl3_accept_~l~5 && !(ssl3_accept_~l~5 % 18446744073709551616 == 4294967266);
    goto loc5;
  loc4_1:
    assume !(ssl3_accept_~s__s3__tmp__reuse_message~5 == 0);
    ssl3_accept_~skip~5 := 0;
