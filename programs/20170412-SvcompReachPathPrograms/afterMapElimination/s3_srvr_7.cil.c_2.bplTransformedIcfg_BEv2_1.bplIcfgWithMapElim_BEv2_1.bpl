...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_~tmp~178, main_~s~178, main_#t~ret49;
    havoc main_~s~178;
    havoc main_~tmp~178;
    main_~s~178 := 8464;
    ssl3_accept_#in~initial_state := main_~s~178;
  ...
  loc2_1:
    ...
    assume ssl3_accept_~__cil_tmp61~5 + 18446744073709551872 == 0;
