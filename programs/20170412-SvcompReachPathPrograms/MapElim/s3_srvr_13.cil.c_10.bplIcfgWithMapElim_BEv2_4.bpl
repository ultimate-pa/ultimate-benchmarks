...
modifies ;
{
  ...
  loc4_0:
    ...
    ssl3_accept_~ret~5 := ssl3_accept_#t~nondet32;
  ...
  loc5_0:
    ...
    assume !(ssl3_accept_~__cil_tmp58~5 % 18446744073709551616 == 4294967294);
    assume !(ssl3_accept_~l~5 % 18446744073709551616 == 4294967266);
    goto loc6;
  loc5_1:
    assume !(ssl3_accept_~s__s3__tmp__reuse_message~5 == 0);
    ssl3_accept_~skip~5 := 0;
