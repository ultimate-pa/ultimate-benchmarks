...
modifies ;
{
  ...
  loc2_1:
    assume !(main_~i~4 < 2048);
    assume !(v_rep_select_ULTIMATE.start_main_~A~4_1024__1 == v_rep_select_ULTIMATE.start_main_~B~4_1024__1) || v_rep_select_ULTIMATE.start_main_~A~4_1024__1 == v_rep_select_ULTIMATE.start_main_~B~4_1024__1;
    __VERIFIER_assert_#in~cond := (if !(v_rep_select_ULTIMATE.start_main_~A~4_1024__1 == v_rep_select_ULTIMATE.start_main_~B~4_1024__1) then 1 else 0);
