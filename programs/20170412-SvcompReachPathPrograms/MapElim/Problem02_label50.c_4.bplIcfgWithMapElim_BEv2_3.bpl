...
modifies ~a11, ~a21, ~a28, ~a17, ~a25, ~a19;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume (((((!(~a11 == 1) && ~a19 == 1) && ~a17 == 8) && !(~a25 == 1)) && ~a28 == 7) && ~a21 == 1) && calculate_output_~input == 6;
    ~a28 := 10;
  ...
  loc10_0:
    assume (((((!(~a25 == 1) && ~a17 == 8) && ~a21 == 1) && ~a28 == 11) && ~a19 == 1) && calculate_output_~input == 1) && !(~a11 == 1);
    ~a28 := 7;
    ~a19 := 0;
    ~a11 := 1;
  ...
  loc10_1:
    ...
    assume !(~a19 == 1);
    assume !(~a19 == 1);
    assume ((((~a21 == 1 && ~a11 == 1) && ~a28 == 7) && ~a17 == 8) && !(~a25 == 1)) && !(~a19 == 1);
    goto loc11;
  loc11:
    assert false;
}
