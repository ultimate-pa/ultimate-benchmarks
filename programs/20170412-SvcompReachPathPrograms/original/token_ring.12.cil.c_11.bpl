...
modifies ~t4_pc, ~t4_st, ~token, ~E_5, ~m_st, ~t1_st, ~t2_st, ~t3_st, ~t5_st, ~t6_st, ~t7_st, ~t8_st, ~t9_st, ~t10_st, ~t11_st, ~t12_st;

implementation main() returns (#res : int){
    var ~__retres1~577 : int;
...
implementation activate_threads() returns (){
    ...
    var ~tmp___8~455 : int;
    var ~tmp___9~455 : int;
    var ~tmp___10~455 : int;
    var ~tmp___11~455 : int;
...
implementation eval() returns (){
    var #t~ret1 : int;
    var #t~nondet2 : int;
    var ~tmp_ndt_1~282 : int;
    var #t~nondet3 : int;
    var ~tmp_ndt_2~287 : int;
    var #t~nondet4 : int;
    var ~tmp_ndt_3~292 : int;
    var #t~nondet5 : int;
    var ~tmp_ndt_4~297 : int;
    var #t~nondet6 : int;
    var ~tmp_ndt_5~302 : int;
    var #t~nondet7 : int;
    var ~tmp_ndt_6~307 : int;
    var #t~nondet8 : int;
    var ~tmp_ndt_7~312 : int;
    var #t~nondet9 : int;
    var ~tmp_ndt_8~317 : int;
    var #t~nondet10 : int;
    var ~tmp_ndt_9~322 : int;
    var #t~nondet11 : int;
    var ~tmp_ndt_10~327 : int;
    var #t~nondet12 : int;
    var ~tmp_ndt_11~332 : int;
    var #t~nondet13 : int;
    var ~tmp_ndt_12~337 : int;
    var #t~nondet14 : int;
    var ~tmp_ndt_13~342 : int;
    var ~tmp~275 : int;
  ...
  loc27_0:
    ...
    ~tmp_ndt_1~282 := #t~nondet2;
    havoc #t~nondet2;
    assume ~tmp_ndt_1~282 != 0;
    ~m_st := 1;
    call master();
    goto loc28;
  loc27_1:
  ...
  loc28:
    ...
    ~tmp_ndt_2~287 := #t~nondet3;
    havoc #t~nondet3;
    assume !(~tmp_ndt_2~287 != 0);
    assume ~t2_st == 0;
    havoc ~tmp_ndt_3~292;
    assume -2147483648 <= #t~nondet4 && #t~nondet4 <= 2147483647;
    ~tmp_ndt_3~292 := #t~nondet4;
    havoc #t~nondet4;
    assume !(~tmp_ndt_3~292 != 0);
    assume ~t3_st == 0;
    havoc ~tmp_ndt_4~297;
    assume -2147483648 <= #t~nondet5 && #t~nondet5 <= 2147483647;
    ~tmp_ndt_4~297 := #t~nondet5;
    havoc #t~nondet5;
    assume !(~tmp_ndt_4~297 != 0);
    goto loc29;
  loc29:
  ...
  loc29_0:
    ...
    ~tmp_ndt_5~302 := #t~nondet6;
    havoc #t~nondet6;
    assume ~tmp_ndt_5~302 != 0;
    ~t4_st := 1;
    call transmit4();
    goto loc30;
  loc29_1:
