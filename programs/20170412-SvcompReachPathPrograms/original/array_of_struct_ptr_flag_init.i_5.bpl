...
implementation main() returns (#res : int){
  ...
  loc7_0:
    ...
    assume !!(~i~7 < 100000);
    assume ~flag~7 == 0;
    call #t~mem6.base, #t~mem6.offset := read~$Pointer$(~#a~7.base, ~#a~7.offset + ~i~7 * 8 + 0, 8);
    call __VERIFIER_assert((if #t~mem6.base == 0 && #t~mem6.offset == 0 then 1 else 0));
    return;
  loc7_1:
    assume !!(~i~7 < 100000);
    call #t~mem4.base, #t~mem4.offset := read~$Pointer$(~#a~7.base, ~#a~7.offset + ~i~7 * 8 + 0, 8);
    assume !(#t~mem4.base != 0 || #t~mem4.offset != 0);
