...
implementation ssl3_connect(#in~initial_state : int) returns (#res : int){
  ...
  loc1:
    ...
    #t~post31 := ~s__in_handshake~4;
    ~s__in_handshake~4 := #t~post31 + 1;
    havoc #t~post31;
...
implementation main() returns (#res : int){
  ...
  loc8:
    havoc ~s~145;
    ~s~145 := 12292;
    call #t~ret51 := ssl3_connect(~s~145);
    return;
}
