...
implementation main() returns (#res : int){
    ...
    var ~__CS_cp___CS_thread_status~28 : [int,int]int;
    var ~__CS_cp___CS_thread_lockedon~28.base : [int,int]int, ~__CS_cp___CS_thread_lockedon~28.offset : [int,int]int;
    var ~__CS_cp_flag1~28 : [int]int;
    var ~__CS_cp_flag2~28 : [int]int;
    var ~__CS_cp_turn~28 : [int]int;
    var ~__CS_cp_x~28 : [int]int;
    var ~i~28 : int;
    var ~j~28 : int;

  loc2:
    havoc ~__CS_cp___CS_thread_status~28;
    havoc ~__CS_cp___CS_thread_lockedon~28.base, ~__CS_cp___CS_thread_lockedon~28.offset;
    havoc ~__CS_cp_flag1~28;
    havoc ~__CS_cp_flag2~28;
    havoc ~__CS_cp_turn~28;
    havoc ~__CS_cp_x~28;
    havoc ~i~28;
    havoc ~j~28;
    ~i~28 := 0;
  ...
  loc4_0:
    assume !(~i~28 < 3);
    ~__CS_thread_status := ~__CS_thread_status[1,0 := ~__CS_cp___CS_thread_status~28[1,0]];
    ~__CS_thread_status := ~__CS_thread_status[2,0 := ~__CS_cp___CS_thread_status~28[2,0]];
    ~__CS_thread_status := ~__CS_thread_status[1,1 := ~__CS_cp___CS_thread_status~28[1,1]];
    ~__CS_thread_status := ~__CS_thread_status[2,1 := ~__CS_cp___CS_thread_status~28[2,1]];
    ~__CS_thread_status := ~__CS_thread_status[1,2 := ~__CS_cp___CS_thread_status~28[1,2]];
    ~__CS_thread_status := ~__CS_thread_status[2,2 := ~__CS_cp___CS_thread_status~28[2,2]];
    ~__CS_thread_lockedon.base, ~__CS_thread_lockedon.offset := ~__CS_thread_lockedon.base[1,0 := ~__CS_cp___CS_thread_lockedon~28.base[1,0]], ~__CS_thread_lockedon.offset[1,0 := ~__CS_cp___CS_thread_lockedon~28.offset[1,0]];
    ~__CS_thread_lockedon.base, ~__CS_thread_lockedon.offset := ~__CS_thread_lockedon.base[2,0 := ~__CS_cp___CS_thread_lockedon~28.base[2,0]], ~__CS_thread_lockedon.offset[2,0 := ~__CS_cp___CS_thread_lockedon~28.offset[2,0]];
    ~__CS_thread_lockedon.base, ~__CS_thread_lockedon.offset := ~__CS_thread_lockedon.base[1,1 := ~__CS_cp___CS_thread_lockedon~28.base[1,1]], ~__CS_thread_lockedon.offset[1,1 := ~__CS_cp___CS_thread_lockedon~28.offset[1,1]];
    ~__CS_thread_lockedon.base, ~__CS_thread_lockedon.offset := ~__CS_thread_lockedon.base[2,1 := ~__CS_cp___CS_thread_lockedon~28.base[2,1]], ~__CS_thread_lockedon.offset[2,1 := ~__CS_cp___CS_thread_lockedon~28.offset[2,1]];
    ~__CS_thread_lockedon.base, ~__CS_thread_lockedon.offset := ~__CS_thread_lockedon.base[1,2 := ~__CS_cp___CS_thread_lockedon~28.base[1,2]], ~__CS_thread_lockedon.offset[1,2 := ~__CS_cp___CS_thread_lockedon~28.offset[1,2]];
    ~__CS_thread_lockedon.base, ~__CS_thread_lockedon.offset := ~__CS_thread_lockedon.base[2,2 := ~__CS_cp___CS_thread_lockedon~28.base[2,2]], ~__CS_thread_lockedon.offset[2,2 := ~__CS_cp___CS_thread_lockedon~28.offset[2,2]];
    ~flag1 := ~flag1[1 := ~__CS_cp_flag1~28[1]];
    ~flag1 := ~flag1[2 := ~__CS_cp_flag1~28[2]];
    ~flag2 := ~flag2[1 := ~__CS_cp_flag2~28[1]];
    ~flag2 := ~flag2[2 := ~__CS_cp_flag2~28[2]];
    ~turn := ~turn[1 := ~__CS_cp_turn~28[1]];
    ~turn := ~turn[2 := ~__CS_cp_turn~28[2]];
    ~x := ~x[1 := ~__CS_cp_x~28[1]];
    ~x := ~x[2 := ~__CS_cp_x~28[2]];
    ~__CS_round := 0;
    ~__CS_thread_index := 0;
    ...
    assume ~__CS_thread_status[0,0] % 256 == ~__CS_cp___CS_thread_status~28[1,0] % 256;
    assume ~__CS_thread_status[1,0] % 256 == ~__CS_cp___CS_thread_status~28[2,0] % 256;
    assume ~__CS_thread_status[0,1] % 256 == ~__CS_cp___CS_thread_status~28[1,1] % 256;
    assume ~__CS_thread_status[1,1] % 256 == ~__CS_cp___CS_thread_status~28[2,1] % 256;
    assume ~__CS_thread_status[0,2] % 256 == ~__CS_cp___CS_thread_status~28[1,2] % 256;
    assume ~__CS_thread_status[1,2] % 256 == ~__CS_cp___CS_thread_status~28[2,2] % 256;
    assume ~__CS_thread_lockedon.base[0,0] == ~__CS_cp___CS_thread_lockedon~28.base[1,0] && ~__CS_thread_lockedon.offset[0,0] == ~__CS_cp___CS_thread_lockedon~28.offset[1,0];
    assume ~__CS_thread_lockedon.base[1,0] == ~__CS_cp___CS_thread_lockedon~28.base[2,0] && ~__CS_thread_lockedon.offset[1,0] == ~__CS_cp___CS_thread_lockedon~28.offset[2,0];
    assume ~__CS_thread_lockedon.base[0,1] == ~__CS_cp___CS_thread_lockedon~28.base[1,1] && ~__CS_thread_lockedon.offset[0,1] == ~__CS_cp___CS_thread_lockedon~28.offset[1,1];
    assume ~__CS_thread_lockedon.base[1,1] == ~__CS_cp___CS_thread_lockedon~28.base[2,1] && ~__CS_thread_lockedon.offset[1,1] == ~__CS_cp___CS_thread_lockedon~28.offset[2,1];
    assume ~__CS_thread_lockedon.base[0,2] == ~__CS_cp___CS_thread_lockedon~28.base[1,2] && ~__CS_thread_lockedon.offset[0,2] == ~__CS_cp___CS_thread_lockedon~28.offset[1,2];
    assume ~__CS_thread_lockedon.base[1,2] == ~__CS_cp___CS_thread_lockedon~28.base[2,2] && ~__CS_thread_lockedon.offset[1,2] == ~__CS_cp___CS_thread_lockedon~28.offset[2,2];
    assume ~flag1[0] == ~__CS_cp_flag1~28[1];
    assume ~flag1[1] == ~__CS_cp_flag1~28[2];
    assume ~flag2[0] == ~__CS_cp_flag2~28[1];
    assume ~flag2[1] == ~__CS_cp_flag2~28[2];
    assume ~turn[0] == ~__CS_cp_turn~28[1];
    assume ~turn[1] == ~__CS_cp_turn~28[2];
    assume ~x[0] == ~__CS_cp_x~28[1];
    assume ~x[1] == ~__CS_cp_x~28[2];
    call __VERIFIER_assert((if ~__CS_error % 256 != 1 then 1 else 0));
    return;
  loc4_1:
    assume !!(~i~28 < 3);
    assume -2147483648 <= #t~nondet16 && #t~nondet16 <= 2147483647;
    ~__CS_cp_flag1~28 := ~__CS_cp_flag1~28[~i~28 := #t~nondet16];
    havoc #t~nondet16;
    assume -2147483648 <= #t~nondet17 && #t~nondet17 <= 2147483647;
    ~__CS_cp_flag2~28 := ~__CS_cp_flag2~28[~i~28 := #t~nondet17];
    havoc #t~nondet17;
    assume -2147483648 <= #t~nondet18 && #t~nondet18 <= 2147483647;
    ~__CS_cp_turn~28 := ~__CS_cp_turn~28[~i~28 := #t~nondet18];
    havoc #t~nondet18;
    assume -2147483648 <= #t~nondet19 && #t~nondet19 <= 2147483647;
    ~__CS_cp_x~28 := ~__CS_cp_x~28[~i~28 := #t~nondet19];
    havoc #t~nondet19;
    ~j~28 := 0;
    goto loc5;
  loc5:
  ...
  loc6_1:
    assume !!(~j~28 < 3);
    ~__CS_cp___CS_thread_status~28 := ~__CS_cp___CS_thread_status~28[~i~28,~j~28 := #t~nondet21];
    havoc #t~nondet21;
    ~__CS_cp___CS_thread_lockedon~28.base, ~__CS_cp___CS_thread_lockedon~28.offset := ~__CS_cp___CS_thread_lockedon~28.base[~i~28,~j~28 := #t~nondet22.base], ~__CS_cp___CS_thread_lockedon~28.offset[~i~28,~j~28 := #t~nondet22.offset];
