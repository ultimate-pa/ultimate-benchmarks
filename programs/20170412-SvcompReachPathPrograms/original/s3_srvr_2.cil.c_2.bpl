...
implementation ssl3_accept(#in~initial_state : int) returns (#res : int){
  ...
  loc3:
    ...
    #t~post29 := ~s__in_handshake~5;
    ~s__in_handshake~5 := #t~post29 + 1;
    havoc #t~post29;
