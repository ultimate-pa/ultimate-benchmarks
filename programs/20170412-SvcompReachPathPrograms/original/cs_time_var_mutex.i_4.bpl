...
implementation main() returns (#res : int){
  ...
  loc4_0:
    ...
    ~block := ~block[1 := ~__CS_cp_block~31[1]];
    ~block := ~block[2 := ~__CS_cp_block~31[2]];
    ~busy := ~busy[1 := ~__CS_cp_busy~31[1]];
    ~busy := ~busy[2 := ~__CS_cp_busy~31[2]];
    ~inode := ~inode[1 := ~__CS_cp_inode~31[1]];
    ~inode := ~inode[2 := ~__CS_cp_inode~31[2]];
    call write~int(~__CS_cp_m_inode~31[1], ~#m_inode.base, ~#m_inode.offset + 1, 1);
    call write~int(~__CS_cp_m_inode~31[2], ~#m_inode.base, ~#m_inode.offset + 2, 1);
    call write~int(~__CS_cp_m_busy~31[1], ~#m_busy.base, ~#m_busy.offset + 1, 1);
    call write~int(~__CS_cp_m_busy~31[2], ~#m_busy.base, ~#m_busy.offset + 2, 1);
    ~__CS_round := 0;
    ~__CS_thread_index := 0;
    ...
    assume ~block[0] == ~__CS_cp_block~31[1];
    assume ~block[1] == ~__CS_cp_block~31[2];
    assume ~busy[0] == ~__CS_cp_busy~31[1];
    assume ~busy[1] == ~__CS_cp_busy~31[2];
    assume ~inode[0] == ~__CS_cp_inode~31[1];
    assume ~inode[1] == ~__CS_cp_inode~31[2];
    call #t~mem50 := read~int(~#m_inode.base, ~#m_inode.offset + 0, 1);
    assume #t~mem50 % 256 == ~__CS_cp_m_inode~31[1] % 256;
    havoc #t~mem50;
    call #t~mem51 := read~int(~#m_inode.base, ~#m_inode.offset + 1, 1);
    assume #t~mem51 % 256 == ~__CS_cp_m_inode~31[2] % 256;
    havoc #t~mem51;
    call #t~mem52 := read~int(~#m_busy.base, ~#m_busy.offset + 0, 1);
    assume #t~mem52 % 256 == ~__CS_cp_m_busy~31[1] % 256;
    havoc #t~mem52;
    call #t~mem53 := read~int(~#m_busy.base, ~#m_busy.offset + 1, 1);
    assume #t~mem53 % 256 == ~__CS_cp_m_busy~31[2] % 256;
    havoc #t~mem53;
