...
modifies ;
{
  ...
  loc0:
    ...
    assume !(255 * gcd_test_~b % 256 <= 127) && 255 * gcd_test_~b < -256;
    gcd_test_~b := 255 * gcd_test_~b % 256 - 256;
    goto loc1;
  loc1:
    goto loc2;
  loc2:
  ...
  loc2_1:
    ...
    assume (((((((!(gcd_test_~a % gcd_test_~b == 0) && gcd_test_~b < 0) && 256 + 256 <= gcd_test_~a % gcd_test_~b) && 255 * gcd_test_~b + gcd_test_~a % gcd_test_~b < -256) && gcd_test_~b + gcd_test_~a % gcd_test_~b < -256) && (gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127) && (255 * gcd_test_~b + gcd_test_~a % gcd_test_~b) % 256 <= 127) && gcd_test_~a < 0) && !(gcd_test_~a % gcd_test_~b % 256 <= 127);
