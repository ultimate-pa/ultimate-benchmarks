...
modifies ;
{
  ...
  loc6_1:
    assume main_~i~4 < 100000;
    main_~b~4 := main_~b~4[main_~i~4 := main_~b~4[main_~i~4] + main_~i~4];
  ...
  loc8_0:
    assume main_~i~4 < 100000;
    main_~b~4 := main_~b~4[main_~i~4 := main_~b~4[main_~i~4] - main_~a~4[main_~i~4]];
  ...
  loc8_1:
    ...
    assume !(main_~b~4[main_~x~4] == main_~x~4);
