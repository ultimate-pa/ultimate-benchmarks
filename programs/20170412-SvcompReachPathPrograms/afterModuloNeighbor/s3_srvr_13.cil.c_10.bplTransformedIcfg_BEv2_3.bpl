...
modifies ;
{
  ...
  loc0:
    ...
    havoc ssl3_accept_~s__s3__tmp__reuse_message~5;
    ...
    ssl3_accept_~s__s3__tmp__new_cipher~5 := ssl3_accept_#t~nondet14;
    havoc ssl3_accept_#t~nondet14;
    havoc ssl3_accept_~s__s3__tmp__new_cipher__algorithms~5;
    havoc ssl3_accept_~s__s3__tmp__next_state___0~5;
    havoc ssl3_accept_~s__s3__tmp__new_cipher__algo_strength~5;
    ...
    ssl3_accept_~num1~5 := ssl3_accept_#t~nondet15;
    ...
    ssl3_accept_~tmp~5 := ssl3_accept_#t~nondet26;
    ...
    ssl3_accept_#t~post27 := ssl3_accept_~s__in_handshake~5;
    ssl3_accept_~s__in_handshake~5 := ssl3_accept_#t~post27 + 1;
  ...
  loc2_0:
    ...
    ssl3_accept_~ret~5 := ssl3_accept_#t~nondet31;
    havoc ssl3_accept_#t~nondet31;
    assume !(ssl3_accept_~ret~5 <= 0);
    ssl3_accept_~s__s3__tmp__next_state___0~5 := 8482;
  ...
  loc3:
    ...
    ssl3_accept_~s__s3__tmp__reuse_message~5 := ssl3_accept_#t~nondet51;
  ...
  loc4_1:
    assume ssl3_accept_~s__s3__tmp__reuse_message~5 == 0;
    assume ssl3_accept_~skip~5 == 0;
    assume ssl3_accept_~state~5 == 8528;
    assume ssl3_accept_~s__state~5 == 8544;
    assume !(ssl3_accept_~tmp___7~5 == 1024);
    assume !(ssl3_accept_~tmp___7~5 == 512);
    assume !(ssl3_accept_~__cil_tmp58~5 % 18446744073709551616 == 4294967294) && ssl3_accept_~__cil_tmp58~5 < -18446744073709551616;
    assume 18446744073709551616 + 18446744073709551616 <= ssl3_accept_~l~5 && !(ssl3_accept_~l~5 % 18446744073709551616 == 4294967266);
    goto loc5;
  loc5:
    assert false;
}
