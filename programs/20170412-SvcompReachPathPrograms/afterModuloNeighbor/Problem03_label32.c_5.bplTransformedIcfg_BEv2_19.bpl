...
modifies ~a13, ~a23, ~a11, ~a21, ~a17, ~a27, ~a15, ~a25, ~a2, ~a4, ~a19, ~a29, ~a0, ~a6, ~a8, ~a20, ~a24, ~a12, ~a22, ~a10, ~a28, ~a16, ~a26, ~a14, ~a1, ~a3, ~a18, ~a9, ~a5, ~a7;
{
  ...
  loc3_0:
    ...
    assume ~a22 == 1 && !(~a3 == 2);
    assume !(~a26 == 1) && ~a12 == 1;
    assume (((!(~a2 == 1) && !(~a5 == 1)) && ~a0 == 1) && ~a15 == 1) && !(~a19 == 1);
    assume ~a0 == 1 && !(~a5 == 1);
    assume !(~a3 == 2);
    assume ((~a22 == 1 && ~a1 == 1) && !(~a2 == 1)) && !(~a11 == 1);
    assume ~a11 == 1;
    assume !(~a27 == 1) && !(~a12 == 1);
    assume !(~a12 == 1) && ~a27 == 1;
    assume !(~a18 == 1) && !(~a7 == 1);
    ...
    assume ~a5 == 1 && ~a26 == 1;
    assume !(~a27 == 1) && !(~a5 == 1);
    assume (~a22 == 1 && !(~a19 == 1)) && !(~a11 == 1);
    assume !(~a6 == 1);
    assume !(~a12 == 1);
    assume ~a12 == 1;
    assume ~a22 == 1 && !(~a11 == 1);
    assume !(~a5 == 1);
    assume (!(~a7 == 1) && !(~a23 == 1)) && !(~a6 == 1);
    assume ~a26 == 1 && ~a27 == 1;
    assume !(~a27 == 1) && !(~a12 == 1);
    assume !(~a11 == 1);
    assume !(calculate_output_~input == 3);
    ...
    assume !(~a3 == 0);
    assume !(~a18 == 1);
    assume ((((((~a3 == 1 && ~a27 == 1) && ~a11 == 1) && ~a6 == 1) && ~a18 == 1) && !(~a26 == 1)) && ~a5 == 1) && ~a12 == 1;
    goto loc4;
  loc3_1:
    assume ((((((((((((((!(~a7 == 1) && ~a18 == 1) && !(~a27 == 1)) && !(~a23 == 1)) && !(~a14 == 1)) && ~a3 == 1) && !(~a26 == 1)) && ~a29 == 1) && ~a10 == 1) && !(~a25 == 1)) && ~a4 == 1) && calculate_output_~input == 1) && !(~a11 == 1)) && !(~a6 == 1)) && ~a5 == 1) && !(~a12 == 1);
    ~a26 := 1;
    ~a11 := 1;
    ~a3 := 0;
    ~a27 := 1;
