...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume !(main_~c~5 % 256 < 8) && 256 + 256 <= main_~c~5;
    assume (((256 <= main_~x~5 && main_~y~5 < 256) && main_~x~5 < 256 + 256) && 0 <= main_~y~5) && main_~x~5 - 256 == main_~y~5;
  ...
  loc2_1:
    ...
    havoc main_~i~6;
    havoc main_~bit~6;
    assume main_~bit~6 < -256 && !(main_~bit~6 % 256 == 0);
    assume (main_~i~6 < 0 && -256 <= main_~i~6) && 256 + 256 <= main_~y~5;
