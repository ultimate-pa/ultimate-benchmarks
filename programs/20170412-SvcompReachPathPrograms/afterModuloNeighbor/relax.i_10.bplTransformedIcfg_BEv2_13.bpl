...
modifies #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    main_~j~12 := 0;
    assume ((main_~pat_len~11 < 18446744073709551616 && 0 <= main_~pat_len~11) && main_~j~12 < 18446744073709551616) && !(main_~j~12 < main_~pat_len~11);
    main_~j~13 := 0;
    assume ((main_~j~13 < 18446744073709551616 && -18446744073709551616 <= main_~a_len~11) && main_~a_len~11 < 0) && !(main_~j~13 < main_~a_len~11 + 18446744073709551616);
    ...
    assume ((!(is_relaxed_prefix_~a_length < is_relaxed_prefix_~pat_length + 18446744073709551615) && is_relaxed_prefix_~pat_length < 0) && is_relaxed_prefix_~a_length + 1 < 18446744073709551616) && -18446744073709551616 <= is_relaxed_prefix_~pat_length;
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume (((!(is_relaxed_prefix_~i~9 % 18446744073709551616 < is_relaxed_prefix_~pat_length + 18446744073709551616) && -18446744073709551616 <= is_relaxed_prefix_~pat_length) && is_relaxed_prefix_~a_length < 18446744073709551616) && is_relaxed_prefix_~i~9 < -18446744073709551616) && 0 <= is_relaxed_prefix_~a_length;
    assume (((is_relaxed_prefix_~shift~8 == 1 && 18446744073709551616 + 18446744073709551616 <= is_relaxed_prefix_~a_length) && -18446744073709551616 <= is_relaxed_prefix_~pat_length) && is_relaxed_prefix_~pat_length < 0) && is_relaxed_prefix_~a_length % 18446744073709551616 < is_relaxed_prefix_~pat_length + 18446744073709551616;
    is_relaxed_prefix_#res := 0;
    main_#t~ret14 := is_relaxed_prefix_#res;
    assume main_#t~ret14 == 0;
    havoc main_#t~ret14;
    assume ((main_~a_len~11 + 1 < 18446744073709551616 && main_~pat_len~11 <= main_~a_len~11 + 1) && main_~pat_len~11 < 18446744073709551616) && 0 <= main_~pat_len~11;
    main_~differences~16 := 0;
    main_~i~17 := 0;
    assume (((main_~a_len~11 < 0 && -18446744073709551616 <= main_~a_len~11) && -18446744073709551616 <= main_~pat_len~11) && !(main_~i~17 < main_~a_len~11 + 18446744073709551616)) && main_~i~17 < 18446744073709551616;
    assume ((main_~pat_len~11 < 18446744073709551616 && main_~a_len~11 < 0) && main_~a_len~11 + 18446744073709551616 < main_~pat_len~11) && -18446744073709551616 <= main_~a_len~11;
    main_#t~pre27 := main_~differences~16 + 1;
    main_~differences~16 := main_~differences~16 + 1;
    havoc main_#t~pre27;
    assume (-18446744073709551616 <= main_~differences~16 && !(0 < main_~differences~16 + 18446744073709551615)) && main_~differences~16 < 0;
    ...
    goto loc3;
  loc2_1:
    assume ((((is_relaxed_prefix_~i~9 < is_relaxed_prefix_~a_length % 18446744073709551616 + 18446744073709551616 && is_relaxed_prefix_~pat_length < 0) && 18446744073709551616 + 18446744073709551616 <= is_relaxed_prefix_~a_length) && 18446744073709551616 <= is_relaxed_prefix_~i~9) && is_relaxed_prefix_~i~9 < is_relaxed_prefix_~pat_length + 36893488147419103232) && -18446744073709551616 <= is_relaxed_prefix_~pat_length;
