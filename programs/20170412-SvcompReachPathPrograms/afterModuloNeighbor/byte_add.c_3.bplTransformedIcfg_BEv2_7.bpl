...
modifies ;
{
  ...
  loc0:
    ...
    mp_add_~nb~5 := 4;
    assume (!(mp_add_~b3~5 - 256 == 0) && mp_add_~b3~5 < 256 + 256) && 256 <= mp_add_~b3~5;
    mp_add_~carry~5 := 0;
    mp_add_~i~5 := 0;
    assume ((((((!(mp_add_~i~5 < mp_add_~na~5) && mp_add_~i~5 < 256) && 65536 + 65536 <= mp_add_~carry~5) && 0 <= mp_add_~i~5) && !(mp_add_~i~5 < mp_add_~nb~5)) && mp_add_~carry~5 % 65536 == 0) && 0 <= mp_add_~nb~5) && 0 <= mp_add_~na~5;
    goto loc1;
  loc1:
    goto loc2;
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume mp_add_~i~5 < 256 + 256 && !(mp_add_~i~5 < 260);
    havoc mp_add_~r~5;
