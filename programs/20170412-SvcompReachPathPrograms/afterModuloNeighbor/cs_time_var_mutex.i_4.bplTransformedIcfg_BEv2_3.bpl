...
modifies ~__CS_round, ~__CS_thread.offset, ~__THREAD_UNUSED, v_rep#funAddr~main_thread.base_1, #NULL.offset, ~__THREAD_FINISHED, ~__CS_thread_lockedon.offset, ~#m_busy.base, ~__CS_ret_ERROR, #length, v_rep#funAddr~main_thread.offset_1, ~__CS_thread_allocated, ~#m_inode.base, ~block, ~__CS_thread.base, ~__CS_thread_status, ~#m_inode.offset, ~__CS_thread_index, #NULL.base, ~#m_busy.offset, ~__CS_error, ~busy, ~inode, #valid, ~__CS_ret_PREEMPTED, ~__CS_thread_lockedon.base, #memory_int, ~__THREAD_RUNNING, ~__CS_thread_born_round, ~__CS_ret;
{
  ...
  loc2_0:
    ...
    ~block := ~block[1 := main_~__CS_cp_block~31[1]];
    ~block := ~block[2 := main_~__CS_cp_block~31[2]];
    ~busy := ~busy[1 := main_~__CS_cp_busy~31[1]];
    ~busy := ~busy[2 := main_~__CS_cp_busy~31[2]];
    ~inode := ~inode[1 := main_~__CS_cp_inode~31[1]];
    ~inode := ~inode[2 := main_~__CS_cp_inode~31[2]];
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, ~#m_inode.base, main_~__CS_cp_m_inode~31[1], ~#m_inode.offset + 1;
    havoc #memory_int;
    assume #memory_int == write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]];
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, ~#m_inode.base, main_~__CS_cp_m_inode~31[2], ~#m_inode.offset + 2;
    havoc #memory_int;
    assume #memory_int == write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]];
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, ~#m_busy.base, main_~__CS_cp_m_busy~31[1], ~#m_busy.offset + 1;
    havoc #memory_int;
    assume #memory_int == write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]];
    write~int_old_#memory_int := #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, ~#m_busy.base, main_~__CS_cp_m_busy~31[2], ~#m_busy.offset + 2;
    havoc #memory_int;
    assume #memory_int == write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]];
    ~__CS_round := 0;
    ~__CS_thread_index := 0;
    ...
    assume (~__CS_thread_allocated[0] < 0 && !(~__CS_thread_allocated[0] + 256 == 1)) && -256 <= ~__CS_thread_allocated[0];
    assume (-256 <= ~__CS_thread_allocated[1] && ~__CS_thread_allocated[1] < 0) && !(~__CS_thread_allocated[1] + 256 == 1);
    assume ~__CS_thread_allocated[2] < -256 && !(~__CS_thread_allocated[2] % 256 == 1);
    assume ((main_~__CS_cp___CS_thread_status~31[1][0] < 256 + 256 && ~__CS_thread_status[0][0] % 256 == main_~__CS_cp___CS_thread_status~31[1][0] - 256) && 256 <= main_~__CS_cp___CS_thread_status~31[1][0]) && ~__CS_thread_status[0][0] < -256;
    assume ((~__CS_thread_status[1][0] == main_~__CS_cp___CS_thread_status~31[2][0] % 256 && ~__CS_thread_status[1][0] < 256) && 256 + 256 <= main_~__CS_cp___CS_thread_status~31[2][0]) && 0 <= ~__CS_thread_status[1][0];
    assume ((~__CS_thread_status[0][1] < 0 && 256 + 256 <= main_~__CS_cp___CS_thread_status~31[1][1]) && ~__CS_thread_status[0][1] + 256 == main_~__CS_cp___CS_thread_status~31[1][1] % 256) && -256 <= ~__CS_thread_status[0][1];
    assume (~__CS_thread_status[1][1] == main_~__CS_cp___CS_thread_status~31[2][1] - 256 && 0 <= ~__CS_thread_status[1][1]) && ~__CS_thread_status[1][1] < 256;
    assume ((-256 <= ~__CS_thread_status[0][2] && ~__CS_thread_status[0][2] < 0) && ~__CS_thread_status[0][2] + 256 == main_~__CS_cp___CS_thread_status~31[1][2] % 256) && 256 + 256 <= main_~__CS_cp___CS_thread_status~31[1][2];
    assume ((~__CS_thread_status[1][2] - 256 == main_~__CS_cp___CS_thread_status~31[2][2] % 256 && 256 <= ~__CS_thread_status[1][2]) && ~__CS_thread_status[1][2] < 256 + 256) && 256 + 256 <= main_~__CS_cp___CS_thread_status~31[2][2];
    ...
    assume ~block[0] == main_~__CS_cp_block~31[1];
    assume ~block[1] == main_~__CS_cp_block~31[2];
    assume ~busy[0] == main_~__CS_cp_busy~31[1];
    assume ~busy[1] == main_~__CS_cp_busy~31[2];
    assume ~inode[0] == main_~__CS_cp_inode~31[1];
    assume ~inode[1] == main_~__CS_cp_inode~31[2];
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := ~#m_inode.base, ~#m_inode.offset, 1;
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    main_#t~mem50 := read~int_#value;
    assume ((0 <= main_#t~mem50 && main_#t~mem50 < 256) && 256 + 256 <= main_~__CS_cp_m_inode~31[1]) && main_#t~mem50 == main_~__CS_cp_m_inode~31[1] % 256;
    havoc main_#t~mem50;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := ~#m_inode.base, ~#m_inode.offset + 1, 1;
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    main_#t~mem51 := read~int_#value;
    assume ((256 + 256 <= main_#t~mem51 && main_#t~mem51 % 256 == main_~__CS_cp_m_inode~31[2]) && 0 <= main_~__CS_cp_m_inode~31[2]) && main_~__CS_cp_m_inode~31[2] < 256;
    havoc main_#t~mem51;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := ~#m_busy.base, ~#m_busy.offset, 1;
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    main_#t~mem52 := read~int_#value;
    assume ((main_~__CS_cp_m_busy~31[1] < 256 + 256 && main_#t~mem52 < -256) && 256 <= main_~__CS_cp_m_busy~31[1]) && main_#t~mem52 % 256 == main_~__CS_cp_m_busy~31[1] - 256;
    havoc main_#t~mem52;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := ~#m_busy.base, ~#m_busy.offset + 1, 1;
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    main_#t~mem53 := read~int_#value;
    assume ((256 + 256 <= main_~__CS_cp_m_busy~31[2] && main_#t~mem53 < 256) && 0 <= main_#t~mem53) && main_#t~mem53 == main_~__CS_cp_m_busy~31[2] % 256;
    havoc main_#t~mem53;
  ...
  loc2_1:
    ...
    main_~i~31 := main_#t~post33 + 1;
    havoc main_#t~post33;
    goto loc1;
  loc3:
    assert false;
}
