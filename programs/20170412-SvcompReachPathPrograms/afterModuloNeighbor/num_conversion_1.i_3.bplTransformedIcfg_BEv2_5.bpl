...
modifies ;
{
  ...
  loc2_0:
    ...
    havoc main_~i~5;
    havoc main_~bit~5;
    assume (main_~bit~5 < 0 && !(main_~bit~5 + 256 == 0)) && -256 <= main_~bit~5;
    assume ((main_~i~5 < 256 + 256 && main_~y~4 < 256 + 256) && 256 <= main_~y~4) && 256 <= main_~i~5;
    main_~y~4 := main_~i~5 + main_~y~4 + -512;
    assume 0 <= main_~c~4 && main_~c~4 < 256;
    main_~c~4 := main_~c~4 + 1;
    goto loc1;
  loc2_1:
    assume !(main_~c~4 < 264) && main_~c~4 < 256 + 256;
