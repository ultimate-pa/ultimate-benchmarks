...
modifies ~__CS_round, ~__CS_thread.offset, ~__THREAD_UNUSED, v_rep#funAddr~main_thread.base_1, #NULL.offset, ~#empty.base, ~__THREAD_FINISHED, ~__CS_thread_lockedon.offset, ~__CS_ret_ERROR, ~#empty.offset, ~num, #length, ~#m.base, v_rep#funAddr~main_thread.offset_1, ~__CS_thread_allocated, ~#m.offset, ~__CS_thread.base, ~__CS_thread_status, ~__CS_thread_index, #NULL.base, ~#full.offset, ~__CS_error, #valid, ~__CS_ret_PREEMPTED, ~__CS_thread_lockedon.base, #memory_int, ~#full.base, ~__THREAD_RUNNING, ~__CS_thread_born_round, ~__CS_ret;
{
  ...
  loc2_0:
    ...
    assume (!(~__CS_thread_allocated[1] - 256 == 1) && 256 <= ~__CS_thread_allocated[1]) && ~__CS_thread_allocated[1] < 256 + 256;
    assume (!(~__CS_thread_allocated[2] + 256 == 1) && -256 <= ~__CS_thread_allocated[2]) && ~__CS_thread_allocated[2] < 0;
    assume (-256 <= main_~__CS_cp___CS_thread_status~33[1][0] && ~__CS_thread_status[0][0] == main_~__CS_cp___CS_thread_status~33[1][0] + 256) && main_~__CS_cp___CS_thread_status~33[1][0] < 0;
    assume ((~__CS_thread_status[0][1] == main_~__CS_cp___CS_thread_status~33[1][1] % 256 && ~__CS_thread_status[0][1] < 256) && 256 + 256 <= main_~__CS_cp___CS_thread_status~33[1][1]) && 0 <= ~__CS_thread_status[0][1];
    assume ((256 <= ~__CS_thread_status[0][2] && ~__CS_thread_status[0][2] < 256 + 256) && 256 + 256 <= main_~__CS_cp___CS_thread_status~33[1][2]) && ~__CS_thread_status[0][2] - 256 == main_~__CS_cp___CS_thread_status~33[1][2] % 256;
    assume ~__CS_thread_lockedon.base[0][0] == main_~__CS_cp___CS_thread_lockedon~33.base[1][0] && ~__CS_thread_lockedon.offset[0][0] == main_~__CS_cp___CS_thread_lockedon~33.offset[1][0];
    assume ~__CS_thread_lockedon.base[0][1] == main_~__CS_cp___CS_thread_lockedon~33.base[1][1] && ~__CS_thread_lockedon.offset[0][1] == main_~__CS_cp___CS_thread_lockedon~33.offset[1][1];
    assume ~__CS_thread_lockedon.base[0][2] == main_~__CS_cp___CS_thread_lockedon~33.base[1][2] && ~__CS_thread_lockedon.offset[0][2] == main_~__CS_cp___CS_thread_lockedon~33.offset[1][2];
    assume ~num[0] == main_~__CS_cp_num~33[1];
    ...
    assume (0 <= main_#t~mem52 && main_#t~mem52 == main_~__CS_cp_m~33[1]) && main_#t~mem52 < 256;
    havoc main_#t~mem52;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := ~#empty.base, ~#empty.offset, 1;
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    main_#t~mem53 := read~int_#value;
    assume (main_~__CS_cp_empty~33[1] < 256 + 256 && 256 <= main_~__CS_cp_empty~33[1]) && main_#t~mem53 - 256 == main_~__CS_cp_empty~33[1] - 256;
    havoc main_#t~mem53;
    read~int_#ptr.base, read~int_#ptr.offset, read~int_#sizeOfReadType := ~#full.base, ~#full.offset, 1;
    havoc read~int_#value;
    assume read~int_#value == #memory_int[read~int_#ptr.base][read~int_#ptr.offset];
    main_#t~mem54 := read~int_#value;
    assume (main_#t~mem54 == main_~__CS_cp_full~33[1] - 256 && 0 <= main_#t~mem54) && main_#t~mem54 < 256;
    havoc main_#t~mem54;
