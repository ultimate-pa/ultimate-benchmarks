...
modifies ~SIZE, #valid, #memory_int, #NULL.offset, #length, #NULL.base;
{
  ...
  loc0:
    ...
    assume 0 <= main_#t~nondet3 && main_#t~nondet3 < 4294967296;
    ~SIZE := main_#t~nondet3 / 8 + 1;
    ...
    assume (~SIZE <= 2147483647 && ~SIZE < 4294967296) && 0 <= ~SIZE;
    linear_search_#in~a.offset, linear_search_#in~a.base, linear_search_#in~q, linear_search_#in~n := main_~#a~7.offset, main_~#a~7.base, 3, ~SIZE;
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume ((!(linear_search_~j~5 % 4294967296 < linear_search_~n) && linear_search_~n < 4294967296) && 4294967296 + 4294967296 <= linear_search_~j~5) && 0 <= linear_search_~n;
    linear_search_#t~short1 := false;
    goto loc3;
  loc2_1:
    assume (((linear_search_~n < 4294967296 && 0 <= linear_search_~j~5) && linear_search_~j~5 < linear_search_~n) && 0 <= linear_search_~n) && linear_search_~j~5 < 4294967296;
  ...
  loc4_0:
    ...
    assume ((0 <= ~SIZE && 4294967296 + 4294967296 <= linear_search_~j~5) && ~SIZE < 4294967296) && !(linear_search_~j~5 % 4294967296 < ~SIZE);
