...
modifies ~a24, ~a17, ~a5, ~a7, ~a2;
{
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume ((((~a7 == 14 && 111 < ~a17) && ~a5 == 3) && ~a2 <= 189) && ~a17 <= 255) && ~a24 == 14;
    goto loc5;
  loc4_1:
    assume !(111 < ~a17);
    assume !(~a24 == 13);
    ...
    assume !(~a24 == 14);
    assume !(~a5 == 3);
    assume !(255 < ~a17) && !(111 < ~a17);
    assume !(~a5 == 6);
    assume !(~a5 == 4);
    assume !(~a24 == 15);
    assume !(~a7 == 14) && !(~a7 == 12);
    assume !(~a7 == 14);
    assume (((((~a7 == 14 && ~a2 <= 281) && ~a17 + 108 <= 0) && 189 < ~a2) && calculate_output_~input == 1) && ~a24 == 15) && ~a5 == 5;
    assume ((((5 * (~a17 % 109) < 29 && !(5 * (~a17 % 109) + 80 == 0)) && !(~a17 % 109 == 0)) && 0 <= 5 * (~a17 % 109) + 80) && ~a17 < -109) && ~a17 < 0;
