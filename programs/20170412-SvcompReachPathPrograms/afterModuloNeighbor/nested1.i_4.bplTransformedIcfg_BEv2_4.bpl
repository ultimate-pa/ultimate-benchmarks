...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume main_~x~4 < 0 && !(main_~x~4 + 4026531841 < 0);
    assume ((((0 <= main_~x~4 % 2 + 4294967294 && main_~x~4 < -2) && main_~x~4 % 2 <= 2147483647) && main_~x~4 < -4294967296) && !(main_~x~4 % 4294967296 < 0)) && main_~x~4 % 2 < 2;
