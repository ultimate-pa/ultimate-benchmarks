...
modifies ~pirp.base, #memory_$Pointer$.base, ~pirp.offset, #NULL.offset, ~customIrp, ~IPC, ~MPR3, #length, ~SKIP1, ~pended, ~DC, ~myStatus, ~compFptr.offset, ~MPR1, ~compRegistered, ~s, #NULL.base, ~myIrp_PendingReturned, ~UNLOADED, ~setEventCalled, #valid, ~routine, #memory_int, ~SKIP2, ~NP, ~lowerDriverReturn, ~compFptr.base, #memory_$Pointer$.offset;
{
    ...
    var CdAudioPower_~Irp.base : int;
    ...
    var CdAudioPower_#t~mem779.offset : int;
    var CdAudioPower_~Irp.offset : int;
    ...
    var CdAudioPower_#t~mem781.base : int;
    var main_~#irp~598.base : int;
    var CdAudioPower_~tmp~589 : int;
    var main_#t~mem802.offset : int;
    var #Ultimate.alloc_old_#valid : [int]int;
    var CdAudioPower_#t~mem777 : int;
    var write~int_#ptr.offset : int;
    var CdAudioPower_#in~Irp.offset : int;
    var main_~d~598.DriverSize : int;
    var CdAudioPower_#t~mem781.offset : int;
    ...
    var CdAudioPower_#t~mem779.base : int;
    ...
    var CdAudioPower_~DeviceObject.offset : int;
    var CdAudioPower_~DeviceObject.base : int;
    var CdAudioPower_#t~mem780.offset : int;
    ...
    var CdAudioPower_~deviceExtension~589.offset : int;
    var CdAudioPower_#in~DeviceObject.base : int;
    ...
    var CdAudioPower_#in~DeviceObject.offset : int;
    ...
    var CdAudioPower_#t~ret782 : int;
    ...
    var CdAudioPower_~deviceExtension~589.base : int;
    var CdAudioPower_#t~mem780.base : int;
    var main_~d~598.DriverSection.base : int;
    var main_#t~post793 : int;
    var CdAudioPower_#in~Irp.base : int;
  ...
  loc4_1:
    ...
    main_~a~598 := main_#t~post797 + 1;
    havoc main_#t~post797;
    goto loc3;
  loc5:
    goto loc6;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume !(main_~a~598 < 904);
    ~pirp.base, ~pirp.offset := main_~#irp~598.base, main_~#irp~598.offset;
    ~UNLOADED := 0;
    ~NP := 1;
    ~DC := 2;
    ~SKIP1 := 3;
    ...
    assume (~compFptr.base + ~compFptr.offset) % 4294967296 <= 2147483647 && ~compFptr.base + ~compFptr.offset < -4294967296;
    ~pended := (~compFptr.offset + ~compFptr.base) % 4294967296;
    write~int_old_#memory_$Pointer$.offset, write~int_old_#memory_$Pointer$.base, write~int_old_#memory_int := #memory_$Pointer$.offset, #memory_$Pointer$.base, #memory_int;
    ...
    assume 0 <= main_~status~598;
    assume !(main_~__BLAST_NONDET___0~598 == 2);
    assume !(main_~__BLAST_NONDET___0~598 == 3);
    assume main_~__BLAST_NONDET___0~598 == 4;
    CdAudioPower_#in~DeviceObject.offset, CdAudioPower_#in~Irp.base, CdAudioPower_#in~Irp.offset, CdAudioPower_#in~DeviceObject.base := main_~#devobj~598.offset, ~pirp.base, ~pirp.offset, main_~#devobj~598.base;
    havoc CdAudioPower_#res;
    havoc CdAudioPower_#t~mem780.offset, CdAudioPower_#t~ret782, CdAudioPower_#t~mem779.offset, CdAudioPower_#t~mem777, CdAudioPower_~deviceExtension~589.offset, CdAudioPower_~Irp.offset, CdAudioPower_~Irp.base, CdAudioPower_#t~mem781.offset, CdAudioPower_#t~mem779.base, CdAudioPower_#t~mem781.base, CdAudioPower_~deviceExtension~589.base, CdAudioPower_#t~mem780.base, CdAudioPower_~tmp~589, CdAudioPower_~DeviceObject.offset, CdAudioPower_~DeviceObject.base;
    CdAudioPower_~DeviceObject.offset, CdAudioPower_~DeviceObject.base := CdAudioPower_#in~DeviceObject.offset, CdAudioPower_#in~DeviceObject.base;
    CdAudioPower_~Irp.offset, CdAudioPower_~Irp.base := CdAudioPower_#in~Irp.offset, CdAudioPower_#in~Irp.base;
    havoc CdAudioPower_~deviceExtension~589.offset, CdAudioPower_~deviceExtension~589.base;
    havoc CdAudioPower_~tmp~589;
    assume !(~s == ~NP);
    goto loc7;
  loc6_1:
    assume main_~a~598 < 904;
    read~$Pointer$_#ptr.base, read~$Pointer$_#sizeOfReadType, read~$Pointer$_#ptr.offset := main_~#irp~598.base, 8, main_~#irp~598.offset + 20;
    havoc read~$Pointer$_#value.base, read~$Pointer$_#value.offset;
    assume read~$Pointer$_#value.base == #memory_$Pointer$.base[read~$Pointer$_#ptr.base][read~$Pointer$_#ptr.offset] && read~$Pointer$_#value.offset == #memory_$Pointer$.offset[read~$Pointer$_#ptr.base][read~$Pointer$_#ptr.offset];
    main_#t~mem802.offset, main_#t~mem802.base := read~$Pointer$_#value.offset, read~$Pointer$_#value.base;
    assume 0 <= main_#t~nondet803 + 128 && main_#t~nondet803 <= 127;
    write~int_old_#memory_$Pointer$.offset, write~int_old_#memory_$Pointer$.base, write~int_old_#memory_int := #memory_$Pointer$.offset, #memory_$Pointer$.base, #memory_int;
    write~int_#sizeOfWrittenType, write~int_#ptr.base, write~int_#value, write~int_#ptr.offset := 1, main_#t~mem802.base, main_#t~nondet803, main_#t~mem802.offset + main_~a~598;
    havoc #memory_$Pointer$.base, #memory_int, #memory_$Pointer$.offset;
    assume (#memory_$Pointer$.offset == write~int_old_#memory_$Pointer$.offset[write~int_#ptr.base := write~int_old_#memory_$Pointer$.offset[write~int_#ptr.base][write~int_#ptr.offset := #memory_$Pointer$.offset[write~int_#ptr.base][write~int_#ptr.offset]]] && #memory_$Pointer$.base == write~int_old_#memory_$Pointer$.base[write~int_#ptr.base := write~int_old_#memory_$Pointer$.base[write~int_#ptr.base][write~int_#ptr.offset := #memory_$Pointer$.base[write~int_#ptr.base][write~int_#ptr.offset]]]) && #memory_int == write~int_old_#memory_int[write~int_#ptr.base := write~int_old_#memory_int[write~int_#ptr.base][write~int_#ptr.offset := write~int_#value]];
    havoc main_#t~mem802.offset, main_#t~mem802.base;
    havoc main_#t~nondet803;
    main_#t~post801 := main_~a~598;
    main_~a~598 := main_#t~post801 + 1;
    havoc main_#t~post801;
    goto loc5;
  loc7:
    assert false;
}
