...
modifies ;
{
  ...
  loc0:
    ...
    havoc main_~b~33;
    havoc main_~r~33;
    main_~b~33 := main_#t~nondet0;
    havoc main_#t~nondet0;
    main_~a~33 := 234770789;
    ...
    havoc mp_add_~b3~5;
    mp_add_~na~5 := 4;
    assume (256 <= mp_add_~a3~5 && mp_add_~a3~5 < 256 + 256) && !(mp_add_~a3~5 - 256 == 0);
    mp_add_~nb~5 := 4;
    assume (mp_add_~b3~5 < 256 && !(mp_add_~b3~5 == 0)) && 0 <= mp_add_~b3~5;
    mp_add_~carry~5 := 0;
    mp_add_~i~5 := 0;
    assume (((((!(mp_add_~i~5 < mp_add_~na~5) && mp_add_~i~5 < 256) && -256 <= mp_add_~nb~5) && mp_add_~carry~5 == 0) && 0 <= mp_add_~i~5) && !(mp_add_~i~5 < mp_add_~nb~5 + 256)) && 0 <= mp_add_~na~5;
    goto loc1;
  loc1:
    goto loc2;
  loc2:
  ...
  loc2_0:
    ...
    goto loc1;
  loc2_1:
    assume 256 + 256 <= mp_add_~i~5 && !(mp_add_~i~5 % 256 < 4);
    havoc mp_add_~r~5;
    mp_add_#res := mp_add_~r~5;
    main_#t~ret1 := mp_add_#res;
    main_~r~33 := main_#t~ret1;
    havoc main_#t~ret1;
    assume ((4294967296 <= main_~r~33 && 4294967296 + 4294967296 <= main_~a~33 + main_~b~33) && !(main_~r~33 - 4294967296 == (main_~a~33 + main_~b~33) % 4294967296)) && main_~r~33 < 4294967296 + 4294967296;
