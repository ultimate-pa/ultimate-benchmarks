...
modifies #memory_$Pointer$.base, #valid, #memory_int, #NULL.offset, #length, #NULL.base, #memory_$Pointer$.offset;
{
  ...
  loc0:
    ...
    #valid := #valid[0 := 0];
    havoc main_#res;
    havoc main_#t~malloc4.offset, main_#t~mem10, main_#t~nondet1, main_#t~mem11, main_~p~6.offset, main_~t~6.base, main_#t~mem6.offset, main_~counter~6, main_#t~malloc4.base, main_~a~6.base, main_~hasSix~6, main_#t~malloc0.offset, main_#t~mem12.offset, main_~hasTwo~6, main_#t~post7, main_~p~6.base, main_#t~short2, main_#t~malloc0.base, main_~t~6.offset, main_~a~6.offset, main_#t~mem12.base, main_#t~mem6.base;
