...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume main_~i~5 < -4294967296 && !(main_~i~5 % 4294967296 < 10);
    ...
    main_~cont~5 := 0;
    main_~i~5 := 0;
    assume ((main_~i~5 < 4294967296 && !(main_~i~5 < main_~n_caracter~5 % 4294967296)) && main_~n_caracter~5 < -4294967296) && 0 <= main_~i~5;
    main_~i~5 := 0;
    main_~cont_aux~5 := 0;
    assume (0 <= main_~i~5 && main_~i~5 < 4294967296) && main_~string_entrada~5[main_~i~5] == 0;
    assume ((main_~cont_aux~5 < 4294967296 && 0 <= main_~cont_aux~5) && main_~cont~5 < -4294967296) && !(main_~cont_aux~5 == main_~cont~5 % 4294967296);
