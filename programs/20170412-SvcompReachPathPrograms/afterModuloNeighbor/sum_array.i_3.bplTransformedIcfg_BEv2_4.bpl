...
modifies ;
{
  ...
  loc2:
    goto loc2_0, loc2_1;
  loc2_0:
    assume ((0 <= main_~i~6 && 4294967296 + 4294967296 <= main_~M~6) && !(main_~i~6 < main_~M~6 % 4294967296)) && main_~i~6 < 4294967296;
    main_~i~6 := 0;
    goto loc3;
  loc2_1:
    assume ((0 <= main_~i~6 && main_~i~6 < main_~M~6) && 0 <= main_~M~6) && main_~M~6 < 4294967296;
  ...
  loc4:
    goto loc4_0, loc4_1;
  loc4_0:
    assume ((main_~i~6 < 4294967296 && main_~i~6 < main_~M~6 % 4294967296) && 4294967296 + 4294967296 <= main_~M~6) && 0 <= main_~i~6;
    ...
    goto loc3;
  loc4_1:
    assume ((4294967296 + 4294967296 <= main_~M~6 && !(main_~i~6 < main_~M~6 % 4294967296 + 4294967296)) && 4294967296 <= main_~i~6) && main_~i~6 < 4294967296 + 4294967296;
    main_~i~6 := 0;
    goto loc5;
  loc5:
    goto loc6;
  loc6:
    goto loc6_0, loc6_1;
  loc6_0:
    assume ((main_~i~6 < 4294967296 + 4294967296 && 4294967296 + 4294967296 <= main_~M~6) && 4294967296 <= main_~i~6) && !(main_~i~6 < main_~M~6 % 4294967296 + 4294967296);
    main_~i~6 := 0;
    assume ((0 <= main_~i~6 && 4294967296 + 4294967296 <= main_~M~6) && main_~i~6 < 4294967296) && main_~i~6 < main_~M~6 % 4294967296;
    ...
    goto loc7;
  loc6_1:
    assume ((main_~i~6 < main_~M~6 % 4294967296 && 0 <= main_~i~6) && main_~i~6 < 4294967296) && 4294967296 + 4294967296 <= main_~M~6;
    assume 0 <= main_~i~6 && main_~i~6 < 4294967296;
