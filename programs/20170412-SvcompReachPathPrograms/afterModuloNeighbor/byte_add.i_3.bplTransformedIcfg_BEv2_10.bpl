...
modifies ;
{
  ...
  loc0:
    ...
    havoc mp_add_~b3~5;
    mp_add_~na~5 := 4;
    assume (0 <= mp_add_~a3~5 && !(mp_add_~a3~5 == 0)) && mp_add_~a3~5 < 256;
    mp_add_~nb~5 := 4;
  ...
  loc2_1:
    ...
    havoc main_#t~ret2;
    assume ((main_~r~33 < 4294967296 && main_~a~33 + main_~b~33 < -4294967296) && !(main_~r~33 == (main_~a~33 + main_~b~33) % 4294967296)) && 0 <= main_~r~33;
