...
modifies ;
{
  ...
  loc0:
    havoc main_#res;
    havoc main_#t~nondet0, main_~dst~5, main_~src~5, main_~j~5, main_~i~5;
    havoc main_~src~5;
    havoc main_~dst~5;
    main_~i~5 := 0;
    main_~j~5 := 0;
  ...
  loc2_0:
    ...
    main_~i~5 := 0;
    assume !(main_~src~5[main_~i~5] == 0) && main_~i~5 < 100000;
    assume !(main_~dst~5[main_~i~5] == main_~src~5[main_~i~5]);
