...
const ~ldv_21573~SS_FREE : int;
const ~ldv_21573~SS_UNCONNECTED : int;
const ~ldv_21573~SS_CONNECTING : int;
const ~ldv_21573~SS_CONNECTED : int;
const ~ldv_21573~SS_DISCONNECTING : int;
...
const ~ldv_27931~NETREG_UNINITIALIZED : int;
const ~ldv_27931~NETREG_REGISTERED : int;
const ~ldv_27931~NETREG_UNREGISTERING : int;
const ~ldv_27931~NETREG_UNREGISTERED : int;
const ~ldv_27931~NETREG_RELEASED : int;
const ~ldv_27931~NETREG_DUMMY : int;
const ~ldv_27932~RTNL_LINK_INITIALIZED : int;
const ~ldv_27932~RTNL_LINK_INITIALIZING : int;
...
axiom ~ldv_21573~SS_FREE == 0;
axiom ~ldv_21573~SS_UNCONNECTED == 1;
axiom ~ldv_21573~SS_CONNECTING == 2;
axiom ~ldv_21573~SS_CONNECTED == 3;
axiom ~ldv_21573~SS_DISCONNECTING == 4;
...
axiom ~ldv_27931~NETREG_UNINITIALIZED == 0;
axiom ~ldv_27931~NETREG_REGISTERED == 1;
axiom ~ldv_27931~NETREG_UNREGISTERING == 2;
axiom ~ldv_27931~NETREG_UNREGISTERED == 3;
axiom ~ldv_27931~NETREG_RELEASED == 4;
axiom ~ldv_27931~NETREG_DUMMY == 5;
axiom ~ldv_27932~RTNL_LINK_INITIALIZED == 0;
axiom ~ldv_27932~RTNL_LINK_INITIALIZING == 1;
...
modifies #valid, #length, #memory_$Pointer$.base, #memory_$Pointer$.offset, #memory_int, ~lbs_dir.base, ~lbs_dir.offset;
