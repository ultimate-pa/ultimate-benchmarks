...
implementation #Ultimate.C_memset(#ptr.base : int, #ptr.offset : int, #value : int, #amount : int) returns (#res.base : int, #res.offset : int){
  ...
  loc1:
    goto loc1_0, loc1_1;
  loc1_0:
    assume #t~loopctr4679 < #amount;
    #memory_int := #memory_int[#ptr.base,#ptr.offset + #t~loopctr4679 * 1 := #value];
    #memory_$Pointer$.base, #memory_$Pointer$.offset := #memory_$Pointer$.base[#ptr.base,#ptr.offset + #t~loopctr4679 * 1 := 0], #memory_$Pointer$.offset[#ptr.base,#ptr.offset + #t~loopctr4679 * 1 := #value % 256];
    #t~loopctr4679 := #t~loopctr4679 + 1;
    goto loc1;
  loc1_1:
    assume !(#t~loopctr4679 < #amount);
...
implementation lbs_init_module() returns (#res : int){
    var #t~ret3584 : int;
    var #t~nondet3585.base : int, #t~nondet3585.offset : int;
    var #t~ret3586 : int;
    var #t~memset3587.base : int, #t~memset3587.offset : int;
    var #t~ret3591 : int;
    var #t~nondet3592.base : int, #t~nondet3592.offset : int;
    var #t~ret3593 : int;
    var ~tmp~4834 : int;
    var ~tmp___0~4834 : int;

  loc4:
    havoc ~tmp~4834;
    havoc ~tmp___0~4834;
    assume !(~bitwiseAnd(~lbs_debug, 5) % 4294967296 == 5);
    call #t~memset3587.base, #t~memset3587.offset := #Ultimate.C_memset(~#confirm_sleep.base, ~#confirm_sleep.offset, 0, 18);
    havoc #t~memset3587.base, #t~memset3587.offset;
...
implementation ldv_undef_int() returns (#res : int){
    var #t~nondet4660 : int;
    var ~tmp~6484 : int;

  loc5:
    havoc ~tmp~6484;
    assume -2147483648 <= #t~nondet4660 && #t~nondet4660 <= 2147483647;
    ~tmp~6484 := #t~nondet4660;
    havoc #t~nondet4660;
    #res := ~tmp~6484;
    assume true;
    return;
...
implementation ldv_entry_EMGentry_38(#in~arg0.base : int, #in~arg0.offset : int) returns (){
  ...
  loc12_1:
    ...
    call #t~ret3760 := ldv_EMGentry_init_lbs_init_module_38_13(~ldv_38_init_lbs_init_module_default.base, ~ldv_38_init_lbs_init_module_default.offset);
    assume -2147483648 <= #t~ret3760 && #t~ret3760 <= 2147483647;
    ~ldv_38_ret_default := #t~ret3760;
    havoc #t~ret3760;
    call #t~ret3761 := ldv_post_init(~ldv_38_ret_default);
    assume -2147483648 <= #t~ret3761 && #t~ret3761 <= 2147483647;
    ~ldv_38_ret_default := #t~ret3761;
    havoc #t~ret3761;
    call #t~ret3762 := ldv_undef_int();
    assume -2147483648 <= #t~ret3762 && #t~ret3762 <= 2147483647;
    ~tmp___0~4939 := #t~ret3762;
    havoc #t~ret3762;
    assume ~tmp___0~4939 != 0;
    ~ldv_statevar_38 := 10;
    assume true;
    return;
}
...
implementation ULTIMATE.init() returns (){
    ...
    var #t~nondet2392.base : int, #t~nondet2392.offset : int;
    ...
    var #t~nondet4258.base : int, #t~nondet4258.offset : int;
    var #t~nondet4259.base : int, #t~nondet4259.offset : int;
    var #t~nondet4260.base : int, #t~nondet4260.offset : int;
    var #t~nondet4383.base : int, #t~nondet4383.offset : int;
    var #t~nondet4384.base : int, #t~nondet4384.offset : int;
    var #t~nondet4385.base : int, #t~nondet4385.offset : int;
  ...
  loc13:
    ...
    call #t~nondet2392.base, #t~nondet2392.offset := #Ultimate.alloc(5);
    #memory_int := #memory_int[#t~nondet2392.base,#t~nondet2392.offset + 0 := 105];
    #memory_int := #memory_int[#t~nondet2392.base,#t~nondet2392.offset + 1 := 110];
    #memory_int := #memory_int[#t~nondet2392.base,#t~nondet2392.offset + 2 := 102];
    #memory_int := #memory_int[#t~nondet2392.base,#t~nondet2392.offset + 3 := 111];
    #memory_int := #memory_int[#t~nondet2392.base,#t~nondet2392.offset + 4 := 0];
    call write~$Pointer$(#t~nondet2392.base, #t~nondet2392.offset, ~#debugfs_files.base, ~#debugfs_files.offset + 0 + 0, 8);
    ...
    call #t~nondet2393.base, #t~nondet2393.offset := #Ultimate.alloc(12);
    call write~$Pointer$(#t~nondet2393.base, #t~nondet2393.offset, ~#debugfs_files.base, ~#debugfs_files.offset + 226 + 0, 8);
    ...
    call #t~nondet2394.base, #t~nondet2394.offset := #Ultimate.alloc(10);
    call write~$Pointer$(#t~nondet2394.base, #t~nondet2394.offset, ~#debugfs_files.base, ~#debugfs_files.offset + 452 + 0, 8);
    ...
    havoc #t~nondet2392.base, #t~nondet2392.offset;
    ...
    call #t~nondet2395.base, #t~nondet2395.offset := #Ultimate.alloc(9);
    call write~$Pointer$(#t~nondet2395.base, #t~nondet2395.offset, ~#debugfs_events_files.base, ~#debugfs_events_files.offset + 0 + 0, 8);
    ...
    call #t~nondet2396.base, #t~nondet2396.offset := #Ultimate.alloc(8);
    call write~$Pointer$(#t~nondet2396.base, #t~nondet2396.offset, ~#debugfs_events_files.base, ~#debugfs_events_files.offset + 226 + 0, 8);
    ...
    call #t~nondet2397.base, #t~nondet2397.offset := #Ultimate.alloc(14);
    call write~$Pointer$(#t~nondet2397.base, #t~nondet2397.offset, ~#debugfs_events_files.base, ~#debugfs_events_files.offset + 452 + 0, 8);
    ...
    call write~$Pointer$(#t~nondet2398.base, #t~nondet2398.offset, ~#debugfs_events_files.base, ~#debugfs_events_files.offset + 678 + 0, 8);
    ...
    call write~$Pointer$(#t~nondet2399.base, #t~nondet2399.offset, ~#debugfs_events_files.base, ~#debugfs_events_files.offset + 904 + 0, 8);
    ...
    call #t~nondet2400.base, #t~nondet2400.offset := #Ultimate.alloc(9);
    call write~$Pointer$(#t~nondet2400.base, #t~nondet2400.offset, ~#debugfs_events_files.base, ~#debugfs_events_files.offset + 1130 + 0, 8);
    ...
    call #t~nondet2401.base, #t~nondet2401.offset := #Ultimate.alloc(6);
    #memory_int := #memory_int[#t~nondet2401.base,#t~nondet2401.offset + 0 := 114];
    #memory_int := #memory_int[#t~nondet2401.base,#t~nondet2401.offset + 1 := 100];
    #memory_int := #memory_int[#t~nondet2401.base,#t~nondet2401.offset + 2 := 109];
    #memory_int := #memory_int[#t~nondet2401.base,#t~nondet2401.offset + 3 := 97];
    #memory_int := #memory_int[#t~nondet2401.base,#t~nondet2401.offset + 4 := 99];
    #memory_int := #memory_int[#t~nondet2401.base,#t~nondet2401.offset + 5 := 0];
    call write~$Pointer$(#t~nondet2401.base, #t~nondet2401.offset, ~#debugfs_regs_files.base, ~#debugfs_regs_files.offset + 0 + 0, 8);
    ...
    #memory_int := #memory_int[#t~nondet2402.base,#t~nondet2402.offset + 0 := 119];
    #memory_int := #memory_int[#t~nondet2402.base,#t~nondet2402.offset + 1 := 114];
    ...
    call write~$Pointer$(#t~nondet2402.base, #t~nondet2402.offset, ~#debugfs_regs_files.base, ~#debugfs_regs_files.offset + 226 + 0, 8);
    ...
    #memory_int := #memory_int[#t~nondet2403.base,#t~nondet2403.offset + 0 := 114];
    #memory_int := #memory_int[#t~nondet2403.base,#t~nondet2403.offset + 1 := 100];
    #memory_int := #memory_int[#t~nondet2403.base,#t~nondet2403.offset + 2 := 98];
    #memory_int := #memory_int[#t~nondet2403.base,#t~nondet2403.offset + 3 := 98];
    #memory_int := #memory_int[#t~nondet2403.base,#t~nondet2403.offset + 4 := 112];
    #memory_int := #memory_int[#t~nondet2403.base,#t~nondet2403.offset + 5 := 0];
    call write~$Pointer$(#t~nondet2403.base, #t~nondet2403.offset, ~#debugfs_regs_files.base, ~#debugfs_regs_files.offset + 452 + 0, 8);
    ...
    #memory_int := #memory_int[#t~nondet2404.base,#t~nondet2404.offset + 0 := 119];
    #memory_int := #memory_int[#t~nondet2404.base,#t~nondet2404.offset + 1 := 114];
    ...
    call write~$Pointer$(#t~nondet2404.base, #t~nondet2404.offset, ~#debugfs_regs_files.base, ~#debugfs_regs_files.offset + 678 + 0, 8);
    ...
    call #t~nondet2405.base, #t~nondet2405.offset := #Ultimate.alloc(5);
    #memory_int := #memory_int[#t~nondet2405.base,#t~nondet2405.offset + 0 := 114];
    #memory_int := #memory_int[#t~nondet2405.base,#t~nondet2405.offset + 1 := 100];
    #memory_int := #memory_int[#t~nondet2405.base,#t~nondet2405.offset + 2 := 114];
    #memory_int := #memory_int[#t~nondet2405.base,#t~nondet2405.offset + 3 := 102];
    #memory_int := #memory_int[#t~nondet2405.base,#t~nondet2405.offset + 4 := 0];
    call write~$Pointer$(#t~nondet2405.base, #t~nondet2405.offset, ~#debugfs_regs_files.base, ~#debugfs_regs_files.offset + 904 + 0, 8);
    ...
    #memory_int := #memory_int[#t~nondet2406.base,#t~nondet2406.offset + 0 := 119];
    #memory_int := #memory_int[#t~nondet2406.base,#t~nondet2406.offset + 1 := 114];
    ...
    call write~$Pointer$(#t~nondet2406.base, #t~nondet2406.offset, ~#debugfs_regs_files.base, ~#debugfs_regs_files.offset + 1130 + 0, 8);
    ...
    call #t~nondet4258.base, #t~nondet4258.offset := #Ultimate.alloc(9);
    call write~$Pointer$(#t~nondet4258.base, #t~nondet4258.offset, ~#dev_attr_lbs_mesh.base, ~#dev_attr_lbs_mesh.offset + 0 + 0, 8);
    ...
    havoc #t~nondet4258.base, #t~nondet4258.offset;
    call ~#dev_attr_anycast_mask.base, ~#dev_attr_anycast_mask.offset := #Ultimate.alloc(43);
    call #t~nondet4259.base, #t~nondet4259.offset := #Ultimate.alloc(13);
    call write~$Pointer$(#t~nondet4259.base, #t~nondet4259.offset, ~#dev_attr_anycast_mask.base, ~#dev_attr_anycast_mask.offset + 0 + 0, 8);
    ...
    havoc #t~nondet4259.base, #t~nondet4259.offset;
    call ~#dev_attr_prb_rsp_limit.base, ~#dev_attr_prb_rsp_limit.offset := #Ultimate.alloc(43);
    call #t~nondet4260.base, #t~nondet4260.offset := #Ultimate.alloc(14);
    call write~$Pointer$(#t~nondet4260.base, #t~nondet4260.offset, ~#dev_attr_prb_rsp_limit.base, ~#dev_attr_prb_rsp_limit.offset + 0 + 0, 8);
    ...
    havoc #t~nondet4260.base, #t~nondet4260.offset;
    ...
    call #t~nondet4383.base, #t~nondet4383.offset := #Ultimate.alloc(9);
    call write~$Pointer$(#t~nondet4383.base, #t~nondet4383.offset, ~#dev_attr_bootflag.base, ~#dev_attr_bootflag.offset + 0 + 0, 8);
    ...
    havoc #t~nondet4383.base, #t~nondet4383.offset;
    call ~#dev_attr_boottime.base, ~#dev_attr_boottime.offset := #Ultimate.alloc(43);
    call #t~nondet4384.base, #t~nondet4384.offset := #Ultimate.alloc(9);
    call write~$Pointer$(#t~nondet4384.base, #t~nondet4384.offset, ~#dev_attr_boottime.base, ~#dev_attr_boottime.offset + 0 + 0, 8);
    ...
    havoc #t~nondet4384.base, #t~nondet4384.offset;
    call ~#dev_attr_channel.base, ~#dev_attr_channel.offset := #Ultimate.alloc(43);
    call #t~nondet4385.base, #t~nondet4385.offset := #Ultimate.alloc(8);
    call write~$Pointer$(#t~nondet4385.base, #t~nondet4385.offset, ~#dev_attr_channel.base, ~#dev_attr_channel.offset + 0 + 0, 8);
    ...
    havoc #t~nondet4385.base, #t~nondet4385.offset;
    call ~#dev_attr_mesh_id.base, ~#dev_attr_mesh_id.offset := #Ultimate.alloc(43);
    call #t~nondet4386.base, #t~nondet4386.offset := #Ultimate.alloc(8);
    call write~$Pointer$(#t~nondet4386.base, #t~nondet4386.offset, ~#dev_attr_mesh_id.base, ~#dev_attr_mesh_id.offset + 0 + 0, 8);
    ...
    call #t~nondet4387.base, #t~nondet4387.offset := #Ultimate.alloc(12);
    call write~$Pointer$(#t~nondet4387.base, #t~nondet4387.offset, ~#dev_attr_protocol_id.base, ~#dev_attr_protocol_id.offset + 0 + 0, 8);
    ...
    call #t~nondet4388.base, #t~nondet4388.offset := #Ultimate.alloc(10);
    call write~$Pointer$(#t~nondet4388.base, #t~nondet4388.offset, ~#dev_attr_metric_id.base, ~#dev_attr_metric_id.offset + 0 + 0, 8);
    ...
    call #t~nondet4389.base, #t~nondet4389.offset := #Ultimate.alloc(11);
    call write~$Pointer$(#t~nondet4389.base, #t~nondet4389.offset, ~#dev_attr_capability.base, ~#dev_attr_capability.offset + 0 + 0, 8);
    ...
    call #t~nondet4390.base, #t~nondet4390.offset := #Ultimate.alloc(13);
    call write~$Pointer$(#t~nondet4390.base, #t~nondet4390.offset, ~#boot_opts_group.base, ~#boot_opts_group.offset + 0, 8);
    ...
    call #t~nondet4391.base, #t~nondet4391.offset := #Ultimate.alloc(8);
    call write~$Pointer$(#t~nondet4391.base, #t~nondet4391.offset, ~#mesh_ie_group.base, ~#mesh_ie_group.offset + 0, 8);
...
implementation ldv_post_init(#in~init_ret_val : int) returns (#res : int){
  ...
  loc20:
    ...
    havoc ~tmp~6445;
    call #t~ret4645 := ldv_filter_positive_int(~init_ret_val);
    assume -2147483648 <= #t~ret4645 && #t~ret4645 <= 2147483647;
    ~tmp~6445 := #t~ret4645;
    havoc #t~ret4645;
    #res := ~tmp~6445;
    assume true;
...
implementation lbs_debugfs_init() returns (){
    ...
    var #t~ret2408.base : int, #t~ret2408.offset : int;
...
implementation ldv_EMGentry_init_lbs_init_module_38_13(#in~arg0.base : int, #in~arg0.offset : int) returns (#res : int){
  ...
  loc22:
    ~arg0.base, ~arg0.offset := #in~arg0.base, #in~arg0.offset;
    havoc ~tmp~4909;
    call #t~ret3606 := lbs_init_module();
    assume -2147483648 <= #t~ret3606 && #t~ret3606 <= 2147483647;
    ~tmp~4909 := #t~ret3606;
    havoc #t~ret3606;
    #res := ~tmp~4909;
    assume true;
...
implementation ldv_allocate_external_0() returns (){
    ...
    var ~tmp~4912.base : int, ~tmp~4912.offset : int;
    var ~tmp___0~4912.base : int, ~tmp___0~4912.offset : int;
    var ~tmp___1~4912.base : int, ~tmp___1~4912.offset : int;
    var ~tmp___2~4912.base : int, ~tmp___2~4912.offset : int;
    var ~tmp___3~4912.base : int, ~tmp___3~4912.offset : int;
    var ~tmp___4~4912.base : int, ~tmp___4~4912.offset : int;
    var ~tmp___5~4912.base : int, ~tmp___5~4912.offset : int;
    var ~tmp___6~4912.base : int, ~tmp___6~4912.offset : int;
    var ~tmp___7~4912.base : int, ~tmp___7~4912.offset : int;
    var ~tmp___8~4912.base : int, ~tmp___8~4912.offset : int;
    var ~tmp___9~4912.base : int, ~tmp___9~4912.offset : int;
    var ~tmp___10~4912.base : int, ~tmp___10~4912.offset : int;
    var ~tmp___11~4912.base : int, ~tmp___11~4912.offset : int;
    var ~tmp___12~4912.base : int, ~tmp___12~4912.offset : int;
    var ~tmp___13~4912.base : int, ~tmp___13~4912.offset : int;
    var ~tmp___14~4912.base : int, ~tmp___14~4912.offset : int;
    var ~tmp___15~4912.base : int, ~tmp___15~4912.offset : int;
    var ~tmp___16~4912.base : int, ~tmp___16~4912.offset : int;
    var ~tmp___17~4912.base : int, ~tmp___17~4912.offset : int;
    var ~tmp___18~4912.base : int, ~tmp___18~4912.offset : int;
    var ~tmp___19~4912.base : int, ~tmp___19~4912.offset : int;
    var ~tmp___20~4912.base : int, ~tmp___20~4912.offset : int;
    var ~tmp___21~4912.base : int, ~tmp___21~4912.offset : int;
    var ~tmp___22~4912.base : int, ~tmp___22~4912.offset : int;
    var ~tmp___23~4912.base : int, ~tmp___23~4912.offset : int;
    var ~tmp___24~4912.base : int, ~tmp___24~4912.offset : int;
    var ~tmp___25~4912.base : int, ~tmp___25~4912.offset : int;
    var ~tmp___26~4912.base : int, ~tmp___26~4912.offset : int;
    var ~tmp___27~4912.base : int, ~tmp___27~4912.offset : int;
    var ~tmp___28~4912.base : int, ~tmp___28~4912.offset : int;
    var ~tmp___29~4912.base : int, ~tmp___29~4912.offset : int;
    var ~tmp___30~4912.base : int, ~tmp___30~4912.offset : int;
    var ~tmp___31~4912.base : int, ~tmp___31~4912.offset : int;
    var ~tmp___32~4912.base : int, ~tmp___32~4912.offset : int;
    var ~tmp___33~4912.base : int, ~tmp___33~4912.offset : int;
    var ~tmp___34~4912.base : int, ~tmp___34~4912.offset : int;
    var ~tmp___35~4912.base : int, ~tmp___35~4912.offset : int;
    var ~tmp___36~4912.base : int, ~tmp___36~4912.offset : int;
    var ~tmp___37~4912.base : int, ~tmp___37~4912.offset : int;
    var ~tmp___38~4912.base : int, ~tmp___38~4912.offset : int;
    var ~tmp___39~4912.base : int, ~tmp___39~4912.offset : int;
    var ~tmp___40~4912.base : int, ~tmp___40~4912.offset : int;
    var ~tmp___41~4912.base : int, ~tmp___41~4912.offset : int;
    var ~tmp___42~4912.base : int, ~tmp___42~4912.offset : int;
    var ~tmp___43~4912.base : int, ~tmp___43~4912.offset : int;
    var ~tmp___44~4912.base : int, ~tmp___44~4912.offset : int;
    var ~tmp___45~4912.base : int, ~tmp___45~4912.offset : int;
    var ~tmp___46~4912.base : int, ~tmp___46~4912.offset : int;
    var ~tmp___47~4912.base : int, ~tmp___47~4912.offset : int;
    var ~tmp___48~4912.base : int, ~tmp___48~4912.offset : int;
    var ~tmp___49~4912.base : int, ~tmp___49~4912.offset : int;
    var ~tmp___50~4912.base : int, ~tmp___50~4912.offset : int;
    var ~tmp___51~4912.base : int, ~tmp___51~4912.offset : int;
    var ~tmp___52~4912.base : int, ~tmp___52~4912.offset : int;
    var ~tmp___53~4912.base : int, ~tmp___53~4912.offset : int;
    var ~tmp___54~4912.base : int, ~tmp___54~4912.offset : int;
    var ~tmp___55~4912.base : int, ~tmp___55~4912.offset : int;
    var ~tmp___56~4912.base : int, ~tmp___56~4912.offset : int;
    var ~tmp___57~4912.base : int, ~tmp___57~4912.offset : int;
    var ~tmp___58~4912.base : int, ~tmp___58~4912.offset : int;
    var ~tmp___59~4912.base : int, ~tmp___59~4912.offset : int;
    var ~tmp___60~4912.base : int, ~tmp___60~4912.offset : int;
    var ~tmp___61~4912.base : int, ~tmp___61~4912.offset : int;
    var ~tmp___62~4912.base : int, ~tmp___62~4912.offset : int;
    var ~tmp___63~4912.base : int, ~tmp___63~4912.offset : int;
    var ~tmp___64~4912.base : int, ~tmp___64~4912.offset : int;
    var ~tmp___65~4912.base : int, ~tmp___65~4912.offset : int;
    var ~tmp___66~4912.base : int, ~tmp___66~4912.offset : int;
    var ~tmp___67~4912.base : int, ~tmp___67~4912.offset : int;
    var ~tmp___68~4912.base : int, ~tmp___68~4912.offset : int;
    var ~tmp___69~4912.base : int, ~tmp___69~4912.offset : int;
    var ~tmp___70~4912.base : int, ~tmp___70~4912.offset : int;
    var ~tmp___71~4912.base : int, ~tmp___71~4912.offset : int;
    var ~tmp___72~4912.base : int, ~tmp___72~4912.offset : int;
    var ~tmp___73~4912.base : int, ~tmp___73~4912.offset : int;
    var ~tmp___74~4912.base : int, ~tmp___74~4912.offset : int;
    var ~tmp___75~4912.base : int, ~tmp___75~4912.offset : int;
    var ~tmp___76~4912.base : int, ~tmp___76~4912.offset : int;
    var ~tmp___77~4912.base : int, ~tmp___77~4912.offset : int;
    var ~tmp___78~4912.base : int, ~tmp___78~4912.offset : int;
    var ~tmp___79~4912.base : int, ~tmp___79~4912.offset : int;
    var ~tmp___80~4912.base : int, ~tmp___80~4912.offset : int;
    var ~tmp___81~4912.base : int, ~tmp___81~4912.offset : int;
    var ~tmp___82~4912.base : int, ~tmp___82~4912.offset : int;
    var ~tmp___83~4912.base : int, ~tmp___83~4912.offset : int;
    var ~tmp___84~4912.base : int, ~tmp___84~4912.offset : int;
    var ~tmp___85~4912.base : int, ~tmp___85~4912.offset : int;
    var ~tmp___86~4912.base : int, ~tmp___86~4912.offset : int;
    var ~tmp___87~4912.base : int, ~tmp___87~4912.offset : int;
    var ~tmp___88~4912.base : int, ~tmp___88~4912.offset : int;
    var ~tmp___89~4912.base : int, ~tmp___89~4912.offset : int;
    var ~tmp___90~4912.base : int, ~tmp___90~4912.offset : int;
    var ~tmp___91~4912.base : int, ~tmp___91~4912.offset : int;
    var ~tmp___92~4912.base : int, ~tmp___92~4912.offset : int;
    var ~tmp___93~4912.base : int, ~tmp___93~4912.offset : int;
    var ~tmp___94~4912.base : int, ~tmp___94~4912.offset : int;
    var ~tmp___95~4912.base : int, ~tmp___95~4912.offset : int;
    var ~tmp___96~4912.base : int, ~tmp___96~4912.offset : int;
    var ~tmp___97~4912.base : int, ~tmp___97~4912.offset : int;
    var ~tmp___98~4912.base : int, ~tmp___98~4912.offset : int;
    var ~tmp___99~4912.base : int, ~tmp___99~4912.offset : int;
    var ~tmp___100~4912.base : int, ~tmp___100~4912.offset : int;
    var ~tmp___101~4912.base : int, ~tmp___101~4912.offset : int;
    var ~tmp___102~4912.base : int, ~tmp___102~4912.offset : int;
    var ~tmp___103~4912.base : int, ~tmp___103~4912.offset : int;
    var ~tmp___104~4912.base : int, ~tmp___104~4912.offset : int;
    var ~tmp___105~4912.base : int, ~tmp___105~4912.offset : int;
    var ~tmp___106~4912.base : int, ~tmp___106~4912.offset : int;
    var ~tmp___107~4912.base : int, ~tmp___107~4912.offset : int;
    var ~tmp___108~4912.base : int, ~tmp___108~4912.offset : int;
    var ~tmp___109~4912.base : int, ~tmp___109~4912.offset : int;
    var ~tmp___110~4912.base : int, ~tmp___110~4912.offset : int;
    var ~tmp___111~4912.base : int, ~tmp___111~4912.offset : int;
    var ~tmp___112~4912.base : int, ~tmp___112~4912.offset : int;
    var ~tmp___113~4912.base : int, ~tmp___113~4912.offset : int;
    var ~tmp___114~4912.base : int, ~tmp___114~4912.offset : int;
    var ~tmp___115~4912.base : int, ~tmp___115~4912.offset : int;
    var ~tmp___116~4912.base : int, ~tmp___116~4912.offset : int;
    var ~tmp___117~4912.base : int, ~tmp___117~4912.offset : int;
    var ~tmp___118~4912.base : int, ~tmp___118~4912.offset : int;
    var ~tmp___119~4912.base : int, ~tmp___119~4912.offset : int;
    var ~tmp___120~4912.base : int, ~tmp___120~4912.offset : int;
    var ~tmp___121~4912.base : int, ~tmp___121~4912.offset : int;
    var ~tmp___122~4912.base : int, ~tmp___122~4912.offset : int;
    var ~tmp___123~4912.base : int, ~tmp___123~4912.offset : int;
    var ~tmp___124~4912.base : int, ~tmp___124~4912.offset : int;
    var ~tmp___125~4912.base : int, ~tmp___125~4912.offset : int;
    var ~tmp___126~4912.base : int, ~tmp___126~4912.offset : int;
    var ~tmp___127~4912.base : int, ~tmp___127~4912.offset : int;
    var ~tmp___128~4912.base : int, ~tmp___128~4912.offset : int;
    var ~tmp___129~4912.base : int, ~tmp___129~4912.offset : int;
    var ~tmp___130~4912.base : int, ~tmp___130~4912.offset : int;
    var ~tmp___131~4912.base : int, ~tmp___131~4912.offset : int;
    var ~tmp___132~4912.base : int, ~tmp___132~4912.offset : int;
    var ~tmp___133~4912.base : int, ~tmp___133~4912.offset : int;
    var ~tmp___134~4912.base : int, ~tmp___134~4912.offset : int;
    var ~tmp___135~4912.base : int, ~tmp___135~4912.offset : int;
    var ~tmp___136~4912.base : int, ~tmp___136~4912.offset : int;
    var ~tmp___137~4912.base : int, ~tmp___137~4912.offset : int;
    var ~tmp___138~4912.base : int, ~tmp___138~4912.offset : int;
    var ~tmp___139~4912.base : int, ~tmp___139~4912.offset : int;
    var ~tmp___140~4912.base : int, ~tmp___140~4912.offset : int;
    var ~tmp___141~4912.base : int, ~tmp___141~4912.offset : int;
    var ~tmp___142~4912.base : int, ~tmp___142~4912.offset : int;
    var ~tmp___143~4912.base : int, ~tmp___143~4912.offset : int;
    var ~tmp___144~4912.base : int, ~tmp___144~4912.offset : int;
    var ~tmp___145~4912.base : int, ~tmp___145~4912.offset : int;
    var ~tmp___146~4912.base : int, ~tmp___146~4912.offset : int;
    var ~tmp___147~4912.base : int, ~tmp___147~4912.offset : int;
    var ~tmp___148~4912.base : int, ~tmp___148~4912.offset : int;

  loc23:
    havoc ~tmp~4912.base, ~tmp~4912.offset;
    havoc ~tmp___0~4912.base, ~tmp___0~4912.offset;
    havoc ~tmp___1~4912.base, ~tmp___1~4912.offset;
    havoc ~tmp___2~4912.base, ~tmp___2~4912.offset;
    havoc ~tmp___3~4912.base, ~tmp___3~4912.offset;
    havoc ~tmp___4~4912.base, ~tmp___4~4912.offset;
    havoc ~tmp___5~4912.base, ~tmp___5~4912.offset;
    havoc ~tmp___6~4912.base, ~tmp___6~4912.offset;
    havoc ~tmp___7~4912.base, ~tmp___7~4912.offset;
    havoc ~tmp___8~4912.base, ~tmp___8~4912.offset;
    havoc ~tmp___9~4912.base, ~tmp___9~4912.offset;
    havoc ~tmp___10~4912.base, ~tmp___10~4912.offset;
    havoc ~tmp___11~4912.base, ~tmp___11~4912.offset;
    havoc ~tmp___12~4912.base, ~tmp___12~4912.offset;
    havoc ~tmp___13~4912.base, ~tmp___13~4912.offset;
    havoc ~tmp___14~4912.base, ~tmp___14~4912.offset;
    havoc ~tmp___15~4912.base, ~tmp___15~4912.offset;
    havoc ~tmp___16~4912.base, ~tmp___16~4912.offset;
    havoc ~tmp___17~4912.base, ~tmp___17~4912.offset;
    havoc ~tmp___18~4912.base, ~tmp___18~4912.offset;
    havoc ~tmp___19~4912.base, ~tmp___19~4912.offset;
    havoc ~tmp___20~4912.base, ~tmp___20~4912.offset;
    havoc ~tmp___21~4912.base, ~tmp___21~4912.offset;
    havoc ~tmp___22~4912.base, ~tmp___22~4912.offset;
    havoc ~tmp___23~4912.base, ~tmp___23~4912.offset;
    havoc ~tmp___24~4912.base, ~tmp___24~4912.offset;
    havoc ~tmp___25~4912.base, ~tmp___25~4912.offset;
    havoc ~tmp___26~4912.base, ~tmp___26~4912.offset;
    havoc ~tmp___27~4912.base, ~tmp___27~4912.offset;
    havoc ~tmp___28~4912.base, ~tmp___28~4912.offset;
    havoc ~tmp___29~4912.base, ~tmp___29~4912.offset;
    havoc ~tmp___30~4912.base, ~tmp___30~4912.offset;
    havoc ~tmp___31~4912.base, ~tmp___31~4912.offset;
    havoc ~tmp___32~4912.base, ~tmp___32~4912.offset;
    havoc ~tmp___33~4912.base, ~tmp___33~4912.offset;
    havoc ~tmp___34~4912.base, ~tmp___34~4912.offset;
    havoc ~tmp___35~4912.base, ~tmp___35~4912.offset;
    havoc ~tmp___36~4912.base, ~tmp___36~4912.offset;
    havoc ~tmp___37~4912.base, ~tmp___37~4912.offset;
    havoc ~tmp___38~4912.base, ~tmp___38~4912.offset;
    havoc ~tmp___39~4912.base, ~tmp___39~4912.offset;
    havoc ~tmp___40~4912.base, ~tmp___40~4912.offset;
    havoc ~tmp___41~4912.base, ~tmp___41~4912.offset;
    havoc ~tmp___42~4912.base, ~tmp___42~4912.offset;
    havoc ~tmp___43~4912.base, ~tmp___43~4912.offset;
    havoc ~tmp___44~4912.base, ~tmp___44~4912.offset;
    havoc ~tmp___45~4912.base, ~tmp___45~4912.offset;
    havoc ~tmp___46~4912.base, ~tmp___46~4912.offset;
    havoc ~tmp___47~4912.base, ~tmp___47~4912.offset;
    havoc ~tmp___48~4912.base, ~tmp___48~4912.offset;
    havoc ~tmp___49~4912.base, ~tmp___49~4912.offset;
    havoc ~tmp___50~4912.base, ~tmp___50~4912.offset;
    havoc ~tmp___51~4912.base, ~tmp___51~4912.offset;
    havoc ~tmp___52~4912.base, ~tmp___52~4912.offset;
    havoc ~tmp___53~4912.base, ~tmp___53~4912.offset;
    havoc ~tmp___54~4912.base, ~tmp___54~4912.offset;
    havoc ~tmp___55~4912.base, ~tmp___55~4912.offset;
    havoc ~tmp___56~4912.base, ~tmp___56~4912.offset;
    havoc ~tmp___57~4912.base, ~tmp___57~4912.offset;
    havoc ~tmp___58~4912.base, ~tmp___58~4912.offset;
    havoc ~tmp___59~4912.base, ~tmp___59~4912.offset;
    havoc ~tmp___60~4912.base, ~tmp___60~4912.offset;
    havoc ~tmp___61~4912.base, ~tmp___61~4912.offset;
    havoc ~tmp___62~4912.base, ~tmp___62~4912.offset;
    havoc ~tmp___63~4912.base, ~tmp___63~4912.offset;
    havoc ~tmp___64~4912.base, ~tmp___64~4912.offset;
    havoc ~tmp___65~4912.base, ~tmp___65~4912.offset;
    havoc ~tmp___66~4912.base, ~tmp___66~4912.offset;
    havoc ~tmp___67~4912.base, ~tmp___67~4912.offset;
    havoc ~tmp___68~4912.base, ~tmp___68~4912.offset;
    havoc ~tmp___69~4912.base, ~tmp___69~4912.offset;
    havoc ~tmp___70~4912.base, ~tmp___70~4912.offset;
    havoc ~tmp___71~4912.base, ~tmp___71~4912.offset;
    havoc ~tmp___72~4912.base, ~tmp___72~4912.offset;
    havoc ~tmp___73~4912.base, ~tmp___73~4912.offset;
    havoc ~tmp___74~4912.base, ~tmp___74~4912.offset;
    havoc ~tmp___75~4912.base, ~tmp___75~4912.offset;
    havoc ~tmp___76~4912.base, ~tmp___76~4912.offset;
    havoc ~tmp___77~4912.base, ~tmp___77~4912.offset;
    havoc ~tmp___78~4912.base, ~tmp___78~4912.offset;
    havoc ~tmp___79~4912.base, ~tmp___79~4912.offset;
    havoc ~tmp___80~4912.base, ~tmp___80~4912.offset;
    havoc ~tmp___81~4912.base, ~tmp___81~4912.offset;
    havoc ~tmp___82~4912.base, ~tmp___82~4912.offset;
    havoc ~tmp___83~4912.base, ~tmp___83~4912.offset;
    havoc ~tmp___84~4912.base, ~tmp___84~4912.offset;
    havoc ~tmp___85~4912.base, ~tmp___85~4912.offset;
    havoc ~tmp___86~4912.base, ~tmp___86~4912.offset;
    havoc ~tmp___87~4912.base, ~tmp___87~4912.offset;
    havoc ~tmp___88~4912.base, ~tmp___88~4912.offset;
    havoc ~tmp___89~4912.base, ~tmp___89~4912.offset;
    havoc ~tmp___90~4912.base, ~tmp___90~4912.offset;
    havoc ~tmp___91~4912.base, ~tmp___91~4912.offset;
    havoc ~tmp___92~4912.base, ~tmp___92~4912.offset;
    havoc ~tmp___93~4912.base, ~tmp___93~4912.offset;
    havoc ~tmp___94~4912.base, ~tmp___94~4912.offset;
    havoc ~tmp___95~4912.base, ~tmp___95~4912.offset;
    havoc ~tmp___96~4912.base, ~tmp___96~4912.offset;
    havoc ~tmp___97~4912.base, ~tmp___97~4912.offset;
    havoc ~tmp___98~4912.base, ~tmp___98~4912.offset;
    havoc ~tmp___99~4912.base, ~tmp___99~4912.offset;
    havoc ~tmp___100~4912.base, ~tmp___100~4912.offset;
    havoc ~tmp___101~4912.base, ~tmp___101~4912.offset;
    havoc ~tmp___102~4912.base, ~tmp___102~4912.offset;
    havoc ~tmp___103~4912.base, ~tmp___103~4912.offset;
    havoc ~tmp___104~4912.base, ~tmp___104~4912.offset;
    havoc ~tmp___105~4912.base, ~tmp___105~4912.offset;
    havoc ~tmp___106~4912.base, ~tmp___106~4912.offset;
    havoc ~tmp___107~4912.base, ~tmp___107~4912.offset;
    havoc ~tmp___108~4912.base, ~tmp___108~4912.offset;
    havoc ~tmp___109~4912.base, ~tmp___109~4912.offset;
    havoc ~tmp___110~4912.base, ~tmp___110~4912.offset;
    havoc ~tmp___111~4912.base, ~tmp___111~4912.offset;
    havoc ~tmp___112~4912.base, ~tmp___112~4912.offset;
    havoc ~tmp___113~4912.base, ~tmp___113~4912.offset;
    havoc ~tmp___114~4912.base, ~tmp___114~4912.offset;
    havoc ~tmp___115~4912.base, ~tmp___115~4912.offset;
    havoc ~tmp___116~4912.base, ~tmp___116~4912.offset;
    havoc ~tmp___117~4912.base, ~tmp___117~4912.offset;
    havoc ~tmp___118~4912.base, ~tmp___118~4912.offset;
    havoc ~tmp___119~4912.base, ~tmp___119~4912.offset;
    havoc ~tmp___120~4912.base, ~tmp___120~4912.offset;
    havoc ~tmp___121~4912.base, ~tmp___121~4912.offset;
    havoc ~tmp___122~4912.base, ~tmp___122~4912.offset;
    havoc ~tmp___123~4912.base, ~tmp___123~4912.offset;
    havoc ~tmp___124~4912.base, ~tmp___124~4912.offset;
    havoc ~tmp___125~4912.base, ~tmp___125~4912.offset;
    havoc ~tmp___126~4912.base, ~tmp___126~4912.offset;
    havoc ~tmp___127~4912.base, ~tmp___127~4912.offset;
    havoc ~tmp___128~4912.base, ~tmp___128~4912.offset;
    havoc ~tmp___129~4912.base, ~tmp___129~4912.offset;
    havoc ~tmp___130~4912.base, ~tmp___130~4912.offset;
    havoc ~tmp___131~4912.base, ~tmp___131~4912.offset;
    havoc ~tmp___132~4912.base, ~tmp___132~4912.offset;
    havoc ~tmp___133~4912.base, ~tmp___133~4912.offset;
    havoc ~tmp___134~4912.base, ~tmp___134~4912.offset;
    havoc ~tmp___135~4912.base, ~tmp___135~4912.offset;
    havoc ~tmp___136~4912.base, ~tmp___136~4912.offset;
    havoc ~tmp___137~4912.base, ~tmp___137~4912.offset;
    havoc ~tmp___138~4912.base, ~tmp___138~4912.offset;
    havoc ~tmp___139~4912.base, ~tmp___139~4912.offset;
    havoc ~tmp___140~4912.base, ~tmp___140~4912.offset;
    havoc ~tmp___141~4912.base, ~tmp___141~4912.offset;
    havoc ~tmp___142~4912.base, ~tmp___142~4912.offset;
    havoc ~tmp___143~4912.base, ~tmp___143~4912.offset;
    havoc ~tmp___144~4912.base, ~tmp___144~4912.offset;
    havoc ~tmp___145~4912.base, ~tmp___145~4912.offset;
    havoc ~tmp___146~4912.base, ~tmp___146~4912.offset;
    havoc ~tmp___147~4912.base, ~tmp___147~4912.offset;
    havoc ~tmp___148~4912.base, ~tmp___148~4912.offset;
    call #t~ret3607.base, #t~ret3607.offset := external_allocated_data();
    ~tmp~4912.base, ~tmp~4912.offset := #t~ret3607.base, #t~ret3607.offset;
    havoc #t~ret3607.base, #t~ret3607.offset;
    ~ldv_0_ldv_param_22_1_default.base, ~ldv_0_ldv_param_22_1_default.offset := ~tmp~4912.base, ~tmp~4912.offset;
    call #t~ret3608.base, #t~ret3608.offset := external_allocated_data();
    ~tmp___0~4912.base, ~tmp___0~4912.offset := #t~ret3608.base, #t~ret3608.offset;
    havoc #t~ret3608.base, #t~ret3608.offset;
    ~ldv_0_ldv_param_22_3_default.base, ~ldv_0_ldv_param_22_3_default.offset := ~tmp___0~4912.base, ~tmp___0~4912.offset;
    call #t~ret3609.base, #t~ret3609.offset := external_allocated_data();
    ~tmp___1~4912.base, ~tmp___1~4912.offset := #t~ret3609.base, #t~ret3609.offset;
    havoc #t~ret3609.base, #t~ret3609.offset;
    ~ldv_0_ldv_param_4_1_default.base, ~ldv_0_ldv_param_4_1_default.offset := ~tmp___1~4912.base, ~tmp___1~4912.offset;
    call #t~ret3610.base, #t~ret3610.offset := external_allocated_data();
    ~tmp___2~4912.base, ~tmp___2~4912.offset := #t~ret3610.base, #t~ret3610.offset;
    havoc #t~ret3610.base, #t~ret3610.offset;
    ~ldv_0_ldv_param_4_3_default.base, ~ldv_0_ldv_param_4_3_default.offset := ~tmp___2~4912.base, ~tmp___2~4912.offset;
    call #t~ret3611.base, #t~ret3611.offset := external_allocated_data();
    ~tmp___3~4912.base, ~tmp___3~4912.offset := #t~ret3611.base, #t~ret3611.offset;
    havoc #t~ret3611.base, #t~ret3611.offset;
    ~ldv_0_resource_file.base, ~ldv_0_resource_file.offset := ~tmp___3~4912.base, ~tmp___3~4912.offset;
    call #t~ret3612.base, #t~ret3612.offset := external_allocated_data();
    ~tmp___4~4912.base, ~tmp___4~4912.offset := #t~ret3612.base, #t~ret3612.offset;
    havoc #t~ret3612.base, #t~ret3612.offset;
    ~ldv_0_resource_inode.base, ~ldv_0_resource_inode.offset := ~tmp___4~4912.base, ~tmp___4~4912.offset;
    call #t~ret3613.base, #t~ret3613.offset := external_allocated_data();
    ~tmp___5~4912.base, ~tmp___5~4912.offset := #t~ret3613.base, #t~ret3613.offset;
    havoc #t~ret3613.base, #t~ret3613.offset;
    ~ldv_1_ldv_param_22_1_default.base, ~ldv_1_ldv_param_22_1_default.offset := ~tmp___5~4912.base, ~tmp___5~4912.offset;
    call #t~ret3614.base, #t~ret3614.offset := external_allocated_data();
    ~tmp___6~4912.base, ~tmp___6~4912.offset := #t~ret3614.base, #t~ret3614.offset;
    havoc #t~ret3614.base, #t~ret3614.offset;
    ~ldv_1_ldv_param_22_3_default.base, ~ldv_1_ldv_param_22_3_default.offset := ~tmp___6~4912.base, ~tmp___6~4912.offset;
    call #t~ret3615.base, #t~ret3615.offset := external_allocated_data();
    ~tmp___7~4912.base, ~tmp___7~4912.offset := #t~ret3615.base, #t~ret3615.offset;
    havoc #t~ret3615.base, #t~ret3615.offset;
    ~ldv_1_ldv_param_4_1_default.base, ~ldv_1_ldv_param_4_1_default.offset := ~tmp___7~4912.base, ~tmp___7~4912.offset;
    call #t~ret3616.base, #t~ret3616.offset := external_allocated_data();
    ~tmp___8~4912.base, ~tmp___8~4912.offset := #t~ret3616.base, #t~ret3616.offset;
    havoc #t~ret3616.base, #t~ret3616.offset;
    ~ldv_1_ldv_param_4_3_default.base, ~ldv_1_ldv_param_4_3_default.offset := ~tmp___8~4912.base, ~tmp___8~4912.offset;
    call #t~ret3617.base, #t~ret3617.offset := external_allocated_data();
    ~tmp___9~4912.base, ~tmp___9~4912.offset := #t~ret3617.base, #t~ret3617.offset;
    havoc #t~ret3617.base, #t~ret3617.offset;
    ~ldv_1_resource_file.base, ~ldv_1_resource_file.offset := ~tmp___9~4912.base, ~tmp___9~4912.offset;
    call #t~ret3618.base, #t~ret3618.offset := external_allocated_data();
    ~tmp___10~4912.base, ~tmp___10~4912.offset := #t~ret3618.base, #t~ret3618.offset;
    havoc #t~ret3618.base, #t~ret3618.offset;
    ~ldv_1_resource_inode.base, ~ldv_1_resource_inode.offset := ~tmp___10~4912.base, ~tmp___10~4912.offset;
    call #t~ret3619.base, #t~ret3619.offset := external_allocated_data();
    ~tmp___11~4912.base, ~tmp___11~4912.offset := #t~ret3619.base, #t~ret3619.offset;
    havoc #t~ret3619.base, #t~ret3619.offset;
    ~ldv_2_ldv_param_22_1_default.base, ~ldv_2_ldv_param_22_1_default.offset := ~tmp___11~4912.base, ~tmp___11~4912.offset;
    call #t~ret3620.base, #t~ret3620.offset := external_allocated_data();
    ~tmp___12~4912.base, ~tmp___12~4912.offset := #t~ret3620.base, #t~ret3620.offset;
    havoc #t~ret3620.base, #t~ret3620.offset;
    ~ldv_2_ldv_param_22_3_default.base, ~ldv_2_ldv_param_22_3_default.offset := ~tmp___12~4912.base, ~tmp___12~4912.offset;
    call #t~ret3621.base, #t~ret3621.offset := external_allocated_data();
    ~tmp___13~4912.base, ~tmp___13~4912.offset := #t~ret3621.base, #t~ret3621.offset;
    havoc #t~ret3621.base, #t~ret3621.offset;
    ~ldv_2_ldv_param_4_1_default.base, ~ldv_2_ldv_param_4_1_default.offset := ~tmp___13~4912.base, ~tmp___13~4912.offset;
    call #t~ret3622.base, #t~ret3622.offset := external_allocated_data();
    ~tmp___14~4912.base, ~tmp___14~4912.offset := #t~ret3622.base, #t~ret3622.offset;
    havoc #t~ret3622.base, #t~ret3622.offset;
    ~ldv_2_ldv_param_4_3_default.base, ~ldv_2_ldv_param_4_3_default.offset := ~tmp___14~4912.base, ~tmp___14~4912.offset;
    call #t~ret3623.base, #t~ret3623.offset := external_allocated_data();
    ~tmp___15~4912.base, ~tmp___15~4912.offset := #t~ret3623.base, #t~ret3623.offset;
    havoc #t~ret3623.base, #t~ret3623.offset;
    ~ldv_2_resource_file.base, ~ldv_2_resource_file.offset := ~tmp___15~4912.base, ~tmp___15~4912.offset;
    call #t~ret3624.base, #t~ret3624.offset := external_allocated_data();
    ~tmp___16~4912.base, ~tmp___16~4912.offset := #t~ret3624.base, #t~ret3624.offset;
    havoc #t~ret3624.base, #t~ret3624.offset;
    ~ldv_2_resource_inode.base, ~ldv_2_resource_inode.offset := ~tmp___16~4912.base, ~tmp___16~4912.offset;
    call #t~ret3625.base, #t~ret3625.offset := external_allocated_data();
    ~tmp___17~4912.base, ~tmp___17~4912.offset := #t~ret3625.base, #t~ret3625.offset;
    havoc #t~ret3625.base, #t~ret3625.offset;
    ~ldv_3_ldv_param_22_1_default.base, ~ldv_3_ldv_param_22_1_default.offset := ~tmp___17~4912.base, ~tmp___17~4912.offset;
    call #t~ret3626.base, #t~ret3626.offset := external_allocated_data();
    ~tmp___18~4912.base, ~tmp___18~4912.offset := #t~ret3626.base, #t~ret3626.offset;
    havoc #t~ret3626.base, #t~ret3626.offset;
    ~ldv_3_ldv_param_22_3_default.base, ~ldv_3_ldv_param_22_3_default.offset := ~tmp___18~4912.base, ~tmp___18~4912.offset;
    call #t~ret3627.base, #t~ret3627.offset := external_allocated_data();
    ~tmp___19~4912.base, ~tmp___19~4912.offset := #t~ret3627.base, #t~ret3627.offset;
    havoc #t~ret3627.base, #t~ret3627.offset;
    ~ldv_3_ldv_param_4_1_default.base, ~ldv_3_ldv_param_4_1_default.offset := ~tmp___19~4912.base, ~tmp___19~4912.offset;
    call #t~ret3628.base, #t~ret3628.offset := external_allocated_data();
    ~tmp___20~4912.base, ~tmp___20~4912.offset := #t~ret3628.base, #t~ret3628.offset;
    havoc #t~ret3628.base, #t~ret3628.offset;
    ~ldv_3_ldv_param_4_3_default.base, ~ldv_3_ldv_param_4_3_default.offset := ~tmp___20~4912.base, ~tmp___20~4912.offset;
    call #t~ret3629.base, #t~ret3629.offset := external_allocated_data();
    ~tmp___21~4912.base, ~tmp___21~4912.offset := #t~ret3629.base, #t~ret3629.offset;
    havoc #t~ret3629.base, #t~ret3629.offset;
    ~ldv_3_resource_file.base, ~ldv_3_resource_file.offset := ~tmp___21~4912.base, ~tmp___21~4912.offset;
    call #t~ret3630.base, #t~ret3630.offset := external_allocated_data();
    ~tmp___22~4912.base, ~tmp___22~4912.offset := #t~ret3630.base, #t~ret3630.offset;
    havoc #t~ret3630.base, #t~ret3630.offset;
    ~ldv_3_resource_inode.base, ~ldv_3_resource_inode.offset := ~tmp___22~4912.base, ~tmp___22~4912.offset;
    call #t~ret3631.base, #t~ret3631.offset := external_allocated_data();
    ~tmp___23~4912.base, ~tmp___23~4912.offset := #t~ret3631.base, #t~ret3631.offset;
    havoc #t~ret3631.base, #t~ret3631.offset;
    ~ldv_4_ldv_param_22_1_default.base, ~ldv_4_ldv_param_22_1_default.offset := ~tmp___23~4912.base, ~tmp___23~4912.offset;
    call #t~ret3632.base, #t~ret3632.offset := external_allocated_data();
    ~tmp___24~4912.base, ~tmp___24~4912.offset := #t~ret3632.base, #t~ret3632.offset;
    havoc #t~ret3632.base, #t~ret3632.offset;
    ~ldv_4_ldv_param_22_3_default.base, ~ldv_4_ldv_param_22_3_default.offset := ~tmp___24~4912.base, ~tmp___24~4912.offset;
    call #t~ret3633.base, #t~ret3633.offset := external_allocated_data();
    ~tmp___25~4912.base, ~tmp___25~4912.offset := #t~ret3633.base, #t~ret3633.offset;
    havoc #t~ret3633.base, #t~ret3633.offset;
    ~ldv_4_ldv_param_4_1_default.base, ~ldv_4_ldv_param_4_1_default.offset := ~tmp___25~4912.base, ~tmp___25~4912.offset;
    call #t~ret3634.base, #t~ret3634.offset := external_allocated_data();
    ~tmp___26~4912.base, ~tmp___26~4912.offset := #t~ret3634.base, #t~ret3634.offset;
    havoc #t~ret3634.base, #t~ret3634.offset;
    ~ldv_4_ldv_param_4_3_default.base, ~ldv_4_ldv_param_4_3_default.offset := ~tmp___26~4912.base, ~tmp___26~4912.offset;
    call #t~ret3635.base, #t~ret3635.offset := external_allocated_data();
    ~tmp___27~4912.base, ~tmp___27~4912.offset := #t~ret3635.base, #t~ret3635.offset;
    havoc #t~ret3635.base, #t~ret3635.offset;
    ~ldv_4_resource_file.base, ~ldv_4_resource_file.offset := ~tmp___27~4912.base, ~tmp___27~4912.offset;
    call #t~ret3636.base, #t~ret3636.offset := external_allocated_data();
    ~tmp___28~4912.base, ~tmp___28~4912.offset := #t~ret3636.base, #t~ret3636.offset;
    havoc #t~ret3636.base, #t~ret3636.offset;
    ~ldv_4_resource_inode.base, ~ldv_4_resource_inode.offset := ~tmp___28~4912.base, ~tmp___28~4912.offset;
    call #t~ret3637.base, #t~ret3637.offset := external_allocated_data();
    ~tmp___29~4912.base, ~tmp___29~4912.offset := #t~ret3637.base, #t~ret3637.offset;
    havoc #t~ret3637.base, #t~ret3637.offset;
    ~ldv_5_ldv_param_22_1_default.base, ~ldv_5_ldv_param_22_1_default.offset := ~tmp___29~4912.base, ~tmp___29~4912.offset;
    call #t~ret3638.base, #t~ret3638.offset := external_allocated_data();
    ~tmp___30~4912.base, ~tmp___30~4912.offset := #t~ret3638.base, #t~ret3638.offset;
    havoc #t~ret3638.base, #t~ret3638.offset;
    ~ldv_5_ldv_param_22_3_default.base, ~ldv_5_ldv_param_22_3_default.offset := ~tmp___30~4912.base, ~tmp___30~4912.offset;
    call #t~ret3639.base, #t~ret3639.offset := external_allocated_data();
    ~tmp___31~4912.base, ~tmp___31~4912.offset := #t~ret3639.base, #t~ret3639.offset;
    havoc #t~ret3639.base, #t~ret3639.offset;
    ~ldv_5_ldv_param_4_1_default.base, ~ldv_5_ldv_param_4_1_default.offset := ~tmp___31~4912.base, ~tmp___31~4912.offset;
    call #t~ret3640.base, #t~ret3640.offset := external_allocated_data();
    ~tmp___32~4912.base, ~tmp___32~4912.offset := #t~ret3640.base, #t~ret3640.offset;
    havoc #t~ret3640.base, #t~ret3640.offset;
    ~ldv_5_ldv_param_4_3_default.base, ~ldv_5_ldv_param_4_3_default.offset := ~tmp___32~4912.base, ~tmp___32~4912.offset;
    call #t~ret3641.base, #t~ret3641.offset := external_allocated_data();
    ~tmp___33~4912.base, ~tmp___33~4912.offset := #t~ret3641.base, #t~ret3641.offset;
    havoc #t~ret3641.base, #t~ret3641.offset;
    ~ldv_5_resource_file.base, ~ldv_5_resource_file.offset := ~tmp___33~4912.base, ~tmp___33~4912.offset;
    call #t~ret3642.base, #t~ret3642.offset := external_allocated_data();
    ~tmp___34~4912.base, ~tmp___34~4912.offset := #t~ret3642.base, #t~ret3642.offset;
    havoc #t~ret3642.base, #t~ret3642.offset;
    ~ldv_5_resource_inode.base, ~ldv_5_resource_inode.offset := ~tmp___34~4912.base, ~tmp___34~4912.offset;
    call #t~ret3643.base, #t~ret3643.offset := external_allocated_data();
    ~tmp___35~4912.base, ~tmp___35~4912.offset := #t~ret3643.base, #t~ret3643.offset;
    havoc #t~ret3643.base, #t~ret3643.offset;
    ~ldv_6_ldv_param_22_1_default.base, ~ldv_6_ldv_param_22_1_default.offset := ~tmp___35~4912.base, ~tmp___35~4912.offset;
    call #t~ret3644.base, #t~ret3644.offset := external_allocated_data();
    ~tmp___36~4912.base, ~tmp___36~4912.offset := #t~ret3644.base, #t~ret3644.offset;
    havoc #t~ret3644.base, #t~ret3644.offset;
    ~ldv_6_ldv_param_22_3_default.base, ~ldv_6_ldv_param_22_3_default.offset := ~tmp___36~4912.base, ~tmp___36~4912.offset;
    call #t~ret3645.base, #t~ret3645.offset := external_allocated_data();
    ~tmp___37~4912.base, ~tmp___37~4912.offset := #t~ret3645.base, #t~ret3645.offset;
    havoc #t~ret3645.base, #t~ret3645.offset;
    ~ldv_6_ldv_param_4_1_default.base, ~ldv_6_ldv_param_4_1_default.offset := ~tmp___37~4912.base, ~tmp___37~4912.offset;
    call #t~ret3646.base, #t~ret3646.offset := external_allocated_data();
    ~tmp___38~4912.base, ~tmp___38~4912.offset := #t~ret3646.base, #t~ret3646.offset;
    havoc #t~ret3646.base, #t~ret3646.offset;
    ~ldv_6_ldv_param_4_3_default.base, ~ldv_6_ldv_param_4_3_default.offset := ~tmp___38~4912.base, ~tmp___38~4912.offset;
    call #t~ret3647.base, #t~ret3647.offset := external_allocated_data();
    ~tmp___39~4912.base, ~tmp___39~4912.offset := #t~ret3647.base, #t~ret3647.offset;
    havoc #t~ret3647.base, #t~ret3647.offset;
    ~ldv_6_resource_file.base, ~ldv_6_resource_file.offset := ~tmp___39~4912.base, ~tmp___39~4912.offset;
    call #t~ret3648.base, #t~ret3648.offset := external_allocated_data();
    ~tmp___40~4912.base, ~tmp___40~4912.offset := #t~ret3648.base, #t~ret3648.offset;
    havoc #t~ret3648.base, #t~ret3648.offset;
    ~ldv_6_resource_inode.base, ~ldv_6_resource_inode.offset := ~tmp___40~4912.base, ~tmp___40~4912.offset;
    call #t~ret3649.base, #t~ret3649.offset := external_allocated_data();
    ~tmp___41~4912.base, ~tmp___41~4912.offset := #t~ret3649.base, #t~ret3649.offset;
    havoc #t~ret3649.base, #t~ret3649.offset;
    ~ldv_7_ldv_param_22_1_default.base, ~ldv_7_ldv_param_22_1_default.offset := ~tmp___41~4912.base, ~tmp___41~4912.offset;
    call #t~ret3650.base, #t~ret3650.offset := external_allocated_data();
    ~tmp___42~4912.base, ~tmp___42~4912.offset := #t~ret3650.base, #t~ret3650.offset;
    havoc #t~ret3650.base, #t~ret3650.offset;
    ~ldv_7_ldv_param_22_3_default.base, ~ldv_7_ldv_param_22_3_default.offset := ~tmp___42~4912.base, ~tmp___42~4912.offset;
    call #t~ret3651.base, #t~ret3651.offset := external_allocated_data();
    ~tmp___43~4912.base, ~tmp___43~4912.offset := #t~ret3651.base, #t~ret3651.offset;
    havoc #t~ret3651.base, #t~ret3651.offset;
    ~ldv_7_ldv_param_4_1_default.base, ~ldv_7_ldv_param_4_1_default.offset := ~tmp___43~4912.base, ~tmp___43~4912.offset;
    call #t~ret3652.base, #t~ret3652.offset := external_allocated_data();
    ~tmp___44~4912.base, ~tmp___44~4912.offset := #t~ret3652.base, #t~ret3652.offset;
    havoc #t~ret3652.base, #t~ret3652.offset;
    ~ldv_7_ldv_param_4_3_default.base, ~ldv_7_ldv_param_4_3_default.offset := ~tmp___44~4912.base, ~tmp___44~4912.offset;
    call #t~ret3653.base, #t~ret3653.offset := external_allocated_data();
    ~tmp___45~4912.base, ~tmp___45~4912.offset := #t~ret3653.base, #t~ret3653.offset;
    havoc #t~ret3653.base, #t~ret3653.offset;
    ~ldv_7_resource_file.base, ~ldv_7_resource_file.offset := ~tmp___45~4912.base, ~tmp___45~4912.offset;
    call #t~ret3654.base, #t~ret3654.offset := external_allocated_data();
    ~tmp___46~4912.base, ~tmp___46~4912.offset := #t~ret3654.base, #t~ret3654.offset;
    havoc #t~ret3654.base, #t~ret3654.offset;
    ~ldv_7_resource_inode.base, ~ldv_7_resource_inode.offset := ~tmp___46~4912.base, ~tmp___46~4912.offset;
    call #t~ret3655.base, #t~ret3655.offset := external_allocated_data();
    ~tmp___47~4912.base, ~tmp___47~4912.offset := #t~ret3655.base, #t~ret3655.offset;
    havoc #t~ret3655.base, #t~ret3655.offset;
    ~ldv_8_ldv_param_22_1_default.base, ~ldv_8_ldv_param_22_1_default.offset := ~tmp___47~4912.base, ~tmp___47~4912.offset;
    call #t~ret3656.base, #t~ret3656.offset := external_allocated_data();
    ~tmp___48~4912.base, ~tmp___48~4912.offset := #t~ret3656.base, #t~ret3656.offset;
    havoc #t~ret3656.base, #t~ret3656.offset;
    ~ldv_8_ldv_param_22_3_default.base, ~ldv_8_ldv_param_22_3_default.offset := ~tmp___48~4912.base, ~tmp___48~4912.offset;
    call #t~ret3657.base, #t~ret3657.offset := external_allocated_data();
    ~tmp___49~4912.base, ~tmp___49~4912.offset := #t~ret3657.base, #t~ret3657.offset;
    havoc #t~ret3657.base, #t~ret3657.offset;
    ~ldv_8_ldv_param_4_1_default.base, ~ldv_8_ldv_param_4_1_default.offset := ~tmp___49~4912.base, ~tmp___49~4912.offset;
    call #t~ret3658.base, #t~ret3658.offset := external_allocated_data();
    ~tmp___50~4912.base, ~tmp___50~4912.offset := #t~ret3658.base, #t~ret3658.offset;
    havoc #t~ret3658.base, #t~ret3658.offset;
    ~ldv_8_ldv_param_4_3_default.base, ~ldv_8_ldv_param_4_3_default.offset := ~tmp___50~4912.base, ~tmp___50~4912.offset;
    call #t~ret3659.base, #t~ret3659.offset := external_allocated_data();
    ~tmp___51~4912.base, ~tmp___51~4912.offset := #t~ret3659.base, #t~ret3659.offset;
    havoc #t~ret3659.base, #t~ret3659.offset;
    ~ldv_8_resource_file.base, ~ldv_8_resource_file.offset := ~tmp___51~4912.base, ~tmp___51~4912.offset;
    call #t~ret3660.base, #t~ret3660.offset := external_allocated_data();
    ~tmp___52~4912.base, ~tmp___52~4912.offset := #t~ret3660.base, #t~ret3660.offset;
    havoc #t~ret3660.base, #t~ret3660.offset;
    ~ldv_8_resource_inode.base, ~ldv_8_resource_inode.offset := ~tmp___52~4912.base, ~tmp___52~4912.offset;
    call #t~ret3661.base, #t~ret3661.offset := external_allocated_data();
    ~tmp___53~4912.base, ~tmp___53~4912.offset := #t~ret3661.base, #t~ret3661.offset;
    havoc #t~ret3661.base, #t~ret3661.offset;
    ~ldv_9_ldv_param_22_1_default.base, ~ldv_9_ldv_param_22_1_default.offset := ~tmp___53~4912.base, ~tmp___53~4912.offset;
    call #t~ret3662.base, #t~ret3662.offset := external_allocated_data();
    ~tmp___54~4912.base, ~tmp___54~4912.offset := #t~ret3662.base, #t~ret3662.offset;
    havoc #t~ret3662.base, #t~ret3662.offset;
    ~ldv_9_ldv_param_22_3_default.base, ~ldv_9_ldv_param_22_3_default.offset := ~tmp___54~4912.base, ~tmp___54~4912.offset;
    call #t~ret3663.base, #t~ret3663.offset := external_allocated_data();
    ~tmp___55~4912.base, ~tmp___55~4912.offset := #t~ret3663.base, #t~ret3663.offset;
    havoc #t~ret3663.base, #t~ret3663.offset;
    ~ldv_9_ldv_param_4_1_default.base, ~ldv_9_ldv_param_4_1_default.offset := ~tmp___55~4912.base, ~tmp___55~4912.offset;
    call #t~ret3664.base, #t~ret3664.offset := external_allocated_data();
    ~tmp___56~4912.base, ~tmp___56~4912.offset := #t~ret3664.base, #t~ret3664.offset;
    havoc #t~ret3664.base, #t~ret3664.offset;
    ~ldv_9_ldv_param_4_3_default.base, ~ldv_9_ldv_param_4_3_default.offset := ~tmp___56~4912.base, ~tmp___56~4912.offset;
    call #t~ret3665.base, #t~ret3665.offset := external_allocated_data();
    ~tmp___57~4912.base, ~tmp___57~4912.offset := #t~ret3665.base, #t~ret3665.offset;
    havoc #t~ret3665.base, #t~ret3665.offset;
    ~ldv_9_resource_file.base, ~ldv_9_resource_file.offset := ~tmp___57~4912.base, ~tmp___57~4912.offset;
    call #t~ret3666.base, #t~ret3666.offset := external_allocated_data();
    ~tmp___58~4912.base, ~tmp___58~4912.offset := #t~ret3666.base, #t~ret3666.offset;
    havoc #t~ret3666.base, #t~ret3666.offset;
    ~ldv_9_resource_inode.base, ~ldv_9_resource_inode.offset := ~tmp___58~4912.base, ~tmp___58~4912.offset;
    call #t~ret3667.base, #t~ret3667.offset := external_allocated_data();
    ~tmp___59~4912.base, ~tmp___59~4912.offset := #t~ret3667.base, #t~ret3667.offset;
    havoc #t~ret3667.base, #t~ret3667.offset;
    ~ldv_10_ldv_param_22_1_default.base, ~ldv_10_ldv_param_22_1_default.offset := ~tmp___59~4912.base, ~tmp___59~4912.offset;
    call #t~ret3668.base, #t~ret3668.offset := external_allocated_data();
    ~tmp___60~4912.base, ~tmp___60~4912.offset := #t~ret3668.base, #t~ret3668.offset;
    havoc #t~ret3668.base, #t~ret3668.offset;
    ~ldv_10_ldv_param_22_3_default.base, ~ldv_10_ldv_param_22_3_default.offset := ~tmp___60~4912.base, ~tmp___60~4912.offset;
    call #t~ret3669.base, #t~ret3669.offset := external_allocated_data();
    ~tmp___61~4912.base, ~tmp___61~4912.offset := #t~ret3669.base, #t~ret3669.offset;
    havoc #t~ret3669.base, #t~ret3669.offset;
    ~ldv_10_ldv_param_4_1_default.base, ~ldv_10_ldv_param_4_1_default.offset := ~tmp___61~4912.base, ~tmp___61~4912.offset;
    call #t~ret3670.base, #t~ret3670.offset := external_allocated_data();
    ~tmp___62~4912.base, ~tmp___62~4912.offset := #t~ret3670.base, #t~ret3670.offset;
    havoc #t~ret3670.base, #t~ret3670.offset;
    ~ldv_10_ldv_param_4_3_default.base, ~ldv_10_ldv_param_4_3_default.offset := ~tmp___62~4912.base, ~tmp___62~4912.offset;
    call #t~ret3671.base, #t~ret3671.offset := external_allocated_data();
    ~tmp___63~4912.base, ~tmp___63~4912.offset := #t~ret3671.base, #t~ret3671.offset;
    havoc #t~ret3671.base, #t~ret3671.offset;
    ~ldv_10_resource_file.base, ~ldv_10_resource_file.offset := ~tmp___63~4912.base, ~tmp___63~4912.offset;
    call #t~ret3672.base, #t~ret3672.offset := external_allocated_data();
    ~tmp___64~4912.base, ~tmp___64~4912.offset := #t~ret3672.base, #t~ret3672.offset;
    havoc #t~ret3672.base, #t~ret3672.offset;
    ~ldv_10_resource_inode.base, ~ldv_10_resource_inode.offset := ~tmp___64~4912.base, ~tmp___64~4912.offset;
    call #t~ret3673.base, #t~ret3673.offset := external_allocated_data();
    ~tmp___65~4912.base, ~tmp___65~4912.offset := #t~ret3673.base, #t~ret3673.offset;
    havoc #t~ret3673.base, #t~ret3673.offset;
    ~ldv_11_ldv_param_22_1_default.base, ~ldv_11_ldv_param_22_1_default.offset := ~tmp___65~4912.base, ~tmp___65~4912.offset;
    call #t~ret3674.base, #t~ret3674.offset := external_allocated_data();
    ~tmp___66~4912.base, ~tmp___66~4912.offset := #t~ret3674.base, #t~ret3674.offset;
    havoc #t~ret3674.base, #t~ret3674.offset;
    ~ldv_11_ldv_param_22_3_default.base, ~ldv_11_ldv_param_22_3_default.offset := ~tmp___66~4912.base, ~tmp___66~4912.offset;
    call #t~ret3675.base, #t~ret3675.offset := external_allocated_data();
    ~tmp___67~4912.base, ~tmp___67~4912.offset := #t~ret3675.base, #t~ret3675.offset;
    havoc #t~ret3675.base, #t~ret3675.offset;
    ~ldv_11_ldv_param_4_1_default.base, ~ldv_11_ldv_param_4_1_default.offset := ~tmp___67~4912.base, ~tmp___67~4912.offset;
    call #t~ret3676.base, #t~ret3676.offset := external_allocated_data();
    ~tmp___68~4912.base, ~tmp___68~4912.offset := #t~ret3676.base, #t~ret3676.offset;
    havoc #t~ret3676.base, #t~ret3676.offset;
    ~ldv_11_ldv_param_4_3_default.base, ~ldv_11_ldv_param_4_3_default.offset := ~tmp___68~4912.base, ~tmp___68~4912.offset;
    call #t~ret3677.base, #t~ret3677.offset := external_allocated_data();
    ~tmp___69~4912.base, ~tmp___69~4912.offset := #t~ret3677.base, #t~ret3677.offset;
    havoc #t~ret3677.base, #t~ret3677.offset;
    ~ldv_11_resource_file.base, ~ldv_11_resource_file.offset := ~tmp___69~4912.base, ~tmp___69~4912.offset;
    call #t~ret3678.base, #t~ret3678.offset := external_allocated_data();
    ~tmp___70~4912.base, ~tmp___70~4912.offset := #t~ret3678.base, #t~ret3678.offset;
    havoc #t~ret3678.base, #t~ret3678.offset;
    ~ldv_11_resource_inode.base, ~ldv_11_resource_inode.offset := ~tmp___70~4912.base, ~tmp___70~4912.offset;
    call #t~ret3679.base, #t~ret3679.offset := external_allocated_data();
    ~tmp___71~4912.base, ~tmp___71~4912.offset := #t~ret3679.base, #t~ret3679.offset;
    havoc #t~ret3679.base, #t~ret3679.offset;
    ~ldv_12_ldv_param_22_1_default.base, ~ldv_12_ldv_param_22_1_default.offset := ~tmp___71~4912.base, ~tmp___71~4912.offset;
    call #t~ret3680.base, #t~ret3680.offset := external_allocated_data();
    ~tmp___72~4912.base, ~tmp___72~4912.offset := #t~ret3680.base, #t~ret3680.offset;
    havoc #t~ret3680.base, #t~ret3680.offset;
    ~ldv_12_ldv_param_22_3_default.base, ~ldv_12_ldv_param_22_3_default.offset := ~tmp___72~4912.base, ~tmp___72~4912.offset;
    call #t~ret3681.base, #t~ret3681.offset := external_allocated_data();
    ~tmp___73~4912.base, ~tmp___73~4912.offset := #t~ret3681.base, #t~ret3681.offset;
    havoc #t~ret3681.base, #t~ret3681.offset;
    ~ldv_12_ldv_param_4_1_default.base, ~ldv_12_ldv_param_4_1_default.offset := ~tmp___73~4912.base, ~tmp___73~4912.offset;
    call #t~ret3682.base, #t~ret3682.offset := external_allocated_data();
    ~tmp___74~4912.base, ~tmp___74~4912.offset := #t~ret3682.base, #t~ret3682.offset;
    havoc #t~ret3682.base, #t~ret3682.offset;
    ~ldv_12_ldv_param_4_3_default.base, ~ldv_12_ldv_param_4_3_default.offset := ~tmp___74~4912.base, ~tmp___74~4912.offset;
    call #t~ret3683.base, #t~ret3683.offset := external_allocated_data();
    ~tmp___75~4912.base, ~tmp___75~4912.offset := #t~ret3683.base, #t~ret3683.offset;
    havoc #t~ret3683.base, #t~ret3683.offset;
    ~ldv_12_resource_file.base, ~ldv_12_resource_file.offset := ~tmp___75~4912.base, ~tmp___75~4912.offset;
    call #t~ret3684.base, #t~ret3684.offset := external_allocated_data();
    ~tmp___76~4912.base, ~tmp___76~4912.offset := #t~ret3684.base, #t~ret3684.offset;
    havoc #t~ret3684.base, #t~ret3684.offset;
    ~ldv_12_resource_inode.base, ~ldv_12_resource_inode.offset := ~tmp___76~4912.base, ~tmp___76~4912.offset;
    call #t~ret3685.base, #t~ret3685.offset := external_allocated_data();
    ~tmp___77~4912.base, ~tmp___77~4912.offset := #t~ret3685.base, #t~ret3685.offset;
    havoc #t~ret3685.base, #t~ret3685.offset;
    ~ldv_13_ldv_param_22_1_default.base, ~ldv_13_ldv_param_22_1_default.offset := ~tmp___77~4912.base, ~tmp___77~4912.offset;
    call #t~ret3686.base, #t~ret3686.offset := external_allocated_data();
    ~tmp___78~4912.base, ~tmp___78~4912.offset := #t~ret3686.base, #t~ret3686.offset;
    havoc #t~ret3686.base, #t~ret3686.offset;
    ~ldv_13_ldv_param_22_3_default.base, ~ldv_13_ldv_param_22_3_default.offset := ~tmp___78~4912.base, ~tmp___78~4912.offset;
    call #t~ret3687.base, #t~ret3687.offset := external_allocated_data();
    ~tmp___79~4912.base, ~tmp___79~4912.offset := #t~ret3687.base, #t~ret3687.offset;
    havoc #t~ret3687.base, #t~ret3687.offset;
    ~ldv_13_ldv_param_4_1_default.base, ~ldv_13_ldv_param_4_1_default.offset := ~tmp___79~4912.base, ~tmp___79~4912.offset;
    call #t~ret3688.base, #t~ret3688.offset := external_allocated_data();
    ~tmp___80~4912.base, ~tmp___80~4912.offset := #t~ret3688.base, #t~ret3688.offset;
    havoc #t~ret3688.base, #t~ret3688.offset;
    ~ldv_13_ldv_param_4_3_default.base, ~ldv_13_ldv_param_4_3_default.offset := ~tmp___80~4912.base, ~tmp___80~4912.offset;
    call #t~ret3689.base, #t~ret3689.offset := external_allocated_data();
    ~tmp___81~4912.base, ~tmp___81~4912.offset := #t~ret3689.base, #t~ret3689.offset;
    havoc #t~ret3689.base, #t~ret3689.offset;
    ~ldv_13_resource_file.base, ~ldv_13_resource_file.offset := ~tmp___81~4912.base, ~tmp___81~4912.offset;
    call #t~ret3690.base, #t~ret3690.offset := external_allocated_data();
    ~tmp___82~4912.base, ~tmp___82~4912.offset := #t~ret3690.base, #t~ret3690.offset;
    havoc #t~ret3690.base, #t~ret3690.offset;
    ~ldv_13_resource_inode.base, ~ldv_13_resource_inode.offset := ~tmp___82~4912.base, ~tmp___82~4912.offset;
    call #t~ret3691.base, #t~ret3691.offset := external_allocated_data();
    ~tmp___83~4912.base, ~tmp___83~4912.offset := #t~ret3691.base, #t~ret3691.offset;
    havoc #t~ret3691.base, #t~ret3691.offset;
    ~ldv_14_ldv_param_22_1_default.base, ~ldv_14_ldv_param_22_1_default.offset := ~tmp___83~4912.base, ~tmp___83~4912.offset;
    call #t~ret3692.base, #t~ret3692.offset := external_allocated_data();
    ~tmp___84~4912.base, ~tmp___84~4912.offset := #t~ret3692.base, #t~ret3692.offset;
    havoc #t~ret3692.base, #t~ret3692.offset;
    ~ldv_14_ldv_param_22_3_default.base, ~ldv_14_ldv_param_22_3_default.offset := ~tmp___84~4912.base, ~tmp___84~4912.offset;
    call #t~ret3693.base, #t~ret3693.offset := external_allocated_data();
    ~tmp___85~4912.base, ~tmp___85~4912.offset := #t~ret3693.base, #t~ret3693.offset;
    havoc #t~ret3693.base, #t~ret3693.offset;
    ~ldv_14_ldv_param_4_1_default.base, ~ldv_14_ldv_param_4_1_default.offset := ~tmp___85~4912.base, ~tmp___85~4912.offset;
    call #t~ret3694.base, #t~ret3694.offset := external_allocated_data();
    ~tmp___86~4912.base, ~tmp___86~4912.offset := #t~ret3694.base, #t~ret3694.offset;
    havoc #t~ret3694.base, #t~ret3694.offset;
    ~ldv_14_ldv_param_4_3_default.base, ~ldv_14_ldv_param_4_3_default.offset := ~tmp___86~4912.base, ~tmp___86~4912.offset;
    call #t~ret3695.base, #t~ret3695.offset := external_allocated_data();
    ~tmp___87~4912.base, ~tmp___87~4912.offset := #t~ret3695.base, #t~ret3695.offset;
    havoc #t~ret3695.base, #t~ret3695.offset;
    ~ldv_14_resource_file.base, ~ldv_14_resource_file.offset := ~tmp___87~4912.base, ~tmp___87~4912.offset;
    call #t~ret3696.base, #t~ret3696.offset := external_allocated_data();
    ~tmp___88~4912.base, ~tmp___88~4912.offset := #t~ret3696.base, #t~ret3696.offset;
    havoc #t~ret3696.base, #t~ret3696.offset;
    ~ldv_14_resource_inode.base, ~ldv_14_resource_inode.offset := ~tmp___88~4912.base, ~tmp___88~4912.offset;
    call #t~ret3697.base, #t~ret3697.offset := external_allocated_data();
    ~tmp___89~4912.base, ~tmp___89~4912.offset := #t~ret3697.base, #t~ret3697.offset;
    havoc #t~ret3697.base, #t~ret3697.offset;
    ~ldv_15_ldv_param_22_1_default.base, ~ldv_15_ldv_param_22_1_default.offset := ~tmp___89~4912.base, ~tmp___89~4912.offset;
    call #t~ret3698.base, #t~ret3698.offset := external_allocated_data();
    ~tmp___90~4912.base, ~tmp___90~4912.offset := #t~ret3698.base, #t~ret3698.offset;
    havoc #t~ret3698.base, #t~ret3698.offset;
    ~ldv_15_ldv_param_22_3_default.base, ~ldv_15_ldv_param_22_3_default.offset := ~tmp___90~4912.base, ~tmp___90~4912.offset;
    call #t~ret3699.base, #t~ret3699.offset := external_allocated_data();
    ~tmp___91~4912.base, ~tmp___91~4912.offset := #t~ret3699.base, #t~ret3699.offset;
    havoc #t~ret3699.base, #t~ret3699.offset;
    ~ldv_15_ldv_param_4_1_default.base, ~ldv_15_ldv_param_4_1_default.offset := ~tmp___91~4912.base, ~tmp___91~4912.offset;
    call #t~ret3700.base, #t~ret3700.offset := external_allocated_data();
    ~tmp___92~4912.base, ~tmp___92~4912.offset := #t~ret3700.base, #t~ret3700.offset;
    havoc #t~ret3700.base, #t~ret3700.offset;
    ~ldv_15_ldv_param_4_3_default.base, ~ldv_15_ldv_param_4_3_default.offset := ~tmp___92~4912.base, ~tmp___92~4912.offset;
    call #t~ret3701.base, #t~ret3701.offset := external_allocated_data();
    ~tmp___93~4912.base, ~tmp___93~4912.offset := #t~ret3701.base, #t~ret3701.offset;
    havoc #t~ret3701.base, #t~ret3701.offset;
    ~ldv_15_resource_file.base, ~ldv_15_resource_file.offset := ~tmp___93~4912.base, ~tmp___93~4912.offset;
    call #t~ret3702.base, #t~ret3702.offset := external_allocated_data();
    ~tmp___94~4912.base, ~tmp___94~4912.offset := #t~ret3702.base, #t~ret3702.offset;
    havoc #t~ret3702.base, #t~ret3702.offset;
    ~ldv_15_resource_inode.base, ~ldv_15_resource_inode.offset := ~tmp___94~4912.base, ~tmp___94~4912.offset;
    call #t~ret3703.base, #t~ret3703.offset := external_allocated_data();
    ~tmp___95~4912.base, ~tmp___95~4912.offset := #t~ret3703.base, #t~ret3703.offset;
    havoc #t~ret3703.base, #t~ret3703.offset;
    ~ldv_16_container_net_device.base, ~ldv_16_container_net_device.offset := ~tmp___95~4912.base, ~tmp___95~4912.offset;
    call #t~ret3704.base, #t~ret3704.offset := external_allocated_data();
    ~tmp___96~4912.base, ~tmp___96~4912.offset := #t~ret3704.base, #t~ret3704.offset;
    havoc #t~ret3704.base, #t~ret3704.offset;
    ~ldv_16_container_struct_ethtool_drvinfo_ptr.base, ~ldv_16_container_struct_ethtool_drvinfo_ptr.offset := ~tmp___96~4912.base, ~tmp___96~4912.offset;
    call #t~ret3705.base, #t~ret3705.offset := external_allocated_data();
    ~tmp___97~4912.base, ~tmp___97~4912.offset := #t~ret3705.base, #t~ret3705.offset;
    havoc #t~ret3705.base, #t~ret3705.offset;
    ~ldv_16_container_struct_ethtool_eeprom_ptr.base, ~ldv_16_container_struct_ethtool_eeprom_ptr.offset := ~tmp___97~4912.base, ~tmp___97~4912.offset;
    call #t~ret3706.base, #t~ret3706.offset := external_allocated_data();
    ~tmp___98~4912.base, ~tmp___98~4912.offset := #t~ret3706.base, #t~ret3706.offset;
    havoc #t~ret3706.base, #t~ret3706.offset;
    ~ldv_16_container_struct_ethtool_stats_ptr.base, ~ldv_16_container_struct_ethtool_stats_ptr.offset := ~tmp___98~4912.base, ~tmp___98~4912.offset;
    call #t~ret3707.base, #t~ret3707.offset := external_allocated_data();
    ~tmp___99~4912.base, ~tmp___99~4912.offset := #t~ret3707.base, #t~ret3707.offset;
    havoc #t~ret3707.base, #t~ret3707.offset;
    ~ldv_16_container_struct_ethtool_wolinfo_ptr.base, ~ldv_16_container_struct_ethtool_wolinfo_ptr.offset := ~tmp___99~4912.base, ~tmp___99~4912.offset;
    call #t~ret3708.base, #t~ret3708.offset := external_allocated_data();
    ~tmp___100~4912.base, ~tmp___100~4912.offset := #t~ret3708.base, #t~ret3708.offset;
    havoc #t~ret3708.base, #t~ret3708.offset;
    ~ldv_16_container_struct_sk_buff_ptr.base, ~ldv_16_container_struct_sk_buff_ptr.offset := ~tmp___100~4912.base, ~tmp___100~4912.offset;
    call #t~ret3709.base, #t~ret3709.offset := external_allocated_data();
    ~tmp___101~4912.base, ~tmp___101~4912.offset := #t~ret3709.base, #t~ret3709.offset;
    havoc #t~ret3709.base, #t~ret3709.offset;
    ~ldv_16_ldv_param_11_2_default.base, ~ldv_16_ldv_param_11_2_default.offset := ~tmp___101~4912.base, ~tmp___101~4912.offset;
    call #t~ret3710.base, #t~ret3710.offset := external_allocated_data();
    ~tmp___102~4912.base, ~tmp___102~4912.offset := #t~ret3710.base, #t~ret3710.offset;
    havoc #t~ret3710.base, #t~ret3710.offset;
    ~ldv_16_ldv_param_17_2_default.base, ~ldv_16_ldv_param_17_2_default.offset := ~tmp___102~4912.base, ~tmp___102~4912.offset;
    call #t~ret3711.base, #t~ret3711.offset := external_allocated_data();
    ~tmp___103~4912.base, ~tmp___103~4912.offset := #t~ret3711.base, #t~ret3711.offset;
    havoc #t~ret3711.base, #t~ret3711.offset;
    ~ldv_16_ldv_param_7_2_default.base, ~ldv_16_ldv_param_7_2_default.offset := ~tmp___103~4912.base, ~tmp___103~4912.offset;
    call #t~ret3712.base, #t~ret3712.offset := external_allocated_data();
    ~tmp___104~4912.base, ~tmp___104~4912.offset := #t~ret3712.base, #t~ret3712.offset;
    havoc #t~ret3712.base, #t~ret3712.offset;
    ~ldv_17_ldv_param_21_3_default.base, ~ldv_17_ldv_param_21_3_default.offset := ~tmp___104~4912.base, ~tmp___104~4912.offset;
    call #t~ret3713.base, #t~ret3713.offset := external_allocated_data();
    ~tmp___105~4912.base, ~tmp___105~4912.offset := #t~ret3713.base, #t~ret3713.offset;
    havoc #t~ret3713.base, #t~ret3713.offset;
    ~ldv_17_ldv_param_24_4_default.base, ~ldv_17_ldv_param_24_4_default.offset := ~tmp___105~4912.base, ~tmp___105~4912.offset;
    call #t~ret3714.base, #t~ret3714.offset := external_allocated_data();
    ~tmp___106~4912.base, ~tmp___106~4912.offset := #t~ret3714.base, #t~ret3714.offset;
    havoc #t~ret3714.base, #t~ret3714.offset;
    ~ldv_17_ldv_param_27_2_default.base, ~ldv_17_ldv_param_27_2_default.offset := ~tmp___106~4912.base, ~tmp___106~4912.offset;
    call #t~ret3715.base, #t~ret3715.offset := external_allocated_data();
    ~tmp___107~4912.base, ~tmp___107~4912.offset := #t~ret3715.base, #t~ret3715.offset;
    havoc #t~ret3715.base, #t~ret3715.offset;
    ~ldv_17_ldv_param_4_4_default.base, ~ldv_17_ldv_param_4_4_default.offset := ~tmp___107~4912.base, ~tmp___107~4912.offset;
    call #t~ret3716.base, #t~ret3716.offset := external_allocated_data();
    ~tmp___108~4912.base, ~tmp___108~4912.offset := #t~ret3716.base, #t~ret3716.offset;
    havoc #t~ret3716.base, #t~ret3716.offset;
    ~ldv_17_resource_struct_cfg80211_chan_def_ptr.base, ~ldv_17_resource_struct_cfg80211_chan_def_ptr.offset := ~tmp___108~4912.base, ~tmp___108~4912.offset;
    call #t~ret3717.base, #t~ret3717.offset := external_allocated_data();
    ~tmp___109~4912.base, ~tmp___109~4912.offset := #t~ret3717.base, #t~ret3717.offset;
    havoc #t~ret3717.base, #t~ret3717.offset;
    ~ldv_17_resource_struct_cfg80211_connect_params_ptr.base, ~ldv_17_resource_struct_cfg80211_connect_params_ptr.offset := ~tmp___109~4912.base, ~tmp___109~4912.offset;
    call #t~ret3718.base, #t~ret3718.offset := external_allocated_data();
    ~tmp___110~4912.base, ~tmp___110~4912.offset := #t~ret3718.base, #t~ret3718.offset;
    havoc #t~ret3718.base, #t~ret3718.offset;
    ~ldv_17_resource_struct_cfg80211_ibss_params_ptr.base, ~ldv_17_resource_struct_cfg80211_ibss_params_ptr.offset := ~tmp___110~4912.base, ~tmp___110~4912.offset;
    call #t~ret3719.base, #t~ret3719.offset := external_allocated_data();
    ~tmp___111~4912.base, ~tmp___111~4912.offset := #t~ret3719.base, #t~ret3719.offset;
    havoc #t~ret3719.base, #t~ret3719.offset;
    ~ldv_17_resource_struct_cfg80211_scan_request_ptr.base, ~ldv_17_resource_struct_cfg80211_scan_request_ptr.offset := ~tmp___111~4912.base, ~tmp___111~4912.offset;
    call #t~ret3720.base, #t~ret3720.offset := external_allocated_data();
    ~tmp___112~4912.base, ~tmp___112~4912.offset := #t~ret3720.base, #t~ret3720.offset;
    havoc #t~ret3720.base, #t~ret3720.offset;
    ~ldv_17_resource_struct_ieee80211_channel_ptr.base, ~ldv_17_resource_struct_ieee80211_channel_ptr.offset := ~tmp___112~4912.base, ~tmp___112~4912.offset;
    call #t~ret3721.base, #t~ret3721.offset := external_allocated_data();
    ~tmp___113~4912.base, ~tmp___113~4912.offset := #t~ret3721.base, #t~ret3721.offset;
    havoc #t~ret3721.base, #t~ret3721.offset;
    ~ldv_17_resource_struct_key_params_ptr.base, ~ldv_17_resource_struct_key_params_ptr.offset := ~tmp___113~4912.base, ~tmp___113~4912.offset;
    call #t~ret3722.base, #t~ret3722.offset := external_allocated_data();
    ~tmp___114~4912.base, ~tmp___114~4912.offset := #t~ret3722.base, #t~ret3722.offset;
    havoc #t~ret3722.base, #t~ret3722.offset;
    ~ldv_17_resource_struct_net_device_ptr.base, ~ldv_17_resource_struct_net_device_ptr.offset := ~tmp___114~4912.base, ~tmp___114~4912.offset;
    call #t~ret3723.base, #t~ret3723.offset := external_allocated_data();
    ~tmp___115~4912.base, ~tmp___115~4912.offset := #t~ret3723.base, #t~ret3723.offset;
    havoc #t~ret3723.base, #t~ret3723.offset;
    ~ldv_17_resource_struct_station_info_ptr.base, ~ldv_17_resource_struct_station_info_ptr.offset := ~tmp___115~4912.base, ~tmp___115~4912.offset;
    call #t~ret3724.base, #t~ret3724.offset := external_allocated_data();
    ~tmp___116~4912.base, ~tmp___116~4912.offset := #t~ret3724.base, #t~ret3724.offset;
    havoc #t~ret3724.base, #t~ret3724.offset;
    ~ldv_17_resource_struct_vif_params_ptr.base, ~ldv_17_resource_struct_vif_params_ptr.offset := ~tmp___116~4912.base, ~tmp___116~4912.offset;
    call #t~ret3725.base, #t~ret3725.offset := external_allocated_data();
    ~tmp___117~4912.base, ~tmp___117~4912.offset := #t~ret3725.base, #t~ret3725.offset;
    havoc #t~ret3725.base, #t~ret3725.offset;
    ~ldv_17_resource_struct_wiphy_ptr.base, ~ldv_17_resource_struct_wiphy_ptr.offset := ~tmp___117~4912.base, ~tmp___117~4912.offset;
    call #t~ret3726.base, #t~ret3726.offset := external_allocated_data();
    ~tmp___118~4912.base, ~tmp___118~4912.offset := #t~ret3726.base, #t~ret3726.offset;
    havoc #t~ret3726.base, #t~ret3726.offset;
    ~ldv_18_container_struct_device_ptr.base, ~ldv_18_container_struct_device_ptr.offset := ~tmp___118~4912.base, ~tmp___118~4912.offset;
    call #t~ret3727.base, #t~ret3727.offset := external_allocated_data();
    ~tmp___119~4912.base, ~tmp___119~4912.offset := #t~ret3727.base, #t~ret3727.offset;
    havoc #t~ret3727.base, #t~ret3727.offset;
    ~ldv_18_ldv_param_3_2_default.base, ~ldv_18_ldv_param_3_2_default.offset := ~tmp___119~4912.base, ~tmp___119~4912.offset;
    call #t~ret3728.base, #t~ret3728.offset := external_allocated_data();
    ~tmp___120~4912.base, ~tmp___120~4912.offset := #t~ret3728.base, #t~ret3728.offset;
    havoc #t~ret3728.base, #t~ret3728.offset;
    ~ldv_18_ldv_param_9_2_default.base, ~ldv_18_ldv_param_9_2_default.offset := ~tmp___120~4912.base, ~tmp___120~4912.offset;
    call #t~ret3729.base, #t~ret3729.offset := external_allocated_data();
    ~tmp___121~4912.base, ~tmp___121~4912.offset := #t~ret3729.base, #t~ret3729.offset;
    havoc #t~ret3729.base, #t~ret3729.offset;
    ~ldv_19_container_struct_device_ptr.base, ~ldv_19_container_struct_device_ptr.offset := ~tmp___121~4912.base, ~tmp___121~4912.offset;
    call #t~ret3730.base, #t~ret3730.offset := external_allocated_data();
    ~tmp___122~4912.base, ~tmp___122~4912.offset := #t~ret3730.base, #t~ret3730.offset;
    havoc #t~ret3730.base, #t~ret3730.offset;
    ~ldv_19_ldv_param_3_2_default.base, ~ldv_19_ldv_param_3_2_default.offset := ~tmp___122~4912.base, ~tmp___122~4912.offset;
    call #t~ret3731.base, #t~ret3731.offset := external_allocated_data();
    ~tmp___123~4912.base, ~tmp___123~4912.offset := #t~ret3731.base, #t~ret3731.offset;
    havoc #t~ret3731.base, #t~ret3731.offset;
    ~ldv_19_ldv_param_9_2_default.base, ~ldv_19_ldv_param_9_2_default.offset := ~tmp___123~4912.base, ~tmp___123~4912.offset;
    call #t~ret3732.base, #t~ret3732.offset := external_allocated_data();
    ~tmp___124~4912.base, ~tmp___124~4912.offset := #t~ret3732.base, #t~ret3732.offset;
    havoc #t~ret3732.base, #t~ret3732.offset;
    ~ldv_20_container_struct_device_ptr.base, ~ldv_20_container_struct_device_ptr.offset := ~tmp___124~4912.base, ~tmp___124~4912.offset;
    call #t~ret3733.base, #t~ret3733.offset := external_allocated_data();
    ~tmp___125~4912.base, ~tmp___125~4912.offset := #t~ret3733.base, #t~ret3733.offset;
    havoc #t~ret3733.base, #t~ret3733.offset;
    ~ldv_20_ldv_param_3_2_default.base, ~ldv_20_ldv_param_3_2_default.offset := ~tmp___125~4912.base, ~tmp___125~4912.offset;
    call #t~ret3734.base, #t~ret3734.offset := external_allocated_data();
    ~tmp___126~4912.base, ~tmp___126~4912.offset := #t~ret3734.base, #t~ret3734.offset;
    havoc #t~ret3734.base, #t~ret3734.offset;
    ~ldv_20_ldv_param_9_2_default.base, ~ldv_20_ldv_param_9_2_default.offset := ~tmp___126~4912.base, ~tmp___126~4912.offset;
    call #t~ret3735.base, #t~ret3735.offset := external_allocated_data();
    ~tmp___127~4912.base, ~tmp___127~4912.offset := #t~ret3735.base, #t~ret3735.offset;
    havoc #t~ret3735.base, #t~ret3735.offset;
    ~ldv_21_container_struct_device_ptr.base, ~ldv_21_container_struct_device_ptr.offset := ~tmp___127~4912.base, ~tmp___127~4912.offset;
    call #t~ret3736.base, #t~ret3736.offset := external_allocated_data();
    ~tmp___128~4912.base, ~tmp___128~4912.offset := #t~ret3736.base, #t~ret3736.offset;
    havoc #t~ret3736.base, #t~ret3736.offset;
    ~ldv_21_ldv_param_3_2_default.base, ~ldv_21_ldv_param_3_2_default.offset := ~tmp___128~4912.base, ~tmp___128~4912.offset;
    call #t~ret3737.base, #t~ret3737.offset := external_allocated_data();
    ~tmp___129~4912.base, ~tmp___129~4912.offset := #t~ret3737.base, #t~ret3737.offset;
    havoc #t~ret3737.base, #t~ret3737.offset;
    ~ldv_21_ldv_param_9_2_default.base, ~ldv_21_ldv_param_9_2_default.offset := ~tmp___129~4912.base, ~tmp___129~4912.offset;
    call #t~ret3738.base, #t~ret3738.offset := external_allocated_data();
    ~tmp___130~4912.base, ~tmp___130~4912.offset := #t~ret3738.base, #t~ret3738.offset;
    havoc #t~ret3738.base, #t~ret3738.offset;
    ~ldv_22_container_struct_device_ptr.base, ~ldv_22_container_struct_device_ptr.offset := ~tmp___130~4912.base, ~tmp___130~4912.offset;
    call #t~ret3739.base, #t~ret3739.offset := external_allocated_data();
    ~tmp___131~4912.base, ~tmp___131~4912.offset := #t~ret3739.base, #t~ret3739.offset;
    havoc #t~ret3739.base, #t~ret3739.offset;
    ~ldv_22_ldv_param_3_2_default.base, ~ldv_22_ldv_param_3_2_default.offset := ~tmp___131~4912.base, ~tmp___131~4912.offset;
    call #t~ret3740.base, #t~ret3740.offset := external_allocated_data();
    ~tmp___132~4912.base, ~tmp___132~4912.offset := #t~ret3740.base, #t~ret3740.offset;
    havoc #t~ret3740.base, #t~ret3740.offset;
    ~ldv_22_ldv_param_9_2_default.base, ~ldv_22_ldv_param_9_2_default.offset := ~tmp___132~4912.base, ~tmp___132~4912.offset;
    call #t~ret3741.base, #t~ret3741.offset := external_allocated_data();
    ~tmp___133~4912.base, ~tmp___133~4912.offset := #t~ret3741.base, #t~ret3741.offset;
    havoc #t~ret3741.base, #t~ret3741.offset;
    ~ldv_23_container_struct_device_ptr.base, ~ldv_23_container_struct_device_ptr.offset := ~tmp___133~4912.base, ~tmp___133~4912.offset;
    call #t~ret3742.base, #t~ret3742.offset := external_allocated_data();
    ~tmp___134~4912.base, ~tmp___134~4912.offset := #t~ret3742.base, #t~ret3742.offset;
    havoc #t~ret3742.base, #t~ret3742.offset;
    ~ldv_23_ldv_param_3_2_default.base, ~ldv_23_ldv_param_3_2_default.offset := ~tmp___134~4912.base, ~tmp___134~4912.offset;
    call #t~ret3743.base, #t~ret3743.offset := external_allocated_data();
    ~tmp___135~4912.base, ~tmp___135~4912.offset := #t~ret3743.base, #t~ret3743.offset;
    havoc #t~ret3743.base, #t~ret3743.offset;
    ~ldv_23_ldv_param_9_2_default.base, ~ldv_23_ldv_param_9_2_default.offset := ~tmp___135~4912.base, ~tmp___135~4912.offset;
    call #t~ret3744.base, #t~ret3744.offset := external_allocated_data();
    ~tmp___136~4912.base, ~tmp___136~4912.offset := #t~ret3744.base, #t~ret3744.offset;
    havoc #t~ret3744.base, #t~ret3744.offset;
    ~ldv_24_container_struct_device_ptr.base, ~ldv_24_container_struct_device_ptr.offset := ~tmp___136~4912.base, ~tmp___136~4912.offset;
    call #t~ret3745.base, #t~ret3745.offset := external_allocated_data();
    ~tmp___137~4912.base, ~tmp___137~4912.offset := #t~ret3745.base, #t~ret3745.offset;
    havoc #t~ret3745.base, #t~ret3745.offset;
    ~ldv_24_ldv_param_3_2_default.base, ~ldv_24_ldv_param_3_2_default.offset := ~tmp___137~4912.base, ~tmp___137~4912.offset;
    call #t~ret3746.base, #t~ret3746.offset := external_allocated_data();
    ~tmp___138~4912.base, ~tmp___138~4912.offset := #t~ret3746.base, #t~ret3746.offset;
    havoc #t~ret3746.base, #t~ret3746.offset;
    ~ldv_24_ldv_param_9_2_default.base, ~ldv_24_ldv_param_9_2_default.offset := ~tmp___138~4912.base, ~tmp___138~4912.offset;
    call #t~ret3747.base, #t~ret3747.offset := external_allocated_data();
    ~tmp___139~4912.base, ~tmp___139~4912.offset := #t~ret3747.base, #t~ret3747.offset;
    havoc #t~ret3747.base, #t~ret3747.offset;
    ~ldv_25_container_struct_device_ptr.base, ~ldv_25_container_struct_device_ptr.offset := ~tmp___139~4912.base, ~tmp___139~4912.offset;
    call #t~ret3748.base, #t~ret3748.offset := external_allocated_data();
    ~tmp___140~4912.base, ~tmp___140~4912.offset := #t~ret3748.base, #t~ret3748.offset;
    havoc #t~ret3748.base, #t~ret3748.offset;
    ~ldv_25_ldv_param_3_2_default.base, ~ldv_25_ldv_param_3_2_default.offset := ~tmp___140~4912.base, ~tmp___140~4912.offset;
    call #t~ret3749.base, #t~ret3749.offset := external_allocated_data();
    ~tmp___141~4912.base, ~tmp___141~4912.offset := #t~ret3749.base, #t~ret3749.offset;
    havoc #t~ret3749.base, #t~ret3749.offset;
    ~ldv_25_ldv_param_9_2_default.base, ~ldv_25_ldv_param_9_2_default.offset := ~tmp___141~4912.base, ~tmp___141~4912.offset;
    call #t~ret3750.base, #t~ret3750.offset := external_allocated_data();
    ~tmp___142~4912.base, ~tmp___142~4912.offset := #t~ret3750.base, #t~ret3750.offset;
    havoc #t~ret3750.base, #t~ret3750.offset;
    ~ldv_26_container_struct_device_ptr.base, ~ldv_26_container_struct_device_ptr.offset := ~tmp___142~4912.base, ~tmp___142~4912.offset;
    call #t~ret3751.base, #t~ret3751.offset := external_allocated_data();
    ~tmp___143~4912.base, ~tmp___143~4912.offset := #t~ret3751.base, #t~ret3751.offset;
    havoc #t~ret3751.base, #t~ret3751.offset;
    ~ldv_26_ldv_param_3_2_default.base, ~ldv_26_ldv_param_3_2_default.offset := ~tmp___143~4912.base, ~tmp___143~4912.offset;
    call #t~ret3752.base, #t~ret3752.offset := external_allocated_data();
    ~tmp___144~4912.base, ~tmp___144~4912.offset := #t~ret3752.base, #t~ret3752.offset;
    havoc #t~ret3752.base, #t~ret3752.offset;
    ~ldv_26_ldv_param_9_2_default.base, ~ldv_26_ldv_param_9_2_default.offset := ~tmp___144~4912.base, ~tmp___144~4912.offset;
    call #t~ret3753.base, #t~ret3753.offset := external_allocated_data();
    ~tmp___145~4912.base, ~tmp___145~4912.offset := #t~ret3753.base, #t~ret3753.offset;
    havoc #t~ret3753.base, #t~ret3753.offset;
    ~ldv_27_container_struct_device_ptr.base, ~ldv_27_container_struct_device_ptr.offset := ~tmp___145~4912.base, ~tmp___145~4912.offset;
    call #t~ret3754.base, #t~ret3754.offset := external_allocated_data();
    ~tmp___146~4912.base, ~tmp___146~4912.offset := #t~ret3754.base, #t~ret3754.offset;
    havoc #t~ret3754.base, #t~ret3754.offset;
    ~ldv_27_ldv_param_3_2_default.base, ~ldv_27_ldv_param_3_2_default.offset := ~tmp___146~4912.base, ~tmp___146~4912.offset;
    call #t~ret3755.base, #t~ret3755.offset := external_allocated_data();
    ~tmp___147~4912.base, ~tmp___147~4912.offset := #t~ret3755.base, #t~ret3755.offset;
    havoc #t~ret3755.base, #t~ret3755.offset;
    ~ldv_27_ldv_param_9_2_default.base, ~ldv_27_ldv_param_9_2_default.offset := ~tmp___147~4912.base, ~tmp___147~4912.offset;
    call #t~ret3756.base, #t~ret3756.offset := external_allocated_data();
    ~tmp___148~4912.base, ~tmp___148~4912.offset := #t~ret3756.base, #t~ret3756.offset;
    havoc #t~ret3756.base, #t~ret3756.offset;
    ~ldv_28_container_timer_list.base, ~ldv_28_container_timer_list.offset := ~tmp___148~4912.base, ~tmp___148~4912.offset;
    assume true;
    return;
}
...
procedure wake_up_process(#in~2947.base : int, #in~2947.offset : int) returns (#res : int);
modifies ;
...
procedure generic_file_llseek(#in~2184.base : int, #in~2184.offset : int, #in~2185 : int, #in~2186 : int) returns (#res : ~loff_t);
modifies ;
...
procedure sprintf(#in~2166.base : int, #in~2166.offset : int, #in~2167.base : int, #in~2167.offset : int) returns (#res : int);
modifies ;

procedure strlen(#in~4139.base : int, #in~4139.offset : int) returns (#res : int);
modifies ;

procedure memcmp(#in~22.base : int, #in~22.offset : int, #in~23.base : int, #in~23.offset : int, #in~24 : int) returns (#res : int);
modifies ;

procedure _raw_spin_unlock_irq(#in~2922.base : int, #in~2922.offset : int) returns ();
modifies ;

procedure strlcpy(#in~2843.base : int, #in~2843.offset : int, #in~2844.base : int, #in~2844.offset : int, #in~2845 : int) returns (#res : int);
modifies ;

procedure eth_validate_addr(#in~2960.base : int, #in~2960.offset : int) returns (#res : int);
modifies ;

procedure netif_rx(#in~3809.base : int, #in~3809.offset : int) returns (#res : int);
modifies ;

procedure _raw_spin_unlock_bh(#in~2921.base : int, #in~2921.offset : int) returns ();
modifies ;
...
procedure strstr(#in~2175.base : int, #in~2175.offset : int, #in~2176.base : int, #in~2176.offset : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure netif_rx_ni(#in~3810.base : int, #in~3810.offset : int) returns (#res : int);
modifies ;
...
procedure netif_device_attach(#in~2950.base : int, #in~2950.offset : int) returns ();
modifies ;

procedure debugfs_remove(#in~2211.base : int, #in~2211.offset : int) returns ();
modifies ;

procedure ldv_del_timer_sync(#in~3600 : int, #in~3601.base : int, #in~3601.offset : int) returns (#res : int);
modifies ;

procedure cfg80211_scan_done(#in~128.base : int, #in~128.offset : int, #in~129 : int) returns ();
modifies ;

procedure cancel_work_sync(#in~2944.base : int, #in~2944.offset : int) returns (#res : ~bool);
modifies ;

procedure debugfs_create_dir(#in~2209.base : int, #in~2209.offset : int, #in~2210.base : int, #in~2210.offset : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure netif_device_detach(#in~2949.base : int, #in~2949.offset : int) returns ();
modifies ;

procedure eth_change_mtu(#in~2958.base : int, #in~2958.offset : int, #in~2959 : int) returns (#res : int);
modifies ;
...
procedure _copy_from_user(#in~2197.base : int, #in~2197.offset : int, #in~2198.base : int, #in~2198.offset : int, #in~2199 : int) returns (#res : int);
modifies ;

procedure simple_strtoul(#in~2163.base : int, #in~2163.offset : int, #in~2164.base : int, #in~2164.offset : int, #in~2165 : int) returns (#res : int);
modifies ;

procedure ldv_unregister_netdev(#in~3604.base : int, #in~3604.offset : int, #in~3605.base : int, #in~3605.offset : int) returns ();
modifies ;

procedure __raw_spin_lock_init(#in~2916.base : int, #in~2916.offset : int, #in~2917.base : int, #in~2917.offset : int, #in~2918.base : int, #in~2918.offset : int) returns ();
modifies ;

procedure sysfs_create_group(#in~4140.base : int, #in~4140.offset : int, #in~4141.base : int, #in~4141.offset : int) returns (#res : int);
modifies ;
...
procedure ldv_after_alloc(#in~4648.base : int, #in~4648.offset : int) returns ();
modifies ;
...
procedure ldv_check_alloc_flags(#in~4647 : int) returns ();
modifies ;
...
procedure malloc(#in~4650 : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure __kfifo_alloc(#in~2966.base : int, #in~2966.offset : int, #in~2967 : int, #in~2968 : int, #in~2969 : int) returns (#res : int);
modifies ;
...
procedure __const_udelay(#in~2180 : int) returns ();
modifies ;
...
procedure kthread_stop(#in~2965.base : int, #in~2965.offset : int) returns (#res : int);
modifies ;
...
procedure kthread_create_on_node(#in~2961.base : int, #in~2961.offset : int, #in~2962.base : int, #in~2962.offset : int, #in~2963 : int, #in~2964.base : int, #in~2964.offset : int) returns (#res.base : int, #res.offset : int);
modifies ;
...
procedure __kfifo_out(#in~2974.base : int, #in~2974.offset : int, #in~2975.base : int, #in~2975.offset : int, #in~2976 : int) returns (#res : int);
modifies ;

procedure ldv_free_netdev(#in~3602.base : int, #in~3602.offset : int, #in~3603.base : int, #in~3603.offset : int) returns ();
modifies ;

procedure request_firmware(#in~4043.base : int, #in~4043.offset : int, #in~4044.base : int, #in~4044.offset : int, #in~4045.base : int, #in~4045.offset : int) returns (#res : int);
modifies ;
...
procedure kstrtoull(#in~4135.base : int, #in~4135.offset : int, #in~4136 : int, #in~4137.base : int, #in~4137.offset : int) returns (#res : int);
modifies ;

procedure _raw_spin_lock_bh(#in~2919.base : int, #in~2919.offset : int) returns ();
modifies ;

procedure strchr(#in~2173.base : int, #in~2173.offset : int, #in~2174 : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure remove_wait_queue(#in~2932.base : int, #in~2932.offset : int, #in~2933.base : int, #in~2933.offset : int) returns ();
modifies ;

procedure cancel_delayed_work_sync(#in~74.base : int, #in~74.offset : int) returns (#res : ~bool);
modifies ;

procedure skb_push(#in~3803.base : int, #in~3803.offset : int, #in~3804 : int) returns (#res.base : int, #res.offset : int);
modifies ;
...
procedure destroy_workqueue(#in~2940.base : int, #in~2940.offset : int) returns ();
modifies ;

procedure sscanf(#in~2171.base : int, #in~2171.offset : int, #in~2172.base : int, #in~2172.offset : int) returns (#res : int);
modifies ;
...
procedure pskb_expand_head(#in~3799.base : int, #in~3799.offset : int, #in~3800 : int, #in~3801 : int, #in~3802 : int) returns (#res : int);
modifies ;
...
procedure device_create_file(#in~4144.base : int, #in~4144.offset : int, #in~4145.base : int, #in~4145.offset : int) returns (#res : int);
modifies ;

procedure C.free(#in~4653.base : int, #in~4653.offset : int) returns ();
modifies ;

procedure alloc_netdev_mqs(#in~2952 : int, #in~2953.base : int, #in~2953.offset : int, #in~2954.base : int, #in~2954.offset : int, #in~2955 : int, #in~2956 : int) returns (#res.base : int, #res.offset : int);
modifies ;
...
procedure del_timer(#in~1943.base : int, #in~1943.offset : int) returns (#res : int);
modifies ;

procedure msleep_interruptible(#in~1944 : int) returns (#res : int);
modifies ;

procedure __kfifo_free(#in~2970.base : int, #in~2970.offset : int) returns ();
modifies ;

procedure __netif_schedule(#in~81.base : int, #in~81.offset : int) returns ();
modifies ;

procedure __kmalloc(#in~2194 : int, #in~2195 : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure consume_skb(#in~3798.base : int, #in~3798.offset : int) returns ();
modifies ;
...
procedure calloc(#in~4651 : int, #in~4652 : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure kfree_skb(#in~1945.base : int, #in~1945.offset : int) returns ();
modifies ;

procedure dev_err(#in~76.base : int, #in~76.offset : int, #in~77.base : int, #in~77.offset : int) returns (#res : int);
modifies ;

procedure __mutex_init(#in~2913.base : int, #in~2913.offset : int, #in~2914.base : int, #in~2914.offset : int, #in~2915.base : int, #in~2915.offset : int) returns ();
modifies ;

procedure queue_work_on(#in~2941 : int, #in~2942.base : int, #in~2942.offset : int, #in~2943.base : int, #in~2943.offset : int) returns (#res : ~bool);
modifies ;
...
procedure add_wait_queue(#in~2930.base : int, #in~2930.offset : int, #in~2931.base : int, #in~2931.offset : int) returns ();
modifies ;

procedure simple_read_from_buffer(#in~2189.base : int, #in~2189.offset : int, #in~2190 : int, #in~2191.base : int, #in~2191.offset : int, #in~2192.base : int, #in~2192.offset : int, #in~2193 : int) returns (#res : int);
modifies ;
...
procedure release_firmware(#in~4053.base : int, #in~4053.offset : int) returns ();
modifies ;

procedure free_pages(#in~2178 : int, #in~2179 : int) returns ();
modifies ;

procedure __kfifo_in(#in~2971.base : int, #in~2971.offset : int, #in~2972.base : int, #in~2972.offset : int, #in~2973 : int) returns (#res : int);
modifies ;

procedure __dev_kfree_skb_any(#in~3937.base : int, #in~3937.offset : int, #in~3938 : int) returns ();
modifies ;
...
procedure strcpy(#in~2911.base : int, #in~2911.offset : int, #in~2912.base : int, #in~2912.offset : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure get_zeroed_page(#in~2177 : int) returns (#res : int);
modifies ;
...
procedure __alloc_workqueue_key(#in~2935.base : int, #in~2935.offset : int, #in~2936 : int, #in~2937 : int, #in~2938.base : int, #in~2938.offset : int, #in~2939.base : int, #in~2939.offset : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure free_netdev(#in~2948.base : int, #in~2948.offset : int) returns ();
modifies ;

procedure del_timer_sync(#in~2934.base : int, #in~2934.offset : int) returns (#res : int);
modifies ;

procedure sysfs_remove_group(#in~4142.base : int, #in~4142.offset : int, #in~4143.base : int, #in~4143.offset : int) returns ();
modifies ;

procedure kfree(#in~79.base : int, #in~79.offset : int) returns ();
modifies ;

procedure ether_setup(#in~2951.base : int, #in~2951.offset : int) returns ();
modifies ;

procedure debugfs_create_file(#in~2204.base : int, #in~2204.offset : int, #in~2205 : int, #in~2206.base : int, #in~2206.offset : int, #in~2207.base : int, #in~2207.offset : int, #in~2208.base : int, #in~2208.offset : int) returns (#res.base : int, #res.offset : int);
modifies ;
...
procedure skb_pull(#in~3805.base : int, #in~3805.offset : int, #in~3806 : int) returns (#res.base : int, #res.offset : int);
modifies ;

procedure __VERIFIER_error() returns ();
modifies ;

procedure eth_type_trans(#in~3811.base : int, #in~3811.offset : int, #in~3812.base : int, #in~3812.offset : int) returns (#res : ~__be16);
modifies ;
...
procedure request_firmware_nowait(#in~4046.base : int, #in~4046.offset : int, #in~4047 : int, #in~4048.base : int, #in~4048.offset : int, #in~4049.base : int, #in~4049.offset : int, #in~4050 : int, #in~4051.base : int, #in~4051.offset : int, #in~4052.base : int, #in~4052.offset : int) returns (#res : int);
modifies ;
...
procedure default_llseek(#in~2181.base : int, #in~2181.offset : int, #in~2182 : int, #in~2183 : int) returns (#res : ~loff_t);
modifies ;

procedure default_wake_function(#in~2923.base : int, #in~2923.offset : int, #in~2924 : int, #in~2925 : int, #in~2926.base : int, #in~2926.offset : int) returns (#res : int);
modifies ;
...
procedure _raw_spin_lock_irq(#in~2920.base : int, #in~2920.offset : int) returns ();
modifies ;

procedure simple_open(#in~2187.base : int, #in~2187.offset : int, #in~2188.base : int, #in~2188.offset : int) returns (#res : int);
modifies ;

procedure snprintf(#in~2168.base : int, #in~2168.offset : int, #in~2169 : int, #in~2170.base : int, #in~2170.offset : int) returns (#res : int);
modifies ;
...
procedure unregister_netdev(#in~2957.base : int, #in~2957.offset : int) returns ();
modifies ;

procedure netpoll_trap() returns (#res : int);
modifies ;

procedure device_remove_file(#in~4146.base : int, #in~4146.offset : int, #in~4147.base : int, #in~4147.offset : int) returns ();
modifies ;
