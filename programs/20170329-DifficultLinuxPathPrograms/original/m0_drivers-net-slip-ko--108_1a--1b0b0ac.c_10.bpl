...
implementation main() returns (#res : int){
  ...
  loc3:
    ...
    call #t~ret603 := slip_init();
    assume -2147483648 <= #t~ret603 && #t~ret603 <= 2147483647;
    ~tmp~496 := #t~ret603;
    havoc #t~ret603;
    assume !(~tmp~496 != 0);
    assume -2147483648 <= #t~nondet617 && #t~nondet617 <= 2147483647;
    ~tmp___1~496 := #t~nondet617;
    havoc #t~nondet617;
    ...
    ~tmp___0~496 := #t~nondet604;
    havoc #t~nondet604;
    #t~switch605 := ~tmp___0~496 == 0;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 1;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 2;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 3;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 4;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 5;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 6;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 7;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 8;
    assume !#t~switch605;
    #t~switch605 := #t~switch605 || ~tmp___0~496 == 9;
    assume #t~switch605;
    assume ~ldv_s_sl_ldisc_tty_ldisc_ops~496 == 0;
    call ldv_handler_precall();
    call #t~ret613 := ldv_slip_open_3(~var_group5~496.base, ~var_group5~496.offset);
    return;
}
...
implementation ULTIMATE.init() returns (){
  ...
  loc6:
    ...
    call #t~nondet546.base, #t~nondet546.offset := #Ultimate.alloc(5);
    #memory_int := #memory_int[#t~nondet546.base,#t~nondet546.offset + 0 := 115];
    #memory_int := #memory_int[#t~nondet546.base,#t~nondet546.offset + 1 := 108];
    #memory_int := #memory_int[#t~nondet546.base,#t~nondet546.offset + 2 := 105];
    #memory_int := #memory_int[#t~nondet546.base,#t~nondet546.offset + 3 := 112];
    #memory_int := #memory_int[#t~nondet546.base,#t~nondet546.offset + 4 := 0];
    call write~$Pointer$(#t~nondet546.base, #t~nondet546.offset, ~#sl_ldisc.base, ~#sl_ldisc.offset + 4, 8);
...
implementation ldv_slip_open_3(#in~tty.base : int, #in~tty.offset : int) returns (#res : int){
  ...
  loc13:
    ...
    havoc ~tmp~527;
    call #t~ret622 := slip_open(~tty.base, ~tty.offset);
...
implementation slip_init() returns (#res : int){
  ...
  loc15:
    ...
    call #t~nondet547.base, #t~nondet547.offset := #Ultimate.alloc(80);
    call #t~ret548 := printk(#t~nondet547.base, #t~nondet547.offset);
    assume -2147483648 <= #t~ret548 && #t~ret548 <= 2147483647;
    havoc #t~nondet547.base, #t~nondet547.offset;
    havoc #t~ret548;
    call #t~nondet549.base, #t~nondet549.offset := #Ultimate.alloc(73);
    ...
    havoc #t~ret550;
    call #t~nondet551.base, #t~nondet551.offset := #Ultimate.alloc(37);
    ...
    havoc #t~ret552;
    call #t~ret553.base, #t~ret553.offset := kzalloc(~slip_maxdev * 8, 208);
    ~tmp~441.base, ~tmp~441.offset := #t~ret553.base, #t~ret553.offset;
    havoc #t~ret553.base, #t~ret553.offset;
    ~slip_devs.base, ~slip_devs.offset := ~tmp~441.base, ~tmp~441.offset;
    assume !((~slip_devs.base + ~slip_devs.offset) % 18446744073709551616 == 0);
    call #t~ret556 := tty_register_ldisc(1, ~#sl_ldisc.base, ~#sl_ldisc.offset);
...
procedure ldv_check_return_value(#in~602 : int) returns ();
modifies ;
