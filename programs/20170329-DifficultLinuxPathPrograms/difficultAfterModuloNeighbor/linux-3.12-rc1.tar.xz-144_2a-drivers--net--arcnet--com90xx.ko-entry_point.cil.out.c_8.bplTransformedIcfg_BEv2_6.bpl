...
modifies ~dev_counter, ~ldv_irq_data_1_0.base, ~#device.base, #memory_$Pointer$.base, #NULL.offset, ~INTERF_STATE, ~ldv_irq_line_1_1, ~cards.offset, ~ldv_irq_line_1_3, ~ldv_irq_data_1_2.base, ~ldv_state_variable_0, ~usb_dev.base, ~ldv_irq_1_3, ~ldv_irq_data_1_0.offset, ~ldv_retval_0, ~ldv_irq_data_1_1.offset, #length, ~ldv_irq_1_1, ~SERIAL_STATE, ~ldv_irq_data_1_3.offset, ~ref_cnt, ~shmem, ~ldv_irq_data_1_2.offset, ~cards.base, ~io, ~usb_urb.base, ~ldv_irq_data_1_1.base, ~usb_urb.offset, #NULL.base, ~ldv_irq_data_1_3.base, ~ldv_irq_line_1_2, ~usb_dev.offset, ~LDV_IN_INTERRUPT, ~com90xx_skip_probe, ~ldv_state_variable_1, ~irq, #valid, ~ldv_irq_line_1_0, ~ldv_irq_1_2, #memory_int, ~#device.offset, ~numcards, ~ldv_irq_1_0, #memory_$Pointer$.offset;
{
  ...
  loc2_0:
    ...
    assume (com90xx_probe_~shmems~57.offset + com90xx_probe_~shmems~57.base) % 18446744073709551616 == 0 && com90xx_probe_~shmems~57.offset + com90xx_probe_~shmems~57.base < -18446744073709551616;
