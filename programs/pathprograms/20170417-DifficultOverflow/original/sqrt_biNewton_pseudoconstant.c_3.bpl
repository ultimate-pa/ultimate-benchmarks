...
implementation SqrtR(#in~Input : real) returns (#res : real){
  ...
  loc2:
    assume true;
    assume !!(~cond~6 != 0);
    ~hn~7 := ~someBinaryArithmeticDOUBLEoperation(1, ~someBinaryArithmeticDOUBLEoperation(~someBinaryArithmeticDOUBLEoperation(~Input, ~xn~6), ~xn~6));
    ~xnp1~6 := ~someBinaryArithmeticDOUBLEoperation(~xn~6, ~someBinaryArithmeticDOUBLEoperation(~someBinaryArithmeticDOUBLEoperation(~xn~6, ~someBinaryArithmeticDOUBLEoperation(~someBinaryArithmeticDOUBLEoperation(~someBinaryArithmeticDOUBLEoperation(8.0, ~hn~7), ~someBinaryArithmeticDOUBLEoperation(~someBinaryArithmeticDOUBLEoperation(6.0, ~hn~7), ~hn~7)), ~someBinaryArithmeticDOUBLEoperation(~someBinaryArithmeticDOUBLEoperation(~someBinaryArithmeticDOUBLEoperation(5.0, ~hn~7), ~hn~7), ~hn~7))), 16.0));
