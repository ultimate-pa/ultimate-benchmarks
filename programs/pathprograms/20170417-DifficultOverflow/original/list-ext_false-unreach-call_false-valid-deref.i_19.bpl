...
implementation main() returns (#res : int){
  ...
  loc4_1:
    ...
    call #t~malloc12.base, #t~malloc12.offset := #Ultimate.alloc(12);
    ~t~7.base, ~t~7.offset := #t~malloc12.base, #t~malloc12.offset;
    assume !(~t~7.base == 0 && ~t~7.offset == 0);
    call write~$Pointer$(~t~7.base, ~t~7.offset, ~p~7.base, ~p~7.offset + 4, 8);
    call #t~mem14.base, #t~mem14.offset := read~$Pointer$(~p~7.base, ~p~7.offset + 4, 8);
    ~p~7.base, ~p~7.offset := #t~mem14.base, #t~mem14.offset;
