...
implementation main() returns (#res : int){
  ...
  loc9:
    ...
    assume ~__BLAST_NONDET~203 == 3;
    call #t~ret218 := KbFilter_PnP(~#devobj~203.base, ~#devobj~203.offset, ~pirp.base, ~pirp.offset);
    return;
}
...
implementation KbFilter_PnP(#in~DeviceObject.base : int, #in~DeviceObject.offset : int, #in~Irp.base : int, #in~Irp.offset : int) returns (#res : ~NTSTATUS){
    ...
    var #t~memcpy124.base : int, #t~memcpy124.offset : int;
    var #t~mem126.base : int, #t~mem126.offset : int;
    var #t~mem131 : int;
    var #t~mem133 : int;
    var #t~mem135.base : int, #t~mem135.offset : int;
    var #t~ret136 : ~NTSTATUS;
    var #t~ret137 : ~NTSTATUS;
    var #t~mem144 : int;
    var #t~mem146.base : int, #t~mem146.offset : int;
    var #t~mem147.base : int, #t~mem147.offset : int;
    var #t~ret148 : ~NTSTATUS;
    var #t~mem150 : int;
    var #t~mem152.base : int, #t~mem152.offset : int;
    var #t~mem153.base : int, #t~mem153.offset : int;
    var #t~ret154 : ~NTSTATUS;
    var #t~mem155 : int;
    var #t~mem157.base : int, #t~mem157.offset : int;
    var #t~mem158.base : int, #t~mem158.offset : int;
    var #t~ret159 : ~NTSTATUS;
    var ~DeviceObject.base : int, ~DeviceObject.offset : int;
    var ~Irp.base : int, ~Irp.offset : int;
    var ~devExt~105.base : int, ~devExt~105.offset : int;
    var ~irpStack~105.base : int, ~irpStack~105.offset : int;
    var ~status~105 : ~NTSTATUS;
    var ~#event~105.base : int, ~#event~105.offset : int;
    var ~irpSp~105.base : int, ~irpSp~105.offset : int;
    var ~nextIrpSp~105.base : int, ~nextIrpSp~105.offset : int;
    var ~irpSp___0~105.base : int, ~irpSp___0~105.offset : int;

  loc11:
    ~DeviceObject.base, ~DeviceObject.offset := #in~DeviceObject.base, #in~DeviceObject.offset;
    ~Irp.base, ~Irp.offset := #in~Irp.base, #in~Irp.offset;
    havoc ~devExt~105.base, ~devExt~105.offset;
    havoc ~irpStack~105.base, ~irpStack~105.offset;
    havoc ~status~105;
    call ~#event~105.base, ~#event~105.offset := #Ultimate.alloc(28);
    havoc ~irpSp~105.base, ~irpSp~105.offset;
    havoc ~nextIrpSp~105.base, ~nextIrpSp~105.offset;
    havoc ~irpSp___0~105.base, ~irpSp___0~105.offset;
    ~status~105 := 0;
    call #t~mem99.base, #t~mem99.offset := read~$Pointer$(~DeviceObject.base, ~DeviceObject.offset + 76, 8);
    ~devExt~105.base, ~devExt~105.offset := #t~mem99.base, #t~mem99.offset;
    havoc #t~mem99.base, #t~mem99.offset;
    call #t~mem100.base, #t~mem100.offset := read~$Pointer$(~Irp.base, ~Irp.offset + 116 + 0 + 48 + 16 + 0, 8);
    ~irpStack~105.base, ~irpStack~105.offset := #t~mem100.base, #t~mem100.offset;
    havoc #t~mem100.base, #t~mem100.offset;
    call #t~mem101 := read~int(~irpStack~105.base, ~irpStack~105.offset + 1, 1);
    assume !(#t~mem101 % 256 == 0);
    havoc #t~mem101;
    call #t~mem102 := read~int(~irpStack~105.base, ~irpStack~105.offset + 1, 1);
    assume #t~mem102 % 256 == 23;
    havoc #t~mem102;
    call write~int(1, ~devExt~105.base, ~devExt~105.offset + 101, 1);
    assume ~s == ~NP;
    ~s := ~SKIP1;
    call #t~mem144 := read~int(~Irp.base, ~Irp.offset + 63, 1);
    assume !(#t~mem144 + 1 <= 2147483647);
    goto loc12;
  loc12:
    assert false;
}

procedure KbFilter_PnP(#in~DeviceObject.base : int, #in~DeviceObject.offset : int, #in~Irp.base : int, #in~Irp.offset : int) returns (#res : ~NTSTATUS);
modifies #memory_int, ~compRegistered, ~compFptr.base, ~compFptr.offset, #memory_$Pointer$.base, #memory_$Pointer$.offset, ~myStatus, ~s, #valid, #length, ~setEventCalled, ~customIrp, ~lowerDriverReturn;
